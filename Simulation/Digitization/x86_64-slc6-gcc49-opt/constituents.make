...
#cmt_local_tagfile = $(Digitization_tag).make
cmt_local_tagfile = $(bin)$(Digitization_tag).make
...
cmt_Digitizationrchk_has_target_tag = 1

#--------------------------------------

ifdef cmt_Digitizationrchk_has_target_tag

cmt_local_tagfile_Digitizationrchk = $(bin)$(Digitization_tag)_Digitizationrchk.make
cmt_final_setup_Digitizationrchk = $(bin)setup_Digitizationrchk.make
cmt_local_Digitizationrchk_makefile = $(bin)Digitizationrchk.make

Digitizationrchk_extratags = -tag_add=target_Digitizationrchk

else

cmt_local_tagfile_Digitizationrchk = $(bin)$(Digitization_tag).make
cmt_final_setup_Digitizationrchk = $(bin)setup.make
cmt_local_Digitizationrchk_makefile = $(bin)Digitizationrchk.make

endif

not_Digitizationrchk_dependencies = { n=0; for p in $?; do m=0; for d in $(Digitizationrchk_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
Digitizationrchkdirs :
	@if test ! -d $(bin)Digitizationrchk; then $(mkdir) -p $(bin)Digitizationrchk; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)Digitizationrchk
else
Digitizationrchkdirs : ;
endif
...
ifndef QUICK
$(cmt_local_Digitizationrchk_makefile) : $(Digitizationrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building Digitizationrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(Digitizationrchk_extratags) build constituent_config -out=$(cmt_local_Digitizationrchk_makefile) Digitizationrchk
else
$(cmt_local_Digitizationrchk_makefile) : $(Digitizationrchk_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_Digitizationrchk) ] || \
	  [ ! -f $(cmt_final_setup_Digitizationrchk) ] || \
	  $(not_Digitizationrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building Digitizationrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(Digitizationrchk_extratags) build constituent_config -out=$(cmt_local_Digitizationrchk_makefile) Digitizationrchk; \
	  fi
endif
...
$(cmt_local_Digitizationrchk_makefile) : $(Digitizationrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building Digitizationrchk.make"; \
	  $(cmtexe) -f=$(bin)Digitizationrchk.in -tag=$(tags) $(Digitizationrchk_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_Digitizationrchk_makefile) Digitizationrchk
else
$(cmt_local_Digitizationrchk_makefile) : $(Digitizationrchk_dependencies) $(cmt_build_library_linksstamp) $(bin)Digitizationrchk.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_Digitizationrchk) ] || \
	  [ ! -f $(cmt_final_setup_Digitizationrchk) ] || \
	  $(not_Digitizationrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(Digitizationrchk_extratags) build constituent_makefile -out=$(cmt_local_Digitizationrchk_makefile) Digitizationrchk

Digitizationrchk :: $(Digitizationrchk_dependencies) $(cmt_local_Digitizationrchk_makefile) dirs Digitizationrchkdirs
	$(echo) "(constituents.make) Starting Digitizationrchk"
	@if test -f $(cmt_local_Digitizationrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_Digitizationrchk_makefile) Digitizationrchk; \
	  fi
#	@$(MAKE) -f $(cmt_local_Digitizationrchk_makefile) Digitizationrchk
	$(echo) "(constituents.make) Digitizationrchk done"

clean :: Digitizationrchkclean ;

Digitizationrchkclean :: $(Digitizationrchkclean_dependencies) ##$(cmt_local_Digitizationrchk_makefile)
	$(echo) "(constituents.make) Starting Digitizationrchkclean"
	@-if test -f $(cmt_local_Digitizationrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_Digitizationrchk_makefile) Digitizationrchkclean; \
	fi
	$(echo) "(constituents.make) Digitizationrchkclean done"
#	@-$(MAKE) -f $(cmt_local_Digitizationrchk_makefile) Digitizationrchkclean

##	  /bin/rm -f $(cmt_local_Digitizationrchk_makefile) $(bin)Digitizationrchk_dependencies.make

install :: Digitizationrchkinstall ;

Digitizationrchkinstall :: $(Digitizationrchk_dependencies) $(cmt_local_Digitizationrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_Digitizationrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_Digitizationrchk_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_Digitizationrchk_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : Digitizationrchkuninstall

$(foreach d,$(Digitizationrchk_dependencies),$(eval $(d)uninstall_dependencies += Digitizationrchkuninstall))

Digitizationrchkuninstall : $(Digitizationrchkuninstall_dependencies) ##$(cmt_local_Digitizationrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_Digitizationrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_Digitizationrchk_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_Digitizationrchk_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: Digitizationrchkuninstall ;
...
cmt_local_tagfile_install_root_include_path = $(bin)$(Digitization_tag)_install_root_include_path.make
...
cmt_local_tagfile_install_root_include_path = $(bin)$(Digitization_tag).make
...
cmt_local_tagfile_install_includes = $(bin)$(Digitization_tag)_install_includes.make
...
cmt_local_tagfile_install_includes = $(bin)$(Digitization_tag).make
...
cmt_local_tagfile_myctest = $(bin)$(Digitization_tag)_myctest.make
...
cmt_local_tagfile_myctest = $(bin)$(Digitization_tag).make
...
cmt_local_tagfile_make = $(bin)$(Digitization_tag)_make.make
...
cmt_local_tagfile_make = $(bin)$(Digitization_tag).make
...
cmt_local_tagfile_CompilePython = $(bin)$(Digitization_tag)_CompilePython.make
...
cmt_local_tagfile_CompilePython = $(bin)$(Digitization_tag).make
...
cmt_local_tagfile_qmtest_run = $(bin)$(Digitization_tag)_qmtest_run.make
...
cmt_local_tagfile_qmtest_run = $(bin)$(Digitization_tag).make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(Digitization_tag)_qmtest_summarize.make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(Digitization_tag).make
...
cmt_local_tagfile_TestPackage = $(bin)$(Digitization_tag)_TestPackage.make
...
cmt_local_tagfile_TestPackage = $(bin)$(Digitization_tag).make
...
cmt_local_tagfile_TestProject = $(bin)$(Digitization_tag)_TestProject.make
...
cmt_local_tagfile_TestProject = $(bin)$(Digitization_tag).make
...
cmt_local_tagfile_new_rootsys = $(bin)$(Digitization_tag)_new_rootsys.make
...
cmt_local_tagfile_new_rootsys = $(bin)$(Digitization_tag).make
...
cmt_local_tagfile_doxygen = $(bin)$(Digitization_tag)_doxygen.make
...
cmt_local_tagfile_doxygen = $(bin)$(Digitization_tag).make
...
cmt_local_tagfile_post_install = $(bin)$(Digitization_tag)_post_install.make
...
cmt_local_tagfile_post_install = $(bin)$(Digitization_tag).make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(Digitization_tag)_post_merge_rootmap.make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(Digitization_tag).make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(Digitization_tag)_post_merge_genconfdb.make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(Digitization_tag).make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(Digitization_tag)_post_build_tpcnvdb.make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(Digitization_tag).make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(Digitization_tag)_all_post_constituents.make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(Digitization_tag).make
...
cmt_local_tagfile_checkreq = $(bin)$(Digitization_tag)_checkreq.make
...
cmt_local_tagfile_checkreq = $(bin)$(Digitization_tag).make
...
Digitization_validateXML_extratags = -tag_add=target_Digitization_validateXML
...
not_Digitization_validateXML_dependencies = { n=0; for p in $?; do m=0; for d in $(Digitization_validateXML_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
Digitization_validateXMLdirs :
	@if test ! -d $(bin)Digitization_validateXML; then $(mkdir) -p $(bin)Digitization_validateXML; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)Digitization_validateXML
else
Digitization_validateXMLdirs : ;
endif
...
ifndef QUICK
$(cmt_local_Digitization_validateXML_makefile) : $(Digitization_validateXML_dependencies) build_library_links
	$(echo) "(constituents.make) Building Digitization_validateXML.make"; \
	  $(cmtexe) -tag=$(tags) $(Digitization_validateXML_extratags) build constituent_config -out=$(cmt_local_Digitization_validateXML_makefile) Digitization_validateXML
else
$(cmt_local_Digitization_validateXML_makefile) : $(Digitization_validateXML_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_Digitization_validateXML) ] || \
	  [ ! -f $(cmt_final_setup_Digitization_validateXML) ] || \
	  $(not_Digitization_validateXML_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building Digitization_validateXML.make"; \
	  $(cmtexe) -tag=$(tags) $(Digitization_validateXML_extratags) build constituent_config -out=$(cmt_local_Digitization_validateXML_makefile) Digitization_validateXML; \
	  fi
endif
...
$(cmt_local_Digitization_validateXML_makefile) : $(Digitization_validateXML_dependencies) build_library_links
	$(echo) "(constituents.make) Building Digitization_validateXML.make"; \
	  $(cmtexe) -f=$(bin)Digitization_validateXML.in -tag=$(tags) $(Digitization_validateXML_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_Digitization_validateXML_makefile) Digitization_validateXML
else
$(cmt_local_Digitization_validateXML_makefile) : $(Digitization_validateXML_dependencies) $(cmt_build_library_linksstamp) $(bin)Digitization_validateXML.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_Digitization_validateXML) ] || \
	  [ ! -f $(cmt_final_setup_Digitization_validateXML) ] || \
	  $(not_Digitization_validateXML_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(Digitization_validateXML_extratags) build constituent_makefile -out=$(cmt_local_Digitization_validateXML_makefile) Digitization_validateXML

Digitization_validateXML :: $(Digitization_validateXML_dependencies) $(cmt_local_Digitization_validateXML_makefile) dirs Digitization_validateXMLdirs
	$(echo) "(constituents.make) Starting Digitization_validateXML"
	@if test -f $(cmt_local_Digitization_validateXML_makefile); then \
	  $(MAKE) -f $(cmt_local_Digitization_validateXML_makefile) Digitization_validateXML; \
	  fi
#	@$(MAKE) -f $(cmt_local_Digitization_validateXML_makefile) Digitization_validateXML
	$(echo) "(constituents.make) Digitization_validateXML done"

clean :: Digitization_validateXMLclean ;

Digitization_validateXMLclean :: $(Digitization_validateXMLclean_dependencies) ##$(cmt_local_Digitization_validateXML_makefile)
	$(echo) "(constituents.make) Starting Digitization_validateXMLclean"
	@-if test -f $(cmt_local_Digitization_validateXML_makefile); then \
	  $(MAKE) -f $(cmt_local_Digitization_validateXML_makefile) Digitization_validateXMLclean; \
	fi
	$(echo) "(constituents.make) Digitization_validateXMLclean done"
#	@-$(MAKE) -f $(cmt_local_Digitization_validateXML_makefile) Digitization_validateXMLclean

##	  /bin/rm -f $(cmt_local_Digitization_validateXML_makefile) $(bin)Digitization_validateXML_dependencies.make

install :: Digitization_validateXMLinstall ;

Digitization_validateXMLinstall :: $(Digitization_validateXML_dependencies) $(cmt_local_Digitization_validateXML_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_Digitization_validateXML_makefile); then \
	  $(MAKE) -f $(cmt_local_Digitization_validateXML_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_Digitization_validateXML_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : Digitization_validateXMLuninstall

$(foreach d,$(Digitization_validateXML_dependencies),$(eval $(d)uninstall_dependencies += Digitization_validateXMLuninstall))

Digitization_validateXMLuninstall : $(Digitization_validateXMLuninstall_dependencies) ##$(cmt_local_Digitization_validateXML_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_Digitization_validateXML_makefile); then \
	  $(MAKE) -f $(cmt_local_Digitization_validateXML_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_Digitization_validateXML_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: Digitization_validateXMLuninstall ;
...
cmt_local_tagfile_check_install_joboptions = $(bin)$(Digitization_tag)_check_install_joboptions.make
...
cmt_local_tagfile_check_install_joboptions = $(bin)$(Digitization_tag).make
...
cmt_local_tagfile_check_install_python_modules = $(bin)$(Digitization_tag)_check_install_python_modules.make
...
cmt_local_tagfile_check_install_python_modules = $(bin)$(Digitization_tag).make
...
cmt_local_tagfile_check_install_runtime = $(bin)$(Digitization_tag)_check_install_runtime.make
...
cmt_local_tagfile_check_install_runtime = $(bin)$(Digitization_tag).make
...
cmt_local_tagfile_find_packages = $(bin)$(Digitization_tag)_find_packages.make
...
cmt_local_tagfile_find_packages = $(bin)$(Digitization_tag).make
...
cmt_local_tagfile_compile = $(bin)$(Digitization_tag)_compile.make
...
cmt_local_tagfile_compile = $(bin)$(Digitization_tag).make
...
cmt_local_tagfile_compile_pkg = $(bin)$(Digitization_tag)_compile_pkg.make
...
cmt_local_tagfile_compile_pkg = $(bin)$(Digitization_tag).make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(Digitization_tag)_new_analysisapp.make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(Digitization_tag).make
...
cmt_local_tagfile_new_pkg = $(bin)$(Digitization_tag)_new_pkg.make
...
cmt_local_tagfile_new_pkg = $(bin)$(Digitization_tag).make
...
cmt_local_tagfile_new_alg = $(bin)$(Digitization_tag)_new_alg.make
...
cmt_local_tagfile_new_alg = $(bin)$(Digitization_tag).make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(Digitization_tag)_new_analysisalg.make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(Digitization_tag).make
...
cmt_local_tagfile_new_asgtool = $(bin)$(Digitization_tag)_new_asgtool.make
...
cmt_local_tagfile_new_asgtool = $(bin)$(Digitization_tag).make
...
cmt_local_tagfile_new_jobo = $(bin)$(Digitization_tag)_new_jobo.make
...
cmt_local_tagfile_new_jobo = $(bin)$(Digitization_tag).make
...
cmt_local_tagfile_new_skeleton = $(bin)$(Digitization_tag)_new_skeleton.make
...
cmt_local_tagfile_new_skeleton = $(bin)$(Digitization_tag).make
...
cmt_local_tagfile_make_skeleton = $(bin)$(Digitization_tag)_make_skeleton.make
...
cmt_local_tagfile_make_skeleton = $(bin)$(Digitization_tag).make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(Digitization_tag)_checkout_pkg.make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(Digitization_tag).make
...
cmt_local_tagfile_cppcheck = $(bin)$(Digitization_tag)_cppcheck.make
...
cmt_local_tagfile_cppcheck = $(bin)$(Digitization_tag).make
