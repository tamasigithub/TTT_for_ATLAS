...
${CMTROOT}/${CMTBIN}/cmt.exe setup -sh -pack=Digitization -version=Digitization-02-00-12-00 -path=/afs/cern.ch/work/t/tkar/testarea/20.20.10.7/Simulation  -no_cleanup $* >${cmtDigitizationtempfile}
if test $? != 0 ; then
  echo >&2 "${CMTROOT}/${CMTBIN}/cmt.exe setup -sh -pack=Digitization -version=Digitization-02-00-12-00 -path=/afs/cern.ch/work/t/tkar/testarea/20.20.10.7/Simulation  -no_cleanup $* >${cmtDigitizationtempfile}"
  cmtsetupstatus=2
