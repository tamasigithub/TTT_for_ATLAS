...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=Digitization -version=Digitization-02-00-12-00 -path=/afs/cern.ch/work/t/tkar/testarea/20.20.10.7/Simulation  $* >${cmtDigitizationtempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=Digitization -version=Digitization-02-00-12-00 -path=/afs/cern.ch/work/t/tkar/testarea/20.20.10.7/Simulation  $* >${cmtDigitizationtempfile}"
