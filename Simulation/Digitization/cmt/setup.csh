...
${CMTROOT}/${CMTBIN}/cmt.exe setup -csh -pack=Digitization -version=Digitization-02-00-12-00 -path=/nfs/dust/atlas/user/tkar/20.20.10.7/Simulation  -no_cleanup $* >${cmtDigitizationtempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe setup -csh -pack=Digitization -version=Digitization-02-00-12-00 -path=/nfs/dust/atlas/user/tkar/20.20.10.7/Simulation  -no_cleanup $* >${cmtDigitizationtempfile}"
