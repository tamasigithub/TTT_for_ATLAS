...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -sh -pack=Digitization -version=Digitization-02-00-12-00 -path=/nfs/dust/atlas/user/tkar/20.20.10.7/Simulation  $* >${cmtDigitizationtempfile}
if test $? != 0 ; then
  echo >&2 "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -sh -pack=Digitization -version=Digitization-02-00-12-00 -path=/nfs/dust/atlas/user/tkar/20.20.10.7/Simulation  $* >${cmtDigitizationtempfile}"
  cmtcleanupstatus=2
