...
#     use AthContainers AthContainers-* Control (no_version_directory)
#     use CxxUtils CxxUtils-* Control (no_version_directory)
# use MCTruth MCTruth-* Simulation/G4Sim (no_version_directory)
#   use AtlasPolicy AtlasPolicy-*  (no_version_directory)
#   use AtlasHepMC AtlasHepMC-* External (no_version_directory) (native_version=2.06.09)
#   use CLIDSvc CLIDSvc-* Control (no_version_directory)
#   use Geant4 Geant4-* External (no_version_directory) (native_version=geant4.10.1.patch03.atlas01)
#   use GeneratorObjects GeneratorObjects-* Generators (no_version_directory)
# use MuonSimEvent MuonSimEvent-* MuonSpectrometer (no_version_directory)
#   use AtlasPolicy AtlasPolicy-*  (no_version_directory)
#   use HitManagement HitManagement-* Simulation (no_version_directory)
#   use AtlasSealCLHEP AtlasSealCLHEP-* Database (no_auto_imports) (no_version_directory)
#     use AtlasPolicy AtlasPolicy-*  (no_version_directory)
#     use AtlasCLHEP AtlasCLHEP-* External (no_version_directory) (native_version=2.2.0.4)
#     use AthenaPoolServices AthenaPoolServices-* Database/AthenaPOOL (no_version_directory)
#       use AtlasPolicy AtlasPolicy-*  (no_version_directory)
#       use GaudiInterface GaudiInterface-* External (no_version_directory)
#   use GeneratorObjects GeneratorObjects-* Generators (no_version_directory)
#   use CLIDSvc CLIDSvc-* Control (no_version_directory)
...
#     use Identifier Identifier-* DetectorDescription (no_version_directory)
#   use Identifier Identifier-* DetectorDescription (no_version_directory)
# use SimHelpers SimHelpers-* Simulation/G4Sim (no_version_directory)
#   use AtlasPolicy AtlasPolicy-*  (no_version_directory)
#   use GaudiInterface GaudiInterface-* External (no_version_directory)
#   use StoreGate StoreGate-* Control (no_version_directory)
#   use Geant4 Geant4-* External (no_version_directory) (native_version=geant4.10.1.patch03.atlas01)
# use TrackWriteFastSim TrackWriteFastSim-* Simulation/G4Utilities (no_version_directory)
#   use AtlasPolicy AtlasPolicy-*  (no_version_directory)
#   use Geant4 Geant4-* External (no_version_directory) (native_version=geant4.10.1.patch03.atlas01)
#   use StoreGate StoreGate-* Control (no_version_directory)
#   use TrackRecord TrackRecord-* Simulation/G4Sim (no_version_directory)
...
use XercesC v1 LCG_Interfaces (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/LCGCMT/LCGCMT_81f)
...
use AtlasXercesC AtlasXercesC-00-00-05 External (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasCore/20.20.10)
...
use Geant4 Geant4-10-01-03-12 External (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasSimulation/20.20.10)
...
use AthenaPoolServices AthenaPoolServices-00-06-26 Database/AthenaPOOL (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasCore/20.20.10) (no_auto_imports)
use AtlasSealCLHEP AtlasSealCLHEP-00-01-09 Database (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasCore/20.20.10) (no_auto_imports)
...
use AtlasTBB AtlasTBB-00-00-06 External (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasCore/20.20.10)
use G4AtlasInterfaces G4AtlasInterfaces-00-00-38 Simulation/G4Atlas (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasSimulation/20.20.10)
...
use MCTruth MCTruth-00-05-00 Simulation/G4Sim (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasSimulation/20.20.10)
...
use TrackRecord TrackRecord-01-01-00 Simulation/G4Sim (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasEvent/20.20.10)
...
use TrackWriteFastSim TrackWriteFastSim-00-03-02 Simulation/G4Utilities (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasSimulation/20.20.10)
use SimHelpers SimHelpers-00-01-07 Simulation/G4Sim (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasSimulation/20.20.10)
...
use MuonIdHelpers MuonIdHelpers-01-02-11 MuonSpectrometer (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasConditions/20.20.10)
use MuonSimEvent MuonSimEvent-01-05-00 MuonSpectrometer (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasEvent/20.20.10)
use G4AtlasTools G4AtlasTools-00-02-11-07 Simulation/G4Atlas (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasProduction/20.20.10.7)
...
no_pack_dist_check (from package G4UserActions) applied [G4UserActions]
----------> CMTPATH
