...
#cmt_local_tagfile = $(G4UserActions_tag).make
cmt_local_tagfile = $(bin)$(G4UserActions_tag).make
...
G4UserActions_extratags = -tag_add=target_G4UserActions
...
not_G4UserActions_dependencies = { n=0; for p in $?; do m=0; for d in $(G4UserActions_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
G4UserActionsdirs :
	@if test ! -d $(bin)G4UserActions; then $(mkdir) -p $(bin)G4UserActions; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)G4UserActions
else
G4UserActionsdirs : ;
endif
...
ifndef QUICK
$(cmt_local_G4UserActions_makefile) : $(G4UserActions_dependencies) build_library_links
	$(echo) "(constituents.make) Building G4UserActions.make"; \
	  $(cmtexe) -tag=$(tags) $(G4UserActions_extratags) build constituent_config -out=$(cmt_local_G4UserActions_makefile) G4UserActions
else
$(cmt_local_G4UserActions_makefile) : $(G4UserActions_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_G4UserActions) ] || \
	  [ ! -f $(cmt_final_setup_G4UserActions) ] || \
	  $(not_G4UserActions_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building G4UserActions.make"; \
	  $(cmtexe) -tag=$(tags) $(G4UserActions_extratags) build constituent_config -out=$(cmt_local_G4UserActions_makefile) G4UserActions; \
	  fi
endif
...
$(cmt_local_G4UserActions_makefile) : $(G4UserActions_dependencies) build_library_links
	$(echo) "(constituents.make) Building G4UserActions.make"; \
	  $(cmtexe) -f=$(bin)G4UserActions.in -tag=$(tags) $(G4UserActions_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_G4UserActions_makefile) G4UserActions
else
$(cmt_local_G4UserActions_makefile) : $(G4UserActions_dependencies) $(cmt_build_library_linksstamp) $(bin)G4UserActions.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_G4UserActions) ] || \
	  [ ! -f $(cmt_final_setup_G4UserActions) ] || \
	  $(not_G4UserActions_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(G4UserActions_extratags) build constituent_makefile -out=$(cmt_local_G4UserActions_makefile) G4UserActions

G4UserActions :: $(G4UserActions_dependencies) $(cmt_local_G4UserActions_makefile) dirs G4UserActionsdirs
	$(echo) "(constituents.make) Starting G4UserActions"
	@if test -f $(cmt_local_G4UserActions_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActions_makefile) G4UserActions; \
	  fi
#	@$(MAKE) -f $(cmt_local_G4UserActions_makefile) G4UserActions
	$(echo) "(constituents.make) G4UserActions done"

clean :: G4UserActionsclean ;

G4UserActionsclean :: $(G4UserActionsclean_dependencies) ##$(cmt_local_G4UserActions_makefile)
	$(echo) "(constituents.make) Starting G4UserActionsclean"
	@-if test -f $(cmt_local_G4UserActions_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActions_makefile) G4UserActionsclean; \
	fi
	$(echo) "(constituents.make) G4UserActionsclean done"
#	@-$(MAKE) -f $(cmt_local_G4UserActions_makefile) G4UserActionsclean

##	  /bin/rm -f $(cmt_local_G4UserActions_makefile) $(bin)G4UserActions_dependencies.make

install :: G4UserActionsinstall ;

G4UserActionsinstall :: $(G4UserActions_dependencies) $(cmt_local_G4UserActions_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_G4UserActions_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActions_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_G4UserActions_makefile) install
...
$(foreach d,$(G4UserActions_dependencies),$(eval $(d)uninstall_dependencies += G4UserActionsuninstall))

G4UserActionsuninstall : $(G4UserActionsuninstall_dependencies) ##$(cmt_local_G4UserActions_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_G4UserActions_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActions_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_G4UserActions_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: G4UserActionsuninstall ;
...
G4UserActionsConf_extratags = -tag_add=target_G4UserActionsConf
...
not_G4UserActionsConf_dependencies = { n=0; for p in $?; do m=0; for d in $(G4UserActionsConf_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
G4UserActionsConfdirs :
	@if test ! -d $(bin)G4UserActionsConf; then $(mkdir) -p $(bin)G4UserActionsConf; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)G4UserActionsConf
else
G4UserActionsConfdirs : ;
endif
...
ifndef QUICK
$(cmt_local_G4UserActionsConf_makefile) : $(G4UserActionsConf_dependencies) build_library_links
	$(echo) "(constituents.make) Building G4UserActionsConf.make"; \
	  $(cmtexe) -tag=$(tags) $(G4UserActionsConf_extratags) build constituent_config -out=$(cmt_local_G4UserActionsConf_makefile) G4UserActionsConf
else
$(cmt_local_G4UserActionsConf_makefile) : $(G4UserActionsConf_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_G4UserActionsConf) ] || \
	  [ ! -f $(cmt_final_setup_G4UserActionsConf) ] || \
	  $(not_G4UserActionsConf_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building G4UserActionsConf.make"; \
	  $(cmtexe) -tag=$(tags) $(G4UserActionsConf_extratags) build constituent_config -out=$(cmt_local_G4UserActionsConf_makefile) G4UserActionsConf; \
	  fi
endif
...
$(cmt_local_G4UserActionsConf_makefile) : $(G4UserActionsConf_dependencies) build_library_links
	$(echo) "(constituents.make) Building G4UserActionsConf.make"; \
	  $(cmtexe) -f=$(bin)G4UserActionsConf.in -tag=$(tags) $(G4UserActionsConf_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_G4UserActionsConf_makefile) G4UserActionsConf
else
$(cmt_local_G4UserActionsConf_makefile) : $(G4UserActionsConf_dependencies) $(cmt_build_library_linksstamp) $(bin)G4UserActionsConf.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_G4UserActionsConf) ] || \
	  [ ! -f $(cmt_final_setup_G4UserActionsConf) ] || \
	  $(not_G4UserActionsConf_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(G4UserActionsConf_extratags) build constituent_makefile -out=$(cmt_local_G4UserActionsConf_makefile) G4UserActionsConf

G4UserActionsConf :: $(G4UserActionsConf_dependencies) $(cmt_local_G4UserActionsConf_makefile) dirs G4UserActionsConfdirs
	$(echo) "(constituents.make) Starting G4UserActionsConf"
	@if test -f $(cmt_local_G4UserActionsConf_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActionsConf_makefile) G4UserActionsConf; \
	  fi
#	@$(MAKE) -f $(cmt_local_G4UserActionsConf_makefile) G4UserActionsConf
	$(echo) "(constituents.make) G4UserActionsConf done"

clean :: G4UserActionsConfclean ;

G4UserActionsConfclean :: $(G4UserActionsConfclean_dependencies) ##$(cmt_local_G4UserActionsConf_makefile)
	$(echo) "(constituents.make) Starting G4UserActionsConfclean"
	@-if test -f $(cmt_local_G4UserActionsConf_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActionsConf_makefile) G4UserActionsConfclean; \
	fi
	$(echo) "(constituents.make) G4UserActionsConfclean done"
#	@-$(MAKE) -f $(cmt_local_G4UserActionsConf_makefile) G4UserActionsConfclean

##	  /bin/rm -f $(cmt_local_G4UserActionsConf_makefile) $(bin)G4UserActionsConf_dependencies.make

install :: G4UserActionsConfinstall ;

G4UserActionsConfinstall :: $(G4UserActionsConf_dependencies) $(cmt_local_G4UserActionsConf_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_G4UserActionsConf_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActionsConf_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_G4UserActionsConf_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(G4UserActionsConf_dependencies),$(eval $(d)uninstall_dependencies += G4UserActionsConfuninstall))

G4UserActionsConfuninstall : $(G4UserActionsConfuninstall_dependencies) ##$(cmt_local_G4UserActionsConf_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_G4UserActionsConf_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActionsConf_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_G4UserActionsConf_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: G4UserActionsConfuninstall ;
...
G4UserActions_python_init_extratags = -tag_add=target_G4UserActions_python_init
...
not_G4UserActions_python_init_dependencies = { n=0; for p in $?; do m=0; for d in $(G4UserActions_python_init_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
G4UserActions_python_initdirs :
	@if test ! -d $(bin)G4UserActions_python_init; then $(mkdir) -p $(bin)G4UserActions_python_init; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)G4UserActions_python_init
else
G4UserActions_python_initdirs : ;
endif
...
ifndef QUICK
$(cmt_local_G4UserActions_python_init_makefile) : $(G4UserActions_python_init_dependencies) build_library_links
	$(echo) "(constituents.make) Building G4UserActions_python_init.make"; \
	  $(cmtexe) -tag=$(tags) $(G4UserActions_python_init_extratags) build constituent_config -out=$(cmt_local_G4UserActions_python_init_makefile) G4UserActions_python_init
else
$(cmt_local_G4UserActions_python_init_makefile) : $(G4UserActions_python_init_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_G4UserActions_python_init) ] || \
	  [ ! -f $(cmt_final_setup_G4UserActions_python_init) ] || \
	  $(not_G4UserActions_python_init_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building G4UserActions_python_init.make"; \
	  $(cmtexe) -tag=$(tags) $(G4UserActions_python_init_extratags) build constituent_config -out=$(cmt_local_G4UserActions_python_init_makefile) G4UserActions_python_init; \
	  fi
endif
...
$(cmt_local_G4UserActions_python_init_makefile) : $(G4UserActions_python_init_dependencies) build_library_links
	$(echo) "(constituents.make) Building G4UserActions_python_init.make"; \
	  $(cmtexe) -f=$(bin)G4UserActions_python_init.in -tag=$(tags) $(G4UserActions_python_init_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_G4UserActions_python_init_makefile) G4UserActions_python_init
else
$(cmt_local_G4UserActions_python_init_makefile) : $(G4UserActions_python_init_dependencies) $(cmt_build_library_linksstamp) $(bin)G4UserActions_python_init.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_G4UserActions_python_init) ] || \
	  [ ! -f $(cmt_final_setup_G4UserActions_python_init) ] || \
	  $(not_G4UserActions_python_init_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(G4UserActions_python_init_extratags) build constituent_makefile -out=$(cmt_local_G4UserActions_python_init_makefile) G4UserActions_python_init

G4UserActions_python_init :: $(G4UserActions_python_init_dependencies) $(cmt_local_G4UserActions_python_init_makefile) dirs G4UserActions_python_initdirs
	$(echo) "(constituents.make) Starting G4UserActions_python_init"
	@if test -f $(cmt_local_G4UserActions_python_init_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActions_python_init_makefile) G4UserActions_python_init; \
	  fi
#	@$(MAKE) -f $(cmt_local_G4UserActions_python_init_makefile) G4UserActions_python_init
	$(echo) "(constituents.make) G4UserActions_python_init done"

clean :: G4UserActions_python_initclean ;

G4UserActions_python_initclean :: $(G4UserActions_python_initclean_dependencies) ##$(cmt_local_G4UserActions_python_init_makefile)
	$(echo) "(constituents.make) Starting G4UserActions_python_initclean"
	@-if test -f $(cmt_local_G4UserActions_python_init_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActions_python_init_makefile) G4UserActions_python_initclean; \
	fi
	$(echo) "(constituents.make) G4UserActions_python_initclean done"
#	@-$(MAKE) -f $(cmt_local_G4UserActions_python_init_makefile) G4UserActions_python_initclean

##	  /bin/rm -f $(cmt_local_G4UserActions_python_init_makefile) $(bin)G4UserActions_python_init_dependencies.make

install :: G4UserActions_python_initinstall ;

G4UserActions_python_initinstall :: $(G4UserActions_python_init_dependencies) $(cmt_local_G4UserActions_python_init_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_G4UserActions_python_init_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActions_python_init_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_G4UserActions_python_init_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(G4UserActions_python_init_dependencies),$(eval $(d)uninstall_dependencies += G4UserActions_python_inituninstall))

G4UserActions_python_inituninstall : $(G4UserActions_python_inituninstall_dependencies) ##$(cmt_local_G4UserActions_python_init_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_G4UserActions_python_init_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActions_python_init_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_G4UserActions_python_init_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: G4UserActions_python_inituninstall ;
...
G4UserActionsConfDbMerge_extratags = -tag_add=target_G4UserActionsConfDbMerge
...
not_G4UserActionsConfDbMerge_dependencies = { n=0; for p in $?; do m=0; for d in $(G4UserActionsConfDbMerge_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
G4UserActionsConfDbMergedirs :
	@if test ! -d $(bin)G4UserActionsConfDbMerge; then $(mkdir) -p $(bin)G4UserActionsConfDbMerge; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)G4UserActionsConfDbMerge
else
G4UserActionsConfDbMergedirs : ;
endif
...
ifndef QUICK
$(cmt_local_G4UserActionsConfDbMerge_makefile) : $(G4UserActionsConfDbMerge_dependencies) build_library_links
	$(echo) "(constituents.make) Building G4UserActionsConfDbMerge.make"; \
	  $(cmtexe) -tag=$(tags) $(G4UserActionsConfDbMerge_extratags) build constituent_config -out=$(cmt_local_G4UserActionsConfDbMerge_makefile) G4UserActionsConfDbMerge
else
$(cmt_local_G4UserActionsConfDbMerge_makefile) : $(G4UserActionsConfDbMerge_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_G4UserActionsConfDbMerge) ] || \
	  [ ! -f $(cmt_final_setup_G4UserActionsConfDbMerge) ] || \
	  $(not_G4UserActionsConfDbMerge_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building G4UserActionsConfDbMerge.make"; \
	  $(cmtexe) -tag=$(tags) $(G4UserActionsConfDbMerge_extratags) build constituent_config -out=$(cmt_local_G4UserActionsConfDbMerge_makefile) G4UserActionsConfDbMerge; \
	  fi
endif
...
$(cmt_local_G4UserActionsConfDbMerge_makefile) : $(G4UserActionsConfDbMerge_dependencies) build_library_links
	$(echo) "(constituents.make) Building G4UserActionsConfDbMerge.make"; \
	  $(cmtexe) -f=$(bin)G4UserActionsConfDbMerge.in -tag=$(tags) $(G4UserActionsConfDbMerge_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_G4UserActionsConfDbMerge_makefile) G4UserActionsConfDbMerge
else
$(cmt_local_G4UserActionsConfDbMerge_makefile) : $(G4UserActionsConfDbMerge_dependencies) $(cmt_build_library_linksstamp) $(bin)G4UserActionsConfDbMerge.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_G4UserActionsConfDbMerge) ] || \
	  [ ! -f $(cmt_final_setup_G4UserActionsConfDbMerge) ] || \
	  $(not_G4UserActionsConfDbMerge_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(G4UserActionsConfDbMerge_extratags) build constituent_makefile -out=$(cmt_local_G4UserActionsConfDbMerge_makefile) G4UserActionsConfDbMerge

G4UserActionsConfDbMerge :: $(G4UserActionsConfDbMerge_dependencies) $(cmt_local_G4UserActionsConfDbMerge_makefile) dirs G4UserActionsConfDbMergedirs
	$(echo) "(constituents.make) Starting G4UserActionsConfDbMerge"
	@if test -f $(cmt_local_G4UserActionsConfDbMerge_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActionsConfDbMerge_makefile) G4UserActionsConfDbMerge; \
	  fi
#	@$(MAKE) -f $(cmt_local_G4UserActionsConfDbMerge_makefile) G4UserActionsConfDbMerge
	$(echo) "(constituents.make) G4UserActionsConfDbMerge done"

clean :: G4UserActionsConfDbMergeclean ;

G4UserActionsConfDbMergeclean :: $(G4UserActionsConfDbMergeclean_dependencies) ##$(cmt_local_G4UserActionsConfDbMerge_makefile)
	$(echo) "(constituents.make) Starting G4UserActionsConfDbMergeclean"
	@-if test -f $(cmt_local_G4UserActionsConfDbMerge_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActionsConfDbMerge_makefile) G4UserActionsConfDbMergeclean; \
	fi
	$(echo) "(constituents.make) G4UserActionsConfDbMergeclean done"
#	@-$(MAKE) -f $(cmt_local_G4UserActionsConfDbMerge_makefile) G4UserActionsConfDbMergeclean

##	  /bin/rm -f $(cmt_local_G4UserActionsConfDbMerge_makefile) $(bin)G4UserActionsConfDbMerge_dependencies.make

install :: G4UserActionsConfDbMergeinstall ;

G4UserActionsConfDbMergeinstall :: $(G4UserActionsConfDbMerge_dependencies) $(cmt_local_G4UserActionsConfDbMerge_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_G4UserActionsConfDbMerge_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActionsConfDbMerge_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_G4UserActionsConfDbMerge_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : G4UserActionsConfDbMergeuninstall

$(foreach d,$(G4UserActionsConfDbMerge_dependencies),$(eval $(d)uninstall_dependencies += G4UserActionsConfDbMergeuninstall))

G4UserActionsConfDbMergeuninstall : $(G4UserActionsConfDbMergeuninstall_dependencies) ##$(cmt_local_G4UserActionsConfDbMerge_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_G4UserActionsConfDbMerge_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActionsConfDbMerge_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_G4UserActionsConfDbMerge_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: G4UserActionsConfDbMergeuninstall ;
...
G4UserActionsComponentsList_extratags = -tag_add=target_G4UserActionsComponentsList
...
not_G4UserActionsComponentsList_dependencies = { n=0; for p in $?; do m=0; for d in $(G4UserActionsComponentsList_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
G4UserActionsComponentsListdirs :
	@if test ! -d $(bin)G4UserActionsComponentsList; then $(mkdir) -p $(bin)G4UserActionsComponentsList; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)G4UserActionsComponentsList
else
G4UserActionsComponentsListdirs : ;
endif
...
ifndef QUICK
$(cmt_local_G4UserActionsComponentsList_makefile) : $(G4UserActionsComponentsList_dependencies) build_library_links
	$(echo) "(constituents.make) Building G4UserActionsComponentsList.make"; \
	  $(cmtexe) -tag=$(tags) $(G4UserActionsComponentsList_extratags) build constituent_config -out=$(cmt_local_G4UserActionsComponentsList_makefile) G4UserActionsComponentsList
else
$(cmt_local_G4UserActionsComponentsList_makefile) : $(G4UserActionsComponentsList_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_G4UserActionsComponentsList) ] || \
	  [ ! -f $(cmt_final_setup_G4UserActionsComponentsList) ] || \
	  $(not_G4UserActionsComponentsList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building G4UserActionsComponentsList.make"; \
	  $(cmtexe) -tag=$(tags) $(G4UserActionsComponentsList_extratags) build constituent_config -out=$(cmt_local_G4UserActionsComponentsList_makefile) G4UserActionsComponentsList; \
	  fi
endif
...
$(cmt_local_G4UserActionsComponentsList_makefile) : $(G4UserActionsComponentsList_dependencies) build_library_links
	$(echo) "(constituents.make) Building G4UserActionsComponentsList.make"; \
	  $(cmtexe) -f=$(bin)G4UserActionsComponentsList.in -tag=$(tags) $(G4UserActionsComponentsList_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_G4UserActionsComponentsList_makefile) G4UserActionsComponentsList
else
$(cmt_local_G4UserActionsComponentsList_makefile) : $(G4UserActionsComponentsList_dependencies) $(cmt_build_library_linksstamp) $(bin)G4UserActionsComponentsList.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_G4UserActionsComponentsList) ] || \
	  [ ! -f $(cmt_final_setup_G4UserActionsComponentsList) ] || \
	  $(not_G4UserActionsComponentsList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(G4UserActionsComponentsList_extratags) build constituent_makefile -out=$(cmt_local_G4UserActionsComponentsList_makefile) G4UserActionsComponentsList

G4UserActionsComponentsList :: $(G4UserActionsComponentsList_dependencies) $(cmt_local_G4UserActionsComponentsList_makefile) dirs G4UserActionsComponentsListdirs
	$(echo) "(constituents.make) Starting G4UserActionsComponentsList"
	@if test -f $(cmt_local_G4UserActionsComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActionsComponentsList_makefile) G4UserActionsComponentsList; \
	  fi
#	@$(MAKE) -f $(cmt_local_G4UserActionsComponentsList_makefile) G4UserActionsComponentsList
	$(echo) "(constituents.make) G4UserActionsComponentsList done"

clean :: G4UserActionsComponentsListclean ;

G4UserActionsComponentsListclean :: $(G4UserActionsComponentsListclean_dependencies) ##$(cmt_local_G4UserActionsComponentsList_makefile)
	$(echo) "(constituents.make) Starting G4UserActionsComponentsListclean"
	@-if test -f $(cmt_local_G4UserActionsComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActionsComponentsList_makefile) G4UserActionsComponentsListclean; \
	fi
	$(echo) "(constituents.make) G4UserActionsComponentsListclean done"
#	@-$(MAKE) -f $(cmt_local_G4UserActionsComponentsList_makefile) G4UserActionsComponentsListclean

##	  /bin/rm -f $(cmt_local_G4UserActionsComponentsList_makefile) $(bin)G4UserActionsComponentsList_dependencies.make

install :: G4UserActionsComponentsListinstall ;

G4UserActionsComponentsListinstall :: $(G4UserActionsComponentsList_dependencies) $(cmt_local_G4UserActionsComponentsList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_G4UserActionsComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActionsComponentsList_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_G4UserActionsComponentsList_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(G4UserActionsComponentsList_dependencies),$(eval $(d)uninstall_dependencies += G4UserActionsComponentsListuninstall))

G4UserActionsComponentsListuninstall : $(G4UserActionsComponentsListuninstall_dependencies) ##$(cmt_local_G4UserActionsComponentsList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_G4UserActionsComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActionsComponentsList_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_G4UserActionsComponentsList_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: G4UserActionsComponentsListuninstall ;
...
G4UserActionsMergeComponentsList_extratags = -tag_add=target_G4UserActionsMergeComponentsList
...
not_G4UserActionsMergeComponentsList_dependencies = { n=0; for p in $?; do m=0; for d in $(G4UserActionsMergeComponentsList_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
G4UserActionsMergeComponentsListdirs :
	@if test ! -d $(bin)G4UserActionsMergeComponentsList; then $(mkdir) -p $(bin)G4UserActionsMergeComponentsList; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)G4UserActionsMergeComponentsList
else
G4UserActionsMergeComponentsListdirs : ;
endif
...
ifndef QUICK
$(cmt_local_G4UserActionsMergeComponentsList_makefile) : $(G4UserActionsMergeComponentsList_dependencies) build_library_links
	$(echo) "(constituents.make) Building G4UserActionsMergeComponentsList.make"; \
	  $(cmtexe) -tag=$(tags) $(G4UserActionsMergeComponentsList_extratags) build constituent_config -out=$(cmt_local_G4UserActionsMergeComponentsList_makefile) G4UserActionsMergeComponentsList
else
$(cmt_local_G4UserActionsMergeComponentsList_makefile) : $(G4UserActionsMergeComponentsList_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_G4UserActionsMergeComponentsList) ] || \
	  [ ! -f $(cmt_final_setup_G4UserActionsMergeComponentsList) ] || \
	  $(not_G4UserActionsMergeComponentsList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building G4UserActionsMergeComponentsList.make"; \
	  $(cmtexe) -tag=$(tags) $(G4UserActionsMergeComponentsList_extratags) build constituent_config -out=$(cmt_local_G4UserActionsMergeComponentsList_makefile) G4UserActionsMergeComponentsList; \
	  fi
endif
...
$(cmt_local_G4UserActionsMergeComponentsList_makefile) : $(G4UserActionsMergeComponentsList_dependencies) build_library_links
	$(echo) "(constituents.make) Building G4UserActionsMergeComponentsList.make"; \
	  $(cmtexe) -f=$(bin)G4UserActionsMergeComponentsList.in -tag=$(tags) $(G4UserActionsMergeComponentsList_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_G4UserActionsMergeComponentsList_makefile) G4UserActionsMergeComponentsList
else
$(cmt_local_G4UserActionsMergeComponentsList_makefile) : $(G4UserActionsMergeComponentsList_dependencies) $(cmt_build_library_linksstamp) $(bin)G4UserActionsMergeComponentsList.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_G4UserActionsMergeComponentsList) ] || \
	  [ ! -f $(cmt_final_setup_G4UserActionsMergeComponentsList) ] || \
	  $(not_G4UserActionsMergeComponentsList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(G4UserActionsMergeComponentsList_extratags) build constituent_makefile -out=$(cmt_local_G4UserActionsMergeComponentsList_makefile) G4UserActionsMergeComponentsList

G4UserActionsMergeComponentsList :: $(G4UserActionsMergeComponentsList_dependencies) $(cmt_local_G4UserActionsMergeComponentsList_makefile) dirs G4UserActionsMergeComponentsListdirs
	$(echo) "(constituents.make) Starting G4UserActionsMergeComponentsList"
	@if test -f $(cmt_local_G4UserActionsMergeComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActionsMergeComponentsList_makefile) G4UserActionsMergeComponentsList; \
	  fi
#	@$(MAKE) -f $(cmt_local_G4UserActionsMergeComponentsList_makefile) G4UserActionsMergeComponentsList
	$(echo) "(constituents.make) G4UserActionsMergeComponentsList done"

clean :: G4UserActionsMergeComponentsListclean ;

G4UserActionsMergeComponentsListclean :: $(G4UserActionsMergeComponentsListclean_dependencies) ##$(cmt_local_G4UserActionsMergeComponentsList_makefile)
	$(echo) "(constituents.make) Starting G4UserActionsMergeComponentsListclean"
	@-if test -f $(cmt_local_G4UserActionsMergeComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActionsMergeComponentsList_makefile) G4UserActionsMergeComponentsListclean; \
	fi
	$(echo) "(constituents.make) G4UserActionsMergeComponentsListclean done"
#	@-$(MAKE) -f $(cmt_local_G4UserActionsMergeComponentsList_makefile) G4UserActionsMergeComponentsListclean

##	  /bin/rm -f $(cmt_local_G4UserActionsMergeComponentsList_makefile) $(bin)G4UserActionsMergeComponentsList_dependencies.make

install :: G4UserActionsMergeComponentsListinstall ;

G4UserActionsMergeComponentsListinstall :: $(G4UserActionsMergeComponentsList_dependencies) $(cmt_local_G4UserActionsMergeComponentsList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_G4UserActionsMergeComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActionsMergeComponentsList_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_G4UserActionsMergeComponentsList_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : G4UserActionsMergeComponentsListuninstall

$(foreach d,$(G4UserActionsMergeComponentsList_dependencies),$(eval $(d)uninstall_dependencies += G4UserActionsMergeComponentsListuninstall))

G4UserActionsMergeComponentsListuninstall : $(G4UserActionsMergeComponentsListuninstall_dependencies) ##$(cmt_local_G4UserActionsMergeComponentsList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_G4UserActionsMergeComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActionsMergeComponentsList_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_G4UserActionsMergeComponentsList_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: G4UserActionsMergeComponentsListuninstall ;
...
G4UserActions_optdebug_library_extratags = -tag_add=target_G4UserActions_optdebug_library
...
not_G4UserActions_optdebug_library_dependencies = { n=0; for p in $?; do m=0; for d in $(G4UserActions_optdebug_library_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
G4UserActions_optdebug_librarydirs :
	@if test ! -d $(bin)G4UserActions_optdebug_library; then $(mkdir) -p $(bin)G4UserActions_optdebug_library; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)G4UserActions_optdebug_library
else
G4UserActions_optdebug_librarydirs : ;
endif
...
ifndef QUICK
$(cmt_local_G4UserActions_optdebug_library_makefile) : $(G4UserActions_optdebug_library_dependencies) build_library_links
	$(echo) "(constituents.make) Building G4UserActions_optdebug_library.make"; \
	  $(cmtexe) -tag=$(tags) $(G4UserActions_optdebug_library_extratags) build constituent_config -out=$(cmt_local_G4UserActions_optdebug_library_makefile) G4UserActions_optdebug_library
else
$(cmt_local_G4UserActions_optdebug_library_makefile) : $(G4UserActions_optdebug_library_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_G4UserActions_optdebug_library) ] || \
	  [ ! -f $(cmt_final_setup_G4UserActions_optdebug_library) ] || \
	  $(not_G4UserActions_optdebug_library_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building G4UserActions_optdebug_library.make"; \
	  $(cmtexe) -tag=$(tags) $(G4UserActions_optdebug_library_extratags) build constituent_config -out=$(cmt_local_G4UserActions_optdebug_library_makefile) G4UserActions_optdebug_library; \
	  fi
endif
...
$(cmt_local_G4UserActions_optdebug_library_makefile) : $(G4UserActions_optdebug_library_dependencies) build_library_links
	$(echo) "(constituents.make) Building G4UserActions_optdebug_library.make"; \
	  $(cmtexe) -f=$(bin)G4UserActions_optdebug_library.in -tag=$(tags) $(G4UserActions_optdebug_library_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_G4UserActions_optdebug_library_makefile) G4UserActions_optdebug_library
else
$(cmt_local_G4UserActions_optdebug_library_makefile) : $(G4UserActions_optdebug_library_dependencies) $(cmt_build_library_linksstamp) $(bin)G4UserActions_optdebug_library.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_G4UserActions_optdebug_library) ] || \
	  [ ! -f $(cmt_final_setup_G4UserActions_optdebug_library) ] || \
	  $(not_G4UserActions_optdebug_library_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(G4UserActions_optdebug_library_extratags) build constituent_makefile -out=$(cmt_local_G4UserActions_optdebug_library_makefile) G4UserActions_optdebug_library

G4UserActions_optdebug_library :: $(G4UserActions_optdebug_library_dependencies) $(cmt_local_G4UserActions_optdebug_library_makefile) dirs G4UserActions_optdebug_librarydirs
	$(echo) "(constituents.make) Starting G4UserActions_optdebug_library"
	@if test -f $(cmt_local_G4UserActions_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActions_optdebug_library_makefile) G4UserActions_optdebug_library; \
	  fi
#	@$(MAKE) -f $(cmt_local_G4UserActions_optdebug_library_makefile) G4UserActions_optdebug_library
	$(echo) "(constituents.make) G4UserActions_optdebug_library done"

clean :: G4UserActions_optdebug_libraryclean ;

G4UserActions_optdebug_libraryclean :: $(G4UserActions_optdebug_libraryclean_dependencies) ##$(cmt_local_G4UserActions_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting G4UserActions_optdebug_libraryclean"
	@-if test -f $(cmt_local_G4UserActions_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActions_optdebug_library_makefile) G4UserActions_optdebug_libraryclean; \
	fi
	$(echo) "(constituents.make) G4UserActions_optdebug_libraryclean done"
#	@-$(MAKE) -f $(cmt_local_G4UserActions_optdebug_library_makefile) G4UserActions_optdebug_libraryclean

##	  /bin/rm -f $(cmt_local_G4UserActions_optdebug_library_makefile) $(bin)G4UserActions_optdebug_library_dependencies.make

install :: G4UserActions_optdebug_libraryinstall ;

G4UserActions_optdebug_libraryinstall :: $(G4UserActions_optdebug_library_dependencies) $(cmt_local_G4UserActions_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_G4UserActions_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActions_optdebug_library_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_G4UserActions_optdebug_library_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(G4UserActions_optdebug_library_dependencies),$(eval $(d)uninstall_dependencies += G4UserActions_optdebug_libraryuninstall))

G4UserActions_optdebug_libraryuninstall : $(G4UserActions_optdebug_libraryuninstall_dependencies) ##$(cmt_local_G4UserActions_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_G4UserActions_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActions_optdebug_library_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_G4UserActions_optdebug_library_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: G4UserActions_optdebug_libraryuninstall ;
...
G4UserActionsCLIDDB_extratags = -tag_add=target_G4UserActionsCLIDDB
...
not_G4UserActionsCLIDDB_dependencies = { n=0; for p in $?; do m=0; for d in $(G4UserActionsCLIDDB_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
G4UserActionsCLIDDBdirs :
	@if test ! -d $(bin)G4UserActionsCLIDDB; then $(mkdir) -p $(bin)G4UserActionsCLIDDB; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)G4UserActionsCLIDDB
else
G4UserActionsCLIDDBdirs : ;
endif
...
ifndef QUICK
$(cmt_local_G4UserActionsCLIDDB_makefile) : $(G4UserActionsCLIDDB_dependencies) build_library_links
	$(echo) "(constituents.make) Building G4UserActionsCLIDDB.make"; \
	  $(cmtexe) -tag=$(tags) $(G4UserActionsCLIDDB_extratags) build constituent_config -out=$(cmt_local_G4UserActionsCLIDDB_makefile) G4UserActionsCLIDDB
else
$(cmt_local_G4UserActionsCLIDDB_makefile) : $(G4UserActionsCLIDDB_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_G4UserActionsCLIDDB) ] || \
	  [ ! -f $(cmt_final_setup_G4UserActionsCLIDDB) ] || \
	  $(not_G4UserActionsCLIDDB_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building G4UserActionsCLIDDB.make"; \
	  $(cmtexe) -tag=$(tags) $(G4UserActionsCLIDDB_extratags) build constituent_config -out=$(cmt_local_G4UserActionsCLIDDB_makefile) G4UserActionsCLIDDB; \
	  fi
endif
...
$(cmt_local_G4UserActionsCLIDDB_makefile) : $(G4UserActionsCLIDDB_dependencies) build_library_links
	$(echo) "(constituents.make) Building G4UserActionsCLIDDB.make"; \
	  $(cmtexe) -f=$(bin)G4UserActionsCLIDDB.in -tag=$(tags) $(G4UserActionsCLIDDB_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_G4UserActionsCLIDDB_makefile) G4UserActionsCLIDDB
else
$(cmt_local_G4UserActionsCLIDDB_makefile) : $(G4UserActionsCLIDDB_dependencies) $(cmt_build_library_linksstamp) $(bin)G4UserActionsCLIDDB.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_G4UserActionsCLIDDB) ] || \
	  [ ! -f $(cmt_final_setup_G4UserActionsCLIDDB) ] || \
	  $(not_G4UserActionsCLIDDB_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(G4UserActionsCLIDDB_extratags) build constituent_makefile -out=$(cmt_local_G4UserActionsCLIDDB_makefile) G4UserActionsCLIDDB

G4UserActionsCLIDDB :: $(G4UserActionsCLIDDB_dependencies) $(cmt_local_G4UserActionsCLIDDB_makefile) dirs G4UserActionsCLIDDBdirs
	$(echo) "(constituents.make) Starting G4UserActionsCLIDDB"
	@if test -f $(cmt_local_G4UserActionsCLIDDB_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActionsCLIDDB_makefile) G4UserActionsCLIDDB; \
	  fi
#	@$(MAKE) -f $(cmt_local_G4UserActionsCLIDDB_makefile) G4UserActionsCLIDDB
	$(echo) "(constituents.make) G4UserActionsCLIDDB done"

clean :: G4UserActionsCLIDDBclean ;

G4UserActionsCLIDDBclean :: $(G4UserActionsCLIDDBclean_dependencies) ##$(cmt_local_G4UserActionsCLIDDB_makefile)
	$(echo) "(constituents.make) Starting G4UserActionsCLIDDBclean"
	@-if test -f $(cmt_local_G4UserActionsCLIDDB_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActionsCLIDDB_makefile) G4UserActionsCLIDDBclean; \
	fi
	$(echo) "(constituents.make) G4UserActionsCLIDDBclean done"
#	@-$(MAKE) -f $(cmt_local_G4UserActionsCLIDDB_makefile) G4UserActionsCLIDDBclean

##	  /bin/rm -f $(cmt_local_G4UserActionsCLIDDB_makefile) $(bin)G4UserActionsCLIDDB_dependencies.make

install :: G4UserActionsCLIDDBinstall ;

G4UserActionsCLIDDBinstall :: $(G4UserActionsCLIDDB_dependencies) $(cmt_local_G4UserActionsCLIDDB_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_G4UserActionsCLIDDB_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActionsCLIDDB_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_G4UserActionsCLIDDB_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : G4UserActionsCLIDDBuninstall

$(foreach d,$(G4UserActionsCLIDDB_dependencies),$(eval $(d)uninstall_dependencies += G4UserActionsCLIDDBuninstall))

G4UserActionsCLIDDBuninstall : $(G4UserActionsCLIDDBuninstall_dependencies) ##$(cmt_local_G4UserActionsCLIDDB_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_G4UserActionsCLIDDB_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActionsCLIDDB_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_G4UserActionsCLIDDB_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: G4UserActionsCLIDDBuninstall ;
...
cmt_G4UserActionsrchk_has_target_tag = 1

#--------------------------------------

ifdef cmt_G4UserActionsrchk_has_target_tag

cmt_local_tagfile_G4UserActionsrchk = $(bin)$(G4UserActions_tag)_G4UserActionsrchk.make
cmt_final_setup_G4UserActionsrchk = $(bin)setup_G4UserActionsrchk.make
cmt_local_G4UserActionsrchk_makefile = $(bin)G4UserActionsrchk.make

G4UserActionsrchk_extratags = -tag_add=target_G4UserActionsrchk

else

cmt_local_tagfile_G4UserActionsrchk = $(bin)$(G4UserActions_tag).make
cmt_final_setup_G4UserActionsrchk = $(bin)setup.make
cmt_local_G4UserActionsrchk_makefile = $(bin)G4UserActionsrchk.make

endif

not_G4UserActionsrchk_dependencies = { n=0; for p in $?; do m=0; for d in $(G4UserActionsrchk_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
G4UserActionsrchkdirs :
	@if test ! -d $(bin)G4UserActionsrchk; then $(mkdir) -p $(bin)G4UserActionsrchk; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)G4UserActionsrchk
else
G4UserActionsrchkdirs : ;
endif
...
ifndef QUICK
$(cmt_local_G4UserActionsrchk_makefile) : $(G4UserActionsrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building G4UserActionsrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(G4UserActionsrchk_extratags) build constituent_config -out=$(cmt_local_G4UserActionsrchk_makefile) G4UserActionsrchk
else
$(cmt_local_G4UserActionsrchk_makefile) : $(G4UserActionsrchk_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_G4UserActionsrchk) ] || \
	  [ ! -f $(cmt_final_setup_G4UserActionsrchk) ] || \
	  $(not_G4UserActionsrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building G4UserActionsrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(G4UserActionsrchk_extratags) build constituent_config -out=$(cmt_local_G4UserActionsrchk_makefile) G4UserActionsrchk; \
	  fi
endif
...
$(cmt_local_G4UserActionsrchk_makefile) : $(G4UserActionsrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building G4UserActionsrchk.make"; \
	  $(cmtexe) -f=$(bin)G4UserActionsrchk.in -tag=$(tags) $(G4UserActionsrchk_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_G4UserActionsrchk_makefile) G4UserActionsrchk
else
$(cmt_local_G4UserActionsrchk_makefile) : $(G4UserActionsrchk_dependencies) $(cmt_build_library_linksstamp) $(bin)G4UserActionsrchk.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_G4UserActionsrchk) ] || \
	  [ ! -f $(cmt_final_setup_G4UserActionsrchk) ] || \
	  $(not_G4UserActionsrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(G4UserActionsrchk_extratags) build constituent_makefile -out=$(cmt_local_G4UserActionsrchk_makefile) G4UserActionsrchk

G4UserActionsrchk :: $(G4UserActionsrchk_dependencies) $(cmt_local_G4UserActionsrchk_makefile) dirs G4UserActionsrchkdirs
	$(echo) "(constituents.make) Starting G4UserActionsrchk"
	@if test -f $(cmt_local_G4UserActionsrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActionsrchk_makefile) G4UserActionsrchk; \
	  fi
#	@$(MAKE) -f $(cmt_local_G4UserActionsrchk_makefile) G4UserActionsrchk
	$(echo) "(constituents.make) G4UserActionsrchk done"

clean :: G4UserActionsrchkclean ;

G4UserActionsrchkclean :: $(G4UserActionsrchkclean_dependencies) ##$(cmt_local_G4UserActionsrchk_makefile)
	$(echo) "(constituents.make) Starting G4UserActionsrchkclean"
	@-if test -f $(cmt_local_G4UserActionsrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActionsrchk_makefile) G4UserActionsrchkclean; \
	fi
	$(echo) "(constituents.make) G4UserActionsrchkclean done"
#	@-$(MAKE) -f $(cmt_local_G4UserActionsrchk_makefile) G4UserActionsrchkclean

##	  /bin/rm -f $(cmt_local_G4UserActionsrchk_makefile) $(bin)G4UserActionsrchk_dependencies.make

install :: G4UserActionsrchkinstall ;

G4UserActionsrchkinstall :: $(G4UserActionsrchk_dependencies) $(cmt_local_G4UserActionsrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_G4UserActionsrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActionsrchk_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_G4UserActionsrchk_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : G4UserActionsrchkuninstall

$(foreach d,$(G4UserActionsrchk_dependencies),$(eval $(d)uninstall_dependencies += G4UserActionsrchkuninstall))

G4UserActionsrchkuninstall : $(G4UserActionsrchkuninstall_dependencies) ##$(cmt_local_G4UserActionsrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_G4UserActionsrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActionsrchk_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_G4UserActionsrchk_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: G4UserActionsrchkuninstall ;
...
cmt_local_tagfile_install_root_include_path = $(bin)$(G4UserActions_tag)_install_root_include_path.make
...
cmt_local_tagfile_install_root_include_path = $(bin)$(G4UserActions_tag).make
...
cmt_local_tagfile_install_includes = $(bin)$(G4UserActions_tag)_install_includes.make
...
cmt_local_tagfile_install_includes = $(bin)$(G4UserActions_tag).make
...
cmt_local_tagfile_make = $(bin)$(G4UserActions_tag)_make.make
...
cmt_local_tagfile_make = $(bin)$(G4UserActions_tag).make
...
cmt_local_tagfile_CompilePython = $(bin)$(G4UserActions_tag)_CompilePython.make
...
cmt_local_tagfile_CompilePython = $(bin)$(G4UserActions_tag).make
...
cmt_local_tagfile_qmtest_run = $(bin)$(G4UserActions_tag)_qmtest_run.make
...
cmt_local_tagfile_qmtest_run = $(bin)$(G4UserActions_tag).make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(G4UserActions_tag)_qmtest_summarize.make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(G4UserActions_tag).make
...
cmt_local_tagfile_TestPackage = $(bin)$(G4UserActions_tag)_TestPackage.make
...
cmt_local_tagfile_TestPackage = $(bin)$(G4UserActions_tag).make
...
cmt_local_tagfile_TestProject = $(bin)$(G4UserActions_tag)_TestProject.make
...
cmt_local_tagfile_TestProject = $(bin)$(G4UserActions_tag).make
...
cmt_local_tagfile_new_rootsys = $(bin)$(G4UserActions_tag)_new_rootsys.make
...
cmt_local_tagfile_new_rootsys = $(bin)$(G4UserActions_tag).make
...
cmt_local_tagfile_doxygen = $(bin)$(G4UserActions_tag)_doxygen.make
...
cmt_local_tagfile_doxygen = $(bin)$(G4UserActions_tag).make
...
cmt_local_tagfile_post_install = $(bin)$(G4UserActions_tag)_post_install.make
...
cmt_local_tagfile_post_install = $(bin)$(G4UserActions_tag).make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(G4UserActions_tag)_post_merge_rootmap.make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(G4UserActions_tag).make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(G4UserActions_tag)_post_merge_genconfdb.make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(G4UserActions_tag).make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(G4UserActions_tag)_post_build_tpcnvdb.make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(G4UserActions_tag).make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(G4UserActions_tag)_all_post_constituents.make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(G4UserActions_tag).make
...
cmt_local_tagfile_checkreq = $(bin)$(G4UserActions_tag)_checkreq.make
...
cmt_local_tagfile_checkreq = $(bin)$(G4UserActions_tag).make
...
cmt_G4UserActions_NICOS_Fix_debuginfo_has_no_target_tag = 1

#--------------------------------------

ifdef cmt_G4UserActions_NICOS_Fix_debuginfo_has_target_tag

cmt_local_tagfile_G4UserActions_NICOS_Fix_debuginfo = $(bin)$(G4UserActions_tag)_G4UserActions_NICOS_Fix_debuginfo.make
cmt_final_setup_G4UserActions_NICOS_Fix_debuginfo = $(bin)setup_G4UserActions_NICOS_Fix_debuginfo.make
cmt_local_G4UserActions_NICOS_Fix_debuginfo_makefile = $(bin)G4UserActions_NICOS_Fix_debuginfo.make

G4UserActions_NICOS_Fix_debuginfo_extratags = -tag_add=target_G4UserActions_NICOS_Fix_debuginfo

else

cmt_local_tagfile_G4UserActions_NICOS_Fix_debuginfo = $(bin)$(G4UserActions_tag).make
cmt_final_setup_G4UserActions_NICOS_Fix_debuginfo = $(bin)setup.make
cmt_local_G4UserActions_NICOS_Fix_debuginfo_makefile = $(bin)G4UserActions_NICOS_Fix_debuginfo.make

endif

not_G4UserActions_NICOS_Fix_debuginfo_dependencies = { n=0; for p in $?; do m=0; for d in $(G4UserActions_NICOS_Fix_debuginfo_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
G4UserActions_NICOS_Fix_debuginfodirs :
	@if test ! -d $(bin)G4UserActions_NICOS_Fix_debuginfo; then $(mkdir) -p $(bin)G4UserActions_NICOS_Fix_debuginfo; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)G4UserActions_NICOS_Fix_debuginfo
else
G4UserActions_NICOS_Fix_debuginfodirs : ;
endif
...
ifndef QUICK
$(cmt_local_G4UserActions_NICOS_Fix_debuginfo_makefile) : $(G4UserActions_NICOS_Fix_debuginfo_dependencies) build_library_links
	$(echo) "(constituents.make) Building G4UserActions_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -tag=$(tags) $(G4UserActions_NICOS_Fix_debuginfo_extratags) build constituent_config -out=$(cmt_local_G4UserActions_NICOS_Fix_debuginfo_makefile) G4UserActions_NICOS_Fix_debuginfo
else
$(cmt_local_G4UserActions_NICOS_Fix_debuginfo_makefile) : $(G4UserActions_NICOS_Fix_debuginfo_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_G4UserActions_NICOS_Fix_debuginfo) ] || \
	  [ ! -f $(cmt_final_setup_G4UserActions_NICOS_Fix_debuginfo) ] || \
	  $(not_G4UserActions_NICOS_Fix_debuginfo_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building G4UserActions_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -tag=$(tags) $(G4UserActions_NICOS_Fix_debuginfo_extratags) build constituent_config -out=$(cmt_local_G4UserActions_NICOS_Fix_debuginfo_makefile) G4UserActions_NICOS_Fix_debuginfo; \
	  fi
endif
...
$(cmt_local_G4UserActions_NICOS_Fix_debuginfo_makefile) : $(G4UserActions_NICOS_Fix_debuginfo_dependencies) build_library_links
	$(echo) "(constituents.make) Building G4UserActions_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -f=$(bin)G4UserActions_NICOS_Fix_debuginfo.in -tag=$(tags) $(G4UserActions_NICOS_Fix_debuginfo_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_G4UserActions_NICOS_Fix_debuginfo_makefile) G4UserActions_NICOS_Fix_debuginfo
else
$(cmt_local_G4UserActions_NICOS_Fix_debuginfo_makefile) : $(G4UserActions_NICOS_Fix_debuginfo_dependencies) $(cmt_build_library_linksstamp) $(bin)G4UserActions_NICOS_Fix_debuginfo.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_G4UserActions_NICOS_Fix_debuginfo) ] || \
	  [ ! -f $(cmt_final_setup_G4UserActions_NICOS_Fix_debuginfo) ] || \
	  $(not_G4UserActions_NICOS_Fix_debuginfo_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(G4UserActions_NICOS_Fix_debuginfo_extratags) build constituent_makefile -out=$(cmt_local_G4UserActions_NICOS_Fix_debuginfo_makefile) G4UserActions_NICOS_Fix_debuginfo

G4UserActions_NICOS_Fix_debuginfo :: $(G4UserActions_NICOS_Fix_debuginfo_dependencies) $(cmt_local_G4UserActions_NICOS_Fix_debuginfo_makefile) dirs G4UserActions_NICOS_Fix_debuginfodirs
	$(echo) "(constituents.make) Starting G4UserActions_NICOS_Fix_debuginfo"
	@if test -f $(cmt_local_G4UserActions_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActions_NICOS_Fix_debuginfo_makefile) G4UserActions_NICOS_Fix_debuginfo; \
	  fi
#	@$(MAKE) -f $(cmt_local_G4UserActions_NICOS_Fix_debuginfo_makefile) G4UserActions_NICOS_Fix_debuginfo
	$(echo) "(constituents.make) G4UserActions_NICOS_Fix_debuginfo done"

clean :: G4UserActions_NICOS_Fix_debuginfoclean ;

G4UserActions_NICOS_Fix_debuginfoclean :: $(G4UserActions_NICOS_Fix_debuginfoclean_dependencies) ##$(cmt_local_G4UserActions_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting G4UserActions_NICOS_Fix_debuginfoclean"
	@-if test -f $(cmt_local_G4UserActions_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActions_NICOS_Fix_debuginfo_makefile) G4UserActions_NICOS_Fix_debuginfoclean; \
	fi
	$(echo) "(constituents.make) G4UserActions_NICOS_Fix_debuginfoclean done"
#	@-$(MAKE) -f $(cmt_local_G4UserActions_NICOS_Fix_debuginfo_makefile) G4UserActions_NICOS_Fix_debuginfoclean

##	  /bin/rm -f $(cmt_local_G4UserActions_NICOS_Fix_debuginfo_makefile) $(bin)G4UserActions_NICOS_Fix_debuginfo_dependencies.make

install :: G4UserActions_NICOS_Fix_debuginfoinstall ;

G4UserActions_NICOS_Fix_debuginfoinstall :: $(G4UserActions_NICOS_Fix_debuginfo_dependencies) $(cmt_local_G4UserActions_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_G4UserActions_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActions_NICOS_Fix_debuginfo_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_G4UserActions_NICOS_Fix_debuginfo_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : G4UserActions_NICOS_Fix_debuginfouninstall

$(foreach d,$(G4UserActions_NICOS_Fix_debuginfo_dependencies),$(eval $(d)uninstall_dependencies += G4UserActions_NICOS_Fix_debuginfouninstall))

G4UserActions_NICOS_Fix_debuginfouninstall : $(G4UserActions_NICOS_Fix_debuginfouninstall_dependencies) ##$(cmt_local_G4UserActions_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_G4UserActions_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_G4UserActions_NICOS_Fix_debuginfo_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_G4UserActions_NICOS_Fix_debuginfo_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: G4UserActions_NICOS_Fix_debuginfouninstall ;
...
cmt_local_tagfile_check_install_python_modules = $(bin)$(G4UserActions_tag)_check_install_python_modules.make
...
cmt_local_tagfile_check_install_python_modules = $(bin)$(G4UserActions_tag).make
...
cmt_local_tagfile_check_install_joboptions = $(bin)$(G4UserActions_tag)_check_install_joboptions.make
...
cmt_local_tagfile_check_install_joboptions = $(bin)$(G4UserActions_tag).make
...
cmt_local_tagfile_find_packages = $(bin)$(G4UserActions_tag)_find_packages.make
...
cmt_local_tagfile_find_packages = $(bin)$(G4UserActions_tag).make
...
cmt_local_tagfile_compile = $(bin)$(G4UserActions_tag)_compile.make
...
cmt_local_tagfile_compile = $(bin)$(G4UserActions_tag).make
...
cmt_local_tagfile_compile_pkg = $(bin)$(G4UserActions_tag)_compile_pkg.make
...
cmt_local_tagfile_compile_pkg = $(bin)$(G4UserActions_tag).make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(G4UserActions_tag)_new_analysisapp.make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(G4UserActions_tag).make
...
cmt_local_tagfile_new_pkg = $(bin)$(G4UserActions_tag)_new_pkg.make
...
cmt_local_tagfile_new_pkg = $(bin)$(G4UserActions_tag).make
...
cmt_local_tagfile_new_alg = $(bin)$(G4UserActions_tag)_new_alg.make
...
cmt_local_tagfile_new_alg = $(bin)$(G4UserActions_tag).make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(G4UserActions_tag)_new_analysisalg.make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(G4UserActions_tag).make
...
cmt_local_tagfile_new_asgtool = $(bin)$(G4UserActions_tag)_new_asgtool.make
...
cmt_local_tagfile_new_asgtool = $(bin)$(G4UserActions_tag).make
...
cmt_local_tagfile_new_jobo = $(bin)$(G4UserActions_tag)_new_jobo.make
...
cmt_local_tagfile_new_jobo = $(bin)$(G4UserActions_tag).make
...
cmt_local_tagfile_new_skeleton = $(bin)$(G4UserActions_tag)_new_skeleton.make
...
cmt_local_tagfile_new_skeleton = $(bin)$(G4UserActions_tag).make
...
cmt_local_tagfile_make_skeleton = $(bin)$(G4UserActions_tag)_make_skeleton.make
...
cmt_local_tagfile_make_skeleton = $(bin)$(G4UserActions_tag).make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(G4UserActions_tag)_checkout_pkg.make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(G4UserActions_tag).make
...
cmt_local_tagfile_cppcheck = $(bin)$(G4UserActions_tag)_cppcheck.make
...
cmt_local_tagfile_cppcheck = $(bin)$(G4UserActions_tag).make
