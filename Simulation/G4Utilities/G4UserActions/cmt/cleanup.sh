...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -sh -pack=G4UserActions -version=G4UserActions-00-01-26 -path=/nfs/dust/atlas/user/tkar/20.20.10.7/Simulation/G4Utilities  $* >${cmtG4UserActionstempfile}
if test $? != 0 ; then
  echo >&2 "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -sh -pack=G4UserActions -version=G4UserActions-00-01-26 -path=/nfs/dust/atlas/user/tkar/20.20.10.7/Simulation/G4Utilities  $* >${cmtG4UserActionstempfile}"
  cmtcleanupstatus=2
