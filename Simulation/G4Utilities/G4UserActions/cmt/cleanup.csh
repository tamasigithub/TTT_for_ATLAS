...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=G4UserActions -version=G4UserActions-00-01-26 -path=/afs/cern.ch/work/t/tkar/testarea/20.20.10.7/Simulation/G4Utilities  $* >${cmtG4UserActionstempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=G4UserActions -version=G4UserActions-00-01-26 -path=/afs/cern.ch/work/t/tkar/testarea/20.20.10.7/Simulation/G4Utilities  $* >${cmtG4UserActionstempfile}"
