...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=WorkArea -version=WorkArea-00-00-00 -path=/afs/cern.ch/work/t/tkar/testarea/20.20.10.7  $* >${cmtWorkAreatempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=WorkArea -version=WorkArea-00-00-00 -path=/afs/cern.ch/work/t/tkar/testarea/20.20.10.7  $* >${cmtWorkAreatempfile}"
