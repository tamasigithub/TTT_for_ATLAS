...
prun --long --exec "run_onGrrid.sh %IN %INPILEUPLOW1 %INPILEUPHIGH1 %INPILEUPLOW2 %INPILEUPHIGH2 %MAXEVENTS %SKIPEVENTS" --extFile TripletTrackFinder_prunJO_Gridhh4b.py --athenaTag 20.20.10.7 --useAthenaPackages --outTarBall tarball-20-20-10-7.tar.gz --outDS user.tkar.hh4bsig5PU200_6/ --inDS mc16_13TeV.309527.PowhegPythia8EvtGen_AZNLO_CTEQ6L1_VBF_2HDM_H_m1000_hh_4b.merge.EVNT.e6415_e5984_tid14487381_00/ --secondaryDSs INPILEUPLOW1:1:$INPILEUPLOW1,INPILEUPHIGH1:1:$INPILEUPHIGH1,INPILEUPLOW2:1:$INPILEUPLOW2,INPILEUPHIGH2:1:$INPILEUPHIGH2 --outputs OUT.AOD.combinedhh4b.pool.root,TTTSiOnly.hh4b.root --nJobs=1 --nEventsPerJob=10 --excludedSite ANALY_MPPMU
