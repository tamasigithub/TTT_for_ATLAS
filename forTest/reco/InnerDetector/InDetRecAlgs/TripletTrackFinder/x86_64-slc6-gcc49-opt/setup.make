...
use InDetCondServices InDetCondServices-01-00-01 InnerDetector/InDetConditions (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasProduction/20.20.10.1)
...
use TrkSurfaces TrkSurfaces-01-03-30 Tracking/TrkDetDescr (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasConditions/20.20.10)
...
use TrkTruthData TrkTruthData-01-00-01 Tracking/TrkEvent (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasEvent/20.20.10)
...
use TrkPrepRawData TrkPrepRawData-07-00-05 Tracking/TrkEvent (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasEvent/20.20.10)
...
use InDetReadoutGeometry InDetReadoutGeometry-02-01-12-00 InnerDetector/InDetDetDescr (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasConditions/20.20.10)
use InDetPrepRawData InDetPrepRawData-02-00-22-01 InnerDetector/InDetRecEvent (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasEvent/20.20.10)
...
no_pack_dist_check (from package TripletTrackFinder) applied [TripletTrackFinder]
----------> CMTPATH
# Add path /cvmfs/atlas.cern.ch/repo/tools/slc6/cmt from CMTUSERCONTEXT
# Add path /afs/cern.ch/work/t/tkar/testarea/20.20.10.1 from initialization
# Add path /cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasProduction/20.20.10.1 from initialization
