...
$(TripletTrackFinderlib) :: $(bin)ReadRDO.o $(bin)SiDet.o $(bin)Frame.o $(bin)Track.o $(bin)TripletParticleReader.o $(bin)TripletTrackFinder_load.o $(bin)TripletTrackFinder_entries.o
...
$(TripletTrackFinderlibname).$(shlibsuffix) :: $(bin)ReadRDO.o $(bin)SiDet.o $(bin)Frame.o $(bin)Track.o $(bin)TripletParticleReader.o $(bin)TripletTrackFinder_load.o $(bin)TripletTrackFinder_entries.o $(use_requirements) $(TripletTrackFinderstamps)
	$(lib_echo) "shared library $@"
	$(lib_silent) $(shlibbuilder) $(shlibflags) -o $@ $(bin)ReadRDO.o $(bin)SiDet.o $(bin)Frame.o $(bin)Track.o $(bin)TripletParticleReader.o $(bin)TripletTrackFinder_load.o $(bin)TripletTrackFinder_entries.o $(TripletTrackFinder_shlibflags)
	$(lib_silent) cat /dev/null >$(TripletTrackFinderstamp) && \
...
TripletTrackFinderclean ::
	...
	$(cleanup_silent) /bin/rm -f $(bin)ReadRDO.o $(bin)SiDet.o $(bin)Frame.o $(bin)Track.o $(bin)TripletParticleReader.o $(bin)TripletTrackFinder_load.o $(bin)TripletTrackFinder_entries.o
	$(cleanup_silent) /bin/rm -f $(patsubst %.o,%.d,$(bin)ReadRDO.o $(bin)SiDet.o $(bin)Frame.o $(bin)Track.o $(bin)TripletParticleReader.o $(bin)TripletTrackFinder_load.o $(bin)TripletTrackFinder_entries.o) $(patsubst %.o,%.dep,$(bin)ReadRDO.o $(bin)SiDet.o $(bin)Frame.o $(bin)Track.o $(bin)TripletParticleReader.o $(bin)TripletTrackFinder_load.o $(bin)TripletTrackFinder_entries.o) $(patsubst %.o,%.d.stamp,$(bin)ReadRDO.o $(bin)SiDet.o $(bin)Frame.o $(bin)Track.o $(bin)TripletParticleReader.o $(bin)TripletTrackFinder_load.o $(bin)TripletTrackFinder_entries.o)
