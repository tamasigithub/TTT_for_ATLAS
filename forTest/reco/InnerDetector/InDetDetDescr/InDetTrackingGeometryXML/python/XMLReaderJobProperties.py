...
class XMLReaderFlags_JobProperties(JobPropertyContainer):
    ...
    def setValuesFromSetup(self,**kwargs):
        ...
        self.addCMOS= True  #kwargs["addCMOS"]
    ...
    def dump(self):
        ...
        print "ID    =>  doPixel ", self.doPix,"  doSCT ",self.doSCT, "  isGMX ",self.isGMX, \
              "  addBCL ",self.addBCL, "  addCMOS ",self.addCMOS
...
jobproperties.XMLReaderFlags_JobProperties.add_JobProperty(addCMOS)
