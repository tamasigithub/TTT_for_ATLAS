...
#cmt_local_tagfile = $(InDetTrackingGeometryXML_tag).make
cmt_local_tagfile = $(bin)$(InDetTrackingGeometryXML_tag).make
...
InDetTrackingGeometryXML_extratags = -tag_add=target_InDetTrackingGeometryXML
...
not_InDetTrackingGeometryXML_dependencies = { n=0; for p in $?; do m=0; for d in $(InDetTrackingGeometryXML_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
InDetTrackingGeometryXMLdirs :
	@if test ! -d $(bin)InDetTrackingGeometryXML; then $(mkdir) -p $(bin)InDetTrackingGeometryXML; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)InDetTrackingGeometryXML
else
InDetTrackingGeometryXMLdirs : ;
endif
...
ifndef QUICK
$(cmt_local_InDetTrackingGeometryXML_makefile) : $(InDetTrackingGeometryXML_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometryXML.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryXML_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometryXML_makefile) InDetTrackingGeometryXML
else
$(cmt_local_InDetTrackingGeometryXML_makefile) : $(InDetTrackingGeometryXML_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometryXML) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometryXML) ] || \
	  $(not_InDetTrackingGeometryXML_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building InDetTrackingGeometryXML.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryXML_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometryXML_makefile) InDetTrackingGeometryXML; \
	  fi
endif
...
$(cmt_local_InDetTrackingGeometryXML_makefile) : $(InDetTrackingGeometryXML_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometryXML.make"; \
	  $(cmtexe) -f=$(bin)InDetTrackingGeometryXML.in -tag=$(tags) $(InDetTrackingGeometryXML_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_InDetTrackingGeometryXML_makefile) InDetTrackingGeometryXML
else
$(cmt_local_InDetTrackingGeometryXML_makefile) : $(InDetTrackingGeometryXML_dependencies) $(cmt_build_library_linksstamp) $(bin)InDetTrackingGeometryXML.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometryXML) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometryXML) ] || \
	  $(not_InDetTrackingGeometryXML_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryXML_extratags) build constituent_makefile -out=$(cmt_local_InDetTrackingGeometryXML_makefile) InDetTrackingGeometryXML

InDetTrackingGeometryXML :: $(InDetTrackingGeometryXML_dependencies) $(cmt_local_InDetTrackingGeometryXML_makefile) dirs InDetTrackingGeometryXMLdirs
	$(echo) "(constituents.make) Starting InDetTrackingGeometryXML"
	@if test -f $(cmt_local_InDetTrackingGeometryXML_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXML_makefile) InDetTrackingGeometryXML; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometryXML_makefile) InDetTrackingGeometryXML
	$(echo) "(constituents.make) InDetTrackingGeometryXML done"

clean :: InDetTrackingGeometryXMLclean ;

InDetTrackingGeometryXMLclean :: $(InDetTrackingGeometryXMLclean_dependencies) ##$(cmt_local_InDetTrackingGeometryXML_makefile)
	$(echo) "(constituents.make) Starting InDetTrackingGeometryXMLclean"
	@-if test -f $(cmt_local_InDetTrackingGeometryXML_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXML_makefile) InDetTrackingGeometryXMLclean; \
	fi
	$(echo) "(constituents.make) InDetTrackingGeometryXMLclean done"
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometryXML_makefile) InDetTrackingGeometryXMLclean

##	  /bin/rm -f $(cmt_local_InDetTrackingGeometryXML_makefile) $(bin)InDetTrackingGeometryXML_dependencies.make

install :: InDetTrackingGeometryXMLinstall ;

InDetTrackingGeometryXMLinstall :: $(InDetTrackingGeometryXML_dependencies) $(cmt_local_InDetTrackingGeometryXML_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_InDetTrackingGeometryXML_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXML_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometryXML_makefile) install
...
$(foreach d,$(InDetTrackingGeometryXML_dependencies),$(eval $(d)uninstall_dependencies += InDetTrackingGeometryXMLuninstall))

InDetTrackingGeometryXMLuninstall : $(InDetTrackingGeometryXMLuninstall_dependencies) ##$(cmt_local_InDetTrackingGeometryXML_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_InDetTrackingGeometryXML_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXML_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometryXML_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: InDetTrackingGeometryXMLuninstall ;
...
InDetTrackingGeometryXML_optdebug_library_extratags = -tag_add=target_InDetTrackingGeometryXML_optdebug_library
...
not_InDetTrackingGeometryXML_optdebug_library_dependencies = { n=0; for p in $?; do m=0; for d in $(InDetTrackingGeometryXML_optdebug_library_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
InDetTrackingGeometryXML_optdebug_librarydirs :
	@if test ! -d $(bin)InDetTrackingGeometryXML_optdebug_library; then $(mkdir) -p $(bin)InDetTrackingGeometryXML_optdebug_library; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)InDetTrackingGeometryXML_optdebug_library
else
InDetTrackingGeometryXML_optdebug_librarydirs : ;
endif
...
ifndef QUICK
$(cmt_local_InDetTrackingGeometryXML_optdebug_library_makefile) : $(InDetTrackingGeometryXML_optdebug_library_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometryXML_optdebug_library.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryXML_optdebug_library_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometryXML_optdebug_library_makefile) InDetTrackingGeometryXML_optdebug_library
else
$(cmt_local_InDetTrackingGeometryXML_optdebug_library_makefile) : $(InDetTrackingGeometryXML_optdebug_library_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometryXML_optdebug_library) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometryXML_optdebug_library) ] || \
	  $(not_InDetTrackingGeometryXML_optdebug_library_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building InDetTrackingGeometryXML_optdebug_library.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryXML_optdebug_library_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometryXML_optdebug_library_makefile) InDetTrackingGeometryXML_optdebug_library; \
	  fi
endif
...
$(cmt_local_InDetTrackingGeometryXML_optdebug_library_makefile) : $(InDetTrackingGeometryXML_optdebug_library_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometryXML_optdebug_library.make"; \
	  $(cmtexe) -f=$(bin)InDetTrackingGeometryXML_optdebug_library.in -tag=$(tags) $(InDetTrackingGeometryXML_optdebug_library_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_InDetTrackingGeometryXML_optdebug_library_makefile) InDetTrackingGeometryXML_optdebug_library
else
$(cmt_local_InDetTrackingGeometryXML_optdebug_library_makefile) : $(InDetTrackingGeometryXML_optdebug_library_dependencies) $(cmt_build_library_linksstamp) $(bin)InDetTrackingGeometryXML_optdebug_library.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometryXML_optdebug_library) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometryXML_optdebug_library) ] || \
	  $(not_InDetTrackingGeometryXML_optdebug_library_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryXML_optdebug_library_extratags) build constituent_makefile -out=$(cmt_local_InDetTrackingGeometryXML_optdebug_library_makefile) InDetTrackingGeometryXML_optdebug_library

InDetTrackingGeometryXML_optdebug_library :: $(InDetTrackingGeometryXML_optdebug_library_dependencies) $(cmt_local_InDetTrackingGeometryXML_optdebug_library_makefile) dirs InDetTrackingGeometryXML_optdebug_librarydirs
	$(echo) "(constituents.make) Starting InDetTrackingGeometryXML_optdebug_library"
	@if test -f $(cmt_local_InDetTrackingGeometryXML_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXML_optdebug_library_makefile) InDetTrackingGeometryXML_optdebug_library; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometryXML_optdebug_library_makefile) InDetTrackingGeometryXML_optdebug_library
	$(echo) "(constituents.make) InDetTrackingGeometryXML_optdebug_library done"

clean :: InDetTrackingGeometryXML_optdebug_libraryclean ;

InDetTrackingGeometryXML_optdebug_libraryclean :: $(InDetTrackingGeometryXML_optdebug_libraryclean_dependencies) ##$(cmt_local_InDetTrackingGeometryXML_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting InDetTrackingGeometryXML_optdebug_libraryclean"
	@-if test -f $(cmt_local_InDetTrackingGeometryXML_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXML_optdebug_library_makefile) InDetTrackingGeometryXML_optdebug_libraryclean; \
	fi
	$(echo) "(constituents.make) InDetTrackingGeometryXML_optdebug_libraryclean done"
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometryXML_optdebug_library_makefile) InDetTrackingGeometryXML_optdebug_libraryclean

##	  /bin/rm -f $(cmt_local_InDetTrackingGeometryXML_optdebug_library_makefile) $(bin)InDetTrackingGeometryXML_optdebug_library_dependencies.make

install :: InDetTrackingGeometryXML_optdebug_libraryinstall ;

InDetTrackingGeometryXML_optdebug_libraryinstall :: $(InDetTrackingGeometryXML_optdebug_library_dependencies) $(cmt_local_InDetTrackingGeometryXML_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_InDetTrackingGeometryXML_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXML_optdebug_library_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometryXML_optdebug_library_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(InDetTrackingGeometryXML_optdebug_library_dependencies),$(eval $(d)uninstall_dependencies += InDetTrackingGeometryXML_optdebug_libraryuninstall))

InDetTrackingGeometryXML_optdebug_libraryuninstall : $(InDetTrackingGeometryXML_optdebug_libraryuninstall_dependencies) ##$(cmt_local_InDetTrackingGeometryXML_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_InDetTrackingGeometryXML_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXML_optdebug_library_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometryXML_optdebug_library_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: InDetTrackingGeometryXML_optdebug_libraryuninstall ;
...
InDetTrackingGeometryXMLConf_extratags = -tag_add=target_InDetTrackingGeometryXMLConf
...
not_InDetTrackingGeometryXMLConf_dependencies = { n=0; for p in $?; do m=0; for d in $(InDetTrackingGeometryXMLConf_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
InDetTrackingGeometryXMLConfdirs :
	@if test ! -d $(bin)InDetTrackingGeometryXMLConf; then $(mkdir) -p $(bin)InDetTrackingGeometryXMLConf; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)InDetTrackingGeometryXMLConf
else
InDetTrackingGeometryXMLConfdirs : ;
endif
...
ifndef QUICK
$(cmt_local_InDetTrackingGeometryXMLConf_makefile) : $(InDetTrackingGeometryXMLConf_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometryXMLConf.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryXMLConf_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometryXMLConf_makefile) InDetTrackingGeometryXMLConf
else
$(cmt_local_InDetTrackingGeometryXMLConf_makefile) : $(InDetTrackingGeometryXMLConf_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometryXMLConf) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometryXMLConf) ] || \
	  $(not_InDetTrackingGeometryXMLConf_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building InDetTrackingGeometryXMLConf.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryXMLConf_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometryXMLConf_makefile) InDetTrackingGeometryXMLConf; \
	  fi
endif
...
$(cmt_local_InDetTrackingGeometryXMLConf_makefile) : $(InDetTrackingGeometryXMLConf_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometryXMLConf.make"; \
	  $(cmtexe) -f=$(bin)InDetTrackingGeometryXMLConf.in -tag=$(tags) $(InDetTrackingGeometryXMLConf_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_InDetTrackingGeometryXMLConf_makefile) InDetTrackingGeometryXMLConf
else
$(cmt_local_InDetTrackingGeometryXMLConf_makefile) : $(InDetTrackingGeometryXMLConf_dependencies) $(cmt_build_library_linksstamp) $(bin)InDetTrackingGeometryXMLConf.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometryXMLConf) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometryXMLConf) ] || \
	  $(not_InDetTrackingGeometryXMLConf_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryXMLConf_extratags) build constituent_makefile -out=$(cmt_local_InDetTrackingGeometryXMLConf_makefile) InDetTrackingGeometryXMLConf

InDetTrackingGeometryXMLConf :: $(InDetTrackingGeometryXMLConf_dependencies) $(cmt_local_InDetTrackingGeometryXMLConf_makefile) dirs InDetTrackingGeometryXMLConfdirs
	$(echo) "(constituents.make) Starting InDetTrackingGeometryXMLConf"
	@if test -f $(cmt_local_InDetTrackingGeometryXMLConf_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLConf_makefile) InDetTrackingGeometryXMLConf; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLConf_makefile) InDetTrackingGeometryXMLConf
	$(echo) "(constituents.make) InDetTrackingGeometryXMLConf done"

clean :: InDetTrackingGeometryXMLConfclean ;

InDetTrackingGeometryXMLConfclean :: $(InDetTrackingGeometryXMLConfclean_dependencies) ##$(cmt_local_InDetTrackingGeometryXMLConf_makefile)
	$(echo) "(constituents.make) Starting InDetTrackingGeometryXMLConfclean"
	@-if test -f $(cmt_local_InDetTrackingGeometryXMLConf_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLConf_makefile) InDetTrackingGeometryXMLConfclean; \
	fi
	$(echo) "(constituents.make) InDetTrackingGeometryXMLConfclean done"
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLConf_makefile) InDetTrackingGeometryXMLConfclean

##	  /bin/rm -f $(cmt_local_InDetTrackingGeometryXMLConf_makefile) $(bin)InDetTrackingGeometryXMLConf_dependencies.make

install :: InDetTrackingGeometryXMLConfinstall ;

InDetTrackingGeometryXMLConfinstall :: $(InDetTrackingGeometryXMLConf_dependencies) $(cmt_local_InDetTrackingGeometryXMLConf_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_InDetTrackingGeometryXMLConf_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLConf_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLConf_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(InDetTrackingGeometryXMLConf_dependencies),$(eval $(d)uninstall_dependencies += InDetTrackingGeometryXMLConfuninstall))

InDetTrackingGeometryXMLConfuninstall : $(InDetTrackingGeometryXMLConfuninstall_dependencies) ##$(cmt_local_InDetTrackingGeometryXMLConf_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_InDetTrackingGeometryXMLConf_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLConf_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLConf_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: InDetTrackingGeometryXMLConfuninstall ;
...
InDetTrackingGeometryXML_python_init_extratags = -tag_add=target_InDetTrackingGeometryXML_python_init
...
not_InDetTrackingGeometryXML_python_init_dependencies = { n=0; for p in $?; do m=0; for d in $(InDetTrackingGeometryXML_python_init_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
InDetTrackingGeometryXML_python_initdirs :
	@if test ! -d $(bin)InDetTrackingGeometryXML_python_init; then $(mkdir) -p $(bin)InDetTrackingGeometryXML_python_init; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)InDetTrackingGeometryXML_python_init
else
InDetTrackingGeometryXML_python_initdirs : ;
endif
...
ifndef QUICK
$(cmt_local_InDetTrackingGeometryXML_python_init_makefile) : $(InDetTrackingGeometryXML_python_init_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometryXML_python_init.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryXML_python_init_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometryXML_python_init_makefile) InDetTrackingGeometryXML_python_init
else
$(cmt_local_InDetTrackingGeometryXML_python_init_makefile) : $(InDetTrackingGeometryXML_python_init_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometryXML_python_init) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometryXML_python_init) ] || \
	  $(not_InDetTrackingGeometryXML_python_init_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building InDetTrackingGeometryXML_python_init.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryXML_python_init_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometryXML_python_init_makefile) InDetTrackingGeometryXML_python_init; \
	  fi
endif
...
$(cmt_local_InDetTrackingGeometryXML_python_init_makefile) : $(InDetTrackingGeometryXML_python_init_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometryXML_python_init.make"; \
	  $(cmtexe) -f=$(bin)InDetTrackingGeometryXML_python_init.in -tag=$(tags) $(InDetTrackingGeometryXML_python_init_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_InDetTrackingGeometryXML_python_init_makefile) InDetTrackingGeometryXML_python_init
else
$(cmt_local_InDetTrackingGeometryXML_python_init_makefile) : $(InDetTrackingGeometryXML_python_init_dependencies) $(cmt_build_library_linksstamp) $(bin)InDetTrackingGeometryXML_python_init.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometryXML_python_init) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometryXML_python_init) ] || \
	  $(not_InDetTrackingGeometryXML_python_init_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryXML_python_init_extratags) build constituent_makefile -out=$(cmt_local_InDetTrackingGeometryXML_python_init_makefile) InDetTrackingGeometryXML_python_init

InDetTrackingGeometryXML_python_init :: $(InDetTrackingGeometryXML_python_init_dependencies) $(cmt_local_InDetTrackingGeometryXML_python_init_makefile) dirs InDetTrackingGeometryXML_python_initdirs
	$(echo) "(constituents.make) Starting InDetTrackingGeometryXML_python_init"
	@if test -f $(cmt_local_InDetTrackingGeometryXML_python_init_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXML_python_init_makefile) InDetTrackingGeometryXML_python_init; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometryXML_python_init_makefile) InDetTrackingGeometryXML_python_init
	$(echo) "(constituents.make) InDetTrackingGeometryXML_python_init done"

clean :: InDetTrackingGeometryXML_python_initclean ;

InDetTrackingGeometryXML_python_initclean :: $(InDetTrackingGeometryXML_python_initclean_dependencies) ##$(cmt_local_InDetTrackingGeometryXML_python_init_makefile)
	$(echo) "(constituents.make) Starting InDetTrackingGeometryXML_python_initclean"
	@-if test -f $(cmt_local_InDetTrackingGeometryXML_python_init_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXML_python_init_makefile) InDetTrackingGeometryXML_python_initclean; \
	fi
	$(echo) "(constituents.make) InDetTrackingGeometryXML_python_initclean done"
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometryXML_python_init_makefile) InDetTrackingGeometryXML_python_initclean

##	  /bin/rm -f $(cmt_local_InDetTrackingGeometryXML_python_init_makefile) $(bin)InDetTrackingGeometryXML_python_init_dependencies.make

install :: InDetTrackingGeometryXML_python_initinstall ;

InDetTrackingGeometryXML_python_initinstall :: $(InDetTrackingGeometryXML_python_init_dependencies) $(cmt_local_InDetTrackingGeometryXML_python_init_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_InDetTrackingGeometryXML_python_init_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXML_python_init_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometryXML_python_init_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(InDetTrackingGeometryXML_python_init_dependencies),$(eval $(d)uninstall_dependencies += InDetTrackingGeometryXML_python_inituninstall))

InDetTrackingGeometryXML_python_inituninstall : $(InDetTrackingGeometryXML_python_inituninstall_dependencies) ##$(cmt_local_InDetTrackingGeometryXML_python_init_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_InDetTrackingGeometryXML_python_init_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXML_python_init_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometryXML_python_init_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: InDetTrackingGeometryXML_python_inituninstall ;
...
InDetTrackingGeometryXMLConfDbMerge_extratags = -tag_add=target_InDetTrackingGeometryXMLConfDbMerge
...
not_InDetTrackingGeometryXMLConfDbMerge_dependencies = { n=0; for p in $?; do m=0; for d in $(InDetTrackingGeometryXMLConfDbMerge_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
InDetTrackingGeometryXMLConfDbMergedirs :
	@if test ! -d $(bin)InDetTrackingGeometryXMLConfDbMerge; then $(mkdir) -p $(bin)InDetTrackingGeometryXMLConfDbMerge; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)InDetTrackingGeometryXMLConfDbMerge
else
InDetTrackingGeometryXMLConfDbMergedirs : ;
endif
...
ifndef QUICK
$(cmt_local_InDetTrackingGeometryXMLConfDbMerge_makefile) : $(InDetTrackingGeometryXMLConfDbMerge_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometryXMLConfDbMerge.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryXMLConfDbMerge_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometryXMLConfDbMerge_makefile) InDetTrackingGeometryXMLConfDbMerge
else
$(cmt_local_InDetTrackingGeometryXMLConfDbMerge_makefile) : $(InDetTrackingGeometryXMLConfDbMerge_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometryXMLConfDbMerge) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometryXMLConfDbMerge) ] || \
	  $(not_InDetTrackingGeometryXMLConfDbMerge_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building InDetTrackingGeometryXMLConfDbMerge.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryXMLConfDbMerge_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometryXMLConfDbMerge_makefile) InDetTrackingGeometryXMLConfDbMerge; \
	  fi
endif
...
$(cmt_local_InDetTrackingGeometryXMLConfDbMerge_makefile) : $(InDetTrackingGeometryXMLConfDbMerge_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometryXMLConfDbMerge.make"; \
	  $(cmtexe) -f=$(bin)InDetTrackingGeometryXMLConfDbMerge.in -tag=$(tags) $(InDetTrackingGeometryXMLConfDbMerge_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_InDetTrackingGeometryXMLConfDbMerge_makefile) InDetTrackingGeometryXMLConfDbMerge
else
$(cmt_local_InDetTrackingGeometryXMLConfDbMerge_makefile) : $(InDetTrackingGeometryXMLConfDbMerge_dependencies) $(cmt_build_library_linksstamp) $(bin)InDetTrackingGeometryXMLConfDbMerge.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometryXMLConfDbMerge) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometryXMLConfDbMerge) ] || \
	  $(not_InDetTrackingGeometryXMLConfDbMerge_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryXMLConfDbMerge_extratags) build constituent_makefile -out=$(cmt_local_InDetTrackingGeometryXMLConfDbMerge_makefile) InDetTrackingGeometryXMLConfDbMerge

InDetTrackingGeometryXMLConfDbMerge :: $(InDetTrackingGeometryXMLConfDbMerge_dependencies) $(cmt_local_InDetTrackingGeometryXMLConfDbMerge_makefile) dirs InDetTrackingGeometryXMLConfDbMergedirs
	$(echo) "(constituents.make) Starting InDetTrackingGeometryXMLConfDbMerge"
	@if test -f $(cmt_local_InDetTrackingGeometryXMLConfDbMerge_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLConfDbMerge_makefile) InDetTrackingGeometryXMLConfDbMerge; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLConfDbMerge_makefile) InDetTrackingGeometryXMLConfDbMerge
	$(echo) "(constituents.make) InDetTrackingGeometryXMLConfDbMerge done"

clean :: InDetTrackingGeometryXMLConfDbMergeclean ;

InDetTrackingGeometryXMLConfDbMergeclean :: $(InDetTrackingGeometryXMLConfDbMergeclean_dependencies) ##$(cmt_local_InDetTrackingGeometryXMLConfDbMerge_makefile)
	$(echo) "(constituents.make) Starting InDetTrackingGeometryXMLConfDbMergeclean"
	@-if test -f $(cmt_local_InDetTrackingGeometryXMLConfDbMerge_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLConfDbMerge_makefile) InDetTrackingGeometryXMLConfDbMergeclean; \
	fi
	$(echo) "(constituents.make) InDetTrackingGeometryXMLConfDbMergeclean done"
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLConfDbMerge_makefile) InDetTrackingGeometryXMLConfDbMergeclean

##	  /bin/rm -f $(cmt_local_InDetTrackingGeometryXMLConfDbMerge_makefile) $(bin)InDetTrackingGeometryXMLConfDbMerge_dependencies.make

install :: InDetTrackingGeometryXMLConfDbMergeinstall ;

InDetTrackingGeometryXMLConfDbMergeinstall :: $(InDetTrackingGeometryXMLConfDbMerge_dependencies) $(cmt_local_InDetTrackingGeometryXMLConfDbMerge_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_InDetTrackingGeometryXMLConfDbMerge_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLConfDbMerge_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLConfDbMerge_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : InDetTrackingGeometryXMLConfDbMergeuninstall

$(foreach d,$(InDetTrackingGeometryXMLConfDbMerge_dependencies),$(eval $(d)uninstall_dependencies += InDetTrackingGeometryXMLConfDbMergeuninstall))

InDetTrackingGeometryXMLConfDbMergeuninstall : $(InDetTrackingGeometryXMLConfDbMergeuninstall_dependencies) ##$(cmt_local_InDetTrackingGeometryXMLConfDbMerge_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_InDetTrackingGeometryXMLConfDbMerge_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLConfDbMerge_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLConfDbMerge_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: InDetTrackingGeometryXMLConfDbMergeuninstall ;
...
InDetTrackingGeometryXMLComponentsList_extratags = -tag_add=target_InDetTrackingGeometryXMLComponentsList
...
not_InDetTrackingGeometryXMLComponentsList_dependencies = { n=0; for p in $?; do m=0; for d in $(InDetTrackingGeometryXMLComponentsList_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
InDetTrackingGeometryXMLComponentsListdirs :
	@if test ! -d $(bin)InDetTrackingGeometryXMLComponentsList; then $(mkdir) -p $(bin)InDetTrackingGeometryXMLComponentsList; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)InDetTrackingGeometryXMLComponentsList
else
InDetTrackingGeometryXMLComponentsListdirs : ;
endif
...
ifndef QUICK
$(cmt_local_InDetTrackingGeometryXMLComponentsList_makefile) : $(InDetTrackingGeometryXMLComponentsList_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometryXMLComponentsList.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryXMLComponentsList_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometryXMLComponentsList_makefile) InDetTrackingGeometryXMLComponentsList
else
$(cmt_local_InDetTrackingGeometryXMLComponentsList_makefile) : $(InDetTrackingGeometryXMLComponentsList_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometryXMLComponentsList) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometryXMLComponentsList) ] || \
	  $(not_InDetTrackingGeometryXMLComponentsList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building InDetTrackingGeometryXMLComponentsList.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryXMLComponentsList_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometryXMLComponentsList_makefile) InDetTrackingGeometryXMLComponentsList; \
	  fi
endif
...
$(cmt_local_InDetTrackingGeometryXMLComponentsList_makefile) : $(InDetTrackingGeometryXMLComponentsList_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometryXMLComponentsList.make"; \
	  $(cmtexe) -f=$(bin)InDetTrackingGeometryXMLComponentsList.in -tag=$(tags) $(InDetTrackingGeometryXMLComponentsList_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_InDetTrackingGeometryXMLComponentsList_makefile) InDetTrackingGeometryXMLComponentsList
else
$(cmt_local_InDetTrackingGeometryXMLComponentsList_makefile) : $(InDetTrackingGeometryXMLComponentsList_dependencies) $(cmt_build_library_linksstamp) $(bin)InDetTrackingGeometryXMLComponentsList.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometryXMLComponentsList) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometryXMLComponentsList) ] || \
	  $(not_InDetTrackingGeometryXMLComponentsList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryXMLComponentsList_extratags) build constituent_makefile -out=$(cmt_local_InDetTrackingGeometryXMLComponentsList_makefile) InDetTrackingGeometryXMLComponentsList

InDetTrackingGeometryXMLComponentsList :: $(InDetTrackingGeometryXMLComponentsList_dependencies) $(cmt_local_InDetTrackingGeometryXMLComponentsList_makefile) dirs InDetTrackingGeometryXMLComponentsListdirs
	$(echo) "(constituents.make) Starting InDetTrackingGeometryXMLComponentsList"
	@if test -f $(cmt_local_InDetTrackingGeometryXMLComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLComponentsList_makefile) InDetTrackingGeometryXMLComponentsList; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLComponentsList_makefile) InDetTrackingGeometryXMLComponentsList
	$(echo) "(constituents.make) InDetTrackingGeometryXMLComponentsList done"

clean :: InDetTrackingGeometryXMLComponentsListclean ;

InDetTrackingGeometryXMLComponentsListclean :: $(InDetTrackingGeometryXMLComponentsListclean_dependencies) ##$(cmt_local_InDetTrackingGeometryXMLComponentsList_makefile)
	$(echo) "(constituents.make) Starting InDetTrackingGeometryXMLComponentsListclean"
	@-if test -f $(cmt_local_InDetTrackingGeometryXMLComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLComponentsList_makefile) InDetTrackingGeometryXMLComponentsListclean; \
	fi
	$(echo) "(constituents.make) InDetTrackingGeometryXMLComponentsListclean done"
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLComponentsList_makefile) InDetTrackingGeometryXMLComponentsListclean

##	  /bin/rm -f $(cmt_local_InDetTrackingGeometryXMLComponentsList_makefile) $(bin)InDetTrackingGeometryXMLComponentsList_dependencies.make

install :: InDetTrackingGeometryXMLComponentsListinstall ;

InDetTrackingGeometryXMLComponentsListinstall :: $(InDetTrackingGeometryXMLComponentsList_dependencies) $(cmt_local_InDetTrackingGeometryXMLComponentsList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_InDetTrackingGeometryXMLComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLComponentsList_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLComponentsList_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(InDetTrackingGeometryXMLComponentsList_dependencies),$(eval $(d)uninstall_dependencies += InDetTrackingGeometryXMLComponentsListuninstall))

InDetTrackingGeometryXMLComponentsListuninstall : $(InDetTrackingGeometryXMLComponentsListuninstall_dependencies) ##$(cmt_local_InDetTrackingGeometryXMLComponentsList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_InDetTrackingGeometryXMLComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLComponentsList_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLComponentsList_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: InDetTrackingGeometryXMLComponentsListuninstall ;
...
InDetTrackingGeometryXMLMergeComponentsList_extratags = -tag_add=target_InDetTrackingGeometryXMLMergeComponentsList
...
not_InDetTrackingGeometryXMLMergeComponentsList_dependencies = { n=0; for p in $?; do m=0; for d in $(InDetTrackingGeometryXMLMergeComponentsList_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
InDetTrackingGeometryXMLMergeComponentsListdirs :
	@if test ! -d $(bin)InDetTrackingGeometryXMLMergeComponentsList; then $(mkdir) -p $(bin)InDetTrackingGeometryXMLMergeComponentsList; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)InDetTrackingGeometryXMLMergeComponentsList
else
InDetTrackingGeometryXMLMergeComponentsListdirs : ;
endif
...
ifndef QUICK
$(cmt_local_InDetTrackingGeometryXMLMergeComponentsList_makefile) : $(InDetTrackingGeometryXMLMergeComponentsList_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometryXMLMergeComponentsList.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryXMLMergeComponentsList_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometryXMLMergeComponentsList_makefile) InDetTrackingGeometryXMLMergeComponentsList
else
$(cmt_local_InDetTrackingGeometryXMLMergeComponentsList_makefile) : $(InDetTrackingGeometryXMLMergeComponentsList_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometryXMLMergeComponentsList) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometryXMLMergeComponentsList) ] || \
	  $(not_InDetTrackingGeometryXMLMergeComponentsList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building InDetTrackingGeometryXMLMergeComponentsList.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryXMLMergeComponentsList_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometryXMLMergeComponentsList_makefile) InDetTrackingGeometryXMLMergeComponentsList; \
	  fi
endif
...
$(cmt_local_InDetTrackingGeometryXMLMergeComponentsList_makefile) : $(InDetTrackingGeometryXMLMergeComponentsList_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometryXMLMergeComponentsList.make"; \
	  $(cmtexe) -f=$(bin)InDetTrackingGeometryXMLMergeComponentsList.in -tag=$(tags) $(InDetTrackingGeometryXMLMergeComponentsList_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_InDetTrackingGeometryXMLMergeComponentsList_makefile) InDetTrackingGeometryXMLMergeComponentsList
else
$(cmt_local_InDetTrackingGeometryXMLMergeComponentsList_makefile) : $(InDetTrackingGeometryXMLMergeComponentsList_dependencies) $(cmt_build_library_linksstamp) $(bin)InDetTrackingGeometryXMLMergeComponentsList.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometryXMLMergeComponentsList) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometryXMLMergeComponentsList) ] || \
	  $(not_InDetTrackingGeometryXMLMergeComponentsList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryXMLMergeComponentsList_extratags) build constituent_makefile -out=$(cmt_local_InDetTrackingGeometryXMLMergeComponentsList_makefile) InDetTrackingGeometryXMLMergeComponentsList

InDetTrackingGeometryXMLMergeComponentsList :: $(InDetTrackingGeometryXMLMergeComponentsList_dependencies) $(cmt_local_InDetTrackingGeometryXMLMergeComponentsList_makefile) dirs InDetTrackingGeometryXMLMergeComponentsListdirs
	$(echo) "(constituents.make) Starting InDetTrackingGeometryXMLMergeComponentsList"
	@if test -f $(cmt_local_InDetTrackingGeometryXMLMergeComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLMergeComponentsList_makefile) InDetTrackingGeometryXMLMergeComponentsList; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLMergeComponentsList_makefile) InDetTrackingGeometryXMLMergeComponentsList
	$(echo) "(constituents.make) InDetTrackingGeometryXMLMergeComponentsList done"

clean :: InDetTrackingGeometryXMLMergeComponentsListclean ;

InDetTrackingGeometryXMLMergeComponentsListclean :: $(InDetTrackingGeometryXMLMergeComponentsListclean_dependencies) ##$(cmt_local_InDetTrackingGeometryXMLMergeComponentsList_makefile)
	$(echo) "(constituents.make) Starting InDetTrackingGeometryXMLMergeComponentsListclean"
	@-if test -f $(cmt_local_InDetTrackingGeometryXMLMergeComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLMergeComponentsList_makefile) InDetTrackingGeometryXMLMergeComponentsListclean; \
	fi
	$(echo) "(constituents.make) InDetTrackingGeometryXMLMergeComponentsListclean done"
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLMergeComponentsList_makefile) InDetTrackingGeometryXMLMergeComponentsListclean

##	  /bin/rm -f $(cmt_local_InDetTrackingGeometryXMLMergeComponentsList_makefile) $(bin)InDetTrackingGeometryXMLMergeComponentsList_dependencies.make

install :: InDetTrackingGeometryXMLMergeComponentsListinstall ;

InDetTrackingGeometryXMLMergeComponentsListinstall :: $(InDetTrackingGeometryXMLMergeComponentsList_dependencies) $(cmt_local_InDetTrackingGeometryXMLMergeComponentsList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_InDetTrackingGeometryXMLMergeComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLMergeComponentsList_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLMergeComponentsList_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : InDetTrackingGeometryXMLMergeComponentsListuninstall

$(foreach d,$(InDetTrackingGeometryXMLMergeComponentsList_dependencies),$(eval $(d)uninstall_dependencies += InDetTrackingGeometryXMLMergeComponentsListuninstall))

InDetTrackingGeometryXMLMergeComponentsListuninstall : $(InDetTrackingGeometryXMLMergeComponentsListuninstall_dependencies) ##$(cmt_local_InDetTrackingGeometryXMLMergeComponentsList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_InDetTrackingGeometryXMLMergeComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLMergeComponentsList_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLMergeComponentsList_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: InDetTrackingGeometryXMLMergeComponentsListuninstall ;
...
InDetTrackingGeometryXMLCLIDDB_extratags = -tag_add=target_InDetTrackingGeometryXMLCLIDDB
...
not_InDetTrackingGeometryXMLCLIDDB_dependencies = { n=0; for p in $?; do m=0; for d in $(InDetTrackingGeometryXMLCLIDDB_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
InDetTrackingGeometryXMLCLIDDBdirs :
	@if test ! -d $(bin)InDetTrackingGeometryXMLCLIDDB; then $(mkdir) -p $(bin)InDetTrackingGeometryXMLCLIDDB; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)InDetTrackingGeometryXMLCLIDDB
else
InDetTrackingGeometryXMLCLIDDBdirs : ;
endif
...
ifndef QUICK
$(cmt_local_InDetTrackingGeometryXMLCLIDDB_makefile) : $(InDetTrackingGeometryXMLCLIDDB_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometryXMLCLIDDB.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryXMLCLIDDB_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometryXMLCLIDDB_makefile) InDetTrackingGeometryXMLCLIDDB
else
$(cmt_local_InDetTrackingGeometryXMLCLIDDB_makefile) : $(InDetTrackingGeometryXMLCLIDDB_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometryXMLCLIDDB) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometryXMLCLIDDB) ] || \
	  $(not_InDetTrackingGeometryXMLCLIDDB_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building InDetTrackingGeometryXMLCLIDDB.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryXMLCLIDDB_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometryXMLCLIDDB_makefile) InDetTrackingGeometryXMLCLIDDB; \
	  fi
endif
...
$(cmt_local_InDetTrackingGeometryXMLCLIDDB_makefile) : $(InDetTrackingGeometryXMLCLIDDB_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometryXMLCLIDDB.make"; \
	  $(cmtexe) -f=$(bin)InDetTrackingGeometryXMLCLIDDB.in -tag=$(tags) $(InDetTrackingGeometryXMLCLIDDB_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_InDetTrackingGeometryXMLCLIDDB_makefile) InDetTrackingGeometryXMLCLIDDB
else
$(cmt_local_InDetTrackingGeometryXMLCLIDDB_makefile) : $(InDetTrackingGeometryXMLCLIDDB_dependencies) $(cmt_build_library_linksstamp) $(bin)InDetTrackingGeometryXMLCLIDDB.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometryXMLCLIDDB) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometryXMLCLIDDB) ] || \
	  $(not_InDetTrackingGeometryXMLCLIDDB_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryXMLCLIDDB_extratags) build constituent_makefile -out=$(cmt_local_InDetTrackingGeometryXMLCLIDDB_makefile) InDetTrackingGeometryXMLCLIDDB

InDetTrackingGeometryXMLCLIDDB :: $(InDetTrackingGeometryXMLCLIDDB_dependencies) $(cmt_local_InDetTrackingGeometryXMLCLIDDB_makefile) dirs InDetTrackingGeometryXMLCLIDDBdirs
	$(echo) "(constituents.make) Starting InDetTrackingGeometryXMLCLIDDB"
	@if test -f $(cmt_local_InDetTrackingGeometryXMLCLIDDB_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLCLIDDB_makefile) InDetTrackingGeometryXMLCLIDDB; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLCLIDDB_makefile) InDetTrackingGeometryXMLCLIDDB
	$(echo) "(constituents.make) InDetTrackingGeometryXMLCLIDDB done"

clean :: InDetTrackingGeometryXMLCLIDDBclean ;

InDetTrackingGeometryXMLCLIDDBclean :: $(InDetTrackingGeometryXMLCLIDDBclean_dependencies) ##$(cmt_local_InDetTrackingGeometryXMLCLIDDB_makefile)
	$(echo) "(constituents.make) Starting InDetTrackingGeometryXMLCLIDDBclean"
	@-if test -f $(cmt_local_InDetTrackingGeometryXMLCLIDDB_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLCLIDDB_makefile) InDetTrackingGeometryXMLCLIDDBclean; \
	fi
	$(echo) "(constituents.make) InDetTrackingGeometryXMLCLIDDBclean done"
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLCLIDDB_makefile) InDetTrackingGeometryXMLCLIDDBclean

##	  /bin/rm -f $(cmt_local_InDetTrackingGeometryXMLCLIDDB_makefile) $(bin)InDetTrackingGeometryXMLCLIDDB_dependencies.make

install :: InDetTrackingGeometryXMLCLIDDBinstall ;

InDetTrackingGeometryXMLCLIDDBinstall :: $(InDetTrackingGeometryXMLCLIDDB_dependencies) $(cmt_local_InDetTrackingGeometryXMLCLIDDB_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_InDetTrackingGeometryXMLCLIDDB_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLCLIDDB_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLCLIDDB_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : InDetTrackingGeometryXMLCLIDDBuninstall

$(foreach d,$(InDetTrackingGeometryXMLCLIDDB_dependencies),$(eval $(d)uninstall_dependencies += InDetTrackingGeometryXMLCLIDDBuninstall))

InDetTrackingGeometryXMLCLIDDBuninstall : $(InDetTrackingGeometryXMLCLIDDBuninstall_dependencies) ##$(cmt_local_InDetTrackingGeometryXMLCLIDDB_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_InDetTrackingGeometryXMLCLIDDB_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLCLIDDB_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLCLIDDB_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: InDetTrackingGeometryXMLCLIDDBuninstall ;
...
cmt_local_tagfile_install_python_modules = $(bin)$(InDetTrackingGeometryXML_tag)_install_python_modules.make
...
cmt_local_tagfile_install_python_modules = $(bin)$(InDetTrackingGeometryXML_tag).make
...
cmt_InDetTrackingGeometryXMLrchk_has_target_tag = 1

#--------------------------------------

ifdef cmt_InDetTrackingGeometryXMLrchk_has_target_tag

cmt_local_tagfile_InDetTrackingGeometryXMLrchk = $(bin)$(InDetTrackingGeometryXML_tag)_InDetTrackingGeometryXMLrchk.make
cmt_final_setup_InDetTrackingGeometryXMLrchk = $(bin)setup_InDetTrackingGeometryXMLrchk.make
cmt_local_InDetTrackingGeometryXMLrchk_makefile = $(bin)InDetTrackingGeometryXMLrchk.make

InDetTrackingGeometryXMLrchk_extratags = -tag_add=target_InDetTrackingGeometryXMLrchk

else

cmt_local_tagfile_InDetTrackingGeometryXMLrchk = $(bin)$(InDetTrackingGeometryXML_tag).make
cmt_final_setup_InDetTrackingGeometryXMLrchk = $(bin)setup.make
cmt_local_InDetTrackingGeometryXMLrchk_makefile = $(bin)InDetTrackingGeometryXMLrchk.make

endif

not_InDetTrackingGeometryXMLrchk_dependencies = { n=0; for p in $?; do m=0; for d in $(InDetTrackingGeometryXMLrchk_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
InDetTrackingGeometryXMLrchkdirs :
	@if test ! -d $(bin)InDetTrackingGeometryXMLrchk; then $(mkdir) -p $(bin)InDetTrackingGeometryXMLrchk; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)InDetTrackingGeometryXMLrchk
else
InDetTrackingGeometryXMLrchkdirs : ;
endif
...
ifndef QUICK
$(cmt_local_InDetTrackingGeometryXMLrchk_makefile) : $(InDetTrackingGeometryXMLrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometryXMLrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryXMLrchk_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometryXMLrchk_makefile) InDetTrackingGeometryXMLrchk
else
$(cmt_local_InDetTrackingGeometryXMLrchk_makefile) : $(InDetTrackingGeometryXMLrchk_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometryXMLrchk) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometryXMLrchk) ] || \
	  $(not_InDetTrackingGeometryXMLrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building InDetTrackingGeometryXMLrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryXMLrchk_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometryXMLrchk_makefile) InDetTrackingGeometryXMLrchk; \
	  fi
endif
...
$(cmt_local_InDetTrackingGeometryXMLrchk_makefile) : $(InDetTrackingGeometryXMLrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometryXMLrchk.make"; \
	  $(cmtexe) -f=$(bin)InDetTrackingGeometryXMLrchk.in -tag=$(tags) $(InDetTrackingGeometryXMLrchk_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_InDetTrackingGeometryXMLrchk_makefile) InDetTrackingGeometryXMLrchk
else
$(cmt_local_InDetTrackingGeometryXMLrchk_makefile) : $(InDetTrackingGeometryXMLrchk_dependencies) $(cmt_build_library_linksstamp) $(bin)InDetTrackingGeometryXMLrchk.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometryXMLrchk) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometryXMLrchk) ] || \
	  $(not_InDetTrackingGeometryXMLrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryXMLrchk_extratags) build constituent_makefile -out=$(cmt_local_InDetTrackingGeometryXMLrchk_makefile) InDetTrackingGeometryXMLrchk

InDetTrackingGeometryXMLrchk :: $(InDetTrackingGeometryXMLrchk_dependencies) $(cmt_local_InDetTrackingGeometryXMLrchk_makefile) dirs InDetTrackingGeometryXMLrchkdirs
	$(echo) "(constituents.make) Starting InDetTrackingGeometryXMLrchk"
	@if test -f $(cmt_local_InDetTrackingGeometryXMLrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLrchk_makefile) InDetTrackingGeometryXMLrchk; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLrchk_makefile) InDetTrackingGeometryXMLrchk
	$(echo) "(constituents.make) InDetTrackingGeometryXMLrchk done"

clean :: InDetTrackingGeometryXMLrchkclean ;

InDetTrackingGeometryXMLrchkclean :: $(InDetTrackingGeometryXMLrchkclean_dependencies) ##$(cmt_local_InDetTrackingGeometryXMLrchk_makefile)
	$(echo) "(constituents.make) Starting InDetTrackingGeometryXMLrchkclean"
	@-if test -f $(cmt_local_InDetTrackingGeometryXMLrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLrchk_makefile) InDetTrackingGeometryXMLrchkclean; \
	fi
	$(echo) "(constituents.make) InDetTrackingGeometryXMLrchkclean done"
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLrchk_makefile) InDetTrackingGeometryXMLrchkclean

##	  /bin/rm -f $(cmt_local_InDetTrackingGeometryXMLrchk_makefile) $(bin)InDetTrackingGeometryXMLrchk_dependencies.make

install :: InDetTrackingGeometryXMLrchkinstall ;

InDetTrackingGeometryXMLrchkinstall :: $(InDetTrackingGeometryXMLrchk_dependencies) $(cmt_local_InDetTrackingGeometryXMLrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_InDetTrackingGeometryXMLrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLrchk_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLrchk_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : InDetTrackingGeometryXMLrchkuninstall

$(foreach d,$(InDetTrackingGeometryXMLrchk_dependencies),$(eval $(d)uninstall_dependencies += InDetTrackingGeometryXMLrchkuninstall))

InDetTrackingGeometryXMLrchkuninstall : $(InDetTrackingGeometryXMLrchkuninstall_dependencies) ##$(cmt_local_InDetTrackingGeometryXMLrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_InDetTrackingGeometryXMLrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLrchk_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometryXMLrchk_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: InDetTrackingGeometryXMLrchkuninstall ;
...
cmt_local_tagfile_install_root_include_path = $(bin)$(InDetTrackingGeometryXML_tag)_install_root_include_path.make
...
cmt_local_tagfile_install_root_include_path = $(bin)$(InDetTrackingGeometryXML_tag).make
...
cmt_local_tagfile_install_includes = $(bin)$(InDetTrackingGeometryXML_tag)_install_includes.make
...
cmt_local_tagfile_install_includes = $(bin)$(InDetTrackingGeometryXML_tag).make
...
cmt_local_tagfile_make = $(bin)$(InDetTrackingGeometryXML_tag)_make.make
...
cmt_local_tagfile_make = $(bin)$(InDetTrackingGeometryXML_tag).make
...
cmt_local_tagfile_CompilePython = $(bin)$(InDetTrackingGeometryXML_tag)_CompilePython.make
...
cmt_local_tagfile_CompilePython = $(bin)$(InDetTrackingGeometryXML_tag).make
...
cmt_local_tagfile_qmtest_run = $(bin)$(InDetTrackingGeometryXML_tag)_qmtest_run.make
...
cmt_local_tagfile_qmtest_run = $(bin)$(InDetTrackingGeometryXML_tag).make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(InDetTrackingGeometryXML_tag)_qmtest_summarize.make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(InDetTrackingGeometryXML_tag).make
...
cmt_local_tagfile_TestPackage = $(bin)$(InDetTrackingGeometryXML_tag)_TestPackage.make
...
cmt_local_tagfile_TestPackage = $(bin)$(InDetTrackingGeometryXML_tag).make
...
cmt_local_tagfile_TestProject = $(bin)$(InDetTrackingGeometryXML_tag)_TestProject.make
...
cmt_local_tagfile_TestProject = $(bin)$(InDetTrackingGeometryXML_tag).make
...
cmt_local_tagfile_new_rootsys = $(bin)$(InDetTrackingGeometryXML_tag)_new_rootsys.make
...
cmt_local_tagfile_new_rootsys = $(bin)$(InDetTrackingGeometryXML_tag).make
...
cmt_local_tagfile_doxygen = $(bin)$(InDetTrackingGeometryXML_tag)_doxygen.make
...
cmt_local_tagfile_doxygen = $(bin)$(InDetTrackingGeometryXML_tag).make
...
cmt_local_tagfile_post_install = $(bin)$(InDetTrackingGeometryXML_tag)_post_install.make
...
cmt_local_tagfile_post_install = $(bin)$(InDetTrackingGeometryXML_tag).make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(InDetTrackingGeometryXML_tag)_post_merge_rootmap.make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(InDetTrackingGeometryXML_tag).make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(InDetTrackingGeometryXML_tag)_post_merge_genconfdb.make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(InDetTrackingGeometryXML_tag).make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(InDetTrackingGeometryXML_tag)_post_build_tpcnvdb.make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(InDetTrackingGeometryXML_tag).make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(InDetTrackingGeometryXML_tag)_all_post_constituents.make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(InDetTrackingGeometryXML_tag).make
...
cmt_local_tagfile_checkreq = $(bin)$(InDetTrackingGeometryXML_tag)_checkreq.make
...
cmt_local_tagfile_checkreq = $(bin)$(InDetTrackingGeometryXML_tag).make
...
cmt_InDetTrackingGeometryXML_NICOS_Fix_debuginfo_has_no_target_tag = 1

#--------------------------------------

ifdef cmt_InDetTrackingGeometryXML_NICOS_Fix_debuginfo_has_target_tag

cmt_local_tagfile_InDetTrackingGeometryXML_NICOS_Fix_debuginfo = $(bin)$(InDetTrackingGeometryXML_tag)_InDetTrackingGeometryXML_NICOS_Fix_debuginfo.make
cmt_final_setup_InDetTrackingGeometryXML_NICOS_Fix_debuginfo = $(bin)setup_InDetTrackingGeometryXML_NICOS_Fix_debuginfo.make
cmt_local_InDetTrackingGeometryXML_NICOS_Fix_debuginfo_makefile = $(bin)InDetTrackingGeometryXML_NICOS_Fix_debuginfo.make

InDetTrackingGeometryXML_NICOS_Fix_debuginfo_extratags = -tag_add=target_InDetTrackingGeometryXML_NICOS_Fix_debuginfo

else

cmt_local_tagfile_InDetTrackingGeometryXML_NICOS_Fix_debuginfo = $(bin)$(InDetTrackingGeometryXML_tag).make
cmt_final_setup_InDetTrackingGeometryXML_NICOS_Fix_debuginfo = $(bin)setup.make
cmt_local_InDetTrackingGeometryXML_NICOS_Fix_debuginfo_makefile = $(bin)InDetTrackingGeometryXML_NICOS_Fix_debuginfo.make

endif

not_InDetTrackingGeometryXML_NICOS_Fix_debuginfo_dependencies = { n=0; for p in $?; do m=0; for d in $(InDetTrackingGeometryXML_NICOS_Fix_debuginfo_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
InDetTrackingGeometryXML_NICOS_Fix_debuginfodirs :
	@if test ! -d $(bin)InDetTrackingGeometryXML_NICOS_Fix_debuginfo; then $(mkdir) -p $(bin)InDetTrackingGeometryXML_NICOS_Fix_debuginfo; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)InDetTrackingGeometryXML_NICOS_Fix_debuginfo
else
InDetTrackingGeometryXML_NICOS_Fix_debuginfodirs : ;
endif
...
ifndef QUICK
$(cmt_local_InDetTrackingGeometryXML_NICOS_Fix_debuginfo_makefile) : $(InDetTrackingGeometryXML_NICOS_Fix_debuginfo_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometryXML_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryXML_NICOS_Fix_debuginfo_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometryXML_NICOS_Fix_debuginfo_makefile) InDetTrackingGeometryXML_NICOS_Fix_debuginfo
else
$(cmt_local_InDetTrackingGeometryXML_NICOS_Fix_debuginfo_makefile) : $(InDetTrackingGeometryXML_NICOS_Fix_debuginfo_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometryXML_NICOS_Fix_debuginfo) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometryXML_NICOS_Fix_debuginfo) ] || \
	  $(not_InDetTrackingGeometryXML_NICOS_Fix_debuginfo_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building InDetTrackingGeometryXML_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryXML_NICOS_Fix_debuginfo_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometryXML_NICOS_Fix_debuginfo_makefile) InDetTrackingGeometryXML_NICOS_Fix_debuginfo; \
	  fi
endif
...
$(cmt_local_InDetTrackingGeometryXML_NICOS_Fix_debuginfo_makefile) : $(InDetTrackingGeometryXML_NICOS_Fix_debuginfo_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometryXML_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -f=$(bin)InDetTrackingGeometryXML_NICOS_Fix_debuginfo.in -tag=$(tags) $(InDetTrackingGeometryXML_NICOS_Fix_debuginfo_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_InDetTrackingGeometryXML_NICOS_Fix_debuginfo_makefile) InDetTrackingGeometryXML_NICOS_Fix_debuginfo
else
$(cmt_local_InDetTrackingGeometryXML_NICOS_Fix_debuginfo_makefile) : $(InDetTrackingGeometryXML_NICOS_Fix_debuginfo_dependencies) $(cmt_build_library_linksstamp) $(bin)InDetTrackingGeometryXML_NICOS_Fix_debuginfo.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometryXML_NICOS_Fix_debuginfo) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometryXML_NICOS_Fix_debuginfo) ] || \
	  $(not_InDetTrackingGeometryXML_NICOS_Fix_debuginfo_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryXML_NICOS_Fix_debuginfo_extratags) build constituent_makefile -out=$(cmt_local_InDetTrackingGeometryXML_NICOS_Fix_debuginfo_makefile) InDetTrackingGeometryXML_NICOS_Fix_debuginfo

InDetTrackingGeometryXML_NICOS_Fix_debuginfo :: $(InDetTrackingGeometryXML_NICOS_Fix_debuginfo_dependencies) $(cmt_local_InDetTrackingGeometryXML_NICOS_Fix_debuginfo_makefile) dirs InDetTrackingGeometryXML_NICOS_Fix_debuginfodirs
	$(echo) "(constituents.make) Starting InDetTrackingGeometryXML_NICOS_Fix_debuginfo"
	@if test -f $(cmt_local_InDetTrackingGeometryXML_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXML_NICOS_Fix_debuginfo_makefile) InDetTrackingGeometryXML_NICOS_Fix_debuginfo; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometryXML_NICOS_Fix_debuginfo_makefile) InDetTrackingGeometryXML_NICOS_Fix_debuginfo
	$(echo) "(constituents.make) InDetTrackingGeometryXML_NICOS_Fix_debuginfo done"

clean :: InDetTrackingGeometryXML_NICOS_Fix_debuginfoclean ;

InDetTrackingGeometryXML_NICOS_Fix_debuginfoclean :: $(InDetTrackingGeometryXML_NICOS_Fix_debuginfoclean_dependencies) ##$(cmt_local_InDetTrackingGeometryXML_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting InDetTrackingGeometryXML_NICOS_Fix_debuginfoclean"
	@-if test -f $(cmt_local_InDetTrackingGeometryXML_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXML_NICOS_Fix_debuginfo_makefile) InDetTrackingGeometryXML_NICOS_Fix_debuginfoclean; \
	fi
	$(echo) "(constituents.make) InDetTrackingGeometryXML_NICOS_Fix_debuginfoclean done"
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometryXML_NICOS_Fix_debuginfo_makefile) InDetTrackingGeometryXML_NICOS_Fix_debuginfoclean

##	  /bin/rm -f $(cmt_local_InDetTrackingGeometryXML_NICOS_Fix_debuginfo_makefile) $(bin)InDetTrackingGeometryXML_NICOS_Fix_debuginfo_dependencies.make

install :: InDetTrackingGeometryXML_NICOS_Fix_debuginfoinstall ;

InDetTrackingGeometryXML_NICOS_Fix_debuginfoinstall :: $(InDetTrackingGeometryXML_NICOS_Fix_debuginfo_dependencies) $(cmt_local_InDetTrackingGeometryXML_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_InDetTrackingGeometryXML_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXML_NICOS_Fix_debuginfo_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometryXML_NICOS_Fix_debuginfo_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : InDetTrackingGeometryXML_NICOS_Fix_debuginfouninstall

$(foreach d,$(InDetTrackingGeometryXML_NICOS_Fix_debuginfo_dependencies),$(eval $(d)uninstall_dependencies += InDetTrackingGeometryXML_NICOS_Fix_debuginfouninstall))

InDetTrackingGeometryXML_NICOS_Fix_debuginfouninstall : $(InDetTrackingGeometryXML_NICOS_Fix_debuginfouninstall_dependencies) ##$(cmt_local_InDetTrackingGeometryXML_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_InDetTrackingGeometryXML_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryXML_NICOS_Fix_debuginfo_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometryXML_NICOS_Fix_debuginfo_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: InDetTrackingGeometryXML_NICOS_Fix_debuginfouninstall ;
...
cmt_local_tagfile_check_install_python_modules = $(bin)$(InDetTrackingGeometryXML_tag)_check_install_python_modules.make
...
cmt_local_tagfile_check_install_python_modules = $(bin)$(InDetTrackingGeometryXML_tag).make
...
cmt_local_tagfile_check_install_runtime = $(bin)$(InDetTrackingGeometryXML_tag)_check_install_runtime.make
...
cmt_local_tagfile_check_install_runtime = $(bin)$(InDetTrackingGeometryXML_tag).make
...
cmt_local_tagfile_find_packages = $(bin)$(InDetTrackingGeometryXML_tag)_find_packages.make
...
cmt_local_tagfile_find_packages = $(bin)$(InDetTrackingGeometryXML_tag).make
...
cmt_local_tagfile_compile = $(bin)$(InDetTrackingGeometryXML_tag)_compile.make
...
cmt_local_tagfile_compile = $(bin)$(InDetTrackingGeometryXML_tag).make
...
cmt_local_tagfile_compile_pkg = $(bin)$(InDetTrackingGeometryXML_tag)_compile_pkg.make
...
cmt_local_tagfile_compile_pkg = $(bin)$(InDetTrackingGeometryXML_tag).make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(InDetTrackingGeometryXML_tag)_new_analysisapp.make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(InDetTrackingGeometryXML_tag).make
...
cmt_local_tagfile_new_pkg = $(bin)$(InDetTrackingGeometryXML_tag)_new_pkg.make
...
cmt_local_tagfile_new_pkg = $(bin)$(InDetTrackingGeometryXML_tag).make
...
cmt_local_tagfile_new_alg = $(bin)$(InDetTrackingGeometryXML_tag)_new_alg.make
...
cmt_local_tagfile_new_alg = $(bin)$(InDetTrackingGeometryXML_tag).make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(InDetTrackingGeometryXML_tag)_new_analysisalg.make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(InDetTrackingGeometryXML_tag).make
...
cmt_local_tagfile_new_asgtool = $(bin)$(InDetTrackingGeometryXML_tag)_new_asgtool.make
...
cmt_local_tagfile_new_asgtool = $(bin)$(InDetTrackingGeometryXML_tag).make
...
cmt_local_tagfile_new_jobo = $(bin)$(InDetTrackingGeometryXML_tag)_new_jobo.make
...
cmt_local_tagfile_new_jobo = $(bin)$(InDetTrackingGeometryXML_tag).make
...
cmt_local_tagfile_new_skeleton = $(bin)$(InDetTrackingGeometryXML_tag)_new_skeleton.make
...
cmt_local_tagfile_new_skeleton = $(bin)$(InDetTrackingGeometryXML_tag).make
...
cmt_local_tagfile_make_skeleton = $(bin)$(InDetTrackingGeometryXML_tag)_make_skeleton.make
...
cmt_local_tagfile_make_skeleton = $(bin)$(InDetTrackingGeometryXML_tag).make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(InDetTrackingGeometryXML_tag)_checkout_pkg.make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(InDetTrackingGeometryXML_tag).make
...
cmt_local_tagfile_cppcheck = $(bin)$(InDetTrackingGeometryXML_tag)_cppcheck.make
...
cmt_local_tagfile_cppcheck = $(bin)$(InDetTrackingGeometryXML_tag).make
