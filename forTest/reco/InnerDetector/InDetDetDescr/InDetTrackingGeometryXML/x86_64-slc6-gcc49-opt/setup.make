...
# use AtlasBoost AtlasBoost-* External (no_version_directory)
# use TrkGeometry TrkGeometry-* Tracking/TrkDetDescr (no_version_directory)
# use TrkGeometryAlpine TrkGeometryAlpine-* Tracking/TrkDetDescr (no_version_directory)
#   use AtlasPolicy AtlasPolicy-*  (no_version_directory)
#   use TrkGeometry TrkGeometry-* Tracking/TrkDetDescr (no_version_directory)
...
#           use DataModel DataModel-* Control (no_version_directory)
#       use AthenaKernel AthenaKernel-* Control (no_version_directory)
# use GeoModelXml GeoModelXml-* DetectorDescription (no_version_directory)
#   use AtlasPolicy AtlasPolicy-*  (no_version_directory)
#   use GeoModelKernel GeoModelKernel-* DetectorDescription/GeoModel (no_version_directory)
#   use AtlasXercesC AtlasXercesC-* External (no_version_directory)
#   use AtlasCLHEP AtlasCLHEP-* External (no_version_directory) (native_version=2.2.0.4)
...
use GeoModelXml GeoModelXml-00-00-07 DetectorDescription (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasCore/20.20.10)
...
use TrkGeometryAlpine TrkGeometryAlpine-00-00-14 Tracking/TrkDetDescr (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasConditions/20.20.10)
...
no_pack_dist_check (from package InDetTrackingGeometryXML) applied [InDetTrackingGeometryXML]
----------> CMTPATH
