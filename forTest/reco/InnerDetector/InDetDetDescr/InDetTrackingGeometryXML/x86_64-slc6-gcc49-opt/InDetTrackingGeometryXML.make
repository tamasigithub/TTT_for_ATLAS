...
$(InDetTrackingGeometryXMLlib) :: $(bin)BarrelBuilderXML.o $(bin)XMLReaderSvc.o $(bin)XMLUtils.o $(bin)EndcapBuilderXML.o $(bin)LayerProviderXML.o $(bin)GMXReaderSvc.o $(bin)StaveBuilderXML.o $(bin)SiModuleProvider.o $(bin)InDetTrackingGeometryXML_load.o $(bin)InDetTrackingGeometryXML_entries.o
...
$(InDetTrackingGeometryXMLlibname).$(shlibsuffix) :: $(bin)BarrelBuilderXML.o $(bin)XMLReaderSvc.o $(bin)XMLUtils.o $(bin)EndcapBuilderXML.o $(bin)LayerProviderXML.o $(bin)GMXReaderSvc.o $(bin)StaveBuilderXML.o $(bin)SiModuleProvider.o $(bin)InDetTrackingGeometryXML_load.o $(bin)InDetTrackingGeometryXML_entries.o $(use_requirements) $(InDetTrackingGeometryXMLstamps)
	$(lib_echo) "shared library $@"
	$(lib_silent) $(shlibbuilder) $(shlibflags) -o $@ $(bin)BarrelBuilderXML.o $(bin)XMLReaderSvc.o $(bin)XMLUtils.o $(bin)EndcapBuilderXML.o $(bin)LayerProviderXML.o $(bin)GMXReaderSvc.o $(bin)StaveBuilderXML.o $(bin)SiModuleProvider.o $(bin)InDetTrackingGeometryXML_load.o $(bin)InDetTrackingGeometryXML_entries.o $(InDetTrackingGeometryXML_shlibflags)
	$(lib_silent) cat /dev/null >$(InDetTrackingGeometryXMLstamp) && \
...
InDetTrackingGeometryXMLclean ::
	...
	$(cleanup_silent) /bin/rm -f $(bin)BarrelBuilderXML.o $(bin)XMLReaderSvc.o $(bin)XMLUtils.o $(bin)EndcapBuilderXML.o $(bin)LayerProviderXML.o $(bin)GMXReaderSvc.o $(bin)StaveBuilderXML.o $(bin)SiModuleProvider.o $(bin)InDetTrackingGeometryXML_load.o $(bin)InDetTrackingGeometryXML_entries.o
	$(cleanup_silent) /bin/rm -f $(patsubst %.o,%.d,$(bin)BarrelBuilderXML.o $(bin)XMLReaderSvc.o $(bin)XMLUtils.o $(bin)EndcapBuilderXML.o $(bin)LayerProviderXML.o $(bin)GMXReaderSvc.o $(bin)StaveBuilderXML.o $(bin)SiModuleProvider.o $(bin)InDetTrackingGeometryXML_load.o $(bin)InDetTrackingGeometryXML_entries.o) $(patsubst %.o,%.dep,$(bin)BarrelBuilderXML.o $(bin)XMLReaderSvc.o $(bin)XMLUtils.o $(bin)EndcapBuilderXML.o $(bin)LayerProviderXML.o $(bin)GMXReaderSvc.o $(bin)StaveBuilderXML.o $(bin)SiModuleProvider.o $(bin)InDetTrackingGeometryXML_load.o $(bin)InDetTrackingGeometryXML_entries.o) $(patsubst %.o,%.d.stamp,$(bin)BarrelBuilderXML.o $(bin)XMLReaderSvc.o $(bin)XMLUtils.o $(bin)EndcapBuilderXML.o $(bin)LayerProviderXML.o $(bin)GMXReaderSvc.o $(bin)StaveBuilderXML.o $(bin)SiModuleProvider.o $(bin)InDetTrackingGeometryXML_load.o $(bin)InDetTrackingGeometryXML_entries.o)
