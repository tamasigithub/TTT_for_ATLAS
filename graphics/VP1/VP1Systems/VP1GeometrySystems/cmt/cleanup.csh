...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=VP1GeometrySystems -version=VP1GeometrySystems-00-16-09 -path=/nfs/dust/atlas/user/tkar/20.20.10.7/graphics/VP1/VP1Systems  $* >${cmtVP1GeometrySystemstempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=VP1GeometrySystems -version=VP1GeometrySystems-00-16-09 -path=/nfs/dust/atlas/user/tkar/20.20.10.7/graphics/VP1/VP1Systems  $* >${cmtVP1GeometrySystemstempfile}"
