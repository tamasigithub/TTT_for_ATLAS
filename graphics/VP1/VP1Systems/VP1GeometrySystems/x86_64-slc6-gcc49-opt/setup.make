...
#       use EventPrimitives EventPrimitives-* Event (no_version_directory)
#   use TrkSurfaces TrkSurfaces-* Tracking/TrkDetDescr (no_version_directory)
# use VP1Utils VP1Utils-* graphics/VP1 (no_version_directory)
#   use AtlasPolicy AtlasPolicy-*  (no_version_directory)
#   use AtlasCLHEP AtlasCLHEP-* External (no_version_directory) (native_version=2.2.0.4)
#   use CLIDSvc CLIDSvc-* Control (no_version_directory)
#   use GaudiInterface GaudiInterface-* External (no_version_directory)
...
#   use VP1Base VP1Base-* graphics/VP1 (no_version_directory)
#   use VP1Qt VP1Qt-* graphics/VP1 (no_version_directory)
#   use ISF_FatrasDetDescrModel ISF_FatrasDetDescrModel-* Simulation/ISF/ISF_Fatras (no_version_directory)
#     use AtlasPolicy AtlasPolicy-*  (no_version_directory)
#     use AtlasROOT AtlasROOT-* External (no_version_directory)
#     use GeoPrimitives GeoPrimitives-* DetectorDescription (no_version_directory)
#     use Identifier Identifier-* DetectorDescription (no_version_directory)
...
#         use GeoPrimitives GeoPrimitives-* DetectorDescription (no_version_directory)
#     use CLIDSvc CLIDSvc-* Control (no_version_directory)
#     use ISF_FatrasDetDescrInterfaces ISF_FatrasDetDescrInterfaces-* Simulation/ISF/ISF_Fatras (no_version_directory)
#       use AtlasPolicy AtlasPolicy-*  (no_version_directory)
#       use AtlasROOT AtlasROOT-* External (no_version_directory)
#       use GaudiInterface GaudiInterface-* External (no_version_directory)
#       use GeoPrimitives GeoPrimitives-* DetectorDescription (no_version_directory)
...
#   use GeoPrimitives GeoPrimitives-* DetectorDescription (no_version_directory)
#   use EventPrimitives EventPrimitives-* Event (no_version_directory)
# use VP1HEPVis VP1HEPVis-* graphics/VP1 (no_version_directory)
#   use AtlasPolicy AtlasPolicy-*  (no_version_directory)
#   use AtlasCoinInventor AtlasCoinInventor-* External (no_version_directory) (native_version=3.1.3p2)
# use AtlasCLHEP AtlasCLHEP-* External (no_version_directory) (native_version=2.2.0.4)
...
use Qt v* LCG_Interfaces (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/LCGCMT/LCGCMT_81f)
...
use AtlasCoinInventor AtlasCoinInventor-00-01-05 External (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasReconstruction/20.20.10)
...
use AtlasQt4 AtlasQt4-00-00-11 External (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasCore/20.20.10)
use AtlasSoQt AtlasSoQt-00-05-06 External (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasReconstruction/20.20.10)
use VP1Qt VP1Qt-00-06-10 graphics/VP1 (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasAnalysis/20.20.10)
...
use VP1HEPVis VP1HEPVis-00-06-15 graphics/VP1 (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasAnalysis/20.20.10)
...
use MuonAlignmentData MuonAlignmentData-03-01-04 MuonSpectrometer/MuonAlignment (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasConditions/20.20.10)
...
use ISF_FatrasDetDescrInterfaces ISF_FatrasDetDescrInterfaces-00-00-05 Simulation/ISF/ISF_Fatras (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasConditions/20.20.10)
...
use ISF_FatrasDetDescrModel ISF_FatrasDetDescrModel-00-00-18 Simulation/ISF/ISF_Fatras (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasConditions/20.20.10)
use TrkDistortedSurfaces TrkDistortedSurfaces-01-00-01 Tracking/TrkDetDescr (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasConditions/20.20.10)
use MuonReadoutGeometry MuonReadoutGeometry-03-03-13 MuonSpectrometer/MuonDetDescr (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasConditions/20.20.10)
use VP1Base VP1Base-00-23-06 graphics/VP1 (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasAnalysis/20.20.10)
use VP1Utils VP1Utils-00-07-04-03 graphics/VP1 (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasAnalysis/20.20.10)
...
no_pack_dist_check (from package VP1GeometrySystems) applied [VP1GeometrySystems]
----------> CMTPATH
