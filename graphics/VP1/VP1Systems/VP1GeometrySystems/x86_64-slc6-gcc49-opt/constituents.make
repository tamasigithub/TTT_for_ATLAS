...
#cmt_local_tagfile = $(VP1GeometrySystems_tag).make
cmt_local_tagfile = $(bin)$(VP1GeometrySystems_tag).make
...
cmt_VP1GeometrySystemsrchk_has_target_tag = 1

#--------------------------------------

ifdef cmt_VP1GeometrySystemsrchk_has_target_tag

cmt_local_tagfile_VP1GeometrySystemsrchk = $(bin)$(VP1GeometrySystems_tag)_VP1GeometrySystemsrchk.make
cmt_final_setup_VP1GeometrySystemsrchk = $(bin)setup_VP1GeometrySystemsrchk.make
cmt_local_VP1GeometrySystemsrchk_makefile = $(bin)VP1GeometrySystemsrchk.make

VP1GeometrySystemsrchk_extratags = -tag_add=target_VP1GeometrySystemsrchk

else

cmt_local_tagfile_VP1GeometrySystemsrchk = $(bin)$(VP1GeometrySystems_tag).make
cmt_final_setup_VP1GeometrySystemsrchk = $(bin)setup.make
cmt_local_VP1GeometrySystemsrchk_makefile = $(bin)VP1GeometrySystemsrchk.make

endif

not_VP1GeometrySystemsrchk_dependencies = { n=0; for p in $?; do m=0; for d in $(VP1GeometrySystemsrchk_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
VP1GeometrySystemsrchkdirs :
	@if test ! -d $(bin)VP1GeometrySystemsrchk; then $(mkdir) -p $(bin)VP1GeometrySystemsrchk; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)VP1GeometrySystemsrchk
else
VP1GeometrySystemsrchkdirs : ;
endif
...
ifndef QUICK
$(cmt_local_VP1GeometrySystemsrchk_makefile) : $(VP1GeometrySystemsrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building VP1GeometrySystemsrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(VP1GeometrySystemsrchk_extratags) build constituent_config -out=$(cmt_local_VP1GeometrySystemsrchk_makefile) VP1GeometrySystemsrchk
else
$(cmt_local_VP1GeometrySystemsrchk_makefile) : $(VP1GeometrySystemsrchk_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_VP1GeometrySystemsrchk) ] || \
	  [ ! -f $(cmt_final_setup_VP1GeometrySystemsrchk) ] || \
	  $(not_VP1GeometrySystemsrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building VP1GeometrySystemsrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(VP1GeometrySystemsrchk_extratags) build constituent_config -out=$(cmt_local_VP1GeometrySystemsrchk_makefile) VP1GeometrySystemsrchk; \
	  fi
endif
...
$(cmt_local_VP1GeometrySystemsrchk_makefile) : $(VP1GeometrySystemsrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building VP1GeometrySystemsrchk.make"; \
	  $(cmtexe) -f=$(bin)VP1GeometrySystemsrchk.in -tag=$(tags) $(VP1GeometrySystemsrchk_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_VP1GeometrySystemsrchk_makefile) VP1GeometrySystemsrchk
else
$(cmt_local_VP1GeometrySystemsrchk_makefile) : $(VP1GeometrySystemsrchk_dependencies) $(cmt_build_library_linksstamp) $(bin)VP1GeometrySystemsrchk.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_VP1GeometrySystemsrchk) ] || \
	  [ ! -f $(cmt_final_setup_VP1GeometrySystemsrchk) ] || \
	  $(not_VP1GeometrySystemsrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(VP1GeometrySystemsrchk_extratags) build constituent_makefile -out=$(cmt_local_VP1GeometrySystemsrchk_makefile) VP1GeometrySystemsrchk

VP1GeometrySystemsrchk :: $(VP1GeometrySystemsrchk_dependencies) $(cmt_local_VP1GeometrySystemsrchk_makefile) dirs VP1GeometrySystemsrchkdirs
	$(echo) "(constituents.make) Starting VP1GeometrySystemsrchk"
	@if test -f $(cmt_local_VP1GeometrySystemsrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_VP1GeometrySystemsrchk_makefile) VP1GeometrySystemsrchk; \
	  fi
#	@$(MAKE) -f $(cmt_local_VP1GeometrySystemsrchk_makefile) VP1GeometrySystemsrchk
	$(echo) "(constituents.make) VP1GeometrySystemsrchk done"

clean :: VP1GeometrySystemsrchkclean ;

VP1GeometrySystemsrchkclean :: $(VP1GeometrySystemsrchkclean_dependencies) ##$(cmt_local_VP1GeometrySystemsrchk_makefile)
	$(echo) "(constituents.make) Starting VP1GeometrySystemsrchkclean"
	@-if test -f $(cmt_local_VP1GeometrySystemsrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_VP1GeometrySystemsrchk_makefile) VP1GeometrySystemsrchkclean; \
	fi
	$(echo) "(constituents.make) VP1GeometrySystemsrchkclean done"
#	@-$(MAKE) -f $(cmt_local_VP1GeometrySystemsrchk_makefile) VP1GeometrySystemsrchkclean

##	  /bin/rm -f $(cmt_local_VP1GeometrySystemsrchk_makefile) $(bin)VP1GeometrySystemsrchk_dependencies.make

install :: VP1GeometrySystemsrchkinstall ;

VP1GeometrySystemsrchkinstall :: $(VP1GeometrySystemsrchk_dependencies) $(cmt_local_VP1GeometrySystemsrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_VP1GeometrySystemsrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_VP1GeometrySystemsrchk_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_VP1GeometrySystemsrchk_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : VP1GeometrySystemsrchkuninstall

$(foreach d,$(VP1GeometrySystemsrchk_dependencies),$(eval $(d)uninstall_dependencies += VP1GeometrySystemsrchkuninstall))

VP1GeometrySystemsrchkuninstall : $(VP1GeometrySystemsrchkuninstall_dependencies) ##$(cmt_local_VP1GeometrySystemsrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_VP1GeometrySystemsrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_VP1GeometrySystemsrchk_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_VP1GeometrySystemsrchk_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: VP1GeometrySystemsrchkuninstall ;
...
cmt_local_tagfile_install_root_include_path = $(bin)$(VP1GeometrySystems_tag)_install_root_include_path.make
...
cmt_local_tagfile_install_root_include_path = $(bin)$(VP1GeometrySystems_tag).make
...
cmt_local_tagfile_install_includes = $(bin)$(VP1GeometrySystems_tag)_install_includes.make
...
cmt_local_tagfile_install_includes = $(bin)$(VP1GeometrySystems_tag).make
...
cmt_local_tagfile_make = $(bin)$(VP1GeometrySystems_tag)_make.make
...
cmt_local_tagfile_make = $(bin)$(VP1GeometrySystems_tag).make
...
cmt_local_tagfile_CompilePython = $(bin)$(VP1GeometrySystems_tag)_CompilePython.make
...
cmt_local_tagfile_CompilePython = $(bin)$(VP1GeometrySystems_tag).make
...
cmt_local_tagfile_qmtest_run = $(bin)$(VP1GeometrySystems_tag)_qmtest_run.make
...
cmt_local_tagfile_qmtest_run = $(bin)$(VP1GeometrySystems_tag).make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(VP1GeometrySystems_tag)_qmtest_summarize.make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(VP1GeometrySystems_tag).make
...
cmt_local_tagfile_TestPackage = $(bin)$(VP1GeometrySystems_tag)_TestPackage.make
...
cmt_local_tagfile_TestPackage = $(bin)$(VP1GeometrySystems_tag).make
...
cmt_local_tagfile_TestProject = $(bin)$(VP1GeometrySystems_tag)_TestProject.make
...
cmt_local_tagfile_TestProject = $(bin)$(VP1GeometrySystems_tag).make
...
cmt_local_tagfile_new_rootsys = $(bin)$(VP1GeometrySystems_tag)_new_rootsys.make
...
cmt_local_tagfile_new_rootsys = $(bin)$(VP1GeometrySystems_tag).make
...
cmt_local_tagfile_doxygen = $(bin)$(VP1GeometrySystems_tag)_doxygen.make
...
cmt_local_tagfile_doxygen = $(bin)$(VP1GeometrySystems_tag).make
...
cmt_local_tagfile_post_install = $(bin)$(VP1GeometrySystems_tag)_post_install.make
...
cmt_local_tagfile_post_install = $(bin)$(VP1GeometrySystems_tag).make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(VP1GeometrySystems_tag)_post_merge_rootmap.make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(VP1GeometrySystems_tag).make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(VP1GeometrySystems_tag)_post_merge_genconfdb.make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(VP1GeometrySystems_tag).make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(VP1GeometrySystems_tag)_post_build_tpcnvdb.make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(VP1GeometrySystems_tag).make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(VP1GeometrySystems_tag)_all_post_constituents.make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(VP1GeometrySystems_tag).make
...
cmt_local_tagfile_checkreq = $(bin)$(VP1GeometrySystems_tag)_checkreq.make
...
cmt_local_tagfile_checkreq = $(bin)$(VP1GeometrySystems_tag).make
...
buildwithqmake_extratags = -tag_add=target_buildwithqmake
...
not_buildwithqmake_dependencies = { n=0; for p in $?; do m=0; for d in $(buildwithqmake_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
buildwithqmakedirs :
	@if test ! -d $(bin)buildwithqmake; then $(mkdir) -p $(bin)buildwithqmake; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)buildwithqmake
else
buildwithqmakedirs : ;
endif
...
ifndef QUICK
$(cmt_local_buildwithqmake_makefile) : $(buildwithqmake_dependencies) build_library_links
	$(echo) "(constituents.make) Building buildwithqmake.make"; \
	  $(cmtexe) -tag=$(tags) $(buildwithqmake_extratags) build constituent_config -out=$(cmt_local_buildwithqmake_makefile) buildwithqmake
else
$(cmt_local_buildwithqmake_makefile) : $(buildwithqmake_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_buildwithqmake) ] || \
	  [ ! -f $(cmt_final_setup_buildwithqmake) ] || \
	  $(not_buildwithqmake_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building buildwithqmake.make"; \
	  $(cmtexe) -tag=$(tags) $(buildwithqmake_extratags) build constituent_config -out=$(cmt_local_buildwithqmake_makefile) buildwithqmake; \
	  fi
endif
...
$(cmt_local_buildwithqmake_makefile) : $(buildwithqmake_dependencies) build_library_links
	$(echo) "(constituents.make) Building buildwithqmake.make"; \
	  $(cmtexe) -f=$(bin)buildwithqmake.in -tag=$(tags) $(buildwithqmake_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_buildwithqmake_makefile) buildwithqmake
else
$(cmt_local_buildwithqmake_makefile) : $(buildwithqmake_dependencies) $(cmt_build_library_linksstamp) $(bin)buildwithqmake.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_buildwithqmake) ] || \
	  [ ! -f $(cmt_final_setup_buildwithqmake) ] || \
	  $(not_buildwithqmake_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(buildwithqmake_extratags) build constituent_makefile -out=$(cmt_local_buildwithqmake_makefile) buildwithqmake

buildwithqmake :: $(buildwithqmake_dependencies) $(cmt_local_buildwithqmake_makefile) dirs buildwithqmakedirs
	$(echo) "(constituents.make) Starting buildwithqmake"
	@if test -f $(cmt_local_buildwithqmake_makefile); then \
	  $(MAKE) -f $(cmt_local_buildwithqmake_makefile) buildwithqmake; \
	  fi
#	@$(MAKE) -f $(cmt_local_buildwithqmake_makefile) buildwithqmake
	$(echo) "(constituents.make) buildwithqmake done"

clean :: buildwithqmakeclean ;

buildwithqmakeclean :: $(buildwithqmakeclean_dependencies) ##$(cmt_local_buildwithqmake_makefile)
	$(echo) "(constituents.make) Starting buildwithqmakeclean"
	@-if test -f $(cmt_local_buildwithqmake_makefile); then \
	  $(MAKE) -f $(cmt_local_buildwithqmake_makefile) buildwithqmakeclean; \
	fi
	$(echo) "(constituents.make) buildwithqmakeclean done"
#	@-$(MAKE) -f $(cmt_local_buildwithqmake_makefile) buildwithqmakeclean

##	  /bin/rm -f $(cmt_local_buildwithqmake_makefile) $(bin)buildwithqmake_dependencies.make

install :: buildwithqmakeinstall ;

buildwithqmakeinstall :: $(buildwithqmake_dependencies) $(cmt_local_buildwithqmake_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_buildwithqmake_makefile); then \
	  $(MAKE) -f $(cmt_local_buildwithqmake_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_buildwithqmake_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : buildwithqmakeuninstall

$(foreach d,$(buildwithqmake_dependencies),$(eval $(d)uninstall_dependencies += buildwithqmakeuninstall))

buildwithqmakeuninstall : $(buildwithqmakeuninstall_dependencies) ##$(cmt_local_buildwithqmake_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_buildwithqmake_makefile); then \
	  $(MAKE) -f $(cmt_local_buildwithqmake_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_buildwithqmake_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: buildwithqmakeuninstall ;
...
cmt_local_tagfile_find_packages = $(bin)$(VP1GeometrySystems_tag)_find_packages.make
...
cmt_local_tagfile_find_packages = $(bin)$(VP1GeometrySystems_tag).make
...
cmt_local_tagfile_compile = $(bin)$(VP1GeometrySystems_tag)_compile.make
...
cmt_local_tagfile_compile = $(bin)$(VP1GeometrySystems_tag).make
...
cmt_local_tagfile_compile_pkg = $(bin)$(VP1GeometrySystems_tag)_compile_pkg.make
...
cmt_local_tagfile_compile_pkg = $(bin)$(VP1GeometrySystems_tag).make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(VP1GeometrySystems_tag)_new_analysisapp.make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(VP1GeometrySystems_tag).make
...
cmt_local_tagfile_new_pkg = $(bin)$(VP1GeometrySystems_tag)_new_pkg.make
...
cmt_local_tagfile_new_pkg = $(bin)$(VP1GeometrySystems_tag).make
...
cmt_local_tagfile_new_alg = $(bin)$(VP1GeometrySystems_tag)_new_alg.make
...
cmt_local_tagfile_new_alg = $(bin)$(VP1GeometrySystems_tag).make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(VP1GeometrySystems_tag)_new_analysisalg.make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(VP1GeometrySystems_tag).make
...
cmt_local_tagfile_new_asgtool = $(bin)$(VP1GeometrySystems_tag)_new_asgtool.make
...
cmt_local_tagfile_new_asgtool = $(bin)$(VP1GeometrySystems_tag).make
...
cmt_local_tagfile_new_jobo = $(bin)$(VP1GeometrySystems_tag)_new_jobo.make
...
cmt_local_tagfile_new_jobo = $(bin)$(VP1GeometrySystems_tag).make
...
cmt_local_tagfile_new_skeleton = $(bin)$(VP1GeometrySystems_tag)_new_skeleton.make
...
cmt_local_tagfile_new_skeleton = $(bin)$(VP1GeometrySystems_tag).make
...
cmt_local_tagfile_make_skeleton = $(bin)$(VP1GeometrySystems_tag)_make_skeleton.make
...
cmt_local_tagfile_make_skeleton = $(bin)$(VP1GeometrySystems_tag).make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(VP1GeometrySystems_tag)_checkout_pkg.make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(VP1GeometrySystems_tag).make
...
cmt_local_tagfile_cppcheck = $(bin)$(VP1GeometrySystems_tag)_cppcheck.make
...
cmt_local_tagfile_cppcheck = $(bin)$(VP1GeometrySystems_tag).make
