...
#cmt_local_tagfile = $(SCT_G4_SD_tag).make
cmt_local_tagfile = $(bin)$(SCT_G4_SD_tag).make
...
SCT_G4_SD_extratags = -tag_add=target_SCT_G4_SD
...
not_SCT_G4_SD_dependencies = { n=0; for p in $?; do m=0; for d in $(SCT_G4_SD_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SCT_G4_SDdirs :
	@if test ! -d $(bin)SCT_G4_SD; then $(mkdir) -p $(bin)SCT_G4_SD; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SCT_G4_SD
else
SCT_G4_SDdirs : ;
endif
...
ifndef QUICK
$(cmt_local_SCT_G4_SD_makefile) : $(SCT_G4_SD_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_G4_SD.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_G4_SD_extratags) build constituent_config -out=$(cmt_local_SCT_G4_SD_makefile) SCT_G4_SD
else
$(cmt_local_SCT_G4_SD_makefile) : $(SCT_G4_SD_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_G4_SD) ] || \
	  [ ! -f $(cmt_final_setup_SCT_G4_SD) ] || \
	  $(not_SCT_G4_SD_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SCT_G4_SD.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_G4_SD_extratags) build constituent_config -out=$(cmt_local_SCT_G4_SD_makefile) SCT_G4_SD; \
	  fi
endif
...
$(cmt_local_SCT_G4_SD_makefile) : $(SCT_G4_SD_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_G4_SD.make"; \
	  $(cmtexe) -f=$(bin)SCT_G4_SD.in -tag=$(tags) $(SCT_G4_SD_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SCT_G4_SD_makefile) SCT_G4_SD
else
$(cmt_local_SCT_G4_SD_makefile) : $(SCT_G4_SD_dependencies) $(cmt_build_library_linksstamp) $(bin)SCT_G4_SD.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_G4_SD) ] || \
	  [ ! -f $(cmt_final_setup_SCT_G4_SD) ] || \
	  $(not_SCT_G4_SD_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SCT_G4_SD_extratags) build constituent_makefile -out=$(cmt_local_SCT_G4_SD_makefile) SCT_G4_SD

SCT_G4_SD :: $(SCT_G4_SD_dependencies) $(cmt_local_SCT_G4_SD_makefile) dirs SCT_G4_SDdirs
	$(echo) "(constituents.make) Starting SCT_G4_SD"
	@if test -f $(cmt_local_SCT_G4_SD_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SD_makefile) SCT_G4_SD; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_G4_SD_makefile) SCT_G4_SD
	$(echo) "(constituents.make) SCT_G4_SD done"

clean :: SCT_G4_SDclean ;

SCT_G4_SDclean :: $(SCT_G4_SDclean_dependencies) ##$(cmt_local_SCT_G4_SD_makefile)
	$(echo) "(constituents.make) Starting SCT_G4_SDclean"
	@-if test -f $(cmt_local_SCT_G4_SD_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SD_makefile) SCT_G4_SDclean; \
	fi
	$(echo) "(constituents.make) SCT_G4_SDclean done"
#	@-$(MAKE) -f $(cmt_local_SCT_G4_SD_makefile) SCT_G4_SDclean

##	  /bin/rm -f $(cmt_local_SCT_G4_SD_makefile) $(bin)SCT_G4_SD_dependencies.make

install :: SCT_G4_SDinstall ;

SCT_G4_SDinstall :: $(SCT_G4_SD_dependencies) $(cmt_local_SCT_G4_SD_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SCT_G4_SD_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SD_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SCT_G4_SD_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(SCT_G4_SD_dependencies),$(eval $(d)uninstall_dependencies += SCT_G4_SDuninstall))

SCT_G4_SDuninstall : $(SCT_G4_SDuninstall_dependencies) ##$(cmt_local_SCT_G4_SD_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SCT_G4_SD_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SD_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_G4_SD_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SCT_G4_SDuninstall ;
...
SCT_G4_SDConf_extratags = -tag_add=target_SCT_G4_SDConf
...
not_SCT_G4_SDConf_dependencies = { n=0; for p in $?; do m=0; for d in $(SCT_G4_SDConf_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SCT_G4_SDConfdirs :
	@if test ! -d $(bin)SCT_G4_SDConf; then $(mkdir) -p $(bin)SCT_G4_SDConf; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SCT_G4_SDConf
else
SCT_G4_SDConfdirs : ;
endif
...
ifndef QUICK
$(cmt_local_SCT_G4_SDConf_makefile) : $(SCT_G4_SDConf_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_G4_SDConf.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_G4_SDConf_extratags) build constituent_config -out=$(cmt_local_SCT_G4_SDConf_makefile) SCT_G4_SDConf
else
$(cmt_local_SCT_G4_SDConf_makefile) : $(SCT_G4_SDConf_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_G4_SDConf) ] || \
	  [ ! -f $(cmt_final_setup_SCT_G4_SDConf) ] || \
	  $(not_SCT_G4_SDConf_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SCT_G4_SDConf.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_G4_SDConf_extratags) build constituent_config -out=$(cmt_local_SCT_G4_SDConf_makefile) SCT_G4_SDConf; \
	  fi
endif
...
$(cmt_local_SCT_G4_SDConf_makefile) : $(SCT_G4_SDConf_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_G4_SDConf.make"; \
	  $(cmtexe) -f=$(bin)SCT_G4_SDConf.in -tag=$(tags) $(SCT_G4_SDConf_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SCT_G4_SDConf_makefile) SCT_G4_SDConf
else
$(cmt_local_SCT_G4_SDConf_makefile) : $(SCT_G4_SDConf_dependencies) $(cmt_build_library_linksstamp) $(bin)SCT_G4_SDConf.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_G4_SDConf) ] || \
	  [ ! -f $(cmt_final_setup_SCT_G4_SDConf) ] || \
	  $(not_SCT_G4_SDConf_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SCT_G4_SDConf_extratags) build constituent_makefile -out=$(cmt_local_SCT_G4_SDConf_makefile) SCT_G4_SDConf

SCT_G4_SDConf :: $(SCT_G4_SDConf_dependencies) $(cmt_local_SCT_G4_SDConf_makefile) dirs SCT_G4_SDConfdirs
	$(echo) "(constituents.make) Starting SCT_G4_SDConf"
	@if test -f $(cmt_local_SCT_G4_SDConf_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SDConf_makefile) SCT_G4_SDConf; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_G4_SDConf_makefile) SCT_G4_SDConf
	$(echo) "(constituents.make) SCT_G4_SDConf done"

clean :: SCT_G4_SDConfclean ;

SCT_G4_SDConfclean :: $(SCT_G4_SDConfclean_dependencies) ##$(cmt_local_SCT_G4_SDConf_makefile)
	$(echo) "(constituents.make) Starting SCT_G4_SDConfclean"
	@-if test -f $(cmt_local_SCT_G4_SDConf_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SDConf_makefile) SCT_G4_SDConfclean; \
	fi
	$(echo) "(constituents.make) SCT_G4_SDConfclean done"
#	@-$(MAKE) -f $(cmt_local_SCT_G4_SDConf_makefile) SCT_G4_SDConfclean

##	  /bin/rm -f $(cmt_local_SCT_G4_SDConf_makefile) $(bin)SCT_G4_SDConf_dependencies.make

install :: SCT_G4_SDConfinstall ;

SCT_G4_SDConfinstall :: $(SCT_G4_SDConf_dependencies) $(cmt_local_SCT_G4_SDConf_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SCT_G4_SDConf_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SDConf_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SCT_G4_SDConf_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(SCT_G4_SDConf_dependencies),$(eval $(d)uninstall_dependencies += SCT_G4_SDConfuninstall))

SCT_G4_SDConfuninstall : $(SCT_G4_SDConfuninstall_dependencies) ##$(cmt_local_SCT_G4_SDConf_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SCT_G4_SDConf_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SDConf_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_G4_SDConf_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SCT_G4_SDConfuninstall ;
...
SCT_G4_SD_python_init_extratags = -tag_add=target_SCT_G4_SD_python_init
...
not_SCT_G4_SD_python_init_dependencies = { n=0; for p in $?; do m=0; for d in $(SCT_G4_SD_python_init_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SCT_G4_SD_python_initdirs :
	@if test ! -d $(bin)SCT_G4_SD_python_init; then $(mkdir) -p $(bin)SCT_G4_SD_python_init; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SCT_G4_SD_python_init
else
SCT_G4_SD_python_initdirs : ;
endif
...
ifndef QUICK
$(cmt_local_SCT_G4_SD_python_init_makefile) : $(SCT_G4_SD_python_init_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_G4_SD_python_init.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_G4_SD_python_init_extratags) build constituent_config -out=$(cmt_local_SCT_G4_SD_python_init_makefile) SCT_G4_SD_python_init
else
$(cmt_local_SCT_G4_SD_python_init_makefile) : $(SCT_G4_SD_python_init_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_G4_SD_python_init) ] || \
	  [ ! -f $(cmt_final_setup_SCT_G4_SD_python_init) ] || \
	  $(not_SCT_G4_SD_python_init_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SCT_G4_SD_python_init.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_G4_SD_python_init_extratags) build constituent_config -out=$(cmt_local_SCT_G4_SD_python_init_makefile) SCT_G4_SD_python_init; \
	  fi
endif
...
$(cmt_local_SCT_G4_SD_python_init_makefile) : $(SCT_G4_SD_python_init_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_G4_SD_python_init.make"; \
	  $(cmtexe) -f=$(bin)SCT_G4_SD_python_init.in -tag=$(tags) $(SCT_G4_SD_python_init_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SCT_G4_SD_python_init_makefile) SCT_G4_SD_python_init
else
$(cmt_local_SCT_G4_SD_python_init_makefile) : $(SCT_G4_SD_python_init_dependencies) $(cmt_build_library_linksstamp) $(bin)SCT_G4_SD_python_init.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_G4_SD_python_init) ] || \
	  [ ! -f $(cmt_final_setup_SCT_G4_SD_python_init) ] || \
	  $(not_SCT_G4_SD_python_init_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SCT_G4_SD_python_init_extratags) build constituent_makefile -out=$(cmt_local_SCT_G4_SD_python_init_makefile) SCT_G4_SD_python_init

SCT_G4_SD_python_init :: $(SCT_G4_SD_python_init_dependencies) $(cmt_local_SCT_G4_SD_python_init_makefile) dirs SCT_G4_SD_python_initdirs
	$(echo) "(constituents.make) Starting SCT_G4_SD_python_init"
	@if test -f $(cmt_local_SCT_G4_SD_python_init_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SD_python_init_makefile) SCT_G4_SD_python_init; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_G4_SD_python_init_makefile) SCT_G4_SD_python_init
	$(echo) "(constituents.make) SCT_G4_SD_python_init done"

clean :: SCT_G4_SD_python_initclean ;

SCT_G4_SD_python_initclean :: $(SCT_G4_SD_python_initclean_dependencies) ##$(cmt_local_SCT_G4_SD_python_init_makefile)
	$(echo) "(constituents.make) Starting SCT_G4_SD_python_initclean"
	@-if test -f $(cmt_local_SCT_G4_SD_python_init_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SD_python_init_makefile) SCT_G4_SD_python_initclean; \
	fi
	$(echo) "(constituents.make) SCT_G4_SD_python_initclean done"
#	@-$(MAKE) -f $(cmt_local_SCT_G4_SD_python_init_makefile) SCT_G4_SD_python_initclean

##	  /bin/rm -f $(cmt_local_SCT_G4_SD_python_init_makefile) $(bin)SCT_G4_SD_python_init_dependencies.make

install :: SCT_G4_SD_python_initinstall ;

SCT_G4_SD_python_initinstall :: $(SCT_G4_SD_python_init_dependencies) $(cmt_local_SCT_G4_SD_python_init_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SCT_G4_SD_python_init_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SD_python_init_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SCT_G4_SD_python_init_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(SCT_G4_SD_python_init_dependencies),$(eval $(d)uninstall_dependencies += SCT_G4_SD_python_inituninstall))

SCT_G4_SD_python_inituninstall : $(SCT_G4_SD_python_inituninstall_dependencies) ##$(cmt_local_SCT_G4_SD_python_init_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SCT_G4_SD_python_init_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SD_python_init_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_G4_SD_python_init_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SCT_G4_SD_python_inituninstall ;
...
SCT_G4_SDConfDbMerge_extratags = -tag_add=target_SCT_G4_SDConfDbMerge
...
not_SCT_G4_SDConfDbMerge_dependencies = { n=0; for p in $?; do m=0; for d in $(SCT_G4_SDConfDbMerge_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SCT_G4_SDConfDbMergedirs :
	@if test ! -d $(bin)SCT_G4_SDConfDbMerge; then $(mkdir) -p $(bin)SCT_G4_SDConfDbMerge; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SCT_G4_SDConfDbMerge
else
SCT_G4_SDConfDbMergedirs : ;
endif
...
ifndef QUICK
$(cmt_local_SCT_G4_SDConfDbMerge_makefile) : $(SCT_G4_SDConfDbMerge_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_G4_SDConfDbMerge.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_G4_SDConfDbMerge_extratags) build constituent_config -out=$(cmt_local_SCT_G4_SDConfDbMerge_makefile) SCT_G4_SDConfDbMerge
else
$(cmt_local_SCT_G4_SDConfDbMerge_makefile) : $(SCT_G4_SDConfDbMerge_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_G4_SDConfDbMerge) ] || \
	  [ ! -f $(cmt_final_setup_SCT_G4_SDConfDbMerge) ] || \
	  $(not_SCT_G4_SDConfDbMerge_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SCT_G4_SDConfDbMerge.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_G4_SDConfDbMerge_extratags) build constituent_config -out=$(cmt_local_SCT_G4_SDConfDbMerge_makefile) SCT_G4_SDConfDbMerge; \
	  fi
endif
...
$(cmt_local_SCT_G4_SDConfDbMerge_makefile) : $(SCT_G4_SDConfDbMerge_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_G4_SDConfDbMerge.make"; \
	  $(cmtexe) -f=$(bin)SCT_G4_SDConfDbMerge.in -tag=$(tags) $(SCT_G4_SDConfDbMerge_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SCT_G4_SDConfDbMerge_makefile) SCT_G4_SDConfDbMerge
else
$(cmt_local_SCT_G4_SDConfDbMerge_makefile) : $(SCT_G4_SDConfDbMerge_dependencies) $(cmt_build_library_linksstamp) $(bin)SCT_G4_SDConfDbMerge.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_G4_SDConfDbMerge) ] || \
	  [ ! -f $(cmt_final_setup_SCT_G4_SDConfDbMerge) ] || \
	  $(not_SCT_G4_SDConfDbMerge_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SCT_G4_SDConfDbMerge_extratags) build constituent_makefile -out=$(cmt_local_SCT_G4_SDConfDbMerge_makefile) SCT_G4_SDConfDbMerge

SCT_G4_SDConfDbMerge :: $(SCT_G4_SDConfDbMerge_dependencies) $(cmt_local_SCT_G4_SDConfDbMerge_makefile) dirs SCT_G4_SDConfDbMergedirs
	$(echo) "(constituents.make) Starting SCT_G4_SDConfDbMerge"
	@if test -f $(cmt_local_SCT_G4_SDConfDbMerge_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SDConfDbMerge_makefile) SCT_G4_SDConfDbMerge; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_G4_SDConfDbMerge_makefile) SCT_G4_SDConfDbMerge
	$(echo) "(constituents.make) SCT_G4_SDConfDbMerge done"

clean :: SCT_G4_SDConfDbMergeclean ;

SCT_G4_SDConfDbMergeclean :: $(SCT_G4_SDConfDbMergeclean_dependencies) ##$(cmt_local_SCT_G4_SDConfDbMerge_makefile)
	$(echo) "(constituents.make) Starting SCT_G4_SDConfDbMergeclean"
	@-if test -f $(cmt_local_SCT_G4_SDConfDbMerge_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SDConfDbMerge_makefile) SCT_G4_SDConfDbMergeclean; \
	fi
	$(echo) "(constituents.make) SCT_G4_SDConfDbMergeclean done"
#	@-$(MAKE) -f $(cmt_local_SCT_G4_SDConfDbMerge_makefile) SCT_G4_SDConfDbMergeclean

##	  /bin/rm -f $(cmt_local_SCT_G4_SDConfDbMerge_makefile) $(bin)SCT_G4_SDConfDbMerge_dependencies.make

install :: SCT_G4_SDConfDbMergeinstall ;

SCT_G4_SDConfDbMergeinstall :: $(SCT_G4_SDConfDbMerge_dependencies) $(cmt_local_SCT_G4_SDConfDbMerge_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SCT_G4_SDConfDbMerge_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SDConfDbMerge_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SCT_G4_SDConfDbMerge_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : SCT_G4_SDConfDbMergeuninstall

$(foreach d,$(SCT_G4_SDConfDbMerge_dependencies),$(eval $(d)uninstall_dependencies += SCT_G4_SDConfDbMergeuninstall))

SCT_G4_SDConfDbMergeuninstall : $(SCT_G4_SDConfDbMergeuninstall_dependencies) ##$(cmt_local_SCT_G4_SDConfDbMerge_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SCT_G4_SDConfDbMerge_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SDConfDbMerge_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_G4_SDConfDbMerge_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SCT_G4_SDConfDbMergeuninstall ;
...
SCT_G4_SDComponentsList_extratags = -tag_add=target_SCT_G4_SDComponentsList
...
not_SCT_G4_SDComponentsList_dependencies = { n=0; for p in $?; do m=0; for d in $(SCT_G4_SDComponentsList_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SCT_G4_SDComponentsListdirs :
	@if test ! -d $(bin)SCT_G4_SDComponentsList; then $(mkdir) -p $(bin)SCT_G4_SDComponentsList; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SCT_G4_SDComponentsList
else
SCT_G4_SDComponentsListdirs : ;
endif
...
ifndef QUICK
$(cmt_local_SCT_G4_SDComponentsList_makefile) : $(SCT_G4_SDComponentsList_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_G4_SDComponentsList.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_G4_SDComponentsList_extratags) build constituent_config -out=$(cmt_local_SCT_G4_SDComponentsList_makefile) SCT_G4_SDComponentsList
else
$(cmt_local_SCT_G4_SDComponentsList_makefile) : $(SCT_G4_SDComponentsList_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_G4_SDComponentsList) ] || \
	  [ ! -f $(cmt_final_setup_SCT_G4_SDComponentsList) ] || \
	  $(not_SCT_G4_SDComponentsList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SCT_G4_SDComponentsList.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_G4_SDComponentsList_extratags) build constituent_config -out=$(cmt_local_SCT_G4_SDComponentsList_makefile) SCT_G4_SDComponentsList; \
	  fi
endif
...
$(cmt_local_SCT_G4_SDComponentsList_makefile) : $(SCT_G4_SDComponentsList_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_G4_SDComponentsList.make"; \
	  $(cmtexe) -f=$(bin)SCT_G4_SDComponentsList.in -tag=$(tags) $(SCT_G4_SDComponentsList_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SCT_G4_SDComponentsList_makefile) SCT_G4_SDComponentsList
else
$(cmt_local_SCT_G4_SDComponentsList_makefile) : $(SCT_G4_SDComponentsList_dependencies) $(cmt_build_library_linksstamp) $(bin)SCT_G4_SDComponentsList.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_G4_SDComponentsList) ] || \
	  [ ! -f $(cmt_final_setup_SCT_G4_SDComponentsList) ] || \
	  $(not_SCT_G4_SDComponentsList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SCT_G4_SDComponentsList_extratags) build constituent_makefile -out=$(cmt_local_SCT_G4_SDComponentsList_makefile) SCT_G4_SDComponentsList

SCT_G4_SDComponentsList :: $(SCT_G4_SDComponentsList_dependencies) $(cmt_local_SCT_G4_SDComponentsList_makefile) dirs SCT_G4_SDComponentsListdirs
	$(echo) "(constituents.make) Starting SCT_G4_SDComponentsList"
	@if test -f $(cmt_local_SCT_G4_SDComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SDComponentsList_makefile) SCT_G4_SDComponentsList; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_G4_SDComponentsList_makefile) SCT_G4_SDComponentsList
	$(echo) "(constituents.make) SCT_G4_SDComponentsList done"

clean :: SCT_G4_SDComponentsListclean ;

SCT_G4_SDComponentsListclean :: $(SCT_G4_SDComponentsListclean_dependencies) ##$(cmt_local_SCT_G4_SDComponentsList_makefile)
	$(echo) "(constituents.make) Starting SCT_G4_SDComponentsListclean"
	@-if test -f $(cmt_local_SCT_G4_SDComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SDComponentsList_makefile) SCT_G4_SDComponentsListclean; \
	fi
	$(echo) "(constituents.make) SCT_G4_SDComponentsListclean done"
#	@-$(MAKE) -f $(cmt_local_SCT_G4_SDComponentsList_makefile) SCT_G4_SDComponentsListclean

##	  /bin/rm -f $(cmt_local_SCT_G4_SDComponentsList_makefile) $(bin)SCT_G4_SDComponentsList_dependencies.make

install :: SCT_G4_SDComponentsListinstall ;

SCT_G4_SDComponentsListinstall :: $(SCT_G4_SDComponentsList_dependencies) $(cmt_local_SCT_G4_SDComponentsList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SCT_G4_SDComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SDComponentsList_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SCT_G4_SDComponentsList_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(SCT_G4_SDComponentsList_dependencies),$(eval $(d)uninstall_dependencies += SCT_G4_SDComponentsListuninstall))

SCT_G4_SDComponentsListuninstall : $(SCT_G4_SDComponentsListuninstall_dependencies) ##$(cmt_local_SCT_G4_SDComponentsList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SCT_G4_SDComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SDComponentsList_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_G4_SDComponentsList_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SCT_G4_SDComponentsListuninstall ;
...
SCT_G4_SDMergeComponentsList_extratags = -tag_add=target_SCT_G4_SDMergeComponentsList
...
not_SCT_G4_SDMergeComponentsList_dependencies = { n=0; for p in $?; do m=0; for d in $(SCT_G4_SDMergeComponentsList_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SCT_G4_SDMergeComponentsListdirs :
	@if test ! -d $(bin)SCT_G4_SDMergeComponentsList; then $(mkdir) -p $(bin)SCT_G4_SDMergeComponentsList; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SCT_G4_SDMergeComponentsList
else
SCT_G4_SDMergeComponentsListdirs : ;
endif
...
ifndef QUICK
$(cmt_local_SCT_G4_SDMergeComponentsList_makefile) : $(SCT_G4_SDMergeComponentsList_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_G4_SDMergeComponentsList.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_G4_SDMergeComponentsList_extratags) build constituent_config -out=$(cmt_local_SCT_G4_SDMergeComponentsList_makefile) SCT_G4_SDMergeComponentsList
else
$(cmt_local_SCT_G4_SDMergeComponentsList_makefile) : $(SCT_G4_SDMergeComponentsList_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_G4_SDMergeComponentsList) ] || \
	  [ ! -f $(cmt_final_setup_SCT_G4_SDMergeComponentsList) ] || \
	  $(not_SCT_G4_SDMergeComponentsList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SCT_G4_SDMergeComponentsList.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_G4_SDMergeComponentsList_extratags) build constituent_config -out=$(cmt_local_SCT_G4_SDMergeComponentsList_makefile) SCT_G4_SDMergeComponentsList; \
	  fi
endif
...
$(cmt_local_SCT_G4_SDMergeComponentsList_makefile) : $(SCT_G4_SDMergeComponentsList_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_G4_SDMergeComponentsList.make"; \
	  $(cmtexe) -f=$(bin)SCT_G4_SDMergeComponentsList.in -tag=$(tags) $(SCT_G4_SDMergeComponentsList_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SCT_G4_SDMergeComponentsList_makefile) SCT_G4_SDMergeComponentsList
else
$(cmt_local_SCT_G4_SDMergeComponentsList_makefile) : $(SCT_G4_SDMergeComponentsList_dependencies) $(cmt_build_library_linksstamp) $(bin)SCT_G4_SDMergeComponentsList.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_G4_SDMergeComponentsList) ] || \
	  [ ! -f $(cmt_final_setup_SCT_G4_SDMergeComponentsList) ] || \
	  $(not_SCT_G4_SDMergeComponentsList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SCT_G4_SDMergeComponentsList_extratags) build constituent_makefile -out=$(cmt_local_SCT_G4_SDMergeComponentsList_makefile) SCT_G4_SDMergeComponentsList

SCT_G4_SDMergeComponentsList :: $(SCT_G4_SDMergeComponentsList_dependencies) $(cmt_local_SCT_G4_SDMergeComponentsList_makefile) dirs SCT_G4_SDMergeComponentsListdirs
	$(echo) "(constituents.make) Starting SCT_G4_SDMergeComponentsList"
	@if test -f $(cmt_local_SCT_G4_SDMergeComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SDMergeComponentsList_makefile) SCT_G4_SDMergeComponentsList; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_G4_SDMergeComponentsList_makefile) SCT_G4_SDMergeComponentsList
	$(echo) "(constituents.make) SCT_G4_SDMergeComponentsList done"

clean :: SCT_G4_SDMergeComponentsListclean ;

SCT_G4_SDMergeComponentsListclean :: $(SCT_G4_SDMergeComponentsListclean_dependencies) ##$(cmt_local_SCT_G4_SDMergeComponentsList_makefile)
	$(echo) "(constituents.make) Starting SCT_G4_SDMergeComponentsListclean"
	@-if test -f $(cmt_local_SCT_G4_SDMergeComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SDMergeComponentsList_makefile) SCT_G4_SDMergeComponentsListclean; \
	fi
	$(echo) "(constituents.make) SCT_G4_SDMergeComponentsListclean done"
#	@-$(MAKE) -f $(cmt_local_SCT_G4_SDMergeComponentsList_makefile) SCT_G4_SDMergeComponentsListclean

##	  /bin/rm -f $(cmt_local_SCT_G4_SDMergeComponentsList_makefile) $(bin)SCT_G4_SDMergeComponentsList_dependencies.make

install :: SCT_G4_SDMergeComponentsListinstall ;

SCT_G4_SDMergeComponentsListinstall :: $(SCT_G4_SDMergeComponentsList_dependencies) $(cmt_local_SCT_G4_SDMergeComponentsList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SCT_G4_SDMergeComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SDMergeComponentsList_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SCT_G4_SDMergeComponentsList_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : SCT_G4_SDMergeComponentsListuninstall

$(foreach d,$(SCT_G4_SDMergeComponentsList_dependencies),$(eval $(d)uninstall_dependencies += SCT_G4_SDMergeComponentsListuninstall))

SCT_G4_SDMergeComponentsListuninstall : $(SCT_G4_SDMergeComponentsListuninstall_dependencies) ##$(cmt_local_SCT_G4_SDMergeComponentsList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SCT_G4_SDMergeComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SDMergeComponentsList_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_G4_SDMergeComponentsList_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SCT_G4_SDMergeComponentsListuninstall ;
...
SCT_G4_SD_optdebug_library_extratags = -tag_add=target_SCT_G4_SD_optdebug_library
...
not_SCT_G4_SD_optdebug_library_dependencies = { n=0; for p in $?; do m=0; for d in $(SCT_G4_SD_optdebug_library_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SCT_G4_SD_optdebug_librarydirs :
	@if test ! -d $(bin)SCT_G4_SD_optdebug_library; then $(mkdir) -p $(bin)SCT_G4_SD_optdebug_library; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SCT_G4_SD_optdebug_library
else
SCT_G4_SD_optdebug_librarydirs : ;
endif
...
ifndef QUICK
$(cmt_local_SCT_G4_SD_optdebug_library_makefile) : $(SCT_G4_SD_optdebug_library_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_G4_SD_optdebug_library.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_G4_SD_optdebug_library_extratags) build constituent_config -out=$(cmt_local_SCT_G4_SD_optdebug_library_makefile) SCT_G4_SD_optdebug_library
else
$(cmt_local_SCT_G4_SD_optdebug_library_makefile) : $(SCT_G4_SD_optdebug_library_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_G4_SD_optdebug_library) ] || \
	  [ ! -f $(cmt_final_setup_SCT_G4_SD_optdebug_library) ] || \
	  $(not_SCT_G4_SD_optdebug_library_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SCT_G4_SD_optdebug_library.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_G4_SD_optdebug_library_extratags) build constituent_config -out=$(cmt_local_SCT_G4_SD_optdebug_library_makefile) SCT_G4_SD_optdebug_library; \
	  fi
endif
...
$(cmt_local_SCT_G4_SD_optdebug_library_makefile) : $(SCT_G4_SD_optdebug_library_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_G4_SD_optdebug_library.make"; \
	  $(cmtexe) -f=$(bin)SCT_G4_SD_optdebug_library.in -tag=$(tags) $(SCT_G4_SD_optdebug_library_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SCT_G4_SD_optdebug_library_makefile) SCT_G4_SD_optdebug_library
else
$(cmt_local_SCT_G4_SD_optdebug_library_makefile) : $(SCT_G4_SD_optdebug_library_dependencies) $(cmt_build_library_linksstamp) $(bin)SCT_G4_SD_optdebug_library.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_G4_SD_optdebug_library) ] || \
	  [ ! -f $(cmt_final_setup_SCT_G4_SD_optdebug_library) ] || \
	  $(not_SCT_G4_SD_optdebug_library_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SCT_G4_SD_optdebug_library_extratags) build constituent_makefile -out=$(cmt_local_SCT_G4_SD_optdebug_library_makefile) SCT_G4_SD_optdebug_library

SCT_G4_SD_optdebug_library :: $(SCT_G4_SD_optdebug_library_dependencies) $(cmt_local_SCT_G4_SD_optdebug_library_makefile) dirs SCT_G4_SD_optdebug_librarydirs
	$(echo) "(constituents.make) Starting SCT_G4_SD_optdebug_library"
	@if test -f $(cmt_local_SCT_G4_SD_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SD_optdebug_library_makefile) SCT_G4_SD_optdebug_library; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_G4_SD_optdebug_library_makefile) SCT_G4_SD_optdebug_library
	$(echo) "(constituents.make) SCT_G4_SD_optdebug_library done"

clean :: SCT_G4_SD_optdebug_libraryclean ;

SCT_G4_SD_optdebug_libraryclean :: $(SCT_G4_SD_optdebug_libraryclean_dependencies) ##$(cmt_local_SCT_G4_SD_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting SCT_G4_SD_optdebug_libraryclean"
	@-if test -f $(cmt_local_SCT_G4_SD_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SD_optdebug_library_makefile) SCT_G4_SD_optdebug_libraryclean; \
	fi
	$(echo) "(constituents.make) SCT_G4_SD_optdebug_libraryclean done"
#	@-$(MAKE) -f $(cmt_local_SCT_G4_SD_optdebug_library_makefile) SCT_G4_SD_optdebug_libraryclean

##	  /bin/rm -f $(cmt_local_SCT_G4_SD_optdebug_library_makefile) $(bin)SCT_G4_SD_optdebug_library_dependencies.make

install :: SCT_G4_SD_optdebug_libraryinstall ;

SCT_G4_SD_optdebug_libraryinstall :: $(SCT_G4_SD_optdebug_library_dependencies) $(cmt_local_SCT_G4_SD_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SCT_G4_SD_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SD_optdebug_library_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SCT_G4_SD_optdebug_library_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(SCT_G4_SD_optdebug_library_dependencies),$(eval $(d)uninstall_dependencies += SCT_G4_SD_optdebug_libraryuninstall))

SCT_G4_SD_optdebug_libraryuninstall : $(SCT_G4_SD_optdebug_libraryuninstall_dependencies) ##$(cmt_local_SCT_G4_SD_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SCT_G4_SD_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SD_optdebug_library_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_G4_SD_optdebug_library_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SCT_G4_SD_optdebug_libraryuninstall ;
...
SCT_G4_SDCLIDDB_extratags = -tag_add=target_SCT_G4_SDCLIDDB
...
not_SCT_G4_SDCLIDDB_dependencies = { n=0; for p in $?; do m=0; for d in $(SCT_G4_SDCLIDDB_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SCT_G4_SDCLIDDBdirs :
	@if test ! -d $(bin)SCT_G4_SDCLIDDB; then $(mkdir) -p $(bin)SCT_G4_SDCLIDDB; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SCT_G4_SDCLIDDB
else
SCT_G4_SDCLIDDBdirs : ;
endif
...
ifndef QUICK
$(cmt_local_SCT_G4_SDCLIDDB_makefile) : $(SCT_G4_SDCLIDDB_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_G4_SDCLIDDB.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_G4_SDCLIDDB_extratags) build constituent_config -out=$(cmt_local_SCT_G4_SDCLIDDB_makefile) SCT_G4_SDCLIDDB
else
$(cmt_local_SCT_G4_SDCLIDDB_makefile) : $(SCT_G4_SDCLIDDB_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_G4_SDCLIDDB) ] || \
	  [ ! -f $(cmt_final_setup_SCT_G4_SDCLIDDB) ] || \
	  $(not_SCT_G4_SDCLIDDB_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SCT_G4_SDCLIDDB.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_G4_SDCLIDDB_extratags) build constituent_config -out=$(cmt_local_SCT_G4_SDCLIDDB_makefile) SCT_G4_SDCLIDDB; \
	  fi
endif
...
$(cmt_local_SCT_G4_SDCLIDDB_makefile) : $(SCT_G4_SDCLIDDB_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_G4_SDCLIDDB.make"; \
	  $(cmtexe) -f=$(bin)SCT_G4_SDCLIDDB.in -tag=$(tags) $(SCT_G4_SDCLIDDB_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SCT_G4_SDCLIDDB_makefile) SCT_G4_SDCLIDDB
else
$(cmt_local_SCT_G4_SDCLIDDB_makefile) : $(SCT_G4_SDCLIDDB_dependencies) $(cmt_build_library_linksstamp) $(bin)SCT_G4_SDCLIDDB.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_G4_SDCLIDDB) ] || \
	  [ ! -f $(cmt_final_setup_SCT_G4_SDCLIDDB) ] || \
	  $(not_SCT_G4_SDCLIDDB_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SCT_G4_SDCLIDDB_extratags) build constituent_makefile -out=$(cmt_local_SCT_G4_SDCLIDDB_makefile) SCT_G4_SDCLIDDB

SCT_G4_SDCLIDDB :: $(SCT_G4_SDCLIDDB_dependencies) $(cmt_local_SCT_G4_SDCLIDDB_makefile) dirs SCT_G4_SDCLIDDBdirs
	$(echo) "(constituents.make) Starting SCT_G4_SDCLIDDB"
	@if test -f $(cmt_local_SCT_G4_SDCLIDDB_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SDCLIDDB_makefile) SCT_G4_SDCLIDDB; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_G4_SDCLIDDB_makefile) SCT_G4_SDCLIDDB
	$(echo) "(constituents.make) SCT_G4_SDCLIDDB done"

clean :: SCT_G4_SDCLIDDBclean ;

SCT_G4_SDCLIDDBclean :: $(SCT_G4_SDCLIDDBclean_dependencies) ##$(cmt_local_SCT_G4_SDCLIDDB_makefile)
	$(echo) "(constituents.make) Starting SCT_G4_SDCLIDDBclean"
	@-if test -f $(cmt_local_SCT_G4_SDCLIDDB_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SDCLIDDB_makefile) SCT_G4_SDCLIDDBclean; \
	fi
	$(echo) "(constituents.make) SCT_G4_SDCLIDDBclean done"
#	@-$(MAKE) -f $(cmt_local_SCT_G4_SDCLIDDB_makefile) SCT_G4_SDCLIDDBclean

##	  /bin/rm -f $(cmt_local_SCT_G4_SDCLIDDB_makefile) $(bin)SCT_G4_SDCLIDDB_dependencies.make

install :: SCT_G4_SDCLIDDBinstall ;

SCT_G4_SDCLIDDBinstall :: $(SCT_G4_SDCLIDDB_dependencies) $(cmt_local_SCT_G4_SDCLIDDB_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SCT_G4_SDCLIDDB_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SDCLIDDB_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SCT_G4_SDCLIDDB_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : SCT_G4_SDCLIDDBuninstall

$(foreach d,$(SCT_G4_SDCLIDDB_dependencies),$(eval $(d)uninstall_dependencies += SCT_G4_SDCLIDDBuninstall))

SCT_G4_SDCLIDDBuninstall : $(SCT_G4_SDCLIDDBuninstall_dependencies) ##$(cmt_local_SCT_G4_SDCLIDDB_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SCT_G4_SDCLIDDB_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SDCLIDDB_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_G4_SDCLIDDB_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SCT_G4_SDCLIDDBuninstall ;
...
cmt_SCT_G4_SDrchk_has_target_tag = 1

#--------------------------------------

ifdef cmt_SCT_G4_SDrchk_has_target_tag

cmt_local_tagfile_SCT_G4_SDrchk = $(bin)$(SCT_G4_SD_tag)_SCT_G4_SDrchk.make
cmt_final_setup_SCT_G4_SDrchk = $(bin)setup_SCT_G4_SDrchk.make
cmt_local_SCT_G4_SDrchk_makefile = $(bin)SCT_G4_SDrchk.make

SCT_G4_SDrchk_extratags = -tag_add=target_SCT_G4_SDrchk

else

cmt_local_tagfile_SCT_G4_SDrchk = $(bin)$(SCT_G4_SD_tag).make
cmt_final_setup_SCT_G4_SDrchk = $(bin)setup.make
cmt_local_SCT_G4_SDrchk_makefile = $(bin)SCT_G4_SDrchk.make

endif

not_SCT_G4_SDrchk_dependencies = { n=0; for p in $?; do m=0; for d in $(SCT_G4_SDrchk_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SCT_G4_SDrchkdirs :
	@if test ! -d $(bin)SCT_G4_SDrchk; then $(mkdir) -p $(bin)SCT_G4_SDrchk; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SCT_G4_SDrchk
else
SCT_G4_SDrchkdirs : ;
endif
...
ifndef QUICK
$(cmt_local_SCT_G4_SDrchk_makefile) : $(SCT_G4_SDrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_G4_SDrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_G4_SDrchk_extratags) build constituent_config -out=$(cmt_local_SCT_G4_SDrchk_makefile) SCT_G4_SDrchk
else
$(cmt_local_SCT_G4_SDrchk_makefile) : $(SCT_G4_SDrchk_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_G4_SDrchk) ] || \
	  [ ! -f $(cmt_final_setup_SCT_G4_SDrchk) ] || \
	  $(not_SCT_G4_SDrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SCT_G4_SDrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_G4_SDrchk_extratags) build constituent_config -out=$(cmt_local_SCT_G4_SDrchk_makefile) SCT_G4_SDrchk; \
	  fi
endif
...
$(cmt_local_SCT_G4_SDrchk_makefile) : $(SCT_G4_SDrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_G4_SDrchk.make"; \
	  $(cmtexe) -f=$(bin)SCT_G4_SDrchk.in -tag=$(tags) $(SCT_G4_SDrchk_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SCT_G4_SDrchk_makefile) SCT_G4_SDrchk
else
$(cmt_local_SCT_G4_SDrchk_makefile) : $(SCT_G4_SDrchk_dependencies) $(cmt_build_library_linksstamp) $(bin)SCT_G4_SDrchk.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_G4_SDrchk) ] || \
	  [ ! -f $(cmt_final_setup_SCT_G4_SDrchk) ] || \
	  $(not_SCT_G4_SDrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SCT_G4_SDrchk_extratags) build constituent_makefile -out=$(cmt_local_SCT_G4_SDrchk_makefile) SCT_G4_SDrchk

SCT_G4_SDrchk :: $(SCT_G4_SDrchk_dependencies) $(cmt_local_SCT_G4_SDrchk_makefile) dirs SCT_G4_SDrchkdirs
	$(echo) "(constituents.make) Starting SCT_G4_SDrchk"
	@if test -f $(cmt_local_SCT_G4_SDrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SDrchk_makefile) SCT_G4_SDrchk; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_G4_SDrchk_makefile) SCT_G4_SDrchk
	$(echo) "(constituents.make) SCT_G4_SDrchk done"

clean :: SCT_G4_SDrchkclean ;

SCT_G4_SDrchkclean :: $(SCT_G4_SDrchkclean_dependencies) ##$(cmt_local_SCT_G4_SDrchk_makefile)
	$(echo) "(constituents.make) Starting SCT_G4_SDrchkclean"
	@-if test -f $(cmt_local_SCT_G4_SDrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SDrchk_makefile) SCT_G4_SDrchkclean; \
	fi
	$(echo) "(constituents.make) SCT_G4_SDrchkclean done"
#	@-$(MAKE) -f $(cmt_local_SCT_G4_SDrchk_makefile) SCT_G4_SDrchkclean

##	  /bin/rm -f $(cmt_local_SCT_G4_SDrchk_makefile) $(bin)SCT_G4_SDrchk_dependencies.make

install :: SCT_G4_SDrchkinstall ;

SCT_G4_SDrchkinstall :: $(SCT_G4_SDrchk_dependencies) $(cmt_local_SCT_G4_SDrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SCT_G4_SDrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SDrchk_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SCT_G4_SDrchk_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : SCT_G4_SDrchkuninstall

$(foreach d,$(SCT_G4_SDrchk_dependencies),$(eval $(d)uninstall_dependencies += SCT_G4_SDrchkuninstall))

SCT_G4_SDrchkuninstall : $(SCT_G4_SDrchkuninstall_dependencies) ##$(cmt_local_SCT_G4_SDrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SCT_G4_SDrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SDrchk_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_G4_SDrchk_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SCT_G4_SDrchkuninstall ;
...
cmt_local_tagfile_install_root_include_path = $(bin)$(SCT_G4_SD_tag)_install_root_include_path.make
...
cmt_local_tagfile_install_root_include_path = $(bin)$(SCT_G4_SD_tag).make
...
cmt_local_tagfile_install_includes = $(bin)$(SCT_G4_SD_tag)_install_includes.make
...
cmt_local_tagfile_install_includes = $(bin)$(SCT_G4_SD_tag).make
...
cmt_local_tagfile_make = $(bin)$(SCT_G4_SD_tag)_make.make
...
cmt_local_tagfile_make = $(bin)$(SCT_G4_SD_tag).make
...
cmt_local_tagfile_CompilePython = $(bin)$(SCT_G4_SD_tag)_CompilePython.make
...
cmt_local_tagfile_CompilePython = $(bin)$(SCT_G4_SD_tag).make
...
cmt_local_tagfile_qmtest_run = $(bin)$(SCT_G4_SD_tag)_qmtest_run.make
...
cmt_local_tagfile_qmtest_run = $(bin)$(SCT_G4_SD_tag).make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(SCT_G4_SD_tag)_qmtest_summarize.make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(SCT_G4_SD_tag).make
...
cmt_local_tagfile_TestPackage = $(bin)$(SCT_G4_SD_tag)_TestPackage.make
...
cmt_local_tagfile_TestPackage = $(bin)$(SCT_G4_SD_tag).make
...
cmt_local_tagfile_TestProject = $(bin)$(SCT_G4_SD_tag)_TestProject.make
...
cmt_local_tagfile_TestProject = $(bin)$(SCT_G4_SD_tag).make
...
cmt_local_tagfile_new_rootsys = $(bin)$(SCT_G4_SD_tag)_new_rootsys.make
...
cmt_local_tagfile_new_rootsys = $(bin)$(SCT_G4_SD_tag).make
...
cmt_local_tagfile_doxygen = $(bin)$(SCT_G4_SD_tag)_doxygen.make
...
cmt_local_tagfile_doxygen = $(bin)$(SCT_G4_SD_tag).make
...
cmt_local_tagfile_post_install = $(bin)$(SCT_G4_SD_tag)_post_install.make
...
cmt_local_tagfile_post_install = $(bin)$(SCT_G4_SD_tag).make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(SCT_G4_SD_tag)_post_merge_rootmap.make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(SCT_G4_SD_tag).make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(SCT_G4_SD_tag)_post_merge_genconfdb.make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(SCT_G4_SD_tag).make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(SCT_G4_SD_tag)_post_build_tpcnvdb.make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(SCT_G4_SD_tag).make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(SCT_G4_SD_tag)_all_post_constituents.make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(SCT_G4_SD_tag).make
...
cmt_local_tagfile_checkreq = $(bin)$(SCT_G4_SD_tag)_checkreq.make
...
cmt_local_tagfile_checkreq = $(bin)$(SCT_G4_SD_tag).make
...
cmt_local_tagfile_check_install_python_modules = $(bin)$(SCT_G4_SD_tag)_check_install_python_modules.make
...
cmt_local_tagfile_check_install_python_modules = $(bin)$(SCT_G4_SD_tag).make
...
cmt_SCT_G4_SD_NICOS_Fix_debuginfo_has_no_target_tag = 1

#--------------------------------------

ifdef cmt_SCT_G4_SD_NICOS_Fix_debuginfo_has_target_tag

cmt_local_tagfile_SCT_G4_SD_NICOS_Fix_debuginfo = $(bin)$(SCT_G4_SD_tag)_SCT_G4_SD_NICOS_Fix_debuginfo.make
cmt_final_setup_SCT_G4_SD_NICOS_Fix_debuginfo = $(bin)setup_SCT_G4_SD_NICOS_Fix_debuginfo.make
cmt_local_SCT_G4_SD_NICOS_Fix_debuginfo_makefile = $(bin)SCT_G4_SD_NICOS_Fix_debuginfo.make

SCT_G4_SD_NICOS_Fix_debuginfo_extratags = -tag_add=target_SCT_G4_SD_NICOS_Fix_debuginfo

else

cmt_local_tagfile_SCT_G4_SD_NICOS_Fix_debuginfo = $(bin)$(SCT_G4_SD_tag).make
cmt_final_setup_SCT_G4_SD_NICOS_Fix_debuginfo = $(bin)setup.make
cmt_local_SCT_G4_SD_NICOS_Fix_debuginfo_makefile = $(bin)SCT_G4_SD_NICOS_Fix_debuginfo.make

endif

not_SCT_G4_SD_NICOS_Fix_debuginfo_dependencies = { n=0; for p in $?; do m=0; for d in $(SCT_G4_SD_NICOS_Fix_debuginfo_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SCT_G4_SD_NICOS_Fix_debuginfodirs :
	@if test ! -d $(bin)SCT_G4_SD_NICOS_Fix_debuginfo; then $(mkdir) -p $(bin)SCT_G4_SD_NICOS_Fix_debuginfo; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SCT_G4_SD_NICOS_Fix_debuginfo
else
SCT_G4_SD_NICOS_Fix_debuginfodirs : ;
endif
...
ifndef QUICK
$(cmt_local_SCT_G4_SD_NICOS_Fix_debuginfo_makefile) : $(SCT_G4_SD_NICOS_Fix_debuginfo_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_G4_SD_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_G4_SD_NICOS_Fix_debuginfo_extratags) build constituent_config -out=$(cmt_local_SCT_G4_SD_NICOS_Fix_debuginfo_makefile) SCT_G4_SD_NICOS_Fix_debuginfo
else
$(cmt_local_SCT_G4_SD_NICOS_Fix_debuginfo_makefile) : $(SCT_G4_SD_NICOS_Fix_debuginfo_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_G4_SD_NICOS_Fix_debuginfo) ] || \
	  [ ! -f $(cmt_final_setup_SCT_G4_SD_NICOS_Fix_debuginfo) ] || \
	  $(not_SCT_G4_SD_NICOS_Fix_debuginfo_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SCT_G4_SD_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_G4_SD_NICOS_Fix_debuginfo_extratags) build constituent_config -out=$(cmt_local_SCT_G4_SD_NICOS_Fix_debuginfo_makefile) SCT_G4_SD_NICOS_Fix_debuginfo; \
	  fi
endif
...
$(cmt_local_SCT_G4_SD_NICOS_Fix_debuginfo_makefile) : $(SCT_G4_SD_NICOS_Fix_debuginfo_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_G4_SD_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -f=$(bin)SCT_G4_SD_NICOS_Fix_debuginfo.in -tag=$(tags) $(SCT_G4_SD_NICOS_Fix_debuginfo_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SCT_G4_SD_NICOS_Fix_debuginfo_makefile) SCT_G4_SD_NICOS_Fix_debuginfo
else
$(cmt_local_SCT_G4_SD_NICOS_Fix_debuginfo_makefile) : $(SCT_G4_SD_NICOS_Fix_debuginfo_dependencies) $(cmt_build_library_linksstamp) $(bin)SCT_G4_SD_NICOS_Fix_debuginfo.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_G4_SD_NICOS_Fix_debuginfo) ] || \
	  [ ! -f $(cmt_final_setup_SCT_G4_SD_NICOS_Fix_debuginfo) ] || \
	  $(not_SCT_G4_SD_NICOS_Fix_debuginfo_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SCT_G4_SD_NICOS_Fix_debuginfo_extratags) build constituent_makefile -out=$(cmt_local_SCT_G4_SD_NICOS_Fix_debuginfo_makefile) SCT_G4_SD_NICOS_Fix_debuginfo

SCT_G4_SD_NICOS_Fix_debuginfo :: $(SCT_G4_SD_NICOS_Fix_debuginfo_dependencies) $(cmt_local_SCT_G4_SD_NICOS_Fix_debuginfo_makefile) dirs SCT_G4_SD_NICOS_Fix_debuginfodirs
	$(echo) "(constituents.make) Starting SCT_G4_SD_NICOS_Fix_debuginfo"
	@if test -f $(cmt_local_SCT_G4_SD_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SD_NICOS_Fix_debuginfo_makefile) SCT_G4_SD_NICOS_Fix_debuginfo; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_G4_SD_NICOS_Fix_debuginfo_makefile) SCT_G4_SD_NICOS_Fix_debuginfo
	$(echo) "(constituents.make) SCT_G4_SD_NICOS_Fix_debuginfo done"

clean :: SCT_G4_SD_NICOS_Fix_debuginfoclean ;

SCT_G4_SD_NICOS_Fix_debuginfoclean :: $(SCT_G4_SD_NICOS_Fix_debuginfoclean_dependencies) ##$(cmt_local_SCT_G4_SD_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting SCT_G4_SD_NICOS_Fix_debuginfoclean"
	@-if test -f $(cmt_local_SCT_G4_SD_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SD_NICOS_Fix_debuginfo_makefile) SCT_G4_SD_NICOS_Fix_debuginfoclean; \
	fi
	$(echo) "(constituents.make) SCT_G4_SD_NICOS_Fix_debuginfoclean done"
#	@-$(MAKE) -f $(cmt_local_SCT_G4_SD_NICOS_Fix_debuginfo_makefile) SCT_G4_SD_NICOS_Fix_debuginfoclean

##	  /bin/rm -f $(cmt_local_SCT_G4_SD_NICOS_Fix_debuginfo_makefile) $(bin)SCT_G4_SD_NICOS_Fix_debuginfo_dependencies.make

install :: SCT_G4_SD_NICOS_Fix_debuginfoinstall ;

SCT_G4_SD_NICOS_Fix_debuginfoinstall :: $(SCT_G4_SD_NICOS_Fix_debuginfo_dependencies) $(cmt_local_SCT_G4_SD_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SCT_G4_SD_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SD_NICOS_Fix_debuginfo_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SCT_G4_SD_NICOS_Fix_debuginfo_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : SCT_G4_SD_NICOS_Fix_debuginfouninstall

$(foreach d,$(SCT_G4_SD_NICOS_Fix_debuginfo_dependencies),$(eval $(d)uninstall_dependencies += SCT_G4_SD_NICOS_Fix_debuginfouninstall))

SCT_G4_SD_NICOS_Fix_debuginfouninstall : $(SCT_G4_SD_NICOS_Fix_debuginfouninstall_dependencies) ##$(cmt_local_SCT_G4_SD_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SCT_G4_SD_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_G4_SD_NICOS_Fix_debuginfo_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_G4_SD_NICOS_Fix_debuginfo_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SCT_G4_SD_NICOS_Fix_debuginfouninstall ;
...
cmt_local_tagfile_find_packages = $(bin)$(SCT_G4_SD_tag)_find_packages.make
...
cmt_local_tagfile_find_packages = $(bin)$(SCT_G4_SD_tag).make
...
cmt_local_tagfile_compile = $(bin)$(SCT_G4_SD_tag)_compile.make
...
cmt_local_tagfile_compile = $(bin)$(SCT_G4_SD_tag).make
...
cmt_local_tagfile_compile_pkg = $(bin)$(SCT_G4_SD_tag)_compile_pkg.make
...
cmt_local_tagfile_compile_pkg = $(bin)$(SCT_G4_SD_tag).make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(SCT_G4_SD_tag)_new_analysisapp.make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(SCT_G4_SD_tag).make
...
cmt_local_tagfile_new_pkg = $(bin)$(SCT_G4_SD_tag)_new_pkg.make
...
cmt_local_tagfile_new_pkg = $(bin)$(SCT_G4_SD_tag).make
...
cmt_local_tagfile_new_alg = $(bin)$(SCT_G4_SD_tag)_new_alg.make
...
cmt_local_tagfile_new_alg = $(bin)$(SCT_G4_SD_tag).make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(SCT_G4_SD_tag)_new_analysisalg.make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(SCT_G4_SD_tag).make
...
cmt_local_tagfile_new_asgtool = $(bin)$(SCT_G4_SD_tag)_new_asgtool.make
...
cmt_local_tagfile_new_asgtool = $(bin)$(SCT_G4_SD_tag).make
...
cmt_local_tagfile_new_jobo = $(bin)$(SCT_G4_SD_tag)_new_jobo.make
...
cmt_local_tagfile_new_jobo = $(bin)$(SCT_G4_SD_tag).make
...
cmt_local_tagfile_new_skeleton = $(bin)$(SCT_G4_SD_tag)_new_skeleton.make
...
cmt_local_tagfile_new_skeleton = $(bin)$(SCT_G4_SD_tag).make
...
cmt_local_tagfile_make_skeleton = $(bin)$(SCT_G4_SD_tag)_make_skeleton.make
...
cmt_local_tagfile_make_skeleton = $(bin)$(SCT_G4_SD_tag).make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(SCT_G4_SD_tag)_checkout_pkg.make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(SCT_G4_SD_tag).make
...
cmt_local_tagfile_cppcheck = $(bin)$(SCT_G4_SD_tag)_cppcheck.make
...
cmt_local_tagfile_cppcheck = $(bin)$(SCT_G4_SD_tag).make
