...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=SCT_G4_SD -version=SCT_G4_SD-00-08-00 -path=/nfs/dust/atlas/user/tkar/20.20.10.7/InnerDetector/InDetG4  $* >${cmtSCT_G4_SDtempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=SCT_G4_SD -version=SCT_G4_SD-00-08-00 -path=/nfs/dust/atlas/user/tkar/20.20.10.7/InnerDetector/InDetG4  $* >${cmtSCT_G4_SDtempfile}"
