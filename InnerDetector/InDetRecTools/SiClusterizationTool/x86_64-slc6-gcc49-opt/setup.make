...
#     use DataModel DataModel-* Control (no_version_directory)
#   use InDetConditionsSummaryService InDetConditionsSummaryService-* InnerDetector/InDetConditions (no_version_directory)
# use DetDescrCondTools DetDescrCondTools-* DetectorDescription/DetDescrCond (no_version_directory)
#   use AtlasPolicy AtlasPolicy-*  (no_version_directory)
#   use GaudiInterface GaudiInterface-* External (no_version_directory)
#   use StoreGate StoreGate-* Control (no_version_directory)
#   use AtlasCLHEP AtlasCLHEP-* External (no_version_directory) (native_version=2.2.0.4)
#   use AthenaBaseComps AthenaBaseComps-* Control (no_version_directory)
# use TrkNeuralNetworkUtils TrkNeuralNetworkUtils-* Tracking/TrkUtilityPackages (no_version_directory)
#   use AtlasPolicy AtlasPolicy-*  (no_version_directory)
#   use AthenaBaseComps AthenaBaseComps-* Control (no_version_directory)
#   use AtlasROOT AtlasROOT-* External (no_version_directory)
# use VxVertex VxVertex-* Tracking/TrkEvent (no_version_directory)
...
use TrkNeuralNetworkUtils TrkNeuralNetworkUtils-00-00-10 Tracking/TrkUtilityPackages (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasReconstruction/20.20.10)
use DetDescrCondTools DetDescrCondTools-00-04-02-03 DetectorDescription/DetDescrCond (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasConditions/20.20.10)
...
NEEDS_CORAL_RELATIONAL_ACCESS (from package CORAL) applied [AtlasCORAL CoraCool] activated AtlasCORAL
...
no_pack_dist_check (from package SiClusterizationTool) applied [SiClusterizationTool]
----------> CMTPATH
