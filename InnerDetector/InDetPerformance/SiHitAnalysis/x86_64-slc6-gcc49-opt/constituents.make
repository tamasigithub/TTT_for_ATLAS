...
#cmt_local_tagfile = $(SiHitAnalysis_tag).make
cmt_local_tagfile = $(bin)$(SiHitAnalysis_tag).make
...
SiHitAnalysis_extratags = -tag_add=target_SiHitAnalysis
...
not_SiHitAnalysis_dependencies = { n=0; for p in $?; do m=0; for d in $(SiHitAnalysis_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SiHitAnalysisdirs :
	@if test ! -d $(bin)SiHitAnalysis; then $(mkdir) -p $(bin)SiHitAnalysis; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SiHitAnalysis
else
SiHitAnalysisdirs : ;
endif
...
ifndef QUICK
$(cmt_local_SiHitAnalysis_makefile) : $(SiHitAnalysis_dependencies) build_library_links
	$(echo) "(constituents.make) Building SiHitAnalysis.make"; \
	  $(cmtexe) -tag=$(tags) $(SiHitAnalysis_extratags) build constituent_config -out=$(cmt_local_SiHitAnalysis_makefile) SiHitAnalysis
else
$(cmt_local_SiHitAnalysis_makefile) : $(SiHitAnalysis_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SiHitAnalysis) ] || \
	  [ ! -f $(cmt_final_setup_SiHitAnalysis) ] || \
	  $(not_SiHitAnalysis_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SiHitAnalysis.make"; \
	  $(cmtexe) -tag=$(tags) $(SiHitAnalysis_extratags) build constituent_config -out=$(cmt_local_SiHitAnalysis_makefile) SiHitAnalysis; \
	  fi
endif
...
$(cmt_local_SiHitAnalysis_makefile) : $(SiHitAnalysis_dependencies) build_library_links
	$(echo) "(constituents.make) Building SiHitAnalysis.make"; \
	  $(cmtexe) -f=$(bin)SiHitAnalysis.in -tag=$(tags) $(SiHitAnalysis_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SiHitAnalysis_makefile) SiHitAnalysis
else
$(cmt_local_SiHitAnalysis_makefile) : $(SiHitAnalysis_dependencies) $(cmt_build_library_linksstamp) $(bin)SiHitAnalysis.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SiHitAnalysis) ] || \
	  [ ! -f $(cmt_final_setup_SiHitAnalysis) ] || \
	  $(not_SiHitAnalysis_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SiHitAnalysis_extratags) build constituent_makefile -out=$(cmt_local_SiHitAnalysis_makefile) SiHitAnalysis

SiHitAnalysis :: $(SiHitAnalysis_dependencies) $(cmt_local_SiHitAnalysis_makefile) dirs SiHitAnalysisdirs
	$(echo) "(constituents.make) Starting SiHitAnalysis"
	@if test -f $(cmt_local_SiHitAnalysis_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysis_makefile) SiHitAnalysis; \
	  fi
#	@$(MAKE) -f $(cmt_local_SiHitAnalysis_makefile) SiHitAnalysis
	$(echo) "(constituents.make) SiHitAnalysis done"

clean :: SiHitAnalysisclean ;

SiHitAnalysisclean :: $(SiHitAnalysisclean_dependencies) ##$(cmt_local_SiHitAnalysis_makefile)
	$(echo) "(constituents.make) Starting SiHitAnalysisclean"
	@-if test -f $(cmt_local_SiHitAnalysis_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysis_makefile) SiHitAnalysisclean; \
	fi
	$(echo) "(constituents.make) SiHitAnalysisclean done"
#	@-$(MAKE) -f $(cmt_local_SiHitAnalysis_makefile) SiHitAnalysisclean

##	  /bin/rm -f $(cmt_local_SiHitAnalysis_makefile) $(bin)SiHitAnalysis_dependencies.make

install :: SiHitAnalysisinstall ;

SiHitAnalysisinstall :: $(SiHitAnalysis_dependencies) $(cmt_local_SiHitAnalysis_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SiHitAnalysis_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysis_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SiHitAnalysis_makefile) install
...
$(foreach d,$(SiHitAnalysis_dependencies),$(eval $(d)uninstall_dependencies += SiHitAnalysisuninstall))

SiHitAnalysisuninstall : $(SiHitAnalysisuninstall_dependencies) ##$(cmt_local_SiHitAnalysis_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SiHitAnalysis_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysis_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SiHitAnalysis_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SiHitAnalysisuninstall ;
...
SiHitAnalysisConf_extratags = -tag_add=target_SiHitAnalysisConf
...
not_SiHitAnalysisConf_dependencies = { n=0; for p in $?; do m=0; for d in $(SiHitAnalysisConf_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SiHitAnalysisConfdirs :
	@if test ! -d $(bin)SiHitAnalysisConf; then $(mkdir) -p $(bin)SiHitAnalysisConf; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SiHitAnalysisConf
else
SiHitAnalysisConfdirs : ;
endif
...
ifndef QUICK
$(cmt_local_SiHitAnalysisConf_makefile) : $(SiHitAnalysisConf_dependencies) build_library_links
	$(echo) "(constituents.make) Building SiHitAnalysisConf.make"; \
	  $(cmtexe) -tag=$(tags) $(SiHitAnalysisConf_extratags) build constituent_config -out=$(cmt_local_SiHitAnalysisConf_makefile) SiHitAnalysisConf
else
$(cmt_local_SiHitAnalysisConf_makefile) : $(SiHitAnalysisConf_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SiHitAnalysisConf) ] || \
	  [ ! -f $(cmt_final_setup_SiHitAnalysisConf) ] || \
	  $(not_SiHitAnalysisConf_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SiHitAnalysisConf.make"; \
	  $(cmtexe) -tag=$(tags) $(SiHitAnalysisConf_extratags) build constituent_config -out=$(cmt_local_SiHitAnalysisConf_makefile) SiHitAnalysisConf; \
	  fi
endif
...
$(cmt_local_SiHitAnalysisConf_makefile) : $(SiHitAnalysisConf_dependencies) build_library_links
	$(echo) "(constituents.make) Building SiHitAnalysisConf.make"; \
	  $(cmtexe) -f=$(bin)SiHitAnalysisConf.in -tag=$(tags) $(SiHitAnalysisConf_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SiHitAnalysisConf_makefile) SiHitAnalysisConf
else
$(cmt_local_SiHitAnalysisConf_makefile) : $(SiHitAnalysisConf_dependencies) $(cmt_build_library_linksstamp) $(bin)SiHitAnalysisConf.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SiHitAnalysisConf) ] || \
	  [ ! -f $(cmt_final_setup_SiHitAnalysisConf) ] || \
	  $(not_SiHitAnalysisConf_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SiHitAnalysisConf_extratags) build constituent_makefile -out=$(cmt_local_SiHitAnalysisConf_makefile) SiHitAnalysisConf

SiHitAnalysisConf :: $(SiHitAnalysisConf_dependencies) $(cmt_local_SiHitAnalysisConf_makefile) dirs SiHitAnalysisConfdirs
	$(echo) "(constituents.make) Starting SiHitAnalysisConf"
	@if test -f $(cmt_local_SiHitAnalysisConf_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysisConf_makefile) SiHitAnalysisConf; \
	  fi
#	@$(MAKE) -f $(cmt_local_SiHitAnalysisConf_makefile) SiHitAnalysisConf
	$(echo) "(constituents.make) SiHitAnalysisConf done"

clean :: SiHitAnalysisConfclean ;

SiHitAnalysisConfclean :: $(SiHitAnalysisConfclean_dependencies) ##$(cmt_local_SiHitAnalysisConf_makefile)
	$(echo) "(constituents.make) Starting SiHitAnalysisConfclean"
	@-if test -f $(cmt_local_SiHitAnalysisConf_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysisConf_makefile) SiHitAnalysisConfclean; \
	fi
	$(echo) "(constituents.make) SiHitAnalysisConfclean done"
#	@-$(MAKE) -f $(cmt_local_SiHitAnalysisConf_makefile) SiHitAnalysisConfclean

##	  /bin/rm -f $(cmt_local_SiHitAnalysisConf_makefile) $(bin)SiHitAnalysisConf_dependencies.make

install :: SiHitAnalysisConfinstall ;

SiHitAnalysisConfinstall :: $(SiHitAnalysisConf_dependencies) $(cmt_local_SiHitAnalysisConf_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SiHitAnalysisConf_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysisConf_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SiHitAnalysisConf_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(SiHitAnalysisConf_dependencies),$(eval $(d)uninstall_dependencies += SiHitAnalysisConfuninstall))

SiHitAnalysisConfuninstall : $(SiHitAnalysisConfuninstall_dependencies) ##$(cmt_local_SiHitAnalysisConf_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SiHitAnalysisConf_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysisConf_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SiHitAnalysisConf_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SiHitAnalysisConfuninstall ;
...
SiHitAnalysis_python_init_extratags = -tag_add=target_SiHitAnalysis_python_init
...
not_SiHitAnalysis_python_init_dependencies = { n=0; for p in $?; do m=0; for d in $(SiHitAnalysis_python_init_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SiHitAnalysis_python_initdirs :
	@if test ! -d $(bin)SiHitAnalysis_python_init; then $(mkdir) -p $(bin)SiHitAnalysis_python_init; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SiHitAnalysis_python_init
else
SiHitAnalysis_python_initdirs : ;
endif
...
ifndef QUICK
$(cmt_local_SiHitAnalysis_python_init_makefile) : $(SiHitAnalysis_python_init_dependencies) build_library_links
	$(echo) "(constituents.make) Building SiHitAnalysis_python_init.make"; \
	  $(cmtexe) -tag=$(tags) $(SiHitAnalysis_python_init_extratags) build constituent_config -out=$(cmt_local_SiHitAnalysis_python_init_makefile) SiHitAnalysis_python_init
else
$(cmt_local_SiHitAnalysis_python_init_makefile) : $(SiHitAnalysis_python_init_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SiHitAnalysis_python_init) ] || \
	  [ ! -f $(cmt_final_setup_SiHitAnalysis_python_init) ] || \
	  $(not_SiHitAnalysis_python_init_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SiHitAnalysis_python_init.make"; \
	  $(cmtexe) -tag=$(tags) $(SiHitAnalysis_python_init_extratags) build constituent_config -out=$(cmt_local_SiHitAnalysis_python_init_makefile) SiHitAnalysis_python_init; \
	  fi
endif
...
$(cmt_local_SiHitAnalysis_python_init_makefile) : $(SiHitAnalysis_python_init_dependencies) build_library_links
	$(echo) "(constituents.make) Building SiHitAnalysis_python_init.make"; \
	  $(cmtexe) -f=$(bin)SiHitAnalysis_python_init.in -tag=$(tags) $(SiHitAnalysis_python_init_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SiHitAnalysis_python_init_makefile) SiHitAnalysis_python_init
else
$(cmt_local_SiHitAnalysis_python_init_makefile) : $(SiHitAnalysis_python_init_dependencies) $(cmt_build_library_linksstamp) $(bin)SiHitAnalysis_python_init.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SiHitAnalysis_python_init) ] || \
	  [ ! -f $(cmt_final_setup_SiHitAnalysis_python_init) ] || \
	  $(not_SiHitAnalysis_python_init_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SiHitAnalysis_python_init_extratags) build constituent_makefile -out=$(cmt_local_SiHitAnalysis_python_init_makefile) SiHitAnalysis_python_init

SiHitAnalysis_python_init :: $(SiHitAnalysis_python_init_dependencies) $(cmt_local_SiHitAnalysis_python_init_makefile) dirs SiHitAnalysis_python_initdirs
	$(echo) "(constituents.make) Starting SiHitAnalysis_python_init"
	@if test -f $(cmt_local_SiHitAnalysis_python_init_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysis_python_init_makefile) SiHitAnalysis_python_init; \
	  fi
#	@$(MAKE) -f $(cmt_local_SiHitAnalysis_python_init_makefile) SiHitAnalysis_python_init
	$(echo) "(constituents.make) SiHitAnalysis_python_init done"

clean :: SiHitAnalysis_python_initclean ;

SiHitAnalysis_python_initclean :: $(SiHitAnalysis_python_initclean_dependencies) ##$(cmt_local_SiHitAnalysis_python_init_makefile)
	$(echo) "(constituents.make) Starting SiHitAnalysis_python_initclean"
	@-if test -f $(cmt_local_SiHitAnalysis_python_init_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysis_python_init_makefile) SiHitAnalysis_python_initclean; \
	fi
	$(echo) "(constituents.make) SiHitAnalysis_python_initclean done"
#	@-$(MAKE) -f $(cmt_local_SiHitAnalysis_python_init_makefile) SiHitAnalysis_python_initclean

##	  /bin/rm -f $(cmt_local_SiHitAnalysis_python_init_makefile) $(bin)SiHitAnalysis_python_init_dependencies.make

install :: SiHitAnalysis_python_initinstall ;

SiHitAnalysis_python_initinstall :: $(SiHitAnalysis_python_init_dependencies) $(cmt_local_SiHitAnalysis_python_init_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SiHitAnalysis_python_init_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysis_python_init_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SiHitAnalysis_python_init_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(SiHitAnalysis_python_init_dependencies),$(eval $(d)uninstall_dependencies += SiHitAnalysis_python_inituninstall))

SiHitAnalysis_python_inituninstall : $(SiHitAnalysis_python_inituninstall_dependencies) ##$(cmt_local_SiHitAnalysis_python_init_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SiHitAnalysis_python_init_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysis_python_init_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SiHitAnalysis_python_init_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SiHitAnalysis_python_inituninstall ;
...
SiHitAnalysisConfDbMerge_extratags = -tag_add=target_SiHitAnalysisConfDbMerge
...
not_SiHitAnalysisConfDbMerge_dependencies = { n=0; for p in $?; do m=0; for d in $(SiHitAnalysisConfDbMerge_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SiHitAnalysisConfDbMergedirs :
	@if test ! -d $(bin)SiHitAnalysisConfDbMerge; then $(mkdir) -p $(bin)SiHitAnalysisConfDbMerge; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SiHitAnalysisConfDbMerge
else
SiHitAnalysisConfDbMergedirs : ;
endif
...
ifndef QUICK
$(cmt_local_SiHitAnalysisConfDbMerge_makefile) : $(SiHitAnalysisConfDbMerge_dependencies) build_library_links
	$(echo) "(constituents.make) Building SiHitAnalysisConfDbMerge.make"; \
	  $(cmtexe) -tag=$(tags) $(SiHitAnalysisConfDbMerge_extratags) build constituent_config -out=$(cmt_local_SiHitAnalysisConfDbMerge_makefile) SiHitAnalysisConfDbMerge
else
$(cmt_local_SiHitAnalysisConfDbMerge_makefile) : $(SiHitAnalysisConfDbMerge_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SiHitAnalysisConfDbMerge) ] || \
	  [ ! -f $(cmt_final_setup_SiHitAnalysisConfDbMerge) ] || \
	  $(not_SiHitAnalysisConfDbMerge_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SiHitAnalysisConfDbMerge.make"; \
	  $(cmtexe) -tag=$(tags) $(SiHitAnalysisConfDbMerge_extratags) build constituent_config -out=$(cmt_local_SiHitAnalysisConfDbMerge_makefile) SiHitAnalysisConfDbMerge; \
	  fi
endif
...
$(cmt_local_SiHitAnalysisConfDbMerge_makefile) : $(SiHitAnalysisConfDbMerge_dependencies) build_library_links
	$(echo) "(constituents.make) Building SiHitAnalysisConfDbMerge.make"; \
	  $(cmtexe) -f=$(bin)SiHitAnalysisConfDbMerge.in -tag=$(tags) $(SiHitAnalysisConfDbMerge_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SiHitAnalysisConfDbMerge_makefile) SiHitAnalysisConfDbMerge
else
$(cmt_local_SiHitAnalysisConfDbMerge_makefile) : $(SiHitAnalysisConfDbMerge_dependencies) $(cmt_build_library_linksstamp) $(bin)SiHitAnalysisConfDbMerge.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SiHitAnalysisConfDbMerge) ] || \
	  [ ! -f $(cmt_final_setup_SiHitAnalysisConfDbMerge) ] || \
	  $(not_SiHitAnalysisConfDbMerge_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SiHitAnalysisConfDbMerge_extratags) build constituent_makefile -out=$(cmt_local_SiHitAnalysisConfDbMerge_makefile) SiHitAnalysisConfDbMerge

SiHitAnalysisConfDbMerge :: $(SiHitAnalysisConfDbMerge_dependencies) $(cmt_local_SiHitAnalysisConfDbMerge_makefile) dirs SiHitAnalysisConfDbMergedirs
	$(echo) "(constituents.make) Starting SiHitAnalysisConfDbMerge"
	@if test -f $(cmt_local_SiHitAnalysisConfDbMerge_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysisConfDbMerge_makefile) SiHitAnalysisConfDbMerge; \
	  fi
#	@$(MAKE) -f $(cmt_local_SiHitAnalysisConfDbMerge_makefile) SiHitAnalysisConfDbMerge
	$(echo) "(constituents.make) SiHitAnalysisConfDbMerge done"

clean :: SiHitAnalysisConfDbMergeclean ;

SiHitAnalysisConfDbMergeclean :: $(SiHitAnalysisConfDbMergeclean_dependencies) ##$(cmt_local_SiHitAnalysisConfDbMerge_makefile)
	$(echo) "(constituents.make) Starting SiHitAnalysisConfDbMergeclean"
	@-if test -f $(cmt_local_SiHitAnalysisConfDbMerge_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysisConfDbMerge_makefile) SiHitAnalysisConfDbMergeclean; \
	fi
	$(echo) "(constituents.make) SiHitAnalysisConfDbMergeclean done"
#	@-$(MAKE) -f $(cmt_local_SiHitAnalysisConfDbMerge_makefile) SiHitAnalysisConfDbMergeclean

##	  /bin/rm -f $(cmt_local_SiHitAnalysisConfDbMerge_makefile) $(bin)SiHitAnalysisConfDbMerge_dependencies.make

install :: SiHitAnalysisConfDbMergeinstall ;

SiHitAnalysisConfDbMergeinstall :: $(SiHitAnalysisConfDbMerge_dependencies) $(cmt_local_SiHitAnalysisConfDbMerge_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SiHitAnalysisConfDbMerge_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysisConfDbMerge_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SiHitAnalysisConfDbMerge_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : SiHitAnalysisConfDbMergeuninstall

$(foreach d,$(SiHitAnalysisConfDbMerge_dependencies),$(eval $(d)uninstall_dependencies += SiHitAnalysisConfDbMergeuninstall))

SiHitAnalysisConfDbMergeuninstall : $(SiHitAnalysisConfDbMergeuninstall_dependencies) ##$(cmt_local_SiHitAnalysisConfDbMerge_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SiHitAnalysisConfDbMerge_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysisConfDbMerge_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SiHitAnalysisConfDbMerge_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SiHitAnalysisConfDbMergeuninstall ;
...
SiHitAnalysisComponentsList_extratags = -tag_add=target_SiHitAnalysisComponentsList
...
not_SiHitAnalysisComponentsList_dependencies = { n=0; for p in $?; do m=0; for d in $(SiHitAnalysisComponentsList_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SiHitAnalysisComponentsListdirs :
	@if test ! -d $(bin)SiHitAnalysisComponentsList; then $(mkdir) -p $(bin)SiHitAnalysisComponentsList; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SiHitAnalysisComponentsList
else
SiHitAnalysisComponentsListdirs : ;
endif
...
ifndef QUICK
$(cmt_local_SiHitAnalysisComponentsList_makefile) : $(SiHitAnalysisComponentsList_dependencies) build_library_links
	$(echo) "(constituents.make) Building SiHitAnalysisComponentsList.make"; \
	  $(cmtexe) -tag=$(tags) $(SiHitAnalysisComponentsList_extratags) build constituent_config -out=$(cmt_local_SiHitAnalysisComponentsList_makefile) SiHitAnalysisComponentsList
else
$(cmt_local_SiHitAnalysisComponentsList_makefile) : $(SiHitAnalysisComponentsList_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SiHitAnalysisComponentsList) ] || \
	  [ ! -f $(cmt_final_setup_SiHitAnalysisComponentsList) ] || \
	  $(not_SiHitAnalysisComponentsList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SiHitAnalysisComponentsList.make"; \
	  $(cmtexe) -tag=$(tags) $(SiHitAnalysisComponentsList_extratags) build constituent_config -out=$(cmt_local_SiHitAnalysisComponentsList_makefile) SiHitAnalysisComponentsList; \
	  fi
endif
...
$(cmt_local_SiHitAnalysisComponentsList_makefile) : $(SiHitAnalysisComponentsList_dependencies) build_library_links
	$(echo) "(constituents.make) Building SiHitAnalysisComponentsList.make"; \
	  $(cmtexe) -f=$(bin)SiHitAnalysisComponentsList.in -tag=$(tags) $(SiHitAnalysisComponentsList_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SiHitAnalysisComponentsList_makefile) SiHitAnalysisComponentsList
else
$(cmt_local_SiHitAnalysisComponentsList_makefile) : $(SiHitAnalysisComponentsList_dependencies) $(cmt_build_library_linksstamp) $(bin)SiHitAnalysisComponentsList.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SiHitAnalysisComponentsList) ] || \
	  [ ! -f $(cmt_final_setup_SiHitAnalysisComponentsList) ] || \
	  $(not_SiHitAnalysisComponentsList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SiHitAnalysisComponentsList_extratags) build constituent_makefile -out=$(cmt_local_SiHitAnalysisComponentsList_makefile) SiHitAnalysisComponentsList

SiHitAnalysisComponentsList :: $(SiHitAnalysisComponentsList_dependencies) $(cmt_local_SiHitAnalysisComponentsList_makefile) dirs SiHitAnalysisComponentsListdirs
	$(echo) "(constituents.make) Starting SiHitAnalysisComponentsList"
	@if test -f $(cmt_local_SiHitAnalysisComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysisComponentsList_makefile) SiHitAnalysisComponentsList; \
	  fi
#	@$(MAKE) -f $(cmt_local_SiHitAnalysisComponentsList_makefile) SiHitAnalysisComponentsList
	$(echo) "(constituents.make) SiHitAnalysisComponentsList done"

clean :: SiHitAnalysisComponentsListclean ;

SiHitAnalysisComponentsListclean :: $(SiHitAnalysisComponentsListclean_dependencies) ##$(cmt_local_SiHitAnalysisComponentsList_makefile)
	$(echo) "(constituents.make) Starting SiHitAnalysisComponentsListclean"
	@-if test -f $(cmt_local_SiHitAnalysisComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysisComponentsList_makefile) SiHitAnalysisComponentsListclean; \
	fi
	$(echo) "(constituents.make) SiHitAnalysisComponentsListclean done"
#	@-$(MAKE) -f $(cmt_local_SiHitAnalysisComponentsList_makefile) SiHitAnalysisComponentsListclean

##	  /bin/rm -f $(cmt_local_SiHitAnalysisComponentsList_makefile) $(bin)SiHitAnalysisComponentsList_dependencies.make

install :: SiHitAnalysisComponentsListinstall ;

SiHitAnalysisComponentsListinstall :: $(SiHitAnalysisComponentsList_dependencies) $(cmt_local_SiHitAnalysisComponentsList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SiHitAnalysisComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysisComponentsList_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SiHitAnalysisComponentsList_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(SiHitAnalysisComponentsList_dependencies),$(eval $(d)uninstall_dependencies += SiHitAnalysisComponentsListuninstall))

SiHitAnalysisComponentsListuninstall : $(SiHitAnalysisComponentsListuninstall_dependencies) ##$(cmt_local_SiHitAnalysisComponentsList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SiHitAnalysisComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysisComponentsList_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SiHitAnalysisComponentsList_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SiHitAnalysisComponentsListuninstall ;
...
SiHitAnalysisMergeComponentsList_extratags = -tag_add=target_SiHitAnalysisMergeComponentsList
...
not_SiHitAnalysisMergeComponentsList_dependencies = { n=0; for p in $?; do m=0; for d in $(SiHitAnalysisMergeComponentsList_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SiHitAnalysisMergeComponentsListdirs :
	@if test ! -d $(bin)SiHitAnalysisMergeComponentsList; then $(mkdir) -p $(bin)SiHitAnalysisMergeComponentsList; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SiHitAnalysisMergeComponentsList
else
SiHitAnalysisMergeComponentsListdirs : ;
endif
...
ifndef QUICK
$(cmt_local_SiHitAnalysisMergeComponentsList_makefile) : $(SiHitAnalysisMergeComponentsList_dependencies) build_library_links
	$(echo) "(constituents.make) Building SiHitAnalysisMergeComponentsList.make"; \
	  $(cmtexe) -tag=$(tags) $(SiHitAnalysisMergeComponentsList_extratags) build constituent_config -out=$(cmt_local_SiHitAnalysisMergeComponentsList_makefile) SiHitAnalysisMergeComponentsList
else
$(cmt_local_SiHitAnalysisMergeComponentsList_makefile) : $(SiHitAnalysisMergeComponentsList_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SiHitAnalysisMergeComponentsList) ] || \
	  [ ! -f $(cmt_final_setup_SiHitAnalysisMergeComponentsList) ] || \
	  $(not_SiHitAnalysisMergeComponentsList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SiHitAnalysisMergeComponentsList.make"; \
	  $(cmtexe) -tag=$(tags) $(SiHitAnalysisMergeComponentsList_extratags) build constituent_config -out=$(cmt_local_SiHitAnalysisMergeComponentsList_makefile) SiHitAnalysisMergeComponentsList; \
	  fi
endif
...
$(cmt_local_SiHitAnalysisMergeComponentsList_makefile) : $(SiHitAnalysisMergeComponentsList_dependencies) build_library_links
	$(echo) "(constituents.make) Building SiHitAnalysisMergeComponentsList.make"; \
	  $(cmtexe) -f=$(bin)SiHitAnalysisMergeComponentsList.in -tag=$(tags) $(SiHitAnalysisMergeComponentsList_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SiHitAnalysisMergeComponentsList_makefile) SiHitAnalysisMergeComponentsList
else
$(cmt_local_SiHitAnalysisMergeComponentsList_makefile) : $(SiHitAnalysisMergeComponentsList_dependencies) $(cmt_build_library_linksstamp) $(bin)SiHitAnalysisMergeComponentsList.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SiHitAnalysisMergeComponentsList) ] || \
	  [ ! -f $(cmt_final_setup_SiHitAnalysisMergeComponentsList) ] || \
	  $(not_SiHitAnalysisMergeComponentsList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SiHitAnalysisMergeComponentsList_extratags) build constituent_makefile -out=$(cmt_local_SiHitAnalysisMergeComponentsList_makefile) SiHitAnalysisMergeComponentsList

SiHitAnalysisMergeComponentsList :: $(SiHitAnalysisMergeComponentsList_dependencies) $(cmt_local_SiHitAnalysisMergeComponentsList_makefile) dirs SiHitAnalysisMergeComponentsListdirs
	$(echo) "(constituents.make) Starting SiHitAnalysisMergeComponentsList"
	@if test -f $(cmt_local_SiHitAnalysisMergeComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysisMergeComponentsList_makefile) SiHitAnalysisMergeComponentsList; \
	  fi
#	@$(MAKE) -f $(cmt_local_SiHitAnalysisMergeComponentsList_makefile) SiHitAnalysisMergeComponentsList
	$(echo) "(constituents.make) SiHitAnalysisMergeComponentsList done"

clean :: SiHitAnalysisMergeComponentsListclean ;

SiHitAnalysisMergeComponentsListclean :: $(SiHitAnalysisMergeComponentsListclean_dependencies) ##$(cmt_local_SiHitAnalysisMergeComponentsList_makefile)
	$(echo) "(constituents.make) Starting SiHitAnalysisMergeComponentsListclean"
	@-if test -f $(cmt_local_SiHitAnalysisMergeComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysisMergeComponentsList_makefile) SiHitAnalysisMergeComponentsListclean; \
	fi
	$(echo) "(constituents.make) SiHitAnalysisMergeComponentsListclean done"
#	@-$(MAKE) -f $(cmt_local_SiHitAnalysisMergeComponentsList_makefile) SiHitAnalysisMergeComponentsListclean

##	  /bin/rm -f $(cmt_local_SiHitAnalysisMergeComponentsList_makefile) $(bin)SiHitAnalysisMergeComponentsList_dependencies.make

install :: SiHitAnalysisMergeComponentsListinstall ;

SiHitAnalysisMergeComponentsListinstall :: $(SiHitAnalysisMergeComponentsList_dependencies) $(cmt_local_SiHitAnalysisMergeComponentsList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SiHitAnalysisMergeComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysisMergeComponentsList_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SiHitAnalysisMergeComponentsList_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : SiHitAnalysisMergeComponentsListuninstall

$(foreach d,$(SiHitAnalysisMergeComponentsList_dependencies),$(eval $(d)uninstall_dependencies += SiHitAnalysisMergeComponentsListuninstall))

SiHitAnalysisMergeComponentsListuninstall : $(SiHitAnalysisMergeComponentsListuninstall_dependencies) ##$(cmt_local_SiHitAnalysisMergeComponentsList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SiHitAnalysisMergeComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysisMergeComponentsList_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SiHitAnalysisMergeComponentsList_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SiHitAnalysisMergeComponentsListuninstall ;
...
SiHitAnalysis_optdebug_library_extratags = -tag_add=target_SiHitAnalysis_optdebug_library
...
not_SiHitAnalysis_optdebug_library_dependencies = { n=0; for p in $?; do m=0; for d in $(SiHitAnalysis_optdebug_library_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SiHitAnalysis_optdebug_librarydirs :
	@if test ! -d $(bin)SiHitAnalysis_optdebug_library; then $(mkdir) -p $(bin)SiHitAnalysis_optdebug_library; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SiHitAnalysis_optdebug_library
else
SiHitAnalysis_optdebug_librarydirs : ;
endif
...
ifndef QUICK
$(cmt_local_SiHitAnalysis_optdebug_library_makefile) : $(SiHitAnalysis_optdebug_library_dependencies) build_library_links
	$(echo) "(constituents.make) Building SiHitAnalysis_optdebug_library.make"; \
	  $(cmtexe) -tag=$(tags) $(SiHitAnalysis_optdebug_library_extratags) build constituent_config -out=$(cmt_local_SiHitAnalysis_optdebug_library_makefile) SiHitAnalysis_optdebug_library
else
$(cmt_local_SiHitAnalysis_optdebug_library_makefile) : $(SiHitAnalysis_optdebug_library_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SiHitAnalysis_optdebug_library) ] || \
	  [ ! -f $(cmt_final_setup_SiHitAnalysis_optdebug_library) ] || \
	  $(not_SiHitAnalysis_optdebug_library_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SiHitAnalysis_optdebug_library.make"; \
	  $(cmtexe) -tag=$(tags) $(SiHitAnalysis_optdebug_library_extratags) build constituent_config -out=$(cmt_local_SiHitAnalysis_optdebug_library_makefile) SiHitAnalysis_optdebug_library; \
	  fi
endif
...
$(cmt_local_SiHitAnalysis_optdebug_library_makefile) : $(SiHitAnalysis_optdebug_library_dependencies) build_library_links
	$(echo) "(constituents.make) Building SiHitAnalysis_optdebug_library.make"; \
	  $(cmtexe) -f=$(bin)SiHitAnalysis_optdebug_library.in -tag=$(tags) $(SiHitAnalysis_optdebug_library_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SiHitAnalysis_optdebug_library_makefile) SiHitAnalysis_optdebug_library
else
$(cmt_local_SiHitAnalysis_optdebug_library_makefile) : $(SiHitAnalysis_optdebug_library_dependencies) $(cmt_build_library_linksstamp) $(bin)SiHitAnalysis_optdebug_library.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SiHitAnalysis_optdebug_library) ] || \
	  [ ! -f $(cmt_final_setup_SiHitAnalysis_optdebug_library) ] || \
	  $(not_SiHitAnalysis_optdebug_library_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SiHitAnalysis_optdebug_library_extratags) build constituent_makefile -out=$(cmt_local_SiHitAnalysis_optdebug_library_makefile) SiHitAnalysis_optdebug_library

SiHitAnalysis_optdebug_library :: $(SiHitAnalysis_optdebug_library_dependencies) $(cmt_local_SiHitAnalysis_optdebug_library_makefile) dirs SiHitAnalysis_optdebug_librarydirs
	$(echo) "(constituents.make) Starting SiHitAnalysis_optdebug_library"
	@if test -f $(cmt_local_SiHitAnalysis_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysis_optdebug_library_makefile) SiHitAnalysis_optdebug_library; \
	  fi
#	@$(MAKE) -f $(cmt_local_SiHitAnalysis_optdebug_library_makefile) SiHitAnalysis_optdebug_library
	$(echo) "(constituents.make) SiHitAnalysis_optdebug_library done"

clean :: SiHitAnalysis_optdebug_libraryclean ;

SiHitAnalysis_optdebug_libraryclean :: $(SiHitAnalysis_optdebug_libraryclean_dependencies) ##$(cmt_local_SiHitAnalysis_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting SiHitAnalysis_optdebug_libraryclean"
	@-if test -f $(cmt_local_SiHitAnalysis_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysis_optdebug_library_makefile) SiHitAnalysis_optdebug_libraryclean; \
	fi
	$(echo) "(constituents.make) SiHitAnalysis_optdebug_libraryclean done"
#	@-$(MAKE) -f $(cmt_local_SiHitAnalysis_optdebug_library_makefile) SiHitAnalysis_optdebug_libraryclean

##	  /bin/rm -f $(cmt_local_SiHitAnalysis_optdebug_library_makefile) $(bin)SiHitAnalysis_optdebug_library_dependencies.make

install :: SiHitAnalysis_optdebug_libraryinstall ;

SiHitAnalysis_optdebug_libraryinstall :: $(SiHitAnalysis_optdebug_library_dependencies) $(cmt_local_SiHitAnalysis_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SiHitAnalysis_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysis_optdebug_library_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SiHitAnalysis_optdebug_library_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(SiHitAnalysis_optdebug_library_dependencies),$(eval $(d)uninstall_dependencies += SiHitAnalysis_optdebug_libraryuninstall))

SiHitAnalysis_optdebug_libraryuninstall : $(SiHitAnalysis_optdebug_libraryuninstall_dependencies) ##$(cmt_local_SiHitAnalysis_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SiHitAnalysis_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysis_optdebug_library_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SiHitAnalysis_optdebug_library_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SiHitAnalysis_optdebug_libraryuninstall ;
...
SiHitAnalysisCLIDDB_extratags = -tag_add=target_SiHitAnalysisCLIDDB
...
not_SiHitAnalysisCLIDDB_dependencies = { n=0; for p in $?; do m=0; for d in $(SiHitAnalysisCLIDDB_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SiHitAnalysisCLIDDBdirs :
	@if test ! -d $(bin)SiHitAnalysisCLIDDB; then $(mkdir) -p $(bin)SiHitAnalysisCLIDDB; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SiHitAnalysisCLIDDB
else
SiHitAnalysisCLIDDBdirs : ;
endif
...
ifndef QUICK
$(cmt_local_SiHitAnalysisCLIDDB_makefile) : $(SiHitAnalysisCLIDDB_dependencies) build_library_links
	$(echo) "(constituents.make) Building SiHitAnalysisCLIDDB.make"; \
	  $(cmtexe) -tag=$(tags) $(SiHitAnalysisCLIDDB_extratags) build constituent_config -out=$(cmt_local_SiHitAnalysisCLIDDB_makefile) SiHitAnalysisCLIDDB
else
$(cmt_local_SiHitAnalysisCLIDDB_makefile) : $(SiHitAnalysisCLIDDB_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SiHitAnalysisCLIDDB) ] || \
	  [ ! -f $(cmt_final_setup_SiHitAnalysisCLIDDB) ] || \
	  $(not_SiHitAnalysisCLIDDB_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SiHitAnalysisCLIDDB.make"; \
	  $(cmtexe) -tag=$(tags) $(SiHitAnalysisCLIDDB_extratags) build constituent_config -out=$(cmt_local_SiHitAnalysisCLIDDB_makefile) SiHitAnalysisCLIDDB; \
	  fi
endif
...
$(cmt_local_SiHitAnalysisCLIDDB_makefile) : $(SiHitAnalysisCLIDDB_dependencies) build_library_links
	$(echo) "(constituents.make) Building SiHitAnalysisCLIDDB.make"; \
	  $(cmtexe) -f=$(bin)SiHitAnalysisCLIDDB.in -tag=$(tags) $(SiHitAnalysisCLIDDB_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SiHitAnalysisCLIDDB_makefile) SiHitAnalysisCLIDDB
else
$(cmt_local_SiHitAnalysisCLIDDB_makefile) : $(SiHitAnalysisCLIDDB_dependencies) $(cmt_build_library_linksstamp) $(bin)SiHitAnalysisCLIDDB.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SiHitAnalysisCLIDDB) ] || \
	  [ ! -f $(cmt_final_setup_SiHitAnalysisCLIDDB) ] || \
	  $(not_SiHitAnalysisCLIDDB_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SiHitAnalysisCLIDDB_extratags) build constituent_makefile -out=$(cmt_local_SiHitAnalysisCLIDDB_makefile) SiHitAnalysisCLIDDB

SiHitAnalysisCLIDDB :: $(SiHitAnalysisCLIDDB_dependencies) $(cmt_local_SiHitAnalysisCLIDDB_makefile) dirs SiHitAnalysisCLIDDBdirs
	$(echo) "(constituents.make) Starting SiHitAnalysisCLIDDB"
	@if test -f $(cmt_local_SiHitAnalysisCLIDDB_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysisCLIDDB_makefile) SiHitAnalysisCLIDDB; \
	  fi
#	@$(MAKE) -f $(cmt_local_SiHitAnalysisCLIDDB_makefile) SiHitAnalysisCLIDDB
	$(echo) "(constituents.make) SiHitAnalysisCLIDDB done"

clean :: SiHitAnalysisCLIDDBclean ;

SiHitAnalysisCLIDDBclean :: $(SiHitAnalysisCLIDDBclean_dependencies) ##$(cmt_local_SiHitAnalysisCLIDDB_makefile)
	$(echo) "(constituents.make) Starting SiHitAnalysisCLIDDBclean"
	@-if test -f $(cmt_local_SiHitAnalysisCLIDDB_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysisCLIDDB_makefile) SiHitAnalysisCLIDDBclean; \
	fi
	$(echo) "(constituents.make) SiHitAnalysisCLIDDBclean done"
#	@-$(MAKE) -f $(cmt_local_SiHitAnalysisCLIDDB_makefile) SiHitAnalysisCLIDDBclean

##	  /bin/rm -f $(cmt_local_SiHitAnalysisCLIDDB_makefile) $(bin)SiHitAnalysisCLIDDB_dependencies.make

install :: SiHitAnalysisCLIDDBinstall ;

SiHitAnalysisCLIDDBinstall :: $(SiHitAnalysisCLIDDB_dependencies) $(cmt_local_SiHitAnalysisCLIDDB_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SiHitAnalysisCLIDDB_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysisCLIDDB_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SiHitAnalysisCLIDDB_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : SiHitAnalysisCLIDDBuninstall

$(foreach d,$(SiHitAnalysisCLIDDB_dependencies),$(eval $(d)uninstall_dependencies += SiHitAnalysisCLIDDBuninstall))

SiHitAnalysisCLIDDBuninstall : $(SiHitAnalysisCLIDDBuninstall_dependencies) ##$(cmt_local_SiHitAnalysisCLIDDB_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SiHitAnalysisCLIDDB_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysisCLIDDB_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SiHitAnalysisCLIDDB_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SiHitAnalysisCLIDDBuninstall ;
...
cmt_local_tagfile_install_joboptions = $(bin)$(SiHitAnalysis_tag)_install_joboptions.make
...
cmt_local_tagfile_install_joboptions = $(bin)$(SiHitAnalysis_tag).make
...
cmt_SiHitAnalysisrchk_has_target_tag = 1

#--------------------------------------

ifdef cmt_SiHitAnalysisrchk_has_target_tag

cmt_local_tagfile_SiHitAnalysisrchk = $(bin)$(SiHitAnalysis_tag)_SiHitAnalysisrchk.make
cmt_final_setup_SiHitAnalysisrchk = $(bin)setup_SiHitAnalysisrchk.make
cmt_local_SiHitAnalysisrchk_makefile = $(bin)SiHitAnalysisrchk.make

SiHitAnalysisrchk_extratags = -tag_add=target_SiHitAnalysisrchk

else

cmt_local_tagfile_SiHitAnalysisrchk = $(bin)$(SiHitAnalysis_tag).make
cmt_final_setup_SiHitAnalysisrchk = $(bin)setup.make
cmt_local_SiHitAnalysisrchk_makefile = $(bin)SiHitAnalysisrchk.make

endif

not_SiHitAnalysisrchk_dependencies = { n=0; for p in $?; do m=0; for d in $(SiHitAnalysisrchk_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SiHitAnalysisrchkdirs :
	@if test ! -d $(bin)SiHitAnalysisrchk; then $(mkdir) -p $(bin)SiHitAnalysisrchk; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SiHitAnalysisrchk
else
SiHitAnalysisrchkdirs : ;
endif
...
ifndef QUICK
$(cmt_local_SiHitAnalysisrchk_makefile) : $(SiHitAnalysisrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building SiHitAnalysisrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(SiHitAnalysisrchk_extratags) build constituent_config -out=$(cmt_local_SiHitAnalysisrchk_makefile) SiHitAnalysisrchk
else
$(cmt_local_SiHitAnalysisrchk_makefile) : $(SiHitAnalysisrchk_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SiHitAnalysisrchk) ] || \
	  [ ! -f $(cmt_final_setup_SiHitAnalysisrchk) ] || \
	  $(not_SiHitAnalysisrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SiHitAnalysisrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(SiHitAnalysisrchk_extratags) build constituent_config -out=$(cmt_local_SiHitAnalysisrchk_makefile) SiHitAnalysisrchk; \
	  fi
endif
...
$(cmt_local_SiHitAnalysisrchk_makefile) : $(SiHitAnalysisrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building SiHitAnalysisrchk.make"; \
	  $(cmtexe) -f=$(bin)SiHitAnalysisrchk.in -tag=$(tags) $(SiHitAnalysisrchk_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SiHitAnalysisrchk_makefile) SiHitAnalysisrchk
else
$(cmt_local_SiHitAnalysisrchk_makefile) : $(SiHitAnalysisrchk_dependencies) $(cmt_build_library_linksstamp) $(bin)SiHitAnalysisrchk.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SiHitAnalysisrchk) ] || \
	  [ ! -f $(cmt_final_setup_SiHitAnalysisrchk) ] || \
	  $(not_SiHitAnalysisrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SiHitAnalysisrchk_extratags) build constituent_makefile -out=$(cmt_local_SiHitAnalysisrchk_makefile) SiHitAnalysisrchk

SiHitAnalysisrchk :: $(SiHitAnalysisrchk_dependencies) $(cmt_local_SiHitAnalysisrchk_makefile) dirs SiHitAnalysisrchkdirs
	$(echo) "(constituents.make) Starting SiHitAnalysisrchk"
	@if test -f $(cmt_local_SiHitAnalysisrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysisrchk_makefile) SiHitAnalysisrchk; \
	  fi
#	@$(MAKE) -f $(cmt_local_SiHitAnalysisrchk_makefile) SiHitAnalysisrchk
	$(echo) "(constituents.make) SiHitAnalysisrchk done"

clean :: SiHitAnalysisrchkclean ;

SiHitAnalysisrchkclean :: $(SiHitAnalysisrchkclean_dependencies) ##$(cmt_local_SiHitAnalysisrchk_makefile)
	$(echo) "(constituents.make) Starting SiHitAnalysisrchkclean"
	@-if test -f $(cmt_local_SiHitAnalysisrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysisrchk_makefile) SiHitAnalysisrchkclean; \
	fi
	$(echo) "(constituents.make) SiHitAnalysisrchkclean done"
#	@-$(MAKE) -f $(cmt_local_SiHitAnalysisrchk_makefile) SiHitAnalysisrchkclean

##	  /bin/rm -f $(cmt_local_SiHitAnalysisrchk_makefile) $(bin)SiHitAnalysisrchk_dependencies.make

install :: SiHitAnalysisrchkinstall ;

SiHitAnalysisrchkinstall :: $(SiHitAnalysisrchk_dependencies) $(cmt_local_SiHitAnalysisrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SiHitAnalysisrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysisrchk_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SiHitAnalysisrchk_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : SiHitAnalysisrchkuninstall

$(foreach d,$(SiHitAnalysisrchk_dependencies),$(eval $(d)uninstall_dependencies += SiHitAnalysisrchkuninstall))

SiHitAnalysisrchkuninstall : $(SiHitAnalysisrchkuninstall_dependencies) ##$(cmt_local_SiHitAnalysisrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SiHitAnalysisrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysisrchk_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SiHitAnalysisrchk_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SiHitAnalysisrchkuninstall ;
...
cmt_local_tagfile_install_root_include_path = $(bin)$(SiHitAnalysis_tag)_install_root_include_path.make
...
cmt_local_tagfile_install_root_include_path = $(bin)$(SiHitAnalysis_tag).make
...
cmt_local_tagfile_install_includes = $(bin)$(SiHitAnalysis_tag)_install_includes.make
...
cmt_local_tagfile_install_includes = $(bin)$(SiHitAnalysis_tag).make
...
cmt_local_tagfile_make = $(bin)$(SiHitAnalysis_tag)_make.make
...
cmt_local_tagfile_make = $(bin)$(SiHitAnalysis_tag).make
...
cmt_local_tagfile_CompilePython = $(bin)$(SiHitAnalysis_tag)_CompilePython.make
...
cmt_local_tagfile_CompilePython = $(bin)$(SiHitAnalysis_tag).make
...
cmt_local_tagfile_qmtest_run = $(bin)$(SiHitAnalysis_tag)_qmtest_run.make
...
cmt_local_tagfile_qmtest_run = $(bin)$(SiHitAnalysis_tag).make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(SiHitAnalysis_tag)_qmtest_summarize.make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(SiHitAnalysis_tag).make
...
cmt_local_tagfile_TestPackage = $(bin)$(SiHitAnalysis_tag)_TestPackage.make
...
cmt_local_tagfile_TestPackage = $(bin)$(SiHitAnalysis_tag).make
...
cmt_local_tagfile_TestProject = $(bin)$(SiHitAnalysis_tag)_TestProject.make
...
cmt_local_tagfile_TestProject = $(bin)$(SiHitAnalysis_tag).make
...
cmt_local_tagfile_new_rootsys = $(bin)$(SiHitAnalysis_tag)_new_rootsys.make
...
cmt_local_tagfile_new_rootsys = $(bin)$(SiHitAnalysis_tag).make
...
cmt_local_tagfile_doxygen = $(bin)$(SiHitAnalysis_tag)_doxygen.make
...
cmt_local_tagfile_doxygen = $(bin)$(SiHitAnalysis_tag).make
...
cmt_local_tagfile_post_install = $(bin)$(SiHitAnalysis_tag)_post_install.make
...
cmt_local_tagfile_post_install = $(bin)$(SiHitAnalysis_tag).make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(SiHitAnalysis_tag)_post_merge_rootmap.make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(SiHitAnalysis_tag).make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(SiHitAnalysis_tag)_post_merge_genconfdb.make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(SiHitAnalysis_tag).make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(SiHitAnalysis_tag)_post_build_tpcnvdb.make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(SiHitAnalysis_tag).make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(SiHitAnalysis_tag)_all_post_constituents.make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(SiHitAnalysis_tag).make
...
cmt_local_tagfile_checkreq = $(bin)$(SiHitAnalysis_tag)_checkreq.make
...
cmt_local_tagfile_checkreq = $(bin)$(SiHitAnalysis_tag).make
...
cmt_SiHitAnalysis_NICOS_Fix_debuginfo_has_no_target_tag = 1

#--------------------------------------

ifdef cmt_SiHitAnalysis_NICOS_Fix_debuginfo_has_target_tag

cmt_local_tagfile_SiHitAnalysis_NICOS_Fix_debuginfo = $(bin)$(SiHitAnalysis_tag)_SiHitAnalysis_NICOS_Fix_debuginfo.make
cmt_final_setup_SiHitAnalysis_NICOS_Fix_debuginfo = $(bin)setup_SiHitAnalysis_NICOS_Fix_debuginfo.make
cmt_local_SiHitAnalysis_NICOS_Fix_debuginfo_makefile = $(bin)SiHitAnalysis_NICOS_Fix_debuginfo.make

SiHitAnalysis_NICOS_Fix_debuginfo_extratags = -tag_add=target_SiHitAnalysis_NICOS_Fix_debuginfo

else

cmt_local_tagfile_SiHitAnalysis_NICOS_Fix_debuginfo = $(bin)$(SiHitAnalysis_tag).make
cmt_final_setup_SiHitAnalysis_NICOS_Fix_debuginfo = $(bin)setup.make
cmt_local_SiHitAnalysis_NICOS_Fix_debuginfo_makefile = $(bin)SiHitAnalysis_NICOS_Fix_debuginfo.make

endif

not_SiHitAnalysis_NICOS_Fix_debuginfo_dependencies = { n=0; for p in $?; do m=0; for d in $(SiHitAnalysis_NICOS_Fix_debuginfo_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SiHitAnalysis_NICOS_Fix_debuginfodirs :
	@if test ! -d $(bin)SiHitAnalysis_NICOS_Fix_debuginfo; then $(mkdir) -p $(bin)SiHitAnalysis_NICOS_Fix_debuginfo; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SiHitAnalysis_NICOS_Fix_debuginfo
else
SiHitAnalysis_NICOS_Fix_debuginfodirs : ;
endif
...
ifndef QUICK
$(cmt_local_SiHitAnalysis_NICOS_Fix_debuginfo_makefile) : $(SiHitAnalysis_NICOS_Fix_debuginfo_dependencies) build_library_links
	$(echo) "(constituents.make) Building SiHitAnalysis_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -tag=$(tags) $(SiHitAnalysis_NICOS_Fix_debuginfo_extratags) build constituent_config -out=$(cmt_local_SiHitAnalysis_NICOS_Fix_debuginfo_makefile) SiHitAnalysis_NICOS_Fix_debuginfo
else
$(cmt_local_SiHitAnalysis_NICOS_Fix_debuginfo_makefile) : $(SiHitAnalysis_NICOS_Fix_debuginfo_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SiHitAnalysis_NICOS_Fix_debuginfo) ] || \
	  [ ! -f $(cmt_final_setup_SiHitAnalysis_NICOS_Fix_debuginfo) ] || \
	  $(not_SiHitAnalysis_NICOS_Fix_debuginfo_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SiHitAnalysis_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -tag=$(tags) $(SiHitAnalysis_NICOS_Fix_debuginfo_extratags) build constituent_config -out=$(cmt_local_SiHitAnalysis_NICOS_Fix_debuginfo_makefile) SiHitAnalysis_NICOS_Fix_debuginfo; \
	  fi
endif
...
$(cmt_local_SiHitAnalysis_NICOS_Fix_debuginfo_makefile) : $(SiHitAnalysis_NICOS_Fix_debuginfo_dependencies) build_library_links
	$(echo) "(constituents.make) Building SiHitAnalysis_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -f=$(bin)SiHitAnalysis_NICOS_Fix_debuginfo.in -tag=$(tags) $(SiHitAnalysis_NICOS_Fix_debuginfo_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SiHitAnalysis_NICOS_Fix_debuginfo_makefile) SiHitAnalysis_NICOS_Fix_debuginfo
else
$(cmt_local_SiHitAnalysis_NICOS_Fix_debuginfo_makefile) : $(SiHitAnalysis_NICOS_Fix_debuginfo_dependencies) $(cmt_build_library_linksstamp) $(bin)SiHitAnalysis_NICOS_Fix_debuginfo.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SiHitAnalysis_NICOS_Fix_debuginfo) ] || \
	  [ ! -f $(cmt_final_setup_SiHitAnalysis_NICOS_Fix_debuginfo) ] || \
	  $(not_SiHitAnalysis_NICOS_Fix_debuginfo_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SiHitAnalysis_NICOS_Fix_debuginfo_extratags) build constituent_makefile -out=$(cmt_local_SiHitAnalysis_NICOS_Fix_debuginfo_makefile) SiHitAnalysis_NICOS_Fix_debuginfo

SiHitAnalysis_NICOS_Fix_debuginfo :: $(SiHitAnalysis_NICOS_Fix_debuginfo_dependencies) $(cmt_local_SiHitAnalysis_NICOS_Fix_debuginfo_makefile) dirs SiHitAnalysis_NICOS_Fix_debuginfodirs
	$(echo) "(constituents.make) Starting SiHitAnalysis_NICOS_Fix_debuginfo"
	@if test -f $(cmt_local_SiHitAnalysis_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysis_NICOS_Fix_debuginfo_makefile) SiHitAnalysis_NICOS_Fix_debuginfo; \
	  fi
#	@$(MAKE) -f $(cmt_local_SiHitAnalysis_NICOS_Fix_debuginfo_makefile) SiHitAnalysis_NICOS_Fix_debuginfo
	$(echo) "(constituents.make) SiHitAnalysis_NICOS_Fix_debuginfo done"

clean :: SiHitAnalysis_NICOS_Fix_debuginfoclean ;

SiHitAnalysis_NICOS_Fix_debuginfoclean :: $(SiHitAnalysis_NICOS_Fix_debuginfoclean_dependencies) ##$(cmt_local_SiHitAnalysis_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting SiHitAnalysis_NICOS_Fix_debuginfoclean"
	@-if test -f $(cmt_local_SiHitAnalysis_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysis_NICOS_Fix_debuginfo_makefile) SiHitAnalysis_NICOS_Fix_debuginfoclean; \
	fi
	$(echo) "(constituents.make) SiHitAnalysis_NICOS_Fix_debuginfoclean done"
#	@-$(MAKE) -f $(cmt_local_SiHitAnalysis_NICOS_Fix_debuginfo_makefile) SiHitAnalysis_NICOS_Fix_debuginfoclean

##	  /bin/rm -f $(cmt_local_SiHitAnalysis_NICOS_Fix_debuginfo_makefile) $(bin)SiHitAnalysis_NICOS_Fix_debuginfo_dependencies.make

install :: SiHitAnalysis_NICOS_Fix_debuginfoinstall ;

SiHitAnalysis_NICOS_Fix_debuginfoinstall :: $(SiHitAnalysis_NICOS_Fix_debuginfo_dependencies) $(cmt_local_SiHitAnalysis_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SiHitAnalysis_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysis_NICOS_Fix_debuginfo_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SiHitAnalysis_NICOS_Fix_debuginfo_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : SiHitAnalysis_NICOS_Fix_debuginfouninstall

$(foreach d,$(SiHitAnalysis_NICOS_Fix_debuginfo_dependencies),$(eval $(d)uninstall_dependencies += SiHitAnalysis_NICOS_Fix_debuginfouninstall))

SiHitAnalysis_NICOS_Fix_debuginfouninstall : $(SiHitAnalysis_NICOS_Fix_debuginfouninstall_dependencies) ##$(cmt_local_SiHitAnalysis_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SiHitAnalysis_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_SiHitAnalysis_NICOS_Fix_debuginfo_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SiHitAnalysis_NICOS_Fix_debuginfo_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SiHitAnalysis_NICOS_Fix_debuginfouninstall ;
...
cmt_local_tagfile_check_install_joboptions = $(bin)$(SiHitAnalysis_tag)_check_install_joboptions.make
...
cmt_local_tagfile_check_install_joboptions = $(bin)$(SiHitAnalysis_tag).make
...
cmt_local_tagfile_find_packages = $(bin)$(SiHitAnalysis_tag)_find_packages.make
...
cmt_local_tagfile_find_packages = $(bin)$(SiHitAnalysis_tag).make
...
cmt_local_tagfile_compile = $(bin)$(SiHitAnalysis_tag)_compile.make
...
cmt_local_tagfile_compile = $(bin)$(SiHitAnalysis_tag).make
...
cmt_local_tagfile_compile_pkg = $(bin)$(SiHitAnalysis_tag)_compile_pkg.make
...
cmt_local_tagfile_compile_pkg = $(bin)$(SiHitAnalysis_tag).make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(SiHitAnalysis_tag)_new_analysisapp.make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(SiHitAnalysis_tag).make
...
cmt_local_tagfile_new_pkg = $(bin)$(SiHitAnalysis_tag)_new_pkg.make
...
cmt_local_tagfile_new_pkg = $(bin)$(SiHitAnalysis_tag).make
...
cmt_local_tagfile_new_alg = $(bin)$(SiHitAnalysis_tag)_new_alg.make
...
cmt_local_tagfile_new_alg = $(bin)$(SiHitAnalysis_tag).make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(SiHitAnalysis_tag)_new_analysisalg.make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(SiHitAnalysis_tag).make
...
cmt_local_tagfile_new_asgtool = $(bin)$(SiHitAnalysis_tag)_new_asgtool.make
...
cmt_local_tagfile_new_asgtool = $(bin)$(SiHitAnalysis_tag).make
...
cmt_local_tagfile_new_jobo = $(bin)$(SiHitAnalysis_tag)_new_jobo.make
...
cmt_local_tagfile_new_jobo = $(bin)$(SiHitAnalysis_tag).make
...
cmt_local_tagfile_new_skeleton = $(bin)$(SiHitAnalysis_tag)_new_skeleton.make
...
cmt_local_tagfile_new_skeleton = $(bin)$(SiHitAnalysis_tag).make
...
cmt_local_tagfile_make_skeleton = $(bin)$(SiHitAnalysis_tag)_make_skeleton.make
...
cmt_local_tagfile_make_skeleton = $(bin)$(SiHitAnalysis_tag).make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(SiHitAnalysis_tag)_checkout_pkg.make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(SiHitAnalysis_tag).make
...
cmt_local_tagfile_cppcheck = $(bin)$(SiHitAnalysis_tag)_cppcheck.make
...
cmt_local_tagfile_cppcheck = $(bin)$(SiHitAnalysis_tag).make
