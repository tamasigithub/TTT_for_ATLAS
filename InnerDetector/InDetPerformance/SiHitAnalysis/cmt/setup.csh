...
${CMTROOT}/${CMTBIN}/cmt.exe setup -csh -pack=SiHitAnalysis -version=SiHitAnalysis-00-00-02 -path=/nfs/dust/atlas/user/tkar/20.20.10.7/InnerDetector/InDetPerformance  -no_cleanup $* >${cmtSiHitAnalysistempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe setup -csh -pack=SiHitAnalysis -version=SiHitAnalysis-00-00-02 -path=/nfs/dust/atlas/user/tkar/20.20.10.7/InnerDetector/InDetPerformance  -no_cleanup $* >${cmtSiHitAnalysistempfile}"
