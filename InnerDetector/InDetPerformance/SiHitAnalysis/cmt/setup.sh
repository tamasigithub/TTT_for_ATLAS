...
${CMTROOT}/${CMTBIN}/cmt.exe setup -sh -pack=SiHitAnalysis -version=SiHitAnalysis-00-00-02 -path=/afs/cern.ch/work/t/tkar/testarea/20.20.10.7/InnerDetector/InDetPerformance  -no_cleanup $* >${cmtSiHitAnalysistempfile}
if test $? != 0 ; then
  echo >&2 "${CMTROOT}/${CMTBIN}/cmt.exe setup -sh -pack=SiHitAnalysis -version=SiHitAnalysis-00-00-02 -path=/afs/cern.ch/work/t/tkar/testarea/20.20.10.7/InnerDetector/InDetPerformance  -no_cleanup $* >${cmtSiHitAnalysistempfile}"
  cmtsetupstatus=2
