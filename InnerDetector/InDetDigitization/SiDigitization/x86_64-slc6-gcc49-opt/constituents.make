...
#cmt_local_tagfile = $(SiDigitization_tag).make
cmt_local_tagfile = $(bin)$(SiDigitization_tag).make
...
SiDigitization_extratags = -tag_add=target_SiDigitization
...
not_SiDigitization_dependencies = { n=0; for p in $?; do m=0; for d in $(SiDigitization_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SiDigitizationdirs :
	@if test ! -d $(bin)SiDigitization; then $(mkdir) -p $(bin)SiDigitization; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SiDigitization
else
SiDigitizationdirs : ;
endif
...
ifndef QUICK
$(cmt_local_SiDigitization_makefile) : $(SiDigitization_dependencies) build_library_links
	$(echo) "(constituents.make) Building SiDigitization.make"; \
	  $(cmtexe) -tag=$(tags) $(SiDigitization_extratags) build constituent_config -out=$(cmt_local_SiDigitization_makefile) SiDigitization
else
$(cmt_local_SiDigitization_makefile) : $(SiDigitization_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SiDigitization) ] || \
	  [ ! -f $(cmt_final_setup_SiDigitization) ] || \
	  $(not_SiDigitization_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SiDigitization.make"; \
	  $(cmtexe) -tag=$(tags) $(SiDigitization_extratags) build constituent_config -out=$(cmt_local_SiDigitization_makefile) SiDigitization; \
	  fi
endif
...
$(cmt_local_SiDigitization_makefile) : $(SiDigitization_dependencies) build_library_links
	$(echo) "(constituents.make) Building SiDigitization.make"; \
	  $(cmtexe) -f=$(bin)SiDigitization.in -tag=$(tags) $(SiDigitization_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SiDigitization_makefile) SiDigitization
else
$(cmt_local_SiDigitization_makefile) : $(SiDigitization_dependencies) $(cmt_build_library_linksstamp) $(bin)SiDigitization.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SiDigitization) ] || \
	  [ ! -f $(cmt_final_setup_SiDigitization) ] || \
	  $(not_SiDigitization_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SiDigitization_extratags) build constituent_makefile -out=$(cmt_local_SiDigitization_makefile) SiDigitization

SiDigitization :: $(SiDigitization_dependencies) $(cmt_local_SiDigitization_makefile) dirs SiDigitizationdirs
	$(echo) "(constituents.make) Starting SiDigitization"
	@if test -f $(cmt_local_SiDigitization_makefile); then \
	  $(MAKE) -f $(cmt_local_SiDigitization_makefile) SiDigitization; \
	  fi
#	@$(MAKE) -f $(cmt_local_SiDigitization_makefile) SiDigitization
	$(echo) "(constituents.make) SiDigitization done"

clean :: SiDigitizationclean ;

SiDigitizationclean :: $(SiDigitizationclean_dependencies) ##$(cmt_local_SiDigitization_makefile)
	$(echo) "(constituents.make) Starting SiDigitizationclean"
	@-if test -f $(cmt_local_SiDigitization_makefile); then \
	  $(MAKE) -f $(cmt_local_SiDigitization_makefile) SiDigitizationclean; \
	fi
	$(echo) "(constituents.make) SiDigitizationclean done"
#	@-$(MAKE) -f $(cmt_local_SiDigitization_makefile) SiDigitizationclean

##	  /bin/rm -f $(cmt_local_SiDigitization_makefile) $(bin)SiDigitization_dependencies.make

install :: SiDigitizationinstall ;

SiDigitizationinstall :: $(SiDigitization_dependencies) $(cmt_local_SiDigitization_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SiDigitization_makefile); then \
	  $(MAKE) -f $(cmt_local_SiDigitization_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SiDigitization_makefile) install
...
$(foreach d,$(SiDigitization_dependencies),$(eval $(d)uninstall_dependencies += SiDigitizationuninstall))

SiDigitizationuninstall : $(SiDigitizationuninstall_dependencies) ##$(cmt_local_SiDigitization_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SiDigitization_makefile); then \
	  $(MAKE) -f $(cmt_local_SiDigitization_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SiDigitization_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SiDigitizationuninstall ;
...
SiDigitization_optdebug_library_extratags = -tag_add=target_SiDigitization_optdebug_library
...
not_SiDigitization_optdebug_library_dependencies = { n=0; for p in $?; do m=0; for d in $(SiDigitization_optdebug_library_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SiDigitization_optdebug_librarydirs :
	@if test ! -d $(bin)SiDigitization_optdebug_library; then $(mkdir) -p $(bin)SiDigitization_optdebug_library; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SiDigitization_optdebug_library
else
SiDigitization_optdebug_librarydirs : ;
endif
...
ifndef QUICK
$(cmt_local_SiDigitization_optdebug_library_makefile) : $(SiDigitization_optdebug_library_dependencies) build_library_links
	$(echo) "(constituents.make) Building SiDigitization_optdebug_library.make"; \
	  $(cmtexe) -tag=$(tags) $(SiDigitization_optdebug_library_extratags) build constituent_config -out=$(cmt_local_SiDigitization_optdebug_library_makefile) SiDigitization_optdebug_library
else
$(cmt_local_SiDigitization_optdebug_library_makefile) : $(SiDigitization_optdebug_library_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SiDigitization_optdebug_library) ] || \
	  [ ! -f $(cmt_final_setup_SiDigitization_optdebug_library) ] || \
	  $(not_SiDigitization_optdebug_library_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SiDigitization_optdebug_library.make"; \
	  $(cmtexe) -tag=$(tags) $(SiDigitization_optdebug_library_extratags) build constituent_config -out=$(cmt_local_SiDigitization_optdebug_library_makefile) SiDigitization_optdebug_library; \
	  fi
endif
...
$(cmt_local_SiDigitization_optdebug_library_makefile) : $(SiDigitization_optdebug_library_dependencies) build_library_links
	$(echo) "(constituents.make) Building SiDigitization_optdebug_library.make"; \
	  $(cmtexe) -f=$(bin)SiDigitization_optdebug_library.in -tag=$(tags) $(SiDigitization_optdebug_library_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SiDigitization_optdebug_library_makefile) SiDigitization_optdebug_library
else
$(cmt_local_SiDigitization_optdebug_library_makefile) : $(SiDigitization_optdebug_library_dependencies) $(cmt_build_library_linksstamp) $(bin)SiDigitization_optdebug_library.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SiDigitization_optdebug_library) ] || \
	  [ ! -f $(cmt_final_setup_SiDigitization_optdebug_library) ] || \
	  $(not_SiDigitization_optdebug_library_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SiDigitization_optdebug_library_extratags) build constituent_makefile -out=$(cmt_local_SiDigitization_optdebug_library_makefile) SiDigitization_optdebug_library

SiDigitization_optdebug_library :: $(SiDigitization_optdebug_library_dependencies) $(cmt_local_SiDigitization_optdebug_library_makefile) dirs SiDigitization_optdebug_librarydirs
	$(echo) "(constituents.make) Starting SiDigitization_optdebug_library"
	@if test -f $(cmt_local_SiDigitization_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_SiDigitization_optdebug_library_makefile) SiDigitization_optdebug_library; \
	  fi
#	@$(MAKE) -f $(cmt_local_SiDigitization_optdebug_library_makefile) SiDigitization_optdebug_library
	$(echo) "(constituents.make) SiDigitization_optdebug_library done"

clean :: SiDigitization_optdebug_libraryclean ;

SiDigitization_optdebug_libraryclean :: $(SiDigitization_optdebug_libraryclean_dependencies) ##$(cmt_local_SiDigitization_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting SiDigitization_optdebug_libraryclean"
	@-if test -f $(cmt_local_SiDigitization_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_SiDigitization_optdebug_library_makefile) SiDigitization_optdebug_libraryclean; \
	fi
	$(echo) "(constituents.make) SiDigitization_optdebug_libraryclean done"
#	@-$(MAKE) -f $(cmt_local_SiDigitization_optdebug_library_makefile) SiDigitization_optdebug_libraryclean

##	  /bin/rm -f $(cmt_local_SiDigitization_optdebug_library_makefile) $(bin)SiDigitization_optdebug_library_dependencies.make

install :: SiDigitization_optdebug_libraryinstall ;

SiDigitization_optdebug_libraryinstall :: $(SiDigitization_optdebug_library_dependencies) $(cmt_local_SiDigitization_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SiDigitization_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_SiDigitization_optdebug_library_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SiDigitization_optdebug_library_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(SiDigitization_optdebug_library_dependencies),$(eval $(d)uninstall_dependencies += SiDigitization_optdebug_libraryuninstall))

SiDigitization_optdebug_libraryuninstall : $(SiDigitization_optdebug_libraryuninstall_dependencies) ##$(cmt_local_SiDigitization_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SiDigitization_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_SiDigitization_optdebug_library_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SiDigitization_optdebug_library_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SiDigitization_optdebug_libraryuninstall ;
...
cmt_SiDigitizationrchk_has_target_tag = 1

#--------------------------------------

ifdef cmt_SiDigitizationrchk_has_target_tag

cmt_local_tagfile_SiDigitizationrchk = $(bin)$(SiDigitization_tag)_SiDigitizationrchk.make
cmt_final_setup_SiDigitizationrchk = $(bin)setup_SiDigitizationrchk.make
cmt_local_SiDigitizationrchk_makefile = $(bin)SiDigitizationrchk.make

SiDigitizationrchk_extratags = -tag_add=target_SiDigitizationrchk

else

cmt_local_tagfile_SiDigitizationrchk = $(bin)$(SiDigitization_tag).make
cmt_final_setup_SiDigitizationrchk = $(bin)setup.make
cmt_local_SiDigitizationrchk_makefile = $(bin)SiDigitizationrchk.make

endif

not_SiDigitizationrchk_dependencies = { n=0; for p in $?; do m=0; for d in $(SiDigitizationrchk_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SiDigitizationrchkdirs :
	@if test ! -d $(bin)SiDigitizationrchk; then $(mkdir) -p $(bin)SiDigitizationrchk; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SiDigitizationrchk
else
SiDigitizationrchkdirs : ;
endif
...
ifndef QUICK
$(cmt_local_SiDigitizationrchk_makefile) : $(SiDigitizationrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building SiDigitizationrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(SiDigitizationrchk_extratags) build constituent_config -out=$(cmt_local_SiDigitizationrchk_makefile) SiDigitizationrchk
else
$(cmt_local_SiDigitizationrchk_makefile) : $(SiDigitizationrchk_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SiDigitizationrchk) ] || \
	  [ ! -f $(cmt_final_setup_SiDigitizationrchk) ] || \
	  $(not_SiDigitizationrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SiDigitizationrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(SiDigitizationrchk_extratags) build constituent_config -out=$(cmt_local_SiDigitizationrchk_makefile) SiDigitizationrchk; \
	  fi
endif
...
$(cmt_local_SiDigitizationrchk_makefile) : $(SiDigitizationrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building SiDigitizationrchk.make"; \
	  $(cmtexe) -f=$(bin)SiDigitizationrchk.in -tag=$(tags) $(SiDigitizationrchk_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SiDigitizationrchk_makefile) SiDigitizationrchk
else
$(cmt_local_SiDigitizationrchk_makefile) : $(SiDigitizationrchk_dependencies) $(cmt_build_library_linksstamp) $(bin)SiDigitizationrchk.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SiDigitizationrchk) ] || \
	  [ ! -f $(cmt_final_setup_SiDigitizationrchk) ] || \
	  $(not_SiDigitizationrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SiDigitizationrchk_extratags) build constituent_makefile -out=$(cmt_local_SiDigitizationrchk_makefile) SiDigitizationrchk

SiDigitizationrchk :: $(SiDigitizationrchk_dependencies) $(cmt_local_SiDigitizationrchk_makefile) dirs SiDigitizationrchkdirs
	$(echo) "(constituents.make) Starting SiDigitizationrchk"
	@if test -f $(cmt_local_SiDigitizationrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_SiDigitizationrchk_makefile) SiDigitizationrchk; \
	  fi
#	@$(MAKE) -f $(cmt_local_SiDigitizationrchk_makefile) SiDigitizationrchk
	$(echo) "(constituents.make) SiDigitizationrchk done"

clean :: SiDigitizationrchkclean ;

SiDigitizationrchkclean :: $(SiDigitizationrchkclean_dependencies) ##$(cmt_local_SiDigitizationrchk_makefile)
	$(echo) "(constituents.make) Starting SiDigitizationrchkclean"
	@-if test -f $(cmt_local_SiDigitizationrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_SiDigitizationrchk_makefile) SiDigitizationrchkclean; \
	fi
	$(echo) "(constituents.make) SiDigitizationrchkclean done"
#	@-$(MAKE) -f $(cmt_local_SiDigitizationrchk_makefile) SiDigitizationrchkclean

##	  /bin/rm -f $(cmt_local_SiDigitizationrchk_makefile) $(bin)SiDigitizationrchk_dependencies.make

install :: SiDigitizationrchkinstall ;

SiDigitizationrchkinstall :: $(SiDigitizationrchk_dependencies) $(cmt_local_SiDigitizationrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SiDigitizationrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_SiDigitizationrchk_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SiDigitizationrchk_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : SiDigitizationrchkuninstall

$(foreach d,$(SiDigitizationrchk_dependencies),$(eval $(d)uninstall_dependencies += SiDigitizationrchkuninstall))

SiDigitizationrchkuninstall : $(SiDigitizationrchkuninstall_dependencies) ##$(cmt_local_SiDigitizationrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SiDigitizationrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_SiDigitizationrchk_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SiDigitizationrchk_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SiDigitizationrchkuninstall ;
...
cmt_local_tagfile_install_root_include_path = $(bin)$(SiDigitization_tag)_install_root_include_path.make
...
cmt_local_tagfile_install_root_include_path = $(bin)$(SiDigitization_tag).make
...
cmt_local_tagfile_install_includes = $(bin)$(SiDigitization_tag)_install_includes.make
...
cmt_local_tagfile_install_includes = $(bin)$(SiDigitization_tag).make
...
cmt_local_tagfile_make = $(bin)$(SiDigitization_tag)_make.make
...
cmt_local_tagfile_make = $(bin)$(SiDigitization_tag).make
...
cmt_local_tagfile_CompilePython = $(bin)$(SiDigitization_tag)_CompilePython.make
...
cmt_local_tagfile_CompilePython = $(bin)$(SiDigitization_tag).make
...
cmt_local_tagfile_qmtest_run = $(bin)$(SiDigitization_tag)_qmtest_run.make
...
cmt_local_tagfile_qmtest_run = $(bin)$(SiDigitization_tag).make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(SiDigitization_tag)_qmtest_summarize.make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(SiDigitization_tag).make
...
cmt_local_tagfile_TestPackage = $(bin)$(SiDigitization_tag)_TestPackage.make
...
cmt_local_tagfile_TestPackage = $(bin)$(SiDigitization_tag).make
...
cmt_local_tagfile_TestProject = $(bin)$(SiDigitization_tag)_TestProject.make
...
cmt_local_tagfile_TestProject = $(bin)$(SiDigitization_tag).make
...
cmt_local_tagfile_new_rootsys = $(bin)$(SiDigitization_tag)_new_rootsys.make
...
cmt_local_tagfile_new_rootsys = $(bin)$(SiDigitization_tag).make
...
cmt_local_tagfile_doxygen = $(bin)$(SiDigitization_tag)_doxygen.make
...
cmt_local_tagfile_doxygen = $(bin)$(SiDigitization_tag).make
...
cmt_local_tagfile_post_install = $(bin)$(SiDigitization_tag)_post_install.make
...
cmt_local_tagfile_post_install = $(bin)$(SiDigitization_tag).make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(SiDigitization_tag)_post_merge_rootmap.make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(SiDigitization_tag).make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(SiDigitization_tag)_post_merge_genconfdb.make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(SiDigitization_tag).make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(SiDigitization_tag)_post_build_tpcnvdb.make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(SiDigitization_tag).make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(SiDigitization_tag)_all_post_constituents.make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(SiDigitization_tag).make
...
cmt_local_tagfile_checkreq = $(bin)$(SiDigitization_tag)_checkreq.make
...
cmt_local_tagfile_checkreq = $(bin)$(SiDigitization_tag).make
...
cmt_SiDigitization_NICOS_Fix_debuginfo_has_no_target_tag = 1

#--------------------------------------

ifdef cmt_SiDigitization_NICOS_Fix_debuginfo_has_target_tag

cmt_local_tagfile_SiDigitization_NICOS_Fix_debuginfo = $(bin)$(SiDigitization_tag)_SiDigitization_NICOS_Fix_debuginfo.make
cmt_final_setup_SiDigitization_NICOS_Fix_debuginfo = $(bin)setup_SiDigitization_NICOS_Fix_debuginfo.make
cmt_local_SiDigitization_NICOS_Fix_debuginfo_makefile = $(bin)SiDigitization_NICOS_Fix_debuginfo.make

SiDigitization_NICOS_Fix_debuginfo_extratags = -tag_add=target_SiDigitization_NICOS_Fix_debuginfo

else

cmt_local_tagfile_SiDigitization_NICOS_Fix_debuginfo = $(bin)$(SiDigitization_tag).make
cmt_final_setup_SiDigitization_NICOS_Fix_debuginfo = $(bin)setup.make
cmt_local_SiDigitization_NICOS_Fix_debuginfo_makefile = $(bin)SiDigitization_NICOS_Fix_debuginfo.make

endif

not_SiDigitization_NICOS_Fix_debuginfo_dependencies = { n=0; for p in $?; do m=0; for d in $(SiDigitization_NICOS_Fix_debuginfo_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SiDigitization_NICOS_Fix_debuginfodirs :
	@if test ! -d $(bin)SiDigitization_NICOS_Fix_debuginfo; then $(mkdir) -p $(bin)SiDigitization_NICOS_Fix_debuginfo; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SiDigitization_NICOS_Fix_debuginfo
else
SiDigitization_NICOS_Fix_debuginfodirs : ;
endif
...
ifndef QUICK
$(cmt_local_SiDigitization_NICOS_Fix_debuginfo_makefile) : $(SiDigitization_NICOS_Fix_debuginfo_dependencies) build_library_links
	$(echo) "(constituents.make) Building SiDigitization_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -tag=$(tags) $(SiDigitization_NICOS_Fix_debuginfo_extratags) build constituent_config -out=$(cmt_local_SiDigitization_NICOS_Fix_debuginfo_makefile) SiDigitization_NICOS_Fix_debuginfo
else
$(cmt_local_SiDigitization_NICOS_Fix_debuginfo_makefile) : $(SiDigitization_NICOS_Fix_debuginfo_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SiDigitization_NICOS_Fix_debuginfo) ] || \
	  [ ! -f $(cmt_final_setup_SiDigitization_NICOS_Fix_debuginfo) ] || \
	  $(not_SiDigitization_NICOS_Fix_debuginfo_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SiDigitization_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -tag=$(tags) $(SiDigitization_NICOS_Fix_debuginfo_extratags) build constituent_config -out=$(cmt_local_SiDigitization_NICOS_Fix_debuginfo_makefile) SiDigitization_NICOS_Fix_debuginfo; \
	  fi
endif
...
$(cmt_local_SiDigitization_NICOS_Fix_debuginfo_makefile) : $(SiDigitization_NICOS_Fix_debuginfo_dependencies) build_library_links
	$(echo) "(constituents.make) Building SiDigitization_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -f=$(bin)SiDigitization_NICOS_Fix_debuginfo.in -tag=$(tags) $(SiDigitization_NICOS_Fix_debuginfo_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SiDigitization_NICOS_Fix_debuginfo_makefile) SiDigitization_NICOS_Fix_debuginfo
else
$(cmt_local_SiDigitization_NICOS_Fix_debuginfo_makefile) : $(SiDigitization_NICOS_Fix_debuginfo_dependencies) $(cmt_build_library_linksstamp) $(bin)SiDigitization_NICOS_Fix_debuginfo.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SiDigitization_NICOS_Fix_debuginfo) ] || \
	  [ ! -f $(cmt_final_setup_SiDigitization_NICOS_Fix_debuginfo) ] || \
	  $(not_SiDigitization_NICOS_Fix_debuginfo_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SiDigitization_NICOS_Fix_debuginfo_extratags) build constituent_makefile -out=$(cmt_local_SiDigitization_NICOS_Fix_debuginfo_makefile) SiDigitization_NICOS_Fix_debuginfo

SiDigitization_NICOS_Fix_debuginfo :: $(SiDigitization_NICOS_Fix_debuginfo_dependencies) $(cmt_local_SiDigitization_NICOS_Fix_debuginfo_makefile) dirs SiDigitization_NICOS_Fix_debuginfodirs
	$(echo) "(constituents.make) Starting SiDigitization_NICOS_Fix_debuginfo"
	@if test -f $(cmt_local_SiDigitization_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_SiDigitization_NICOS_Fix_debuginfo_makefile) SiDigitization_NICOS_Fix_debuginfo; \
	  fi
#	@$(MAKE) -f $(cmt_local_SiDigitization_NICOS_Fix_debuginfo_makefile) SiDigitization_NICOS_Fix_debuginfo
	$(echo) "(constituents.make) SiDigitization_NICOS_Fix_debuginfo done"

clean :: SiDigitization_NICOS_Fix_debuginfoclean ;

SiDigitization_NICOS_Fix_debuginfoclean :: $(SiDigitization_NICOS_Fix_debuginfoclean_dependencies) ##$(cmt_local_SiDigitization_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting SiDigitization_NICOS_Fix_debuginfoclean"
	@-if test -f $(cmt_local_SiDigitization_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_SiDigitization_NICOS_Fix_debuginfo_makefile) SiDigitization_NICOS_Fix_debuginfoclean; \
	fi
	$(echo) "(constituents.make) SiDigitization_NICOS_Fix_debuginfoclean done"
#	@-$(MAKE) -f $(cmt_local_SiDigitization_NICOS_Fix_debuginfo_makefile) SiDigitization_NICOS_Fix_debuginfoclean

##	  /bin/rm -f $(cmt_local_SiDigitization_NICOS_Fix_debuginfo_makefile) $(bin)SiDigitization_NICOS_Fix_debuginfo_dependencies.make

install :: SiDigitization_NICOS_Fix_debuginfoinstall ;

SiDigitization_NICOS_Fix_debuginfoinstall :: $(SiDigitization_NICOS_Fix_debuginfo_dependencies) $(cmt_local_SiDigitization_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SiDigitization_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_SiDigitization_NICOS_Fix_debuginfo_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SiDigitization_NICOS_Fix_debuginfo_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : SiDigitization_NICOS_Fix_debuginfouninstall

$(foreach d,$(SiDigitization_NICOS_Fix_debuginfo_dependencies),$(eval $(d)uninstall_dependencies += SiDigitization_NICOS_Fix_debuginfouninstall))

SiDigitization_NICOS_Fix_debuginfouninstall : $(SiDigitization_NICOS_Fix_debuginfouninstall_dependencies) ##$(cmt_local_SiDigitization_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SiDigitization_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_SiDigitization_NICOS_Fix_debuginfo_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SiDigitization_NICOS_Fix_debuginfo_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SiDigitization_NICOS_Fix_debuginfouninstall ;
...
cmt_local_tagfile_find_packages = $(bin)$(SiDigitization_tag)_find_packages.make
...
cmt_local_tagfile_find_packages = $(bin)$(SiDigitization_tag).make
...
cmt_local_tagfile_compile = $(bin)$(SiDigitization_tag)_compile.make
...
cmt_local_tagfile_compile = $(bin)$(SiDigitization_tag).make
...
cmt_local_tagfile_compile_pkg = $(bin)$(SiDigitization_tag)_compile_pkg.make
...
cmt_local_tagfile_compile_pkg = $(bin)$(SiDigitization_tag).make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(SiDigitization_tag)_new_analysisapp.make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(SiDigitization_tag).make
...
cmt_local_tagfile_new_pkg = $(bin)$(SiDigitization_tag)_new_pkg.make
...
cmt_local_tagfile_new_pkg = $(bin)$(SiDigitization_tag).make
...
cmt_local_tagfile_new_alg = $(bin)$(SiDigitization_tag)_new_alg.make
...
cmt_local_tagfile_new_alg = $(bin)$(SiDigitization_tag).make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(SiDigitization_tag)_new_analysisalg.make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(SiDigitization_tag).make
...
cmt_local_tagfile_new_asgtool = $(bin)$(SiDigitization_tag)_new_asgtool.make
...
cmt_local_tagfile_new_asgtool = $(bin)$(SiDigitization_tag).make
...
cmt_local_tagfile_new_jobo = $(bin)$(SiDigitization_tag)_new_jobo.make
...
cmt_local_tagfile_new_jobo = $(bin)$(SiDigitization_tag).make
...
cmt_local_tagfile_new_skeleton = $(bin)$(SiDigitization_tag)_new_skeleton.make
...
cmt_local_tagfile_new_skeleton = $(bin)$(SiDigitization_tag).make
...
cmt_local_tagfile_make_skeleton = $(bin)$(SiDigitization_tag)_make_skeleton.make
...
cmt_local_tagfile_make_skeleton = $(bin)$(SiDigitization_tag).make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(SiDigitization_tag)_checkout_pkg.make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(SiDigitization_tag).make
...
cmt_local_tagfile_cppcheck = $(bin)$(SiDigitization_tag)_cppcheck.make
...
cmt_local_tagfile_cppcheck = $(bin)$(SiDigitization_tag).make
