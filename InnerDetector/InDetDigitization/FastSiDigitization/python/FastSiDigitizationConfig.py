...
######################################################################################
def SCT_SmearedDigitizationTool(name="SCT_SmearedDigitizationTool", **kwargs):
    # Import Digitization job properties
    from Digitization.DigitizationFlags import digitizationFlags
    # set the random service, stream name
    streamName = kwargs.setdefault("RndmEngine", "FastSCT_Digitization")
    ...
    kwargs.setdefault("ClusterContainerName", "SCT_Clusters")
    kwargs.setdefault("PRD_MultiTruthName", "PRD_MultiTruthSCT")
    
    from AthenaCommon import CfgMgr
    return CfgMgr.SCT_SmearedDigitizationTool(name,**kwargs)
