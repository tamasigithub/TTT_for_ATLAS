...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=SCT_Digitization -version=SCT_Digitization-02-00-14-54 -path=/nfs/dust/atlas/user/tkar/20.20.10.7/InnerDetector/InDetDigitization  $* >${cmtSCT_Digitizationtempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=SCT_Digitization -version=SCT_Digitization-02-00-14-54 -path=/nfs/dust/atlas/user/tkar/20.20.10.7/InnerDetector/InDetDigitization  $* >${cmtSCT_Digitizationtempfile}"
