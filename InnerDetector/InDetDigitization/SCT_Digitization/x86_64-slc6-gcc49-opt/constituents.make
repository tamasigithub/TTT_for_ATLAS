...
#cmt_local_tagfile = $(SCT_Digitization_tag).make
cmt_local_tagfile = $(bin)$(SCT_Digitization_tag).make
...
SCT_Digitization_extratags = -tag_add=target_SCT_Digitization
...
not_SCT_Digitization_dependencies = { n=0; for p in $?; do m=0; for d in $(SCT_Digitization_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SCT_Digitizationdirs :
	@if test ! -d $(bin)SCT_Digitization; then $(mkdir) -p $(bin)SCT_Digitization; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SCT_Digitization
else
SCT_Digitizationdirs : ;
endif
...
ifndef QUICK
$(cmt_local_SCT_Digitization_makefile) : $(SCT_Digitization_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_Digitization.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_Digitization_extratags) build constituent_config -out=$(cmt_local_SCT_Digitization_makefile) SCT_Digitization
else
$(cmt_local_SCT_Digitization_makefile) : $(SCT_Digitization_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_Digitization) ] || \
	  [ ! -f $(cmt_final_setup_SCT_Digitization) ] || \
	  $(not_SCT_Digitization_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SCT_Digitization.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_Digitization_extratags) build constituent_config -out=$(cmt_local_SCT_Digitization_makefile) SCT_Digitization; \
	  fi
endif
...
$(cmt_local_SCT_Digitization_makefile) : $(SCT_Digitization_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_Digitization.make"; \
	  $(cmtexe) -f=$(bin)SCT_Digitization.in -tag=$(tags) $(SCT_Digitization_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SCT_Digitization_makefile) SCT_Digitization
else
$(cmt_local_SCT_Digitization_makefile) : $(SCT_Digitization_dependencies) $(cmt_build_library_linksstamp) $(bin)SCT_Digitization.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_Digitization) ] || \
	  [ ! -f $(cmt_final_setup_SCT_Digitization) ] || \
	  $(not_SCT_Digitization_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SCT_Digitization_extratags) build constituent_makefile -out=$(cmt_local_SCT_Digitization_makefile) SCT_Digitization

SCT_Digitization :: $(SCT_Digitization_dependencies) $(cmt_local_SCT_Digitization_makefile) dirs SCT_Digitizationdirs
	$(echo) "(constituents.make) Starting SCT_Digitization"
	@if test -f $(cmt_local_SCT_Digitization_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_Digitization_makefile) SCT_Digitization; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_Digitization_makefile) SCT_Digitization
	$(echo) "(constituents.make) SCT_Digitization done"

clean :: SCT_Digitizationclean ;

SCT_Digitizationclean :: $(SCT_Digitizationclean_dependencies) ##$(cmt_local_SCT_Digitization_makefile)
	$(echo) "(constituents.make) Starting SCT_Digitizationclean"
	@-if test -f $(cmt_local_SCT_Digitization_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_Digitization_makefile) SCT_Digitizationclean; \
	fi
	$(echo) "(constituents.make) SCT_Digitizationclean done"
#	@-$(MAKE) -f $(cmt_local_SCT_Digitization_makefile) SCT_Digitizationclean

##	  /bin/rm -f $(cmt_local_SCT_Digitization_makefile) $(bin)SCT_Digitization_dependencies.make

install :: SCT_Digitizationinstall ;

SCT_Digitizationinstall :: $(SCT_Digitization_dependencies) $(cmt_local_SCT_Digitization_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SCT_Digitization_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_Digitization_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SCT_Digitization_makefile) install
...
$(foreach d,$(SCT_Digitization_dependencies),$(eval $(d)uninstall_dependencies += SCT_Digitizationuninstall))

SCT_Digitizationuninstall : $(SCT_Digitizationuninstall_dependencies) ##$(cmt_local_SCT_Digitization_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SCT_Digitization_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_Digitization_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_Digitization_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SCT_Digitizationuninstall ;
...
SCT_DigitizationConf_extratags = -tag_add=target_SCT_DigitizationConf
...
not_SCT_DigitizationConf_dependencies = { n=0; for p in $?; do m=0; for d in $(SCT_DigitizationConf_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SCT_DigitizationConfdirs :
	@if test ! -d $(bin)SCT_DigitizationConf; then $(mkdir) -p $(bin)SCT_DigitizationConf; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SCT_DigitizationConf
else
SCT_DigitizationConfdirs : ;
endif
...
ifndef QUICK
$(cmt_local_SCT_DigitizationConf_makefile) : $(SCT_DigitizationConf_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_DigitizationConf.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_DigitizationConf_extratags) build constituent_config -out=$(cmt_local_SCT_DigitizationConf_makefile) SCT_DigitizationConf
else
$(cmt_local_SCT_DigitizationConf_makefile) : $(SCT_DigitizationConf_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_DigitizationConf) ] || \
	  [ ! -f $(cmt_final_setup_SCT_DigitizationConf) ] || \
	  $(not_SCT_DigitizationConf_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SCT_DigitizationConf.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_DigitizationConf_extratags) build constituent_config -out=$(cmt_local_SCT_DigitizationConf_makefile) SCT_DigitizationConf; \
	  fi
endif
...
$(cmt_local_SCT_DigitizationConf_makefile) : $(SCT_DigitizationConf_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_DigitizationConf.make"; \
	  $(cmtexe) -f=$(bin)SCT_DigitizationConf.in -tag=$(tags) $(SCT_DigitizationConf_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SCT_DigitizationConf_makefile) SCT_DigitizationConf
else
$(cmt_local_SCT_DigitizationConf_makefile) : $(SCT_DigitizationConf_dependencies) $(cmt_build_library_linksstamp) $(bin)SCT_DigitizationConf.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_DigitizationConf) ] || \
	  [ ! -f $(cmt_final_setup_SCT_DigitizationConf) ] || \
	  $(not_SCT_DigitizationConf_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SCT_DigitizationConf_extratags) build constituent_makefile -out=$(cmt_local_SCT_DigitizationConf_makefile) SCT_DigitizationConf

SCT_DigitizationConf :: $(SCT_DigitizationConf_dependencies) $(cmt_local_SCT_DigitizationConf_makefile) dirs SCT_DigitizationConfdirs
	$(echo) "(constituents.make) Starting SCT_DigitizationConf"
	@if test -f $(cmt_local_SCT_DigitizationConf_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_DigitizationConf_makefile) SCT_DigitizationConf; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_DigitizationConf_makefile) SCT_DigitizationConf
	$(echo) "(constituents.make) SCT_DigitizationConf done"

clean :: SCT_DigitizationConfclean ;

SCT_DigitizationConfclean :: $(SCT_DigitizationConfclean_dependencies) ##$(cmt_local_SCT_DigitizationConf_makefile)
	$(echo) "(constituents.make) Starting SCT_DigitizationConfclean"
	@-if test -f $(cmt_local_SCT_DigitizationConf_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_DigitizationConf_makefile) SCT_DigitizationConfclean; \
	fi
	$(echo) "(constituents.make) SCT_DigitizationConfclean done"
#	@-$(MAKE) -f $(cmt_local_SCT_DigitizationConf_makefile) SCT_DigitizationConfclean

##	  /bin/rm -f $(cmt_local_SCT_DigitizationConf_makefile) $(bin)SCT_DigitizationConf_dependencies.make

install :: SCT_DigitizationConfinstall ;

SCT_DigitizationConfinstall :: $(SCT_DigitizationConf_dependencies) $(cmt_local_SCT_DigitizationConf_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SCT_DigitizationConf_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_DigitizationConf_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SCT_DigitizationConf_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(SCT_DigitizationConf_dependencies),$(eval $(d)uninstall_dependencies += SCT_DigitizationConfuninstall))

SCT_DigitizationConfuninstall : $(SCT_DigitizationConfuninstall_dependencies) ##$(cmt_local_SCT_DigitizationConf_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SCT_DigitizationConf_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_DigitizationConf_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_DigitizationConf_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SCT_DigitizationConfuninstall ;
...
SCT_Digitization_python_init_extratags = -tag_add=target_SCT_Digitization_python_init
...
not_SCT_Digitization_python_init_dependencies = { n=0; for p in $?; do m=0; for d in $(SCT_Digitization_python_init_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SCT_Digitization_python_initdirs :
	@if test ! -d $(bin)SCT_Digitization_python_init; then $(mkdir) -p $(bin)SCT_Digitization_python_init; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SCT_Digitization_python_init
else
SCT_Digitization_python_initdirs : ;
endif
...
ifndef QUICK
$(cmt_local_SCT_Digitization_python_init_makefile) : $(SCT_Digitization_python_init_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_Digitization_python_init.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_Digitization_python_init_extratags) build constituent_config -out=$(cmt_local_SCT_Digitization_python_init_makefile) SCT_Digitization_python_init
else
$(cmt_local_SCT_Digitization_python_init_makefile) : $(SCT_Digitization_python_init_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_Digitization_python_init) ] || \
	  [ ! -f $(cmt_final_setup_SCT_Digitization_python_init) ] || \
	  $(not_SCT_Digitization_python_init_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SCT_Digitization_python_init.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_Digitization_python_init_extratags) build constituent_config -out=$(cmt_local_SCT_Digitization_python_init_makefile) SCT_Digitization_python_init; \
	  fi
endif
...
$(cmt_local_SCT_Digitization_python_init_makefile) : $(SCT_Digitization_python_init_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_Digitization_python_init.make"; \
	  $(cmtexe) -f=$(bin)SCT_Digitization_python_init.in -tag=$(tags) $(SCT_Digitization_python_init_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SCT_Digitization_python_init_makefile) SCT_Digitization_python_init
else
$(cmt_local_SCT_Digitization_python_init_makefile) : $(SCT_Digitization_python_init_dependencies) $(cmt_build_library_linksstamp) $(bin)SCT_Digitization_python_init.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_Digitization_python_init) ] || \
	  [ ! -f $(cmt_final_setup_SCT_Digitization_python_init) ] || \
	  $(not_SCT_Digitization_python_init_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SCT_Digitization_python_init_extratags) build constituent_makefile -out=$(cmt_local_SCT_Digitization_python_init_makefile) SCT_Digitization_python_init

SCT_Digitization_python_init :: $(SCT_Digitization_python_init_dependencies) $(cmt_local_SCT_Digitization_python_init_makefile) dirs SCT_Digitization_python_initdirs
	$(echo) "(constituents.make) Starting SCT_Digitization_python_init"
	@if test -f $(cmt_local_SCT_Digitization_python_init_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_Digitization_python_init_makefile) SCT_Digitization_python_init; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_Digitization_python_init_makefile) SCT_Digitization_python_init
	$(echo) "(constituents.make) SCT_Digitization_python_init done"

clean :: SCT_Digitization_python_initclean ;

SCT_Digitization_python_initclean :: $(SCT_Digitization_python_initclean_dependencies) ##$(cmt_local_SCT_Digitization_python_init_makefile)
	$(echo) "(constituents.make) Starting SCT_Digitization_python_initclean"
	@-if test -f $(cmt_local_SCT_Digitization_python_init_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_Digitization_python_init_makefile) SCT_Digitization_python_initclean; \
	fi
	$(echo) "(constituents.make) SCT_Digitization_python_initclean done"
#	@-$(MAKE) -f $(cmt_local_SCT_Digitization_python_init_makefile) SCT_Digitization_python_initclean

##	  /bin/rm -f $(cmt_local_SCT_Digitization_python_init_makefile) $(bin)SCT_Digitization_python_init_dependencies.make

install :: SCT_Digitization_python_initinstall ;

SCT_Digitization_python_initinstall :: $(SCT_Digitization_python_init_dependencies) $(cmt_local_SCT_Digitization_python_init_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SCT_Digitization_python_init_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_Digitization_python_init_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SCT_Digitization_python_init_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(SCT_Digitization_python_init_dependencies),$(eval $(d)uninstall_dependencies += SCT_Digitization_python_inituninstall))

SCT_Digitization_python_inituninstall : $(SCT_Digitization_python_inituninstall_dependencies) ##$(cmt_local_SCT_Digitization_python_init_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SCT_Digitization_python_init_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_Digitization_python_init_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_Digitization_python_init_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SCT_Digitization_python_inituninstall ;
...
SCT_DigitizationConfDbMerge_extratags = -tag_add=target_SCT_DigitizationConfDbMerge
...
not_SCT_DigitizationConfDbMerge_dependencies = { n=0; for p in $?; do m=0; for d in $(SCT_DigitizationConfDbMerge_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SCT_DigitizationConfDbMergedirs :
	@if test ! -d $(bin)SCT_DigitizationConfDbMerge; then $(mkdir) -p $(bin)SCT_DigitizationConfDbMerge; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SCT_DigitizationConfDbMerge
else
SCT_DigitizationConfDbMergedirs : ;
endif
...
ifndef QUICK
$(cmt_local_SCT_DigitizationConfDbMerge_makefile) : $(SCT_DigitizationConfDbMerge_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_DigitizationConfDbMerge.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_DigitizationConfDbMerge_extratags) build constituent_config -out=$(cmt_local_SCT_DigitizationConfDbMerge_makefile) SCT_DigitizationConfDbMerge
else
$(cmt_local_SCT_DigitizationConfDbMerge_makefile) : $(SCT_DigitizationConfDbMerge_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_DigitizationConfDbMerge) ] || \
	  [ ! -f $(cmt_final_setup_SCT_DigitizationConfDbMerge) ] || \
	  $(not_SCT_DigitizationConfDbMerge_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SCT_DigitizationConfDbMerge.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_DigitizationConfDbMerge_extratags) build constituent_config -out=$(cmt_local_SCT_DigitizationConfDbMerge_makefile) SCT_DigitizationConfDbMerge; \
	  fi
endif
...
$(cmt_local_SCT_DigitizationConfDbMerge_makefile) : $(SCT_DigitizationConfDbMerge_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_DigitizationConfDbMerge.make"; \
	  $(cmtexe) -f=$(bin)SCT_DigitizationConfDbMerge.in -tag=$(tags) $(SCT_DigitizationConfDbMerge_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SCT_DigitizationConfDbMerge_makefile) SCT_DigitizationConfDbMerge
else
$(cmt_local_SCT_DigitizationConfDbMerge_makefile) : $(SCT_DigitizationConfDbMerge_dependencies) $(cmt_build_library_linksstamp) $(bin)SCT_DigitizationConfDbMerge.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_DigitizationConfDbMerge) ] || \
	  [ ! -f $(cmt_final_setup_SCT_DigitizationConfDbMerge) ] || \
	  $(not_SCT_DigitizationConfDbMerge_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SCT_DigitizationConfDbMerge_extratags) build constituent_makefile -out=$(cmt_local_SCT_DigitizationConfDbMerge_makefile) SCT_DigitizationConfDbMerge

SCT_DigitizationConfDbMerge :: $(SCT_DigitizationConfDbMerge_dependencies) $(cmt_local_SCT_DigitizationConfDbMerge_makefile) dirs SCT_DigitizationConfDbMergedirs
	$(echo) "(constituents.make) Starting SCT_DigitizationConfDbMerge"
	@if test -f $(cmt_local_SCT_DigitizationConfDbMerge_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_DigitizationConfDbMerge_makefile) SCT_DigitizationConfDbMerge; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_DigitizationConfDbMerge_makefile) SCT_DigitizationConfDbMerge
	$(echo) "(constituents.make) SCT_DigitizationConfDbMerge done"

clean :: SCT_DigitizationConfDbMergeclean ;

SCT_DigitizationConfDbMergeclean :: $(SCT_DigitizationConfDbMergeclean_dependencies) ##$(cmt_local_SCT_DigitizationConfDbMerge_makefile)
	$(echo) "(constituents.make) Starting SCT_DigitizationConfDbMergeclean"
	@-if test -f $(cmt_local_SCT_DigitizationConfDbMerge_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_DigitizationConfDbMerge_makefile) SCT_DigitizationConfDbMergeclean; \
	fi
	$(echo) "(constituents.make) SCT_DigitizationConfDbMergeclean done"
#	@-$(MAKE) -f $(cmt_local_SCT_DigitizationConfDbMerge_makefile) SCT_DigitizationConfDbMergeclean

##	  /bin/rm -f $(cmt_local_SCT_DigitizationConfDbMerge_makefile) $(bin)SCT_DigitizationConfDbMerge_dependencies.make

install :: SCT_DigitizationConfDbMergeinstall ;

SCT_DigitizationConfDbMergeinstall :: $(SCT_DigitizationConfDbMerge_dependencies) $(cmt_local_SCT_DigitizationConfDbMerge_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SCT_DigitizationConfDbMerge_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_DigitizationConfDbMerge_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SCT_DigitizationConfDbMerge_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : SCT_DigitizationConfDbMergeuninstall

$(foreach d,$(SCT_DigitizationConfDbMerge_dependencies),$(eval $(d)uninstall_dependencies += SCT_DigitizationConfDbMergeuninstall))

SCT_DigitizationConfDbMergeuninstall : $(SCT_DigitizationConfDbMergeuninstall_dependencies) ##$(cmt_local_SCT_DigitizationConfDbMerge_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SCT_DigitizationConfDbMerge_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_DigitizationConfDbMerge_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_DigitizationConfDbMerge_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SCT_DigitizationConfDbMergeuninstall ;
...
SCT_DigitizationComponentsList_extratags = -tag_add=target_SCT_DigitizationComponentsList
...
not_SCT_DigitizationComponentsList_dependencies = { n=0; for p in $?; do m=0; for d in $(SCT_DigitizationComponentsList_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SCT_DigitizationComponentsListdirs :
	@if test ! -d $(bin)SCT_DigitizationComponentsList; then $(mkdir) -p $(bin)SCT_DigitizationComponentsList; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SCT_DigitizationComponentsList
else
SCT_DigitizationComponentsListdirs : ;
endif
...
ifndef QUICK
$(cmt_local_SCT_DigitizationComponentsList_makefile) : $(SCT_DigitizationComponentsList_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_DigitizationComponentsList.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_DigitizationComponentsList_extratags) build constituent_config -out=$(cmt_local_SCT_DigitizationComponentsList_makefile) SCT_DigitizationComponentsList
else
$(cmt_local_SCT_DigitizationComponentsList_makefile) : $(SCT_DigitizationComponentsList_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_DigitizationComponentsList) ] || \
	  [ ! -f $(cmt_final_setup_SCT_DigitizationComponentsList) ] || \
	  $(not_SCT_DigitizationComponentsList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SCT_DigitizationComponentsList.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_DigitizationComponentsList_extratags) build constituent_config -out=$(cmt_local_SCT_DigitizationComponentsList_makefile) SCT_DigitizationComponentsList; \
	  fi
endif
...
$(cmt_local_SCT_DigitizationComponentsList_makefile) : $(SCT_DigitizationComponentsList_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_DigitizationComponentsList.make"; \
	  $(cmtexe) -f=$(bin)SCT_DigitizationComponentsList.in -tag=$(tags) $(SCT_DigitizationComponentsList_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SCT_DigitizationComponentsList_makefile) SCT_DigitizationComponentsList
else
$(cmt_local_SCT_DigitizationComponentsList_makefile) : $(SCT_DigitizationComponentsList_dependencies) $(cmt_build_library_linksstamp) $(bin)SCT_DigitizationComponentsList.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_DigitizationComponentsList) ] || \
	  [ ! -f $(cmt_final_setup_SCT_DigitizationComponentsList) ] || \
	  $(not_SCT_DigitizationComponentsList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SCT_DigitizationComponentsList_extratags) build constituent_makefile -out=$(cmt_local_SCT_DigitizationComponentsList_makefile) SCT_DigitizationComponentsList

SCT_DigitizationComponentsList :: $(SCT_DigitizationComponentsList_dependencies) $(cmt_local_SCT_DigitizationComponentsList_makefile) dirs SCT_DigitizationComponentsListdirs
	$(echo) "(constituents.make) Starting SCT_DigitizationComponentsList"
	@if test -f $(cmt_local_SCT_DigitizationComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_DigitizationComponentsList_makefile) SCT_DigitizationComponentsList; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_DigitizationComponentsList_makefile) SCT_DigitizationComponentsList
	$(echo) "(constituents.make) SCT_DigitizationComponentsList done"

clean :: SCT_DigitizationComponentsListclean ;

SCT_DigitizationComponentsListclean :: $(SCT_DigitizationComponentsListclean_dependencies) ##$(cmt_local_SCT_DigitizationComponentsList_makefile)
	$(echo) "(constituents.make) Starting SCT_DigitizationComponentsListclean"
	@-if test -f $(cmt_local_SCT_DigitizationComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_DigitizationComponentsList_makefile) SCT_DigitizationComponentsListclean; \
	fi
	$(echo) "(constituents.make) SCT_DigitizationComponentsListclean done"
#	@-$(MAKE) -f $(cmt_local_SCT_DigitizationComponentsList_makefile) SCT_DigitizationComponentsListclean

##	  /bin/rm -f $(cmt_local_SCT_DigitizationComponentsList_makefile) $(bin)SCT_DigitizationComponentsList_dependencies.make

install :: SCT_DigitizationComponentsListinstall ;

SCT_DigitizationComponentsListinstall :: $(SCT_DigitizationComponentsList_dependencies) $(cmt_local_SCT_DigitizationComponentsList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SCT_DigitizationComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_DigitizationComponentsList_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SCT_DigitizationComponentsList_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(SCT_DigitizationComponentsList_dependencies),$(eval $(d)uninstall_dependencies += SCT_DigitizationComponentsListuninstall))

SCT_DigitizationComponentsListuninstall : $(SCT_DigitizationComponentsListuninstall_dependencies) ##$(cmt_local_SCT_DigitizationComponentsList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SCT_DigitizationComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_DigitizationComponentsList_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_DigitizationComponentsList_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SCT_DigitizationComponentsListuninstall ;
...
SCT_DigitizationMergeComponentsList_extratags = -tag_add=target_SCT_DigitizationMergeComponentsList
...
not_SCT_DigitizationMergeComponentsList_dependencies = { n=0; for p in $?; do m=0; for d in $(SCT_DigitizationMergeComponentsList_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SCT_DigitizationMergeComponentsListdirs :
	@if test ! -d $(bin)SCT_DigitizationMergeComponentsList; then $(mkdir) -p $(bin)SCT_DigitizationMergeComponentsList; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SCT_DigitizationMergeComponentsList
else
SCT_DigitizationMergeComponentsListdirs : ;
endif
...
ifndef QUICK
$(cmt_local_SCT_DigitizationMergeComponentsList_makefile) : $(SCT_DigitizationMergeComponentsList_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_DigitizationMergeComponentsList.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_DigitizationMergeComponentsList_extratags) build constituent_config -out=$(cmt_local_SCT_DigitizationMergeComponentsList_makefile) SCT_DigitizationMergeComponentsList
else
$(cmt_local_SCT_DigitizationMergeComponentsList_makefile) : $(SCT_DigitizationMergeComponentsList_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_DigitizationMergeComponentsList) ] || \
	  [ ! -f $(cmt_final_setup_SCT_DigitizationMergeComponentsList) ] || \
	  $(not_SCT_DigitizationMergeComponentsList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SCT_DigitizationMergeComponentsList.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_DigitizationMergeComponentsList_extratags) build constituent_config -out=$(cmt_local_SCT_DigitizationMergeComponentsList_makefile) SCT_DigitizationMergeComponentsList; \
	  fi
endif
...
$(cmt_local_SCT_DigitizationMergeComponentsList_makefile) : $(SCT_DigitizationMergeComponentsList_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_DigitizationMergeComponentsList.make"; \
	  $(cmtexe) -f=$(bin)SCT_DigitizationMergeComponentsList.in -tag=$(tags) $(SCT_DigitizationMergeComponentsList_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SCT_DigitizationMergeComponentsList_makefile) SCT_DigitizationMergeComponentsList
else
$(cmt_local_SCT_DigitizationMergeComponentsList_makefile) : $(SCT_DigitizationMergeComponentsList_dependencies) $(cmt_build_library_linksstamp) $(bin)SCT_DigitizationMergeComponentsList.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_DigitizationMergeComponentsList) ] || \
	  [ ! -f $(cmt_final_setup_SCT_DigitizationMergeComponentsList) ] || \
	  $(not_SCT_DigitizationMergeComponentsList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SCT_DigitizationMergeComponentsList_extratags) build constituent_makefile -out=$(cmt_local_SCT_DigitizationMergeComponentsList_makefile) SCT_DigitizationMergeComponentsList

SCT_DigitizationMergeComponentsList :: $(SCT_DigitizationMergeComponentsList_dependencies) $(cmt_local_SCT_DigitizationMergeComponentsList_makefile) dirs SCT_DigitizationMergeComponentsListdirs
	$(echo) "(constituents.make) Starting SCT_DigitizationMergeComponentsList"
	@if test -f $(cmt_local_SCT_DigitizationMergeComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_DigitizationMergeComponentsList_makefile) SCT_DigitizationMergeComponentsList; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_DigitizationMergeComponentsList_makefile) SCT_DigitizationMergeComponentsList
	$(echo) "(constituents.make) SCT_DigitizationMergeComponentsList done"

clean :: SCT_DigitizationMergeComponentsListclean ;

SCT_DigitizationMergeComponentsListclean :: $(SCT_DigitizationMergeComponentsListclean_dependencies) ##$(cmt_local_SCT_DigitizationMergeComponentsList_makefile)
	$(echo) "(constituents.make) Starting SCT_DigitizationMergeComponentsListclean"
	@-if test -f $(cmt_local_SCT_DigitizationMergeComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_DigitizationMergeComponentsList_makefile) SCT_DigitizationMergeComponentsListclean; \
	fi
	$(echo) "(constituents.make) SCT_DigitizationMergeComponentsListclean done"
#	@-$(MAKE) -f $(cmt_local_SCT_DigitizationMergeComponentsList_makefile) SCT_DigitizationMergeComponentsListclean

##	  /bin/rm -f $(cmt_local_SCT_DigitizationMergeComponentsList_makefile) $(bin)SCT_DigitizationMergeComponentsList_dependencies.make

install :: SCT_DigitizationMergeComponentsListinstall ;

SCT_DigitizationMergeComponentsListinstall :: $(SCT_DigitizationMergeComponentsList_dependencies) $(cmt_local_SCT_DigitizationMergeComponentsList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SCT_DigitizationMergeComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_DigitizationMergeComponentsList_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SCT_DigitizationMergeComponentsList_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : SCT_DigitizationMergeComponentsListuninstall

$(foreach d,$(SCT_DigitizationMergeComponentsList_dependencies),$(eval $(d)uninstall_dependencies += SCT_DigitizationMergeComponentsListuninstall))

SCT_DigitizationMergeComponentsListuninstall : $(SCT_DigitizationMergeComponentsListuninstall_dependencies) ##$(cmt_local_SCT_DigitizationMergeComponentsList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SCT_DigitizationMergeComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_DigitizationMergeComponentsList_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_DigitizationMergeComponentsList_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SCT_DigitizationMergeComponentsListuninstall ;
...
cmt_SCT_Digitization_optdebug_library_has_no_target_tag = 1

#--------------------------------------

ifdef cmt_SCT_Digitization_optdebug_library_has_target_tag

cmt_local_tagfile_SCT_Digitization_optdebug_library = $(bin)$(SCT_Digitization_tag)_SCT_Digitization_optdebug_library.make
cmt_final_setup_SCT_Digitization_optdebug_library = $(bin)setup_SCT_Digitization_optdebug_library.make
cmt_local_SCT_Digitization_optdebug_library_makefile = $(bin)SCT_Digitization_optdebug_library.make

SCT_Digitization_optdebug_library_extratags = -tag_add=target_SCT_Digitization_optdebug_library

else

cmt_local_tagfile_SCT_Digitization_optdebug_library = $(bin)$(SCT_Digitization_tag).make
cmt_final_setup_SCT_Digitization_optdebug_library = $(bin)setup.make
cmt_local_SCT_Digitization_optdebug_library_makefile = $(bin)SCT_Digitization_optdebug_library.make

endif

not_SCT_Digitization_optdebug_library_dependencies = { n=0; for p in $?; do m=0; for d in $(SCT_Digitization_optdebug_library_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SCT_Digitization_optdebug_librarydirs :
	@if test ! -d $(bin)SCT_Digitization_optdebug_library; then $(mkdir) -p $(bin)SCT_Digitization_optdebug_library; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SCT_Digitization_optdebug_library
else
SCT_Digitization_optdebug_librarydirs : ;
endif
...
ifndef QUICK
$(cmt_local_SCT_Digitization_optdebug_library_makefile) : $(SCT_Digitization_optdebug_library_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_Digitization_optdebug_library.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_Digitization_optdebug_library_extratags) build constituent_config -out=$(cmt_local_SCT_Digitization_optdebug_library_makefile) SCT_Digitization_optdebug_library
else
$(cmt_local_SCT_Digitization_optdebug_library_makefile) : $(SCT_Digitization_optdebug_library_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_Digitization_optdebug_library) ] || \
	  [ ! -f $(cmt_final_setup_SCT_Digitization_optdebug_library) ] || \
	  $(not_SCT_Digitization_optdebug_library_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SCT_Digitization_optdebug_library.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_Digitization_optdebug_library_extratags) build constituent_config -out=$(cmt_local_SCT_Digitization_optdebug_library_makefile) SCT_Digitization_optdebug_library; \
	  fi
endif
...
$(cmt_local_SCT_Digitization_optdebug_library_makefile) : $(SCT_Digitization_optdebug_library_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_Digitization_optdebug_library.make"; \
	  $(cmtexe) -f=$(bin)SCT_Digitization_optdebug_library.in -tag=$(tags) $(SCT_Digitization_optdebug_library_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SCT_Digitization_optdebug_library_makefile) SCT_Digitization_optdebug_library
else
$(cmt_local_SCT_Digitization_optdebug_library_makefile) : $(SCT_Digitization_optdebug_library_dependencies) $(cmt_build_library_linksstamp) $(bin)SCT_Digitization_optdebug_library.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_Digitization_optdebug_library) ] || \
	  [ ! -f $(cmt_final_setup_SCT_Digitization_optdebug_library) ] || \
	  $(not_SCT_Digitization_optdebug_library_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SCT_Digitization_optdebug_library_extratags) build constituent_makefile -out=$(cmt_local_SCT_Digitization_optdebug_library_makefile) SCT_Digitization_optdebug_library

SCT_Digitization_optdebug_library :: $(SCT_Digitization_optdebug_library_dependencies) $(cmt_local_SCT_Digitization_optdebug_library_makefile) dirs SCT_Digitization_optdebug_librarydirs
	$(echo) "(constituents.make) Starting SCT_Digitization_optdebug_library"
	@if test -f $(cmt_local_SCT_Digitization_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_Digitization_optdebug_library_makefile) SCT_Digitization_optdebug_library; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_Digitization_optdebug_library_makefile) SCT_Digitization_optdebug_library
	$(echo) "(constituents.make) SCT_Digitization_optdebug_library done"

clean :: SCT_Digitization_optdebug_libraryclean ;

SCT_Digitization_optdebug_libraryclean :: $(SCT_Digitization_optdebug_libraryclean_dependencies) ##$(cmt_local_SCT_Digitization_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting SCT_Digitization_optdebug_libraryclean"
	@-if test -f $(cmt_local_SCT_Digitization_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_Digitization_optdebug_library_makefile) SCT_Digitization_optdebug_libraryclean; \
	fi
	$(echo) "(constituents.make) SCT_Digitization_optdebug_libraryclean done"
#	@-$(MAKE) -f $(cmt_local_SCT_Digitization_optdebug_library_makefile) SCT_Digitization_optdebug_libraryclean

##	  /bin/rm -f $(cmt_local_SCT_Digitization_optdebug_library_makefile) $(bin)SCT_Digitization_optdebug_library_dependencies.make

install :: SCT_Digitization_optdebug_libraryinstall ;

SCT_Digitization_optdebug_libraryinstall :: $(SCT_Digitization_optdebug_library_dependencies) $(cmt_local_SCT_Digitization_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SCT_Digitization_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_Digitization_optdebug_library_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SCT_Digitization_optdebug_library_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : SCT_Digitization_optdebug_libraryuninstall

$(foreach d,$(SCT_Digitization_optdebug_library_dependencies),$(eval $(d)uninstall_dependencies += SCT_Digitization_optdebug_libraryuninstall))

SCT_Digitization_optdebug_libraryuninstall : $(SCT_Digitization_optdebug_libraryuninstall_dependencies) ##$(cmt_local_SCT_Digitization_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SCT_Digitization_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_Digitization_optdebug_library_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_Digitization_optdebug_library_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SCT_Digitization_optdebug_libraryuninstall ;
...
SCT_DigitizationCLIDDB_extratags = -tag_add=target_SCT_DigitizationCLIDDB
...
not_SCT_DigitizationCLIDDB_dependencies = { n=0; for p in $?; do m=0; for d in $(SCT_DigitizationCLIDDB_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SCT_DigitizationCLIDDBdirs :
	@if test ! -d $(bin)SCT_DigitizationCLIDDB; then $(mkdir) -p $(bin)SCT_DigitizationCLIDDB; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SCT_DigitizationCLIDDB
else
SCT_DigitizationCLIDDBdirs : ;
endif
...
ifndef QUICK
$(cmt_local_SCT_DigitizationCLIDDB_makefile) : $(SCT_DigitizationCLIDDB_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_DigitizationCLIDDB.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_DigitizationCLIDDB_extratags) build constituent_config -out=$(cmt_local_SCT_DigitizationCLIDDB_makefile) SCT_DigitizationCLIDDB
else
$(cmt_local_SCT_DigitizationCLIDDB_makefile) : $(SCT_DigitizationCLIDDB_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_DigitizationCLIDDB) ] || \
	  [ ! -f $(cmt_final_setup_SCT_DigitizationCLIDDB) ] || \
	  $(not_SCT_DigitizationCLIDDB_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SCT_DigitizationCLIDDB.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_DigitizationCLIDDB_extratags) build constituent_config -out=$(cmt_local_SCT_DigitizationCLIDDB_makefile) SCT_DigitizationCLIDDB; \
	  fi
endif
...
$(cmt_local_SCT_DigitizationCLIDDB_makefile) : $(SCT_DigitizationCLIDDB_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_DigitizationCLIDDB.make"; \
	  $(cmtexe) -f=$(bin)SCT_DigitizationCLIDDB.in -tag=$(tags) $(SCT_DigitizationCLIDDB_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SCT_DigitizationCLIDDB_makefile) SCT_DigitizationCLIDDB
else
$(cmt_local_SCT_DigitizationCLIDDB_makefile) : $(SCT_DigitizationCLIDDB_dependencies) $(cmt_build_library_linksstamp) $(bin)SCT_DigitizationCLIDDB.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_DigitizationCLIDDB) ] || \
	  [ ! -f $(cmt_final_setup_SCT_DigitizationCLIDDB) ] || \
	  $(not_SCT_DigitizationCLIDDB_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SCT_DigitizationCLIDDB_extratags) build constituent_makefile -out=$(cmt_local_SCT_DigitizationCLIDDB_makefile) SCT_DigitizationCLIDDB

SCT_DigitizationCLIDDB :: $(SCT_DigitizationCLIDDB_dependencies) $(cmt_local_SCT_DigitizationCLIDDB_makefile) dirs SCT_DigitizationCLIDDBdirs
	$(echo) "(constituents.make) Starting SCT_DigitizationCLIDDB"
	@if test -f $(cmt_local_SCT_DigitizationCLIDDB_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_DigitizationCLIDDB_makefile) SCT_DigitizationCLIDDB; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_DigitizationCLIDDB_makefile) SCT_DigitizationCLIDDB
	$(echo) "(constituents.make) SCT_DigitizationCLIDDB done"

clean :: SCT_DigitizationCLIDDBclean ;

SCT_DigitizationCLIDDBclean :: $(SCT_DigitizationCLIDDBclean_dependencies) ##$(cmt_local_SCT_DigitizationCLIDDB_makefile)
	$(echo) "(constituents.make) Starting SCT_DigitizationCLIDDBclean"
	@-if test -f $(cmt_local_SCT_DigitizationCLIDDB_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_DigitizationCLIDDB_makefile) SCT_DigitizationCLIDDBclean; \
	fi
	$(echo) "(constituents.make) SCT_DigitizationCLIDDBclean done"
#	@-$(MAKE) -f $(cmt_local_SCT_DigitizationCLIDDB_makefile) SCT_DigitizationCLIDDBclean

##	  /bin/rm -f $(cmt_local_SCT_DigitizationCLIDDB_makefile) $(bin)SCT_DigitizationCLIDDB_dependencies.make

install :: SCT_DigitizationCLIDDBinstall ;

SCT_DigitizationCLIDDBinstall :: $(SCT_DigitizationCLIDDB_dependencies) $(cmt_local_SCT_DigitizationCLIDDB_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SCT_DigitizationCLIDDB_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_DigitizationCLIDDB_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SCT_DigitizationCLIDDB_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : SCT_DigitizationCLIDDBuninstall

$(foreach d,$(SCT_DigitizationCLIDDB_dependencies),$(eval $(d)uninstall_dependencies += SCT_DigitizationCLIDDBuninstall))

SCT_DigitizationCLIDDBuninstall : $(SCT_DigitizationCLIDDBuninstall_dependencies) ##$(cmt_local_SCT_DigitizationCLIDDB_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SCT_DigitizationCLIDDB_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_DigitizationCLIDDB_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_DigitizationCLIDDB_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SCT_DigitizationCLIDDBuninstall ;
...
cmt_local_tagfile_install_runtime = $(bin)$(SCT_Digitization_tag)_install_runtime.make
...
cmt_local_tagfile_install_runtime = $(bin)$(SCT_Digitization_tag).make
...
cmt_local_tagfile_install_python_modules = $(bin)$(SCT_Digitization_tag)_install_python_modules.make
...
cmt_local_tagfile_install_python_modules = $(bin)$(SCT_Digitization_tag).make
...
cmt_SCT_Digitizationrchk_has_target_tag = 1

#--------------------------------------

ifdef cmt_SCT_Digitizationrchk_has_target_tag

cmt_local_tagfile_SCT_Digitizationrchk = $(bin)$(SCT_Digitization_tag)_SCT_Digitizationrchk.make
cmt_final_setup_SCT_Digitizationrchk = $(bin)setup_SCT_Digitizationrchk.make
cmt_local_SCT_Digitizationrchk_makefile = $(bin)SCT_Digitizationrchk.make

SCT_Digitizationrchk_extratags = -tag_add=target_SCT_Digitizationrchk

else

cmt_local_tagfile_SCT_Digitizationrchk = $(bin)$(SCT_Digitization_tag).make
cmt_final_setup_SCT_Digitizationrchk = $(bin)setup.make
cmt_local_SCT_Digitizationrchk_makefile = $(bin)SCT_Digitizationrchk.make

endif

not_SCT_Digitizationrchk_dependencies = { n=0; for p in $?; do m=0; for d in $(SCT_Digitizationrchk_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SCT_Digitizationrchkdirs :
	@if test ! -d $(bin)SCT_Digitizationrchk; then $(mkdir) -p $(bin)SCT_Digitizationrchk; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SCT_Digitizationrchk
else
SCT_Digitizationrchkdirs : ;
endif
...
ifndef QUICK
$(cmt_local_SCT_Digitizationrchk_makefile) : $(SCT_Digitizationrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_Digitizationrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_Digitizationrchk_extratags) build constituent_config -out=$(cmt_local_SCT_Digitizationrchk_makefile) SCT_Digitizationrchk
else
$(cmt_local_SCT_Digitizationrchk_makefile) : $(SCT_Digitizationrchk_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_Digitizationrchk) ] || \
	  [ ! -f $(cmt_final_setup_SCT_Digitizationrchk) ] || \
	  $(not_SCT_Digitizationrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SCT_Digitizationrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_Digitizationrchk_extratags) build constituent_config -out=$(cmt_local_SCT_Digitizationrchk_makefile) SCT_Digitizationrchk; \
	  fi
endif
...
$(cmt_local_SCT_Digitizationrchk_makefile) : $(SCT_Digitizationrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_Digitizationrchk.make"; \
	  $(cmtexe) -f=$(bin)SCT_Digitizationrchk.in -tag=$(tags) $(SCT_Digitizationrchk_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SCT_Digitizationrchk_makefile) SCT_Digitizationrchk
else
$(cmt_local_SCT_Digitizationrchk_makefile) : $(SCT_Digitizationrchk_dependencies) $(cmt_build_library_linksstamp) $(bin)SCT_Digitizationrchk.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_Digitizationrchk) ] || \
	  [ ! -f $(cmt_final_setup_SCT_Digitizationrchk) ] || \
	  $(not_SCT_Digitizationrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SCT_Digitizationrchk_extratags) build constituent_makefile -out=$(cmt_local_SCT_Digitizationrchk_makefile) SCT_Digitizationrchk

SCT_Digitizationrchk :: $(SCT_Digitizationrchk_dependencies) $(cmt_local_SCT_Digitizationrchk_makefile) dirs SCT_Digitizationrchkdirs
	$(echo) "(constituents.make) Starting SCT_Digitizationrchk"
	@if test -f $(cmt_local_SCT_Digitizationrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_Digitizationrchk_makefile) SCT_Digitizationrchk; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_Digitizationrchk_makefile) SCT_Digitizationrchk
	$(echo) "(constituents.make) SCT_Digitizationrchk done"

clean :: SCT_Digitizationrchkclean ;

SCT_Digitizationrchkclean :: $(SCT_Digitizationrchkclean_dependencies) ##$(cmt_local_SCT_Digitizationrchk_makefile)
	$(echo) "(constituents.make) Starting SCT_Digitizationrchkclean"
	@-if test -f $(cmt_local_SCT_Digitizationrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_Digitizationrchk_makefile) SCT_Digitizationrchkclean; \
	fi
	$(echo) "(constituents.make) SCT_Digitizationrchkclean done"
#	@-$(MAKE) -f $(cmt_local_SCT_Digitizationrchk_makefile) SCT_Digitizationrchkclean

##	  /bin/rm -f $(cmt_local_SCT_Digitizationrchk_makefile) $(bin)SCT_Digitizationrchk_dependencies.make

install :: SCT_Digitizationrchkinstall ;

SCT_Digitizationrchkinstall :: $(SCT_Digitizationrchk_dependencies) $(cmt_local_SCT_Digitizationrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SCT_Digitizationrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_Digitizationrchk_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SCT_Digitizationrchk_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : SCT_Digitizationrchkuninstall

$(foreach d,$(SCT_Digitizationrchk_dependencies),$(eval $(d)uninstall_dependencies += SCT_Digitizationrchkuninstall))

SCT_Digitizationrchkuninstall : $(SCT_Digitizationrchkuninstall_dependencies) ##$(cmt_local_SCT_Digitizationrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SCT_Digitizationrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_Digitizationrchk_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_Digitizationrchk_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SCT_Digitizationrchkuninstall ;
...
cmt_local_tagfile_install_root_include_path = $(bin)$(SCT_Digitization_tag)_install_root_include_path.make
...
cmt_local_tagfile_install_root_include_path = $(bin)$(SCT_Digitization_tag).make
...
cmt_local_tagfile_install_includes = $(bin)$(SCT_Digitization_tag)_install_includes.make
...
cmt_local_tagfile_install_includes = $(bin)$(SCT_Digitization_tag).make
...
cmt_local_tagfile_make = $(bin)$(SCT_Digitization_tag)_make.make
...
cmt_local_tagfile_make = $(bin)$(SCT_Digitization_tag).make
...
cmt_local_tagfile_CompilePython = $(bin)$(SCT_Digitization_tag)_CompilePython.make
...
cmt_local_tagfile_CompilePython = $(bin)$(SCT_Digitization_tag).make
...
cmt_local_tagfile_qmtest_run = $(bin)$(SCT_Digitization_tag)_qmtest_run.make
...
cmt_local_tagfile_qmtest_run = $(bin)$(SCT_Digitization_tag).make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(SCT_Digitization_tag)_qmtest_summarize.make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(SCT_Digitization_tag).make
...
cmt_local_tagfile_TestPackage = $(bin)$(SCT_Digitization_tag)_TestPackage.make
...
cmt_local_tagfile_TestPackage = $(bin)$(SCT_Digitization_tag).make
...
cmt_local_tagfile_TestProject = $(bin)$(SCT_Digitization_tag)_TestProject.make
...
cmt_local_tagfile_TestProject = $(bin)$(SCT_Digitization_tag).make
...
cmt_local_tagfile_new_rootsys = $(bin)$(SCT_Digitization_tag)_new_rootsys.make
...
cmt_local_tagfile_new_rootsys = $(bin)$(SCT_Digitization_tag).make
...
cmt_local_tagfile_doxygen = $(bin)$(SCT_Digitization_tag)_doxygen.make
...
cmt_local_tagfile_doxygen = $(bin)$(SCT_Digitization_tag).make
...
cmt_local_tagfile_post_install = $(bin)$(SCT_Digitization_tag)_post_install.make
...
cmt_local_tagfile_post_install = $(bin)$(SCT_Digitization_tag).make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(SCT_Digitization_tag)_post_merge_rootmap.make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(SCT_Digitization_tag).make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(SCT_Digitization_tag)_post_merge_genconfdb.make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(SCT_Digitization_tag).make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(SCT_Digitization_tag)_post_build_tpcnvdb.make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(SCT_Digitization_tag).make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(SCT_Digitization_tag)_all_post_constituents.make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(SCT_Digitization_tag).make
...
cmt_local_tagfile_checkreq = $(bin)$(SCT_Digitization_tag)_checkreq.make
...
cmt_local_tagfile_checkreq = $(bin)$(SCT_Digitization_tag).make
...
cmt_SCT_Digitization_NICOS_Fix_debuginfo_has_no_target_tag = 1

#--------------------------------------

ifdef cmt_SCT_Digitization_NICOS_Fix_debuginfo_has_target_tag

cmt_local_tagfile_SCT_Digitization_NICOS_Fix_debuginfo = $(bin)$(SCT_Digitization_tag)_SCT_Digitization_NICOS_Fix_debuginfo.make
cmt_final_setup_SCT_Digitization_NICOS_Fix_debuginfo = $(bin)setup_SCT_Digitization_NICOS_Fix_debuginfo.make
cmt_local_SCT_Digitization_NICOS_Fix_debuginfo_makefile = $(bin)SCT_Digitization_NICOS_Fix_debuginfo.make

SCT_Digitization_NICOS_Fix_debuginfo_extratags = -tag_add=target_SCT_Digitization_NICOS_Fix_debuginfo

else

cmt_local_tagfile_SCT_Digitization_NICOS_Fix_debuginfo = $(bin)$(SCT_Digitization_tag).make
cmt_final_setup_SCT_Digitization_NICOS_Fix_debuginfo = $(bin)setup.make
cmt_local_SCT_Digitization_NICOS_Fix_debuginfo_makefile = $(bin)SCT_Digitization_NICOS_Fix_debuginfo.make

endif

not_SCT_Digitization_NICOS_Fix_debuginfo_dependencies = { n=0; for p in $?; do m=0; for d in $(SCT_Digitization_NICOS_Fix_debuginfo_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SCT_Digitization_NICOS_Fix_debuginfodirs :
	@if test ! -d $(bin)SCT_Digitization_NICOS_Fix_debuginfo; then $(mkdir) -p $(bin)SCT_Digitization_NICOS_Fix_debuginfo; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SCT_Digitization_NICOS_Fix_debuginfo
else
SCT_Digitization_NICOS_Fix_debuginfodirs : ;
endif
...
ifndef QUICK
$(cmt_local_SCT_Digitization_NICOS_Fix_debuginfo_makefile) : $(SCT_Digitization_NICOS_Fix_debuginfo_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_Digitization_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_Digitization_NICOS_Fix_debuginfo_extratags) build constituent_config -out=$(cmt_local_SCT_Digitization_NICOS_Fix_debuginfo_makefile) SCT_Digitization_NICOS_Fix_debuginfo
else
$(cmt_local_SCT_Digitization_NICOS_Fix_debuginfo_makefile) : $(SCT_Digitization_NICOS_Fix_debuginfo_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_Digitization_NICOS_Fix_debuginfo) ] || \
	  [ ! -f $(cmt_final_setup_SCT_Digitization_NICOS_Fix_debuginfo) ] || \
	  $(not_SCT_Digitization_NICOS_Fix_debuginfo_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SCT_Digitization_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -tag=$(tags) $(SCT_Digitization_NICOS_Fix_debuginfo_extratags) build constituent_config -out=$(cmt_local_SCT_Digitization_NICOS_Fix_debuginfo_makefile) SCT_Digitization_NICOS_Fix_debuginfo; \
	  fi
endif
...
$(cmt_local_SCT_Digitization_NICOS_Fix_debuginfo_makefile) : $(SCT_Digitization_NICOS_Fix_debuginfo_dependencies) build_library_links
	$(echo) "(constituents.make) Building SCT_Digitization_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -f=$(bin)SCT_Digitization_NICOS_Fix_debuginfo.in -tag=$(tags) $(SCT_Digitization_NICOS_Fix_debuginfo_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SCT_Digitization_NICOS_Fix_debuginfo_makefile) SCT_Digitization_NICOS_Fix_debuginfo
else
$(cmt_local_SCT_Digitization_NICOS_Fix_debuginfo_makefile) : $(SCT_Digitization_NICOS_Fix_debuginfo_dependencies) $(cmt_build_library_linksstamp) $(bin)SCT_Digitization_NICOS_Fix_debuginfo.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SCT_Digitization_NICOS_Fix_debuginfo) ] || \
	  [ ! -f $(cmt_final_setup_SCT_Digitization_NICOS_Fix_debuginfo) ] || \
	  $(not_SCT_Digitization_NICOS_Fix_debuginfo_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SCT_Digitization_NICOS_Fix_debuginfo_extratags) build constituent_makefile -out=$(cmt_local_SCT_Digitization_NICOS_Fix_debuginfo_makefile) SCT_Digitization_NICOS_Fix_debuginfo

SCT_Digitization_NICOS_Fix_debuginfo :: $(SCT_Digitization_NICOS_Fix_debuginfo_dependencies) $(cmt_local_SCT_Digitization_NICOS_Fix_debuginfo_makefile) dirs SCT_Digitization_NICOS_Fix_debuginfodirs
	$(echo) "(constituents.make) Starting SCT_Digitization_NICOS_Fix_debuginfo"
	@if test -f $(cmt_local_SCT_Digitization_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_Digitization_NICOS_Fix_debuginfo_makefile) SCT_Digitization_NICOS_Fix_debuginfo; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_Digitization_NICOS_Fix_debuginfo_makefile) SCT_Digitization_NICOS_Fix_debuginfo
	$(echo) "(constituents.make) SCT_Digitization_NICOS_Fix_debuginfo done"

clean :: SCT_Digitization_NICOS_Fix_debuginfoclean ;

SCT_Digitization_NICOS_Fix_debuginfoclean :: $(SCT_Digitization_NICOS_Fix_debuginfoclean_dependencies) ##$(cmt_local_SCT_Digitization_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting SCT_Digitization_NICOS_Fix_debuginfoclean"
	@-if test -f $(cmt_local_SCT_Digitization_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_Digitization_NICOS_Fix_debuginfo_makefile) SCT_Digitization_NICOS_Fix_debuginfoclean; \
	fi
	$(echo) "(constituents.make) SCT_Digitization_NICOS_Fix_debuginfoclean done"
#	@-$(MAKE) -f $(cmt_local_SCT_Digitization_NICOS_Fix_debuginfo_makefile) SCT_Digitization_NICOS_Fix_debuginfoclean

##	  /bin/rm -f $(cmt_local_SCT_Digitization_NICOS_Fix_debuginfo_makefile) $(bin)SCT_Digitization_NICOS_Fix_debuginfo_dependencies.make

install :: SCT_Digitization_NICOS_Fix_debuginfoinstall ;

SCT_Digitization_NICOS_Fix_debuginfoinstall :: $(SCT_Digitization_NICOS_Fix_debuginfo_dependencies) $(cmt_local_SCT_Digitization_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_SCT_Digitization_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_Digitization_NICOS_Fix_debuginfo_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_SCT_Digitization_NICOS_Fix_debuginfo_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : SCT_Digitization_NICOS_Fix_debuginfouninstall

$(foreach d,$(SCT_Digitization_NICOS_Fix_debuginfo_dependencies),$(eval $(d)uninstall_dependencies += SCT_Digitization_NICOS_Fix_debuginfouninstall))

SCT_Digitization_NICOS_Fix_debuginfouninstall : $(SCT_Digitization_NICOS_Fix_debuginfouninstall_dependencies) ##$(cmt_local_SCT_Digitization_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_SCT_Digitization_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_SCT_Digitization_NICOS_Fix_debuginfo_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SCT_Digitization_NICOS_Fix_debuginfo_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: SCT_Digitization_NICOS_Fix_debuginfouninstall ;
...
cmt_local_tagfile_check_install_runtime = $(bin)$(SCT_Digitization_tag)_check_install_runtime.make
...
cmt_local_tagfile_check_install_runtime = $(bin)$(SCT_Digitization_tag).make
...
cmt_local_tagfile_check_install_joboptions = $(bin)$(SCT_Digitization_tag)_check_install_joboptions.make
...
cmt_local_tagfile_check_install_joboptions = $(bin)$(SCT_Digitization_tag).make
...
cmt_local_tagfile_check_install_python_modules = $(bin)$(SCT_Digitization_tag)_check_install_python_modules.make
...
cmt_local_tagfile_check_install_python_modules = $(bin)$(SCT_Digitization_tag).make
...
cmt_local_tagfile_find_packages = $(bin)$(SCT_Digitization_tag)_find_packages.make
...
cmt_local_tagfile_find_packages = $(bin)$(SCT_Digitization_tag).make
...
cmt_local_tagfile_compile = $(bin)$(SCT_Digitization_tag)_compile.make
...
cmt_local_tagfile_compile = $(bin)$(SCT_Digitization_tag).make
...
cmt_local_tagfile_compile_pkg = $(bin)$(SCT_Digitization_tag)_compile_pkg.make
...
cmt_local_tagfile_compile_pkg = $(bin)$(SCT_Digitization_tag).make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(SCT_Digitization_tag)_new_analysisapp.make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(SCT_Digitization_tag).make
...
cmt_local_tagfile_new_pkg = $(bin)$(SCT_Digitization_tag)_new_pkg.make
...
cmt_local_tagfile_new_pkg = $(bin)$(SCT_Digitization_tag).make
...
cmt_local_tagfile_new_alg = $(bin)$(SCT_Digitization_tag)_new_alg.make
...
cmt_local_tagfile_new_alg = $(bin)$(SCT_Digitization_tag).make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(SCT_Digitization_tag)_new_analysisalg.make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(SCT_Digitization_tag).make
...
cmt_local_tagfile_new_asgtool = $(bin)$(SCT_Digitization_tag)_new_asgtool.make
...
cmt_local_tagfile_new_asgtool = $(bin)$(SCT_Digitization_tag).make
...
cmt_local_tagfile_new_jobo = $(bin)$(SCT_Digitization_tag)_new_jobo.make
...
cmt_local_tagfile_new_jobo = $(bin)$(SCT_Digitization_tag).make
...
cmt_local_tagfile_new_skeleton = $(bin)$(SCT_Digitization_tag)_new_skeleton.make
...
cmt_local_tagfile_new_skeleton = $(bin)$(SCT_Digitization_tag).make
...
cmt_local_tagfile_make_skeleton = $(bin)$(SCT_Digitization_tag)_make_skeleton.make
...
cmt_local_tagfile_make_skeleton = $(bin)$(SCT_Digitization_tag).make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(SCT_Digitization_tag)_checkout_pkg.make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(SCT_Digitization_tag).make
...
cmt_local_tagfile_cppcheck = $(bin)$(SCT_Digitization_tag)_cppcheck.make
...
cmt_local_tagfile_cppcheck = $(bin)$(SCT_Digitization_tag).make
