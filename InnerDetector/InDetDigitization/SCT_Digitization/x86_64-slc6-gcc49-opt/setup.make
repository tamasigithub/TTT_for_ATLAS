...
#   use AtlasPolicy AtlasPolicy-*  (no_version_directory)
# use GeneratorObjects GeneratorObjects-* Generators (no_version_directory)
# use SCT_ModuleDistortions SCT_ModuleDistortions-* InnerDetector/InDetDetDescr (no_version_directory)
#   use GaudiInterface GaudiInterface-* External (no_version_directory)
#   use AthenaKernel AthenaKernel-* Control (no_version_directory)
#   use InDetReadoutGeometry InDetReadoutGeometry-* InnerDetector/InDetDetDescr (no_version_directory)
#   use Identifier Identifier-* DetectorDescription (no_version_directory)
...
use SCT_ConditionsData SCT_ConditionsData-00-06-06 InnerDetector/InDetConditions (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasConditions/20.20.10)
use SCT_ConditionsServices SCT_ConditionsServices-00-04-44 InnerDetector/InDetConditions (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasConditions/20.20.10)
...
use SCT_ModuleDistortions SCT_ModuleDistortions-00-01-02 InnerDetector/InDetDetDescr (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasConditions/20.20.10)
...
no_pack_dist_check (from package SCT_Digitization) applied [SCT_Digitization]
----------> CMTPATH
