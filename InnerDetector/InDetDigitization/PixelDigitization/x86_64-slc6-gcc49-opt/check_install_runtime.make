...
#cmt_local_tagfile_check_install_runtime = $(PixelDigitization_tag)_check_install_runtime.make
...
#cmt_local_tagfile_check_install_runtime = $(PixelDigitization_tag).make
...
#cmt_final_setup_check_install_runtime = $(bin)PixelDigitization_check_install_runtimesetup.make
...
#cmt_final_setup_check_install_runtime = $(bin)PixelDigitizationsetup.make
cmt_local_check_install_runtime_makefile = $(bin)check_install_runtime.make
...
$(check_install_runtimeactionstamp) ::
	$(silent) /cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasCore/20.20.10/External/ExternalPolicy/cmt/atlas_check_installations.sh -files=' -s=../share 3DFEI3-3E-problist-1um_v1.txt 3DFEI4-2E-problist-1um_v0.txt Bichsel_*.dat  ' -installdir=/afs/cern.ch/work/t/tkar/testarea/20.20.10.7/InstallArea/share -level=
