...
#   use ExternalPolicy ExternalPolicy-* External (no_version_directory)
#   use LCG_Configuration v*  (no_version_directory)
# use AtlasCLHEP_RandomGenerators AtlasCLHEP_RandomGenerators-* Simulation/Tools (no_version_directory)
...
#     use Identifier Identifier-* DetectorDescription (no_version_directory)
#   use Identifier Identifier-* DetectorDescription (no_version_directory)
# use PixelConditionsData PixelConditionsData-* InnerDetector/InDetConditions (no_version_directory)
#   use AtlasPolicy AtlasPolicy-*  (no_version_directory)
#   use Identifier Identifier-* DetectorDescription (no_version_directory)
#   use CLIDSvc CLIDSvc-* Control (no_version_directory)
#   use DataModel DataModel-* Control (no_version_directory)
#   use PixelCoralClientUtils PixelCoralClientUtils-* InnerDetector/InDetConditions (no_version_directory)
...
#     use CoraCool CoraCool-* Database (no_version_directory)
...
#   use GaudiInterface GaudiInterface-* External (no_version_directory)
#   use InDetReadoutGeometry InDetReadoutGeometry-* InnerDetector/InDetDetDescr (no_version_directory)
# use PixelCabling PixelCabling-* InnerDetector/InDetDetDescr (no_version_directory)
#   use AtlasPolicy AtlasPolicy-*  (no_version_directory)
...
#   use AtlasPolicy AtlasPolicy-*  (no_version_directory)
#   use GaudiInterface GaudiInterface-* External (no_version_directory)
# use PixelConditionsServices PixelConditionsServices-* InnerDetector/InDetConditions (no_version_directory)
#   use AtlasPolicy AtlasPolicy-*  (no_version_directory)
#   use AthenaBaseComps AthenaBaseComps-* Control (no_version_directory)
...
#   use GaudiInterface GaudiInterface-* External (no_version_directory)
#   use PixelConditionsData PixelConditionsData-* InnerDetector/InDetConditions (no_version_directory)
#   use InDetByteStreamErrors InDetByteStreamErrors-* InnerDetector/InDetConditions (no_version_directory)
#     use AtlasPolicy AtlasPolicy-*  (no_version_directory)
#     use Identifier Identifier-* DetectorDescription (no_version_directory)
#     use AtlasReflex AtlasReflex-* External (no_version_directory)
#     use CLIDSvc CLIDSvc-* Control (no_version_directory)
#     use DataModel DataModel-* Control (no_version_directory)
#   use InDetConditionsSummaryService InDetConditionsSummaryService-* InnerDetector/InDetConditions (no_version_directory)
# use PixelGeoModel PixelGeoModel-* InnerDetector/InDetDetDescr (no_version_directory)
#   use AtlasPolicy AtlasPolicy-*  (no_version_directory)
#   use GaudiInterface GaudiInterface-* External (no_version_directory)
#   use AthenaKernel AthenaKernel-* Control (no_version_directory)
#   use AtlasCLHEP AtlasCLHEP-* External (no_version_directory) (native_version=2.2.0.4)
...
#   use GeoModelKernel GeoModelKernel-* DetectorDescription/GeoModel (no_version_directory)
#   use Identifier Identifier-* DetectorDescription (no_version_directory)
#   use InDetGeoModelUtils InDetGeoModelUtils-* InnerDetector/InDetDetDescr (no_version_directory)
#     use AtlasPolicy AtlasPolicy-*  (no_version_directory)
#     use GaudiInterface GaudiInterface-* External (no_version_directory)
#     use AthenaKernel AthenaKernel-* Control (no_version_directory)
#     use AtlasCLHEP AtlasCLHEP-* External (no_version_directory) (native_version=2.2.0.4)
...
#     use RDBAccessSvc RDBAccessSvc-* Database/AthenaPOOL (no_version_directory)
#   use InDetReadoutGeometry InDetReadoutGeometry-* InnerDetector/InDetDetDescr (no_version_directory)
#   use PixelInterfaces PixelInterfaces-* InnerDetector/InDetDetDescr/PixelLayouts (no_version_directory)
#     use AtlasPolicy AtlasPolicy-*  (no_version_directory)
#     use AthenaKernel AthenaKernel-* Control (no_version_directory)
#     use GaudiInterface GaudiInterface-* External (no_version_directory)
#   use RDBAccessSvc RDBAccessSvc-* Database/AthenaPOOL (no_version_directory)
...
use TDAQCPolicyExt v* TDAQCPolicy (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/tdaq-common/tdaq-common-01-46-00)
...
use LCG_Policy v1  (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/LCGCMT/LCGCMT_81f)
...
use DetCommonPolicy DetCommonPolicy-00-00-27  (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/DetCommon/20.20.10)
...
use COOL v1 LCG_Interfaces (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/LCGCMT/LCGCMT_81f)
use CoraCool CoraCool-00-05-01 Database (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/DetCommon/20.20.10)
...
use AtlasHepMC AtlasHepMC-00-00-23 External (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasEvent/20.20.10)
...
use DataCollection DataCollection-00-18-06 External (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasCore/20.20.10)
...
use InDetConditionsSummaryService InDetConditionsSummaryService-00-01-01 InnerDetector/InDetConditions (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasConditions/20.20.10)
use PixelCoralClientUtils PixelCoralClientUtils-00-05-08 InnerDetector/InDetConditions (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasConditions/20.20.10)
...
use EventContainers EventContainers-00-04-16 Event (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasCore/20.20.10)
...
use PixelInterfaces PixelInterfaces-00-00-06 InnerDetector/InDetDetDescr/PixelLayouts (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasConditions/20.20.10)
use InDetGeoModelUtils InDetGeoModelUtils-00-06-19-04 InnerDetector/InDetDetDescr (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasProduction/20.20.10.7)
use PixelCabling PixelCabling-00-01-20 InnerDetector/InDetDetDescr (/afs/cern.ch/work/t/tkar/testarea/20.20.10.7)
...
use PixelConditionsTools PixelConditionsTools-00-06-08 InnerDetector/InDetConditions (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasProduction/20.20.10.7)
...
use EventInfo EventInfo-00-11-02-03 Event (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasCore/20.20.10)
...
use CommissionEvent CommissionEvent-00-01-04 Commission (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasEvent/20.20.10)
...
use InDetRawData InDetRawData-01-09-05 InnerDetector/InDetRawEvent (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasEvent/20.20.10)
...
use TrkDigEvent TrkDigEvent-00-00-02 Tracking/TrkDigitization (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasEvent/20.20.10)
use TrkDigInterfaces TrkDigInterfaces-00-00-00 Tracking/TrkDigitization (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasEvent/20.20.10)
...
use PixelGeoModel PixelGeoModel-00-09-63-02 InnerDetector/InDetDetDescr (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasConditions/20.20.10)
use SiPropertiesSvc SiPropertiesSvc-00-00-09 InnerDetector/InDetConditions (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasConditions/20.20.10)
...
use InDetByteStreamErrors InDetByteStreamErrors-00-00-10 InnerDetector/InDetConditions (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasConditions/20.20.10)
use DBDataModel DBDataModel-00-08-02 Database/AthenaPOOL (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasCore/20.20.10)
use AthenaPoolUtilities AthenaPoolUtilities-00-07-00 Database/AthenaPOOL (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasCore/20.20.10)
use IOVDbDataModel IOVDbDataModel-00-00-27 Database (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasCore/20.20.10)
use AsgTools AsgTools-00-00-85 Control/AthToolSupport (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasCore/20.20.10)
use PathResolver PathResolver-00-02-14 Tools (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasCore/20.20.10)
use PixelConditionsData PixelConditionsData-00-10-04 InnerDetector/InDetConditions (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasConditions/20.20.10)
use PixelConditionsServices PixelConditionsServices-00-24-28-01 InnerDetector/InDetConditions (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasProduction/20.20.10.7)
use PileUpTools PileUpTools-01-16-01 Control (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasCore/20.20.10)
use HitManagement HitManagement-00-01-21 Simulation (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasEvent/20.20.10)
...
use GeneratorObjects GeneratorObjects-01-04-00-01 Generators (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasEvent/20.20.10)
use InDetSimEvent InDetSimEvent-00-07-01 InnerDetector (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasEvent/20.20.10)
use SiDigitization SiDigitization-04-10-01 InnerDetector/InDetDigitization (/afs/cern.ch/work/t/tkar/testarea/20.20.10.7)
use InDetSimData InDetSimData-03-00-08 InnerDetector/InDetRawEvent (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasEvent/20.20.10)
use AtlasCLHEP_RandomGenerators AtlasCLHEP_RandomGenerators-00-02-05-02 Simulation/Tools (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasCore/20.20.10)
...
NEEDS_CORAL_RELATIONAL_ACCESS (from package CORAL) applied [CoraCool AtlasCORAL] activated CoraCool
NEEDS_CORAL_BASE (from package CORAL) applied [AthenaPoolUtilities] activated AthenaPoolUtilities
NEEDS_COOL_FACTORY (from package COOL) applied [CoraCool] activated CoraCool
NotAtlasP1 (from package PathResolver) applied [PathResolver]
no_pack_dist_check (from package PixelDigitization) applied [PixelDigitization]
----------> CMTPATH
