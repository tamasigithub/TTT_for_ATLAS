...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=PixelDigitization -version=PixelDigitization-02-00-20-18 -path=/afs/cern.ch/work/t/tkar/testarea/20.20.10.7/InnerDetector/InDetDigitization  $* >${cmtPixelDigitizationtempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=PixelDigitization -version=PixelDigitization-02-00-20-18 -path=/afs/cern.ch/work/t/tkar/testarea/20.20.10.7/InnerDetector/InDetDigitization  $* >${cmtPixelDigitizationtempfile}"
