...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -sh -pack=PixelDigitization -version=PixelDigitization-02-00-20-18 -path=/nfs/dust/atlas/user/tkar/20.20.10.7/InnerDetector/InDetDigitization  $* >${cmtPixelDigitizationtempfile}
if test $? != 0 ; then
  echo >&2 "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -sh -pack=PixelDigitization -version=PixelDigitization-02-00-20-18 -path=/nfs/dust/atlas/user/tkar/20.20.10.7/InnerDetector/InDetDigitization  $* >${cmtPixelDigitizationtempfile}"
  cmtcleanupstatus=2
