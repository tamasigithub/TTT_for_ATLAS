    ...
    def __init__(self):
        ...
        if (SLHC_Flags.LayoutOption == "LightBrlv2" ):
            ...
            SLHC_Setup_XMLReader(PixelLayout = "InclBrl4Ref_InclinedDuals",
                                 ...
                                 doSCT=True,
                                 isGMX=auto_isGMX,
                                 addBCL=False, #True # If you want to set this to True, you must also change 
                                                     # InnerDetector/InDetDetDescr/GmxLayouts/cmt/requirements to point to the 
                                                     # Strips layout containing the BCL, otherwise Reco will segfault - Ben
                                 addCMOS=True,
                                 )
