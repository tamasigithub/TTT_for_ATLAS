...
#cmt_local_tagfile_check_install_runtime = $(InDetSLHC_Example_tag)_check_install_runtime.make
...
#cmt_local_tagfile_check_install_runtime = $(InDetSLHC_Example_tag).make
...
#cmt_final_setup_check_install_runtime = $(bin)InDetSLHC_Example_check_install_runtimesetup.make
...
#cmt_final_setup_check_install_runtime = $(bin)InDetSLHC_Examplesetup.make
cmt_local_check_install_runtime_makefile = $(bin)check_install_runtime.make
...
$(check_install_runtimeactionstamp) ::
	$(silent) /cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasCore/20.20.10/External/ExternalPolicy/cmt/atlas_check_installations.sh -files=' -s=../share -s=../data *.txt *.xml ../test/InDetSLHC_Example_TestConfiguration.xml ../scripts/make*.C ../scripts/IDPerf*.py ../scripts/IDRTT_*.sh ../ExtraFiles/ALL*.html ' -installdir=/afs/cern.ch/work/t/tkar/testarea/20.20.10.7/InstallArea/share -level=
