...
#       use LCG_Configuration v*  (no_version_directory)
#       use LCG_Settings v*  (no_version_directory)
# use RDBAccessSvc RDBAccessSvc-* Database/AthenaPOOL (no_auto_imports) (no_version_directory)
#   use AtlasPolicy AtlasPolicy-*  (no_version_directory)
#   use GaudiInterface GaudiInterface-* External (no_version_directory)
#   use AtlasCORAL AtlasCORAL-* External (no_version_directory)
#   use AtlasBoost AtlasBoost-* External (no_version_directory)
...
use RDBAccessSvc RDBAccessSvc-00-09-09-02 Database/AthenaPOOL (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasCore/20.20.10) (no_auto_imports)
...
no_pack_dist_check (from package InDetSLHC_Example) applied [InDetSLHC_Example]
----------> CMTPATH
