...
${CMTROOT}/${CMTBIN}/cmt.exe setup -csh -pack=InDetSLHC_Example -version=InDetSLHC_Example-00-02-94 -path=/nfs/dust/atlas/user/tkar/20.20.10.7/InnerDetector/InDetExample  -no_cleanup $* >${cmtInDetSLHC_Exampletempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe setup -csh -pack=InDetSLHC_Example -version=InDetSLHC_Example-00-02-94 -path=/nfs/dust/atlas/user/tkar/20.20.10.7/InnerDetector/InDetExample  -no_cleanup $* >${cmtInDetSLHC_Exampletempfile}"
