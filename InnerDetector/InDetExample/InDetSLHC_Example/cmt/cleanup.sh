...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -sh -pack=InDetSLHC_Example -version=InDetSLHC_Example-00-02-94 -path=/nfs/dust/atlas/user/tkar/20.20.10.7/InnerDetector/InDetExample  $* >${cmtInDetSLHC_Exampletempfile}
if test $? != 0 ; then
  echo >&2 "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -sh -pack=InDetSLHC_Example -version=InDetSLHC_Example-00-02-94 -path=/nfs/dust/atlas/user/tkar/20.20.10.7/InnerDetector/InDetExample  $* >${cmtInDetSLHC_Exampletempfile}"
  cmtcleanupstatus=2
