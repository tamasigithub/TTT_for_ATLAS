...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=InDetSLHC_Example -version=InDetSLHC_Example-00-02-94 -path=/afs/cern.ch/work/t/tkar/testarea/20.20.10.7/InnerDetector/InDetExample  $* >${cmtInDetSLHC_Exampletempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=InDetSLHC_Example -version=InDetSLHC_Example-00-02-94 -path=/afs/cern.ch/work/t/tkar/testarea/20.20.10.7/InnerDetector/InDetExample  $* >${cmtInDetSLHC_Exampletempfile}"
