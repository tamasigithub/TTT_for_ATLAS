...
#cmt_local_tagfile = $(GmxLayouts_tag).make
cmt_local_tagfile = $(bin)$(GmxLayouts_tag).make
...
cmt_GmxLayoutsrchk_has_target_tag = 1

#--------------------------------------

ifdef cmt_GmxLayoutsrchk_has_target_tag

cmt_local_tagfile_GmxLayoutsrchk = $(bin)$(GmxLayouts_tag)_GmxLayoutsrchk.make
cmt_final_setup_GmxLayoutsrchk = $(bin)setup_GmxLayoutsrchk.make
cmt_local_GmxLayoutsrchk_makefile = $(bin)GmxLayoutsrchk.make

GmxLayoutsrchk_extratags = -tag_add=target_GmxLayoutsrchk

else

cmt_local_tagfile_GmxLayoutsrchk = $(bin)$(GmxLayouts_tag).make
cmt_final_setup_GmxLayoutsrchk = $(bin)setup.make
cmt_local_GmxLayoutsrchk_makefile = $(bin)GmxLayoutsrchk.make

endif

not_GmxLayoutsrchk_dependencies = { n=0; for p in $?; do m=0; for d in $(GmxLayoutsrchk_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
GmxLayoutsrchkdirs :
	@if test ! -d $(bin)GmxLayoutsrchk; then $(mkdir) -p $(bin)GmxLayoutsrchk; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)GmxLayoutsrchk
else
GmxLayoutsrchkdirs : ;
endif
...
ifndef QUICK
$(cmt_local_GmxLayoutsrchk_makefile) : $(GmxLayoutsrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building GmxLayoutsrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(GmxLayoutsrchk_extratags) build constituent_config -out=$(cmt_local_GmxLayoutsrchk_makefile) GmxLayoutsrchk
else
$(cmt_local_GmxLayoutsrchk_makefile) : $(GmxLayoutsrchk_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_GmxLayoutsrchk) ] || \
	  [ ! -f $(cmt_final_setup_GmxLayoutsrchk) ] || \
	  $(not_GmxLayoutsrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building GmxLayoutsrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(GmxLayoutsrchk_extratags) build constituent_config -out=$(cmt_local_GmxLayoutsrchk_makefile) GmxLayoutsrchk; \
	  fi
endif
...
$(cmt_local_GmxLayoutsrchk_makefile) : $(GmxLayoutsrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building GmxLayoutsrchk.make"; \
	  $(cmtexe) -f=$(bin)GmxLayoutsrchk.in -tag=$(tags) $(GmxLayoutsrchk_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_GmxLayoutsrchk_makefile) GmxLayoutsrchk
else
$(cmt_local_GmxLayoutsrchk_makefile) : $(GmxLayoutsrchk_dependencies) $(cmt_build_library_linksstamp) $(bin)GmxLayoutsrchk.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_GmxLayoutsrchk) ] || \
	  [ ! -f $(cmt_final_setup_GmxLayoutsrchk) ] || \
	  $(not_GmxLayoutsrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(GmxLayoutsrchk_extratags) build constituent_makefile -out=$(cmt_local_GmxLayoutsrchk_makefile) GmxLayoutsrchk

GmxLayoutsrchk :: $(GmxLayoutsrchk_dependencies) $(cmt_local_GmxLayoutsrchk_makefile) dirs GmxLayoutsrchkdirs
	$(echo) "(constituents.make) Starting GmxLayoutsrchk"
	@if test -f $(cmt_local_GmxLayoutsrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_GmxLayoutsrchk_makefile) GmxLayoutsrchk; \
	  fi
#	@$(MAKE) -f $(cmt_local_GmxLayoutsrchk_makefile) GmxLayoutsrchk
	$(echo) "(constituents.make) GmxLayoutsrchk done"

clean :: GmxLayoutsrchkclean ;

GmxLayoutsrchkclean :: $(GmxLayoutsrchkclean_dependencies) ##$(cmt_local_GmxLayoutsrchk_makefile)
	$(echo) "(constituents.make) Starting GmxLayoutsrchkclean"
	@-if test -f $(cmt_local_GmxLayoutsrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_GmxLayoutsrchk_makefile) GmxLayoutsrchkclean; \
	fi
	$(echo) "(constituents.make) GmxLayoutsrchkclean done"
#	@-$(MAKE) -f $(cmt_local_GmxLayoutsrchk_makefile) GmxLayoutsrchkclean

##	  /bin/rm -f $(cmt_local_GmxLayoutsrchk_makefile) $(bin)GmxLayoutsrchk_dependencies.make

install :: GmxLayoutsrchkinstall ;

GmxLayoutsrchkinstall :: $(GmxLayoutsrchk_dependencies) $(cmt_local_GmxLayoutsrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_GmxLayoutsrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_GmxLayoutsrchk_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_GmxLayoutsrchk_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : GmxLayoutsrchkuninstall

$(foreach d,$(GmxLayoutsrchk_dependencies),$(eval $(d)uninstall_dependencies += GmxLayoutsrchkuninstall))

GmxLayoutsrchkuninstall : $(GmxLayoutsrchkuninstall_dependencies) ##$(cmt_local_GmxLayoutsrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_GmxLayoutsrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_GmxLayoutsrchk_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_GmxLayoutsrchk_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: GmxLayoutsrchkuninstall ;
...
cmt_local_tagfile_install_root_include_path = $(bin)$(GmxLayouts_tag)_install_root_include_path.make
...
cmt_local_tagfile_install_root_include_path = $(bin)$(GmxLayouts_tag).make
...
cmt_local_tagfile_install_includes = $(bin)$(GmxLayouts_tag)_install_includes.make
...
cmt_local_tagfile_install_includes = $(bin)$(GmxLayouts_tag).make
...
cmt_local_tagfile_make = $(bin)$(GmxLayouts_tag)_make.make
...
cmt_local_tagfile_make = $(bin)$(GmxLayouts_tag).make
...
cmt_local_tagfile_CompilePython = $(bin)$(GmxLayouts_tag)_CompilePython.make
...
cmt_local_tagfile_CompilePython = $(bin)$(GmxLayouts_tag).make
...
cmt_local_tagfile_qmtest_run = $(bin)$(GmxLayouts_tag)_qmtest_run.make
...
cmt_local_tagfile_qmtest_run = $(bin)$(GmxLayouts_tag).make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(GmxLayouts_tag)_qmtest_summarize.make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(GmxLayouts_tag).make
...
cmt_local_tagfile_TestPackage = $(bin)$(GmxLayouts_tag)_TestPackage.make
...
cmt_local_tagfile_TestPackage = $(bin)$(GmxLayouts_tag).make
...
cmt_local_tagfile_TestProject = $(bin)$(GmxLayouts_tag)_TestProject.make
...
cmt_local_tagfile_TestProject = $(bin)$(GmxLayouts_tag).make
...
cmt_local_tagfile_new_rootsys = $(bin)$(GmxLayouts_tag)_new_rootsys.make
...
cmt_local_tagfile_new_rootsys = $(bin)$(GmxLayouts_tag).make
...
cmt_local_tagfile_doxygen = $(bin)$(GmxLayouts_tag)_doxygen.make
...
cmt_local_tagfile_doxygen = $(bin)$(GmxLayouts_tag).make
...
cmt_local_tagfile_post_install = $(bin)$(GmxLayouts_tag)_post_install.make
...
cmt_local_tagfile_post_install = $(bin)$(GmxLayouts_tag).make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(GmxLayouts_tag)_post_merge_rootmap.make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(GmxLayouts_tag).make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(GmxLayouts_tag)_post_merge_genconfdb.make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(GmxLayouts_tag).make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(GmxLayouts_tag)_post_build_tpcnvdb.make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(GmxLayouts_tag).make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(GmxLayouts_tag)_all_post_constituents.make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(GmxLayouts_tag).make
...
cmt_local_tagfile_checkreq = $(bin)$(GmxLayouts_tag)_checkreq.make
...
cmt_local_tagfile_checkreq = $(bin)$(GmxLayouts_tag).make
...
cmt_local_tagfile_check_install_runtime = $(bin)$(GmxLayouts_tag)_check_install_runtime.make
...
cmt_local_tagfile_check_install_runtime = $(bin)$(GmxLayouts_tag).make
...
cmt_local_tagfile_find_packages = $(bin)$(GmxLayouts_tag)_find_packages.make
...
cmt_local_tagfile_find_packages = $(bin)$(GmxLayouts_tag).make
...
cmt_local_tagfile_compile = $(bin)$(GmxLayouts_tag)_compile.make
...
cmt_local_tagfile_compile = $(bin)$(GmxLayouts_tag).make
...
cmt_local_tagfile_compile_pkg = $(bin)$(GmxLayouts_tag)_compile_pkg.make
...
cmt_local_tagfile_compile_pkg = $(bin)$(GmxLayouts_tag).make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(GmxLayouts_tag)_new_analysisapp.make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(GmxLayouts_tag).make
...
cmt_local_tagfile_new_pkg = $(bin)$(GmxLayouts_tag)_new_pkg.make
...
cmt_local_tagfile_new_pkg = $(bin)$(GmxLayouts_tag).make
...
cmt_local_tagfile_new_alg = $(bin)$(GmxLayouts_tag)_new_alg.make
...
cmt_local_tagfile_new_alg = $(bin)$(GmxLayouts_tag).make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(GmxLayouts_tag)_new_analysisalg.make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(GmxLayouts_tag).make
...
cmt_local_tagfile_new_asgtool = $(bin)$(GmxLayouts_tag)_new_asgtool.make
...
cmt_local_tagfile_new_asgtool = $(bin)$(GmxLayouts_tag).make
...
cmt_local_tagfile_new_jobo = $(bin)$(GmxLayouts_tag)_new_jobo.make
...
cmt_local_tagfile_new_jobo = $(bin)$(GmxLayouts_tag).make
...
cmt_local_tagfile_new_skeleton = $(bin)$(GmxLayouts_tag)_new_skeleton.make
...
cmt_local_tagfile_new_skeleton = $(bin)$(GmxLayouts_tag).make
...
cmt_local_tagfile_make_skeleton = $(bin)$(GmxLayouts_tag)_make_skeleton.make
...
cmt_local_tagfile_make_skeleton = $(bin)$(GmxLayouts_tag).make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(GmxLayouts_tag)_checkout_pkg.make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(GmxLayouts_tag).make
...
cmt_local_tagfile_cppcheck = $(bin)$(GmxLayouts_tag)_cppcheck.make
...
cmt_local_tagfile_cppcheck = $(bin)$(GmxLayouts_tag).make
