...
#cmt_local_tagfile = $(InDetTrackingGeometry_tag).make
cmt_local_tagfile = $(bin)$(InDetTrackingGeometry_tag).make
...
InDetTrackingGeometry_extratags = -tag_add=target_InDetTrackingGeometry
...
not_InDetTrackingGeometry_dependencies = { n=0; for p in $?; do m=0; for d in $(InDetTrackingGeometry_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
InDetTrackingGeometrydirs :
	@if test ! -d $(bin)InDetTrackingGeometry; then $(mkdir) -p $(bin)InDetTrackingGeometry; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)InDetTrackingGeometry
else
InDetTrackingGeometrydirs : ;
endif
...
ifndef QUICK
$(cmt_local_InDetTrackingGeometry_makefile) : $(InDetTrackingGeometry_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometry.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometry_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometry_makefile) InDetTrackingGeometry
else
$(cmt_local_InDetTrackingGeometry_makefile) : $(InDetTrackingGeometry_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometry) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometry) ] || \
	  $(not_InDetTrackingGeometry_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building InDetTrackingGeometry.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometry_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometry_makefile) InDetTrackingGeometry; \
	  fi
endif
...
$(cmt_local_InDetTrackingGeometry_makefile) : $(InDetTrackingGeometry_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometry.make"; \
	  $(cmtexe) -f=$(bin)InDetTrackingGeometry.in -tag=$(tags) $(InDetTrackingGeometry_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_InDetTrackingGeometry_makefile) InDetTrackingGeometry
else
$(cmt_local_InDetTrackingGeometry_makefile) : $(InDetTrackingGeometry_dependencies) $(cmt_build_library_linksstamp) $(bin)InDetTrackingGeometry.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometry) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometry) ] || \
	  $(not_InDetTrackingGeometry_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometry_extratags) build constituent_makefile -out=$(cmt_local_InDetTrackingGeometry_makefile) InDetTrackingGeometry

InDetTrackingGeometry :: $(InDetTrackingGeometry_dependencies) $(cmt_local_InDetTrackingGeometry_makefile) dirs InDetTrackingGeometrydirs
	$(echo) "(constituents.make) Starting InDetTrackingGeometry"
	@if test -f $(cmt_local_InDetTrackingGeometry_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometry_makefile) InDetTrackingGeometry; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometry_makefile) InDetTrackingGeometry
	$(echo) "(constituents.make) InDetTrackingGeometry done"

clean :: InDetTrackingGeometryclean ;

InDetTrackingGeometryclean :: $(InDetTrackingGeometryclean_dependencies) ##$(cmt_local_InDetTrackingGeometry_makefile)
	$(echo) "(constituents.make) Starting InDetTrackingGeometryclean"
	@-if test -f $(cmt_local_InDetTrackingGeometry_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometry_makefile) InDetTrackingGeometryclean; \
	fi
	$(echo) "(constituents.make) InDetTrackingGeometryclean done"
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometry_makefile) InDetTrackingGeometryclean

##	  /bin/rm -f $(cmt_local_InDetTrackingGeometry_makefile) $(bin)InDetTrackingGeometry_dependencies.make

install :: InDetTrackingGeometryinstall ;

InDetTrackingGeometryinstall :: $(InDetTrackingGeometry_dependencies) $(cmt_local_InDetTrackingGeometry_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_InDetTrackingGeometry_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometry_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometry_makefile) install
...
$(foreach d,$(InDetTrackingGeometry_dependencies),$(eval $(d)uninstall_dependencies += InDetTrackingGeometryuninstall))

InDetTrackingGeometryuninstall : $(InDetTrackingGeometryuninstall_dependencies) ##$(cmt_local_InDetTrackingGeometry_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_InDetTrackingGeometry_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometry_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometry_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: InDetTrackingGeometryuninstall ;
...
InDetTrackingGeometryConf_extratags = -tag_add=target_InDetTrackingGeometryConf
...
not_InDetTrackingGeometryConf_dependencies = { n=0; for p in $?; do m=0; for d in $(InDetTrackingGeometryConf_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
InDetTrackingGeometryConfdirs :
	@if test ! -d $(bin)InDetTrackingGeometryConf; then $(mkdir) -p $(bin)InDetTrackingGeometryConf; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)InDetTrackingGeometryConf
else
InDetTrackingGeometryConfdirs : ;
endif
...
ifndef QUICK
$(cmt_local_InDetTrackingGeometryConf_makefile) : $(InDetTrackingGeometryConf_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometryConf.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryConf_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometryConf_makefile) InDetTrackingGeometryConf
else
$(cmt_local_InDetTrackingGeometryConf_makefile) : $(InDetTrackingGeometryConf_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometryConf) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometryConf) ] || \
	  $(not_InDetTrackingGeometryConf_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building InDetTrackingGeometryConf.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryConf_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometryConf_makefile) InDetTrackingGeometryConf; \
	  fi
endif
...
$(cmt_local_InDetTrackingGeometryConf_makefile) : $(InDetTrackingGeometryConf_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometryConf.make"; \
	  $(cmtexe) -f=$(bin)InDetTrackingGeometryConf.in -tag=$(tags) $(InDetTrackingGeometryConf_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_InDetTrackingGeometryConf_makefile) InDetTrackingGeometryConf
else
$(cmt_local_InDetTrackingGeometryConf_makefile) : $(InDetTrackingGeometryConf_dependencies) $(cmt_build_library_linksstamp) $(bin)InDetTrackingGeometryConf.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometryConf) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometryConf) ] || \
	  $(not_InDetTrackingGeometryConf_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryConf_extratags) build constituent_makefile -out=$(cmt_local_InDetTrackingGeometryConf_makefile) InDetTrackingGeometryConf

InDetTrackingGeometryConf :: $(InDetTrackingGeometryConf_dependencies) $(cmt_local_InDetTrackingGeometryConf_makefile) dirs InDetTrackingGeometryConfdirs
	$(echo) "(constituents.make) Starting InDetTrackingGeometryConf"
	@if test -f $(cmt_local_InDetTrackingGeometryConf_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryConf_makefile) InDetTrackingGeometryConf; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometryConf_makefile) InDetTrackingGeometryConf
	$(echo) "(constituents.make) InDetTrackingGeometryConf done"

clean :: InDetTrackingGeometryConfclean ;

InDetTrackingGeometryConfclean :: $(InDetTrackingGeometryConfclean_dependencies) ##$(cmt_local_InDetTrackingGeometryConf_makefile)
	$(echo) "(constituents.make) Starting InDetTrackingGeometryConfclean"
	@-if test -f $(cmt_local_InDetTrackingGeometryConf_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryConf_makefile) InDetTrackingGeometryConfclean; \
	fi
	$(echo) "(constituents.make) InDetTrackingGeometryConfclean done"
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometryConf_makefile) InDetTrackingGeometryConfclean

##	  /bin/rm -f $(cmt_local_InDetTrackingGeometryConf_makefile) $(bin)InDetTrackingGeometryConf_dependencies.make

install :: InDetTrackingGeometryConfinstall ;

InDetTrackingGeometryConfinstall :: $(InDetTrackingGeometryConf_dependencies) $(cmt_local_InDetTrackingGeometryConf_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_InDetTrackingGeometryConf_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryConf_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometryConf_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(InDetTrackingGeometryConf_dependencies),$(eval $(d)uninstall_dependencies += InDetTrackingGeometryConfuninstall))

InDetTrackingGeometryConfuninstall : $(InDetTrackingGeometryConfuninstall_dependencies) ##$(cmt_local_InDetTrackingGeometryConf_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_InDetTrackingGeometryConf_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryConf_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometryConf_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: InDetTrackingGeometryConfuninstall ;
...
InDetTrackingGeometry_python_init_extratags = -tag_add=target_InDetTrackingGeometry_python_init
...
not_InDetTrackingGeometry_python_init_dependencies = { n=0; for p in $?; do m=0; for d in $(InDetTrackingGeometry_python_init_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
InDetTrackingGeometry_python_initdirs :
	@if test ! -d $(bin)InDetTrackingGeometry_python_init; then $(mkdir) -p $(bin)InDetTrackingGeometry_python_init; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)InDetTrackingGeometry_python_init
else
InDetTrackingGeometry_python_initdirs : ;
endif
...
ifndef QUICK
$(cmt_local_InDetTrackingGeometry_python_init_makefile) : $(InDetTrackingGeometry_python_init_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometry_python_init.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometry_python_init_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometry_python_init_makefile) InDetTrackingGeometry_python_init
else
$(cmt_local_InDetTrackingGeometry_python_init_makefile) : $(InDetTrackingGeometry_python_init_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometry_python_init) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometry_python_init) ] || \
	  $(not_InDetTrackingGeometry_python_init_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building InDetTrackingGeometry_python_init.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometry_python_init_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometry_python_init_makefile) InDetTrackingGeometry_python_init; \
	  fi
endif
...
$(cmt_local_InDetTrackingGeometry_python_init_makefile) : $(InDetTrackingGeometry_python_init_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometry_python_init.make"; \
	  $(cmtexe) -f=$(bin)InDetTrackingGeometry_python_init.in -tag=$(tags) $(InDetTrackingGeometry_python_init_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_InDetTrackingGeometry_python_init_makefile) InDetTrackingGeometry_python_init
else
$(cmt_local_InDetTrackingGeometry_python_init_makefile) : $(InDetTrackingGeometry_python_init_dependencies) $(cmt_build_library_linksstamp) $(bin)InDetTrackingGeometry_python_init.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometry_python_init) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometry_python_init) ] || \
	  $(not_InDetTrackingGeometry_python_init_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometry_python_init_extratags) build constituent_makefile -out=$(cmt_local_InDetTrackingGeometry_python_init_makefile) InDetTrackingGeometry_python_init

InDetTrackingGeometry_python_init :: $(InDetTrackingGeometry_python_init_dependencies) $(cmt_local_InDetTrackingGeometry_python_init_makefile) dirs InDetTrackingGeometry_python_initdirs
	$(echo) "(constituents.make) Starting InDetTrackingGeometry_python_init"
	@if test -f $(cmt_local_InDetTrackingGeometry_python_init_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometry_python_init_makefile) InDetTrackingGeometry_python_init; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometry_python_init_makefile) InDetTrackingGeometry_python_init
	$(echo) "(constituents.make) InDetTrackingGeometry_python_init done"

clean :: InDetTrackingGeometry_python_initclean ;

InDetTrackingGeometry_python_initclean :: $(InDetTrackingGeometry_python_initclean_dependencies) ##$(cmt_local_InDetTrackingGeometry_python_init_makefile)
	$(echo) "(constituents.make) Starting InDetTrackingGeometry_python_initclean"
	@-if test -f $(cmt_local_InDetTrackingGeometry_python_init_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometry_python_init_makefile) InDetTrackingGeometry_python_initclean; \
	fi
	$(echo) "(constituents.make) InDetTrackingGeometry_python_initclean done"
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometry_python_init_makefile) InDetTrackingGeometry_python_initclean

##	  /bin/rm -f $(cmt_local_InDetTrackingGeometry_python_init_makefile) $(bin)InDetTrackingGeometry_python_init_dependencies.make

install :: InDetTrackingGeometry_python_initinstall ;

InDetTrackingGeometry_python_initinstall :: $(InDetTrackingGeometry_python_init_dependencies) $(cmt_local_InDetTrackingGeometry_python_init_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_InDetTrackingGeometry_python_init_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometry_python_init_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometry_python_init_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(InDetTrackingGeometry_python_init_dependencies),$(eval $(d)uninstall_dependencies += InDetTrackingGeometry_python_inituninstall))

InDetTrackingGeometry_python_inituninstall : $(InDetTrackingGeometry_python_inituninstall_dependencies) ##$(cmt_local_InDetTrackingGeometry_python_init_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_InDetTrackingGeometry_python_init_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometry_python_init_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometry_python_init_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: InDetTrackingGeometry_python_inituninstall ;
...
InDetTrackingGeometryConfDbMerge_extratags = -tag_add=target_InDetTrackingGeometryConfDbMerge
...
not_InDetTrackingGeometryConfDbMerge_dependencies = { n=0; for p in $?; do m=0; for d in $(InDetTrackingGeometryConfDbMerge_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
InDetTrackingGeometryConfDbMergedirs :
	@if test ! -d $(bin)InDetTrackingGeometryConfDbMerge; then $(mkdir) -p $(bin)InDetTrackingGeometryConfDbMerge; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)InDetTrackingGeometryConfDbMerge
else
InDetTrackingGeometryConfDbMergedirs : ;
endif
...
ifndef QUICK
$(cmt_local_InDetTrackingGeometryConfDbMerge_makefile) : $(InDetTrackingGeometryConfDbMerge_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometryConfDbMerge.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryConfDbMerge_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometryConfDbMerge_makefile) InDetTrackingGeometryConfDbMerge
else
$(cmt_local_InDetTrackingGeometryConfDbMerge_makefile) : $(InDetTrackingGeometryConfDbMerge_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometryConfDbMerge) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometryConfDbMerge) ] || \
	  $(not_InDetTrackingGeometryConfDbMerge_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building InDetTrackingGeometryConfDbMerge.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryConfDbMerge_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometryConfDbMerge_makefile) InDetTrackingGeometryConfDbMerge; \
	  fi
endif
...
$(cmt_local_InDetTrackingGeometryConfDbMerge_makefile) : $(InDetTrackingGeometryConfDbMerge_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometryConfDbMerge.make"; \
	  $(cmtexe) -f=$(bin)InDetTrackingGeometryConfDbMerge.in -tag=$(tags) $(InDetTrackingGeometryConfDbMerge_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_InDetTrackingGeometryConfDbMerge_makefile) InDetTrackingGeometryConfDbMerge
else
$(cmt_local_InDetTrackingGeometryConfDbMerge_makefile) : $(InDetTrackingGeometryConfDbMerge_dependencies) $(cmt_build_library_linksstamp) $(bin)InDetTrackingGeometryConfDbMerge.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometryConfDbMerge) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometryConfDbMerge) ] || \
	  $(not_InDetTrackingGeometryConfDbMerge_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryConfDbMerge_extratags) build constituent_makefile -out=$(cmt_local_InDetTrackingGeometryConfDbMerge_makefile) InDetTrackingGeometryConfDbMerge

InDetTrackingGeometryConfDbMerge :: $(InDetTrackingGeometryConfDbMerge_dependencies) $(cmt_local_InDetTrackingGeometryConfDbMerge_makefile) dirs InDetTrackingGeometryConfDbMergedirs
	$(echo) "(constituents.make) Starting InDetTrackingGeometryConfDbMerge"
	@if test -f $(cmt_local_InDetTrackingGeometryConfDbMerge_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryConfDbMerge_makefile) InDetTrackingGeometryConfDbMerge; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometryConfDbMerge_makefile) InDetTrackingGeometryConfDbMerge
	$(echo) "(constituents.make) InDetTrackingGeometryConfDbMerge done"

clean :: InDetTrackingGeometryConfDbMergeclean ;

InDetTrackingGeometryConfDbMergeclean :: $(InDetTrackingGeometryConfDbMergeclean_dependencies) ##$(cmt_local_InDetTrackingGeometryConfDbMerge_makefile)
	$(echo) "(constituents.make) Starting InDetTrackingGeometryConfDbMergeclean"
	@-if test -f $(cmt_local_InDetTrackingGeometryConfDbMerge_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryConfDbMerge_makefile) InDetTrackingGeometryConfDbMergeclean; \
	fi
	$(echo) "(constituents.make) InDetTrackingGeometryConfDbMergeclean done"
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometryConfDbMerge_makefile) InDetTrackingGeometryConfDbMergeclean

##	  /bin/rm -f $(cmt_local_InDetTrackingGeometryConfDbMerge_makefile) $(bin)InDetTrackingGeometryConfDbMerge_dependencies.make

install :: InDetTrackingGeometryConfDbMergeinstall ;

InDetTrackingGeometryConfDbMergeinstall :: $(InDetTrackingGeometryConfDbMerge_dependencies) $(cmt_local_InDetTrackingGeometryConfDbMerge_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_InDetTrackingGeometryConfDbMerge_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryConfDbMerge_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometryConfDbMerge_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : InDetTrackingGeometryConfDbMergeuninstall

$(foreach d,$(InDetTrackingGeometryConfDbMerge_dependencies),$(eval $(d)uninstall_dependencies += InDetTrackingGeometryConfDbMergeuninstall))

InDetTrackingGeometryConfDbMergeuninstall : $(InDetTrackingGeometryConfDbMergeuninstall_dependencies) ##$(cmt_local_InDetTrackingGeometryConfDbMerge_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_InDetTrackingGeometryConfDbMerge_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryConfDbMerge_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometryConfDbMerge_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: InDetTrackingGeometryConfDbMergeuninstall ;
...
InDetTrackingGeometryComponentsList_extratags = -tag_add=target_InDetTrackingGeometryComponentsList
...
not_InDetTrackingGeometryComponentsList_dependencies = { n=0; for p in $?; do m=0; for d in $(InDetTrackingGeometryComponentsList_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
InDetTrackingGeometryComponentsListdirs :
	@if test ! -d $(bin)InDetTrackingGeometryComponentsList; then $(mkdir) -p $(bin)InDetTrackingGeometryComponentsList; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)InDetTrackingGeometryComponentsList
else
InDetTrackingGeometryComponentsListdirs : ;
endif
...
ifndef QUICK
$(cmt_local_InDetTrackingGeometryComponentsList_makefile) : $(InDetTrackingGeometryComponentsList_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometryComponentsList.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryComponentsList_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometryComponentsList_makefile) InDetTrackingGeometryComponentsList
else
$(cmt_local_InDetTrackingGeometryComponentsList_makefile) : $(InDetTrackingGeometryComponentsList_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometryComponentsList) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometryComponentsList) ] || \
	  $(not_InDetTrackingGeometryComponentsList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building InDetTrackingGeometryComponentsList.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryComponentsList_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometryComponentsList_makefile) InDetTrackingGeometryComponentsList; \
	  fi
endif
...
$(cmt_local_InDetTrackingGeometryComponentsList_makefile) : $(InDetTrackingGeometryComponentsList_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometryComponentsList.make"; \
	  $(cmtexe) -f=$(bin)InDetTrackingGeometryComponentsList.in -tag=$(tags) $(InDetTrackingGeometryComponentsList_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_InDetTrackingGeometryComponentsList_makefile) InDetTrackingGeometryComponentsList
else
$(cmt_local_InDetTrackingGeometryComponentsList_makefile) : $(InDetTrackingGeometryComponentsList_dependencies) $(cmt_build_library_linksstamp) $(bin)InDetTrackingGeometryComponentsList.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometryComponentsList) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometryComponentsList) ] || \
	  $(not_InDetTrackingGeometryComponentsList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryComponentsList_extratags) build constituent_makefile -out=$(cmt_local_InDetTrackingGeometryComponentsList_makefile) InDetTrackingGeometryComponentsList

InDetTrackingGeometryComponentsList :: $(InDetTrackingGeometryComponentsList_dependencies) $(cmt_local_InDetTrackingGeometryComponentsList_makefile) dirs InDetTrackingGeometryComponentsListdirs
	$(echo) "(constituents.make) Starting InDetTrackingGeometryComponentsList"
	@if test -f $(cmt_local_InDetTrackingGeometryComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryComponentsList_makefile) InDetTrackingGeometryComponentsList; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometryComponentsList_makefile) InDetTrackingGeometryComponentsList
	$(echo) "(constituents.make) InDetTrackingGeometryComponentsList done"

clean :: InDetTrackingGeometryComponentsListclean ;

InDetTrackingGeometryComponentsListclean :: $(InDetTrackingGeometryComponentsListclean_dependencies) ##$(cmt_local_InDetTrackingGeometryComponentsList_makefile)
	$(echo) "(constituents.make) Starting InDetTrackingGeometryComponentsListclean"
	@-if test -f $(cmt_local_InDetTrackingGeometryComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryComponentsList_makefile) InDetTrackingGeometryComponentsListclean; \
	fi
	$(echo) "(constituents.make) InDetTrackingGeometryComponentsListclean done"
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometryComponentsList_makefile) InDetTrackingGeometryComponentsListclean

##	  /bin/rm -f $(cmt_local_InDetTrackingGeometryComponentsList_makefile) $(bin)InDetTrackingGeometryComponentsList_dependencies.make

install :: InDetTrackingGeometryComponentsListinstall ;

InDetTrackingGeometryComponentsListinstall :: $(InDetTrackingGeometryComponentsList_dependencies) $(cmt_local_InDetTrackingGeometryComponentsList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_InDetTrackingGeometryComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryComponentsList_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometryComponentsList_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(InDetTrackingGeometryComponentsList_dependencies),$(eval $(d)uninstall_dependencies += InDetTrackingGeometryComponentsListuninstall))

InDetTrackingGeometryComponentsListuninstall : $(InDetTrackingGeometryComponentsListuninstall_dependencies) ##$(cmt_local_InDetTrackingGeometryComponentsList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_InDetTrackingGeometryComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryComponentsList_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometryComponentsList_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: InDetTrackingGeometryComponentsListuninstall ;
...
InDetTrackingGeometryMergeComponentsList_extratags = -tag_add=target_InDetTrackingGeometryMergeComponentsList
...
not_InDetTrackingGeometryMergeComponentsList_dependencies = { n=0; for p in $?; do m=0; for d in $(InDetTrackingGeometryMergeComponentsList_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
InDetTrackingGeometryMergeComponentsListdirs :
	@if test ! -d $(bin)InDetTrackingGeometryMergeComponentsList; then $(mkdir) -p $(bin)InDetTrackingGeometryMergeComponentsList; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)InDetTrackingGeometryMergeComponentsList
else
InDetTrackingGeometryMergeComponentsListdirs : ;
endif
...
ifndef QUICK
$(cmt_local_InDetTrackingGeometryMergeComponentsList_makefile) : $(InDetTrackingGeometryMergeComponentsList_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometryMergeComponentsList.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryMergeComponentsList_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometryMergeComponentsList_makefile) InDetTrackingGeometryMergeComponentsList
else
$(cmt_local_InDetTrackingGeometryMergeComponentsList_makefile) : $(InDetTrackingGeometryMergeComponentsList_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometryMergeComponentsList) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometryMergeComponentsList) ] || \
	  $(not_InDetTrackingGeometryMergeComponentsList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building InDetTrackingGeometryMergeComponentsList.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryMergeComponentsList_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometryMergeComponentsList_makefile) InDetTrackingGeometryMergeComponentsList; \
	  fi
endif
...
$(cmt_local_InDetTrackingGeometryMergeComponentsList_makefile) : $(InDetTrackingGeometryMergeComponentsList_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometryMergeComponentsList.make"; \
	  $(cmtexe) -f=$(bin)InDetTrackingGeometryMergeComponentsList.in -tag=$(tags) $(InDetTrackingGeometryMergeComponentsList_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_InDetTrackingGeometryMergeComponentsList_makefile) InDetTrackingGeometryMergeComponentsList
else
$(cmt_local_InDetTrackingGeometryMergeComponentsList_makefile) : $(InDetTrackingGeometryMergeComponentsList_dependencies) $(cmt_build_library_linksstamp) $(bin)InDetTrackingGeometryMergeComponentsList.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometryMergeComponentsList) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometryMergeComponentsList) ] || \
	  $(not_InDetTrackingGeometryMergeComponentsList_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryMergeComponentsList_extratags) build constituent_makefile -out=$(cmt_local_InDetTrackingGeometryMergeComponentsList_makefile) InDetTrackingGeometryMergeComponentsList

InDetTrackingGeometryMergeComponentsList :: $(InDetTrackingGeometryMergeComponentsList_dependencies) $(cmt_local_InDetTrackingGeometryMergeComponentsList_makefile) dirs InDetTrackingGeometryMergeComponentsListdirs
	$(echo) "(constituents.make) Starting InDetTrackingGeometryMergeComponentsList"
	@if test -f $(cmt_local_InDetTrackingGeometryMergeComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryMergeComponentsList_makefile) InDetTrackingGeometryMergeComponentsList; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometryMergeComponentsList_makefile) InDetTrackingGeometryMergeComponentsList
	$(echo) "(constituents.make) InDetTrackingGeometryMergeComponentsList done"

clean :: InDetTrackingGeometryMergeComponentsListclean ;

InDetTrackingGeometryMergeComponentsListclean :: $(InDetTrackingGeometryMergeComponentsListclean_dependencies) ##$(cmt_local_InDetTrackingGeometryMergeComponentsList_makefile)
	$(echo) "(constituents.make) Starting InDetTrackingGeometryMergeComponentsListclean"
	@-if test -f $(cmt_local_InDetTrackingGeometryMergeComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryMergeComponentsList_makefile) InDetTrackingGeometryMergeComponentsListclean; \
	fi
	$(echo) "(constituents.make) InDetTrackingGeometryMergeComponentsListclean done"
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometryMergeComponentsList_makefile) InDetTrackingGeometryMergeComponentsListclean

##	  /bin/rm -f $(cmt_local_InDetTrackingGeometryMergeComponentsList_makefile) $(bin)InDetTrackingGeometryMergeComponentsList_dependencies.make

install :: InDetTrackingGeometryMergeComponentsListinstall ;

InDetTrackingGeometryMergeComponentsListinstall :: $(InDetTrackingGeometryMergeComponentsList_dependencies) $(cmt_local_InDetTrackingGeometryMergeComponentsList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_InDetTrackingGeometryMergeComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryMergeComponentsList_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometryMergeComponentsList_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : InDetTrackingGeometryMergeComponentsListuninstall

$(foreach d,$(InDetTrackingGeometryMergeComponentsList_dependencies),$(eval $(d)uninstall_dependencies += InDetTrackingGeometryMergeComponentsListuninstall))

InDetTrackingGeometryMergeComponentsListuninstall : $(InDetTrackingGeometryMergeComponentsListuninstall_dependencies) ##$(cmt_local_InDetTrackingGeometryMergeComponentsList_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_InDetTrackingGeometryMergeComponentsList_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryMergeComponentsList_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometryMergeComponentsList_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: InDetTrackingGeometryMergeComponentsListuninstall ;
...
cmt_InDetTrackingGeometry_optdebug_library_has_no_target_tag = 1

#--------------------------------------

ifdef cmt_InDetTrackingGeometry_optdebug_library_has_target_tag

cmt_local_tagfile_InDetTrackingGeometry_optdebug_library = $(bin)$(InDetTrackingGeometry_tag)_InDetTrackingGeometry_optdebug_library.make
cmt_final_setup_InDetTrackingGeometry_optdebug_library = $(bin)setup_InDetTrackingGeometry_optdebug_library.make
cmt_local_InDetTrackingGeometry_optdebug_library_makefile = $(bin)InDetTrackingGeometry_optdebug_library.make

InDetTrackingGeometry_optdebug_library_extratags = -tag_add=target_InDetTrackingGeometry_optdebug_library

else

cmt_local_tagfile_InDetTrackingGeometry_optdebug_library = $(bin)$(InDetTrackingGeometry_tag).make
cmt_final_setup_InDetTrackingGeometry_optdebug_library = $(bin)setup.make
cmt_local_InDetTrackingGeometry_optdebug_library_makefile = $(bin)InDetTrackingGeometry_optdebug_library.make

endif

not_InDetTrackingGeometry_optdebug_library_dependencies = { n=0; for p in $?; do m=0; for d in $(InDetTrackingGeometry_optdebug_library_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
InDetTrackingGeometry_optdebug_librarydirs :
	@if test ! -d $(bin)InDetTrackingGeometry_optdebug_library; then $(mkdir) -p $(bin)InDetTrackingGeometry_optdebug_library; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)InDetTrackingGeometry_optdebug_library
else
InDetTrackingGeometry_optdebug_librarydirs : ;
endif
...
ifndef QUICK
$(cmt_local_InDetTrackingGeometry_optdebug_library_makefile) : $(InDetTrackingGeometry_optdebug_library_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometry_optdebug_library.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometry_optdebug_library_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometry_optdebug_library_makefile) InDetTrackingGeometry_optdebug_library
else
$(cmt_local_InDetTrackingGeometry_optdebug_library_makefile) : $(InDetTrackingGeometry_optdebug_library_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometry_optdebug_library) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometry_optdebug_library) ] || \
	  $(not_InDetTrackingGeometry_optdebug_library_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building InDetTrackingGeometry_optdebug_library.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometry_optdebug_library_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometry_optdebug_library_makefile) InDetTrackingGeometry_optdebug_library; \
	  fi
endif
...
$(cmt_local_InDetTrackingGeometry_optdebug_library_makefile) : $(InDetTrackingGeometry_optdebug_library_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometry_optdebug_library.make"; \
	  $(cmtexe) -f=$(bin)InDetTrackingGeometry_optdebug_library.in -tag=$(tags) $(InDetTrackingGeometry_optdebug_library_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_InDetTrackingGeometry_optdebug_library_makefile) InDetTrackingGeometry_optdebug_library
else
$(cmt_local_InDetTrackingGeometry_optdebug_library_makefile) : $(InDetTrackingGeometry_optdebug_library_dependencies) $(cmt_build_library_linksstamp) $(bin)InDetTrackingGeometry_optdebug_library.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometry_optdebug_library) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometry_optdebug_library) ] || \
	  $(not_InDetTrackingGeometry_optdebug_library_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometry_optdebug_library_extratags) build constituent_makefile -out=$(cmt_local_InDetTrackingGeometry_optdebug_library_makefile) InDetTrackingGeometry_optdebug_library

InDetTrackingGeometry_optdebug_library :: $(InDetTrackingGeometry_optdebug_library_dependencies) $(cmt_local_InDetTrackingGeometry_optdebug_library_makefile) dirs InDetTrackingGeometry_optdebug_librarydirs
	$(echo) "(constituents.make) Starting InDetTrackingGeometry_optdebug_library"
	@if test -f $(cmt_local_InDetTrackingGeometry_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometry_optdebug_library_makefile) InDetTrackingGeometry_optdebug_library; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometry_optdebug_library_makefile) InDetTrackingGeometry_optdebug_library
	$(echo) "(constituents.make) InDetTrackingGeometry_optdebug_library done"

clean :: InDetTrackingGeometry_optdebug_libraryclean ;

InDetTrackingGeometry_optdebug_libraryclean :: $(InDetTrackingGeometry_optdebug_libraryclean_dependencies) ##$(cmt_local_InDetTrackingGeometry_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting InDetTrackingGeometry_optdebug_libraryclean"
	@-if test -f $(cmt_local_InDetTrackingGeometry_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometry_optdebug_library_makefile) InDetTrackingGeometry_optdebug_libraryclean; \
	fi
	$(echo) "(constituents.make) InDetTrackingGeometry_optdebug_libraryclean done"
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometry_optdebug_library_makefile) InDetTrackingGeometry_optdebug_libraryclean

##	  /bin/rm -f $(cmt_local_InDetTrackingGeometry_optdebug_library_makefile) $(bin)InDetTrackingGeometry_optdebug_library_dependencies.make

install :: InDetTrackingGeometry_optdebug_libraryinstall ;

InDetTrackingGeometry_optdebug_libraryinstall :: $(InDetTrackingGeometry_optdebug_library_dependencies) $(cmt_local_InDetTrackingGeometry_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_InDetTrackingGeometry_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometry_optdebug_library_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometry_optdebug_library_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : InDetTrackingGeometry_optdebug_libraryuninstall

$(foreach d,$(InDetTrackingGeometry_optdebug_library_dependencies),$(eval $(d)uninstall_dependencies += InDetTrackingGeometry_optdebug_libraryuninstall))

InDetTrackingGeometry_optdebug_libraryuninstall : $(InDetTrackingGeometry_optdebug_libraryuninstall_dependencies) ##$(cmt_local_InDetTrackingGeometry_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_InDetTrackingGeometry_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometry_optdebug_library_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometry_optdebug_library_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: InDetTrackingGeometry_optdebug_libraryuninstall ;
...
InDetTrackingGeometryCLIDDB_extratags = -tag_add=target_InDetTrackingGeometryCLIDDB
...
not_InDetTrackingGeometryCLIDDB_dependencies = { n=0; for p in $?; do m=0; for d in $(InDetTrackingGeometryCLIDDB_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
InDetTrackingGeometryCLIDDBdirs :
	@if test ! -d $(bin)InDetTrackingGeometryCLIDDB; then $(mkdir) -p $(bin)InDetTrackingGeometryCLIDDB; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)InDetTrackingGeometryCLIDDB
else
InDetTrackingGeometryCLIDDBdirs : ;
endif
...
ifndef QUICK
$(cmt_local_InDetTrackingGeometryCLIDDB_makefile) : $(InDetTrackingGeometryCLIDDB_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometryCLIDDB.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryCLIDDB_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometryCLIDDB_makefile) InDetTrackingGeometryCLIDDB
else
$(cmt_local_InDetTrackingGeometryCLIDDB_makefile) : $(InDetTrackingGeometryCLIDDB_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometryCLIDDB) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometryCLIDDB) ] || \
	  $(not_InDetTrackingGeometryCLIDDB_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building InDetTrackingGeometryCLIDDB.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryCLIDDB_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometryCLIDDB_makefile) InDetTrackingGeometryCLIDDB; \
	  fi
endif
...
$(cmt_local_InDetTrackingGeometryCLIDDB_makefile) : $(InDetTrackingGeometryCLIDDB_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometryCLIDDB.make"; \
	  $(cmtexe) -f=$(bin)InDetTrackingGeometryCLIDDB.in -tag=$(tags) $(InDetTrackingGeometryCLIDDB_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_InDetTrackingGeometryCLIDDB_makefile) InDetTrackingGeometryCLIDDB
else
$(cmt_local_InDetTrackingGeometryCLIDDB_makefile) : $(InDetTrackingGeometryCLIDDB_dependencies) $(cmt_build_library_linksstamp) $(bin)InDetTrackingGeometryCLIDDB.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometryCLIDDB) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometryCLIDDB) ] || \
	  $(not_InDetTrackingGeometryCLIDDB_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryCLIDDB_extratags) build constituent_makefile -out=$(cmt_local_InDetTrackingGeometryCLIDDB_makefile) InDetTrackingGeometryCLIDDB

InDetTrackingGeometryCLIDDB :: $(InDetTrackingGeometryCLIDDB_dependencies) $(cmt_local_InDetTrackingGeometryCLIDDB_makefile) dirs InDetTrackingGeometryCLIDDBdirs
	$(echo) "(constituents.make) Starting InDetTrackingGeometryCLIDDB"
	@if test -f $(cmt_local_InDetTrackingGeometryCLIDDB_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryCLIDDB_makefile) InDetTrackingGeometryCLIDDB; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometryCLIDDB_makefile) InDetTrackingGeometryCLIDDB
	$(echo) "(constituents.make) InDetTrackingGeometryCLIDDB done"

clean :: InDetTrackingGeometryCLIDDBclean ;

InDetTrackingGeometryCLIDDBclean :: $(InDetTrackingGeometryCLIDDBclean_dependencies) ##$(cmt_local_InDetTrackingGeometryCLIDDB_makefile)
	$(echo) "(constituents.make) Starting InDetTrackingGeometryCLIDDBclean"
	@-if test -f $(cmt_local_InDetTrackingGeometryCLIDDB_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryCLIDDB_makefile) InDetTrackingGeometryCLIDDBclean; \
	fi
	$(echo) "(constituents.make) InDetTrackingGeometryCLIDDBclean done"
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometryCLIDDB_makefile) InDetTrackingGeometryCLIDDBclean

##	  /bin/rm -f $(cmt_local_InDetTrackingGeometryCLIDDB_makefile) $(bin)InDetTrackingGeometryCLIDDB_dependencies.make

install :: InDetTrackingGeometryCLIDDBinstall ;

InDetTrackingGeometryCLIDDBinstall :: $(InDetTrackingGeometryCLIDDB_dependencies) $(cmt_local_InDetTrackingGeometryCLIDDB_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_InDetTrackingGeometryCLIDDB_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryCLIDDB_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometryCLIDDB_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : InDetTrackingGeometryCLIDDBuninstall

$(foreach d,$(InDetTrackingGeometryCLIDDB_dependencies),$(eval $(d)uninstall_dependencies += InDetTrackingGeometryCLIDDBuninstall))

InDetTrackingGeometryCLIDDBuninstall : $(InDetTrackingGeometryCLIDDBuninstall_dependencies) ##$(cmt_local_InDetTrackingGeometryCLIDDB_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_InDetTrackingGeometryCLIDDB_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryCLIDDB_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometryCLIDDB_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: InDetTrackingGeometryCLIDDBuninstall ;
...
cmt_InDetTrackingGeometryrchk_has_target_tag = 1

#--------------------------------------

ifdef cmt_InDetTrackingGeometryrchk_has_target_tag

cmt_local_tagfile_InDetTrackingGeometryrchk = $(bin)$(InDetTrackingGeometry_tag)_InDetTrackingGeometryrchk.make
cmt_final_setup_InDetTrackingGeometryrchk = $(bin)setup_InDetTrackingGeometryrchk.make
cmt_local_InDetTrackingGeometryrchk_makefile = $(bin)InDetTrackingGeometryrchk.make

InDetTrackingGeometryrchk_extratags = -tag_add=target_InDetTrackingGeometryrchk

else

cmt_local_tagfile_InDetTrackingGeometryrchk = $(bin)$(InDetTrackingGeometry_tag).make
cmt_final_setup_InDetTrackingGeometryrchk = $(bin)setup.make
cmt_local_InDetTrackingGeometryrchk_makefile = $(bin)InDetTrackingGeometryrchk.make

endif

not_InDetTrackingGeometryrchk_dependencies = { n=0; for p in $?; do m=0; for d in $(InDetTrackingGeometryrchk_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
InDetTrackingGeometryrchkdirs :
	@if test ! -d $(bin)InDetTrackingGeometryrchk; then $(mkdir) -p $(bin)InDetTrackingGeometryrchk; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)InDetTrackingGeometryrchk
else
InDetTrackingGeometryrchkdirs : ;
endif
...
ifndef QUICK
$(cmt_local_InDetTrackingGeometryrchk_makefile) : $(InDetTrackingGeometryrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometryrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryrchk_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometryrchk_makefile) InDetTrackingGeometryrchk
else
$(cmt_local_InDetTrackingGeometryrchk_makefile) : $(InDetTrackingGeometryrchk_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometryrchk) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometryrchk) ] || \
	  $(not_InDetTrackingGeometryrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building InDetTrackingGeometryrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryrchk_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometryrchk_makefile) InDetTrackingGeometryrchk; \
	  fi
endif
...
$(cmt_local_InDetTrackingGeometryrchk_makefile) : $(InDetTrackingGeometryrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometryrchk.make"; \
	  $(cmtexe) -f=$(bin)InDetTrackingGeometryrchk.in -tag=$(tags) $(InDetTrackingGeometryrchk_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_InDetTrackingGeometryrchk_makefile) InDetTrackingGeometryrchk
else
$(cmt_local_InDetTrackingGeometryrchk_makefile) : $(InDetTrackingGeometryrchk_dependencies) $(cmt_build_library_linksstamp) $(bin)InDetTrackingGeometryrchk.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometryrchk) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometryrchk) ] || \
	  $(not_InDetTrackingGeometryrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometryrchk_extratags) build constituent_makefile -out=$(cmt_local_InDetTrackingGeometryrchk_makefile) InDetTrackingGeometryrchk

InDetTrackingGeometryrchk :: $(InDetTrackingGeometryrchk_dependencies) $(cmt_local_InDetTrackingGeometryrchk_makefile) dirs InDetTrackingGeometryrchkdirs
	$(echo) "(constituents.make) Starting InDetTrackingGeometryrchk"
	@if test -f $(cmt_local_InDetTrackingGeometryrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryrchk_makefile) InDetTrackingGeometryrchk; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometryrchk_makefile) InDetTrackingGeometryrchk
	$(echo) "(constituents.make) InDetTrackingGeometryrchk done"

clean :: InDetTrackingGeometryrchkclean ;

InDetTrackingGeometryrchkclean :: $(InDetTrackingGeometryrchkclean_dependencies) ##$(cmt_local_InDetTrackingGeometryrchk_makefile)
	$(echo) "(constituents.make) Starting InDetTrackingGeometryrchkclean"
	@-if test -f $(cmt_local_InDetTrackingGeometryrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryrchk_makefile) InDetTrackingGeometryrchkclean; \
	fi
	$(echo) "(constituents.make) InDetTrackingGeometryrchkclean done"
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometryrchk_makefile) InDetTrackingGeometryrchkclean

##	  /bin/rm -f $(cmt_local_InDetTrackingGeometryrchk_makefile) $(bin)InDetTrackingGeometryrchk_dependencies.make

install :: InDetTrackingGeometryrchkinstall ;

InDetTrackingGeometryrchkinstall :: $(InDetTrackingGeometryrchk_dependencies) $(cmt_local_InDetTrackingGeometryrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_InDetTrackingGeometryrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryrchk_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometryrchk_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : InDetTrackingGeometryrchkuninstall

$(foreach d,$(InDetTrackingGeometryrchk_dependencies),$(eval $(d)uninstall_dependencies += InDetTrackingGeometryrchkuninstall))

InDetTrackingGeometryrchkuninstall : $(InDetTrackingGeometryrchkuninstall_dependencies) ##$(cmt_local_InDetTrackingGeometryrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_InDetTrackingGeometryrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometryrchk_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometryrchk_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: InDetTrackingGeometryrchkuninstall ;
...
cmt_local_tagfile_install_root_include_path = $(bin)$(InDetTrackingGeometry_tag)_install_root_include_path.make
...
cmt_local_tagfile_install_root_include_path = $(bin)$(InDetTrackingGeometry_tag).make
...
cmt_local_tagfile_install_includes = $(bin)$(InDetTrackingGeometry_tag)_install_includes.make
...
cmt_local_tagfile_install_includes = $(bin)$(InDetTrackingGeometry_tag).make
...
cmt_local_tagfile_make = $(bin)$(InDetTrackingGeometry_tag)_make.make
...
cmt_local_tagfile_make = $(bin)$(InDetTrackingGeometry_tag).make
...
cmt_local_tagfile_CompilePython = $(bin)$(InDetTrackingGeometry_tag)_CompilePython.make
...
cmt_local_tagfile_CompilePython = $(bin)$(InDetTrackingGeometry_tag).make
...
cmt_local_tagfile_qmtest_run = $(bin)$(InDetTrackingGeometry_tag)_qmtest_run.make
...
cmt_local_tagfile_qmtest_run = $(bin)$(InDetTrackingGeometry_tag).make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(InDetTrackingGeometry_tag)_qmtest_summarize.make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(InDetTrackingGeometry_tag).make
...
cmt_local_tagfile_TestPackage = $(bin)$(InDetTrackingGeometry_tag)_TestPackage.make
...
cmt_local_tagfile_TestPackage = $(bin)$(InDetTrackingGeometry_tag).make
...
cmt_local_tagfile_TestProject = $(bin)$(InDetTrackingGeometry_tag)_TestProject.make
...
cmt_local_tagfile_TestProject = $(bin)$(InDetTrackingGeometry_tag).make
...
cmt_local_tagfile_new_rootsys = $(bin)$(InDetTrackingGeometry_tag)_new_rootsys.make
...
cmt_local_tagfile_new_rootsys = $(bin)$(InDetTrackingGeometry_tag).make
...
cmt_local_tagfile_doxygen = $(bin)$(InDetTrackingGeometry_tag)_doxygen.make
...
cmt_local_tagfile_doxygen = $(bin)$(InDetTrackingGeometry_tag).make
...
cmt_local_tagfile_post_install = $(bin)$(InDetTrackingGeometry_tag)_post_install.make
...
cmt_local_tagfile_post_install = $(bin)$(InDetTrackingGeometry_tag).make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(InDetTrackingGeometry_tag)_post_merge_rootmap.make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(InDetTrackingGeometry_tag).make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(InDetTrackingGeometry_tag)_post_merge_genconfdb.make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(InDetTrackingGeometry_tag).make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(InDetTrackingGeometry_tag)_post_build_tpcnvdb.make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(InDetTrackingGeometry_tag).make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(InDetTrackingGeometry_tag)_all_post_constituents.make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(InDetTrackingGeometry_tag).make
...
cmt_local_tagfile_checkreq = $(bin)$(InDetTrackingGeometry_tag)_checkreq.make
...
cmt_local_tagfile_checkreq = $(bin)$(InDetTrackingGeometry_tag).make
...
cmt_InDetTrackingGeometry_NICOS_Fix_debuginfo_has_no_target_tag = 1

#--------------------------------------

ifdef cmt_InDetTrackingGeometry_NICOS_Fix_debuginfo_has_target_tag

cmt_local_tagfile_InDetTrackingGeometry_NICOS_Fix_debuginfo = $(bin)$(InDetTrackingGeometry_tag)_InDetTrackingGeometry_NICOS_Fix_debuginfo.make
cmt_final_setup_InDetTrackingGeometry_NICOS_Fix_debuginfo = $(bin)setup_InDetTrackingGeometry_NICOS_Fix_debuginfo.make
cmt_local_InDetTrackingGeometry_NICOS_Fix_debuginfo_makefile = $(bin)InDetTrackingGeometry_NICOS_Fix_debuginfo.make

InDetTrackingGeometry_NICOS_Fix_debuginfo_extratags = -tag_add=target_InDetTrackingGeometry_NICOS_Fix_debuginfo

else

cmt_local_tagfile_InDetTrackingGeometry_NICOS_Fix_debuginfo = $(bin)$(InDetTrackingGeometry_tag).make
cmt_final_setup_InDetTrackingGeometry_NICOS_Fix_debuginfo = $(bin)setup.make
cmt_local_InDetTrackingGeometry_NICOS_Fix_debuginfo_makefile = $(bin)InDetTrackingGeometry_NICOS_Fix_debuginfo.make

endif

not_InDetTrackingGeometry_NICOS_Fix_debuginfo_dependencies = { n=0; for p in $?; do m=0; for d in $(InDetTrackingGeometry_NICOS_Fix_debuginfo_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
InDetTrackingGeometry_NICOS_Fix_debuginfodirs :
	@if test ! -d $(bin)InDetTrackingGeometry_NICOS_Fix_debuginfo; then $(mkdir) -p $(bin)InDetTrackingGeometry_NICOS_Fix_debuginfo; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)InDetTrackingGeometry_NICOS_Fix_debuginfo
else
InDetTrackingGeometry_NICOS_Fix_debuginfodirs : ;
endif
...
ifndef QUICK
$(cmt_local_InDetTrackingGeometry_NICOS_Fix_debuginfo_makefile) : $(InDetTrackingGeometry_NICOS_Fix_debuginfo_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometry_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometry_NICOS_Fix_debuginfo_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometry_NICOS_Fix_debuginfo_makefile) InDetTrackingGeometry_NICOS_Fix_debuginfo
else
$(cmt_local_InDetTrackingGeometry_NICOS_Fix_debuginfo_makefile) : $(InDetTrackingGeometry_NICOS_Fix_debuginfo_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometry_NICOS_Fix_debuginfo) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometry_NICOS_Fix_debuginfo) ] || \
	  $(not_InDetTrackingGeometry_NICOS_Fix_debuginfo_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building InDetTrackingGeometry_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometry_NICOS_Fix_debuginfo_extratags) build constituent_config -out=$(cmt_local_InDetTrackingGeometry_NICOS_Fix_debuginfo_makefile) InDetTrackingGeometry_NICOS_Fix_debuginfo; \
	  fi
endif
...
$(cmt_local_InDetTrackingGeometry_NICOS_Fix_debuginfo_makefile) : $(InDetTrackingGeometry_NICOS_Fix_debuginfo_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetTrackingGeometry_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -f=$(bin)InDetTrackingGeometry_NICOS_Fix_debuginfo.in -tag=$(tags) $(InDetTrackingGeometry_NICOS_Fix_debuginfo_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_InDetTrackingGeometry_NICOS_Fix_debuginfo_makefile) InDetTrackingGeometry_NICOS_Fix_debuginfo
else
$(cmt_local_InDetTrackingGeometry_NICOS_Fix_debuginfo_makefile) : $(InDetTrackingGeometry_NICOS_Fix_debuginfo_dependencies) $(cmt_build_library_linksstamp) $(bin)InDetTrackingGeometry_NICOS_Fix_debuginfo.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetTrackingGeometry_NICOS_Fix_debuginfo) ] || \
	  [ ! -f $(cmt_final_setup_InDetTrackingGeometry_NICOS_Fix_debuginfo) ] || \
	  $(not_InDetTrackingGeometry_NICOS_Fix_debuginfo_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(InDetTrackingGeometry_NICOS_Fix_debuginfo_extratags) build constituent_makefile -out=$(cmt_local_InDetTrackingGeometry_NICOS_Fix_debuginfo_makefile) InDetTrackingGeometry_NICOS_Fix_debuginfo

InDetTrackingGeometry_NICOS_Fix_debuginfo :: $(InDetTrackingGeometry_NICOS_Fix_debuginfo_dependencies) $(cmt_local_InDetTrackingGeometry_NICOS_Fix_debuginfo_makefile) dirs InDetTrackingGeometry_NICOS_Fix_debuginfodirs
	$(echo) "(constituents.make) Starting InDetTrackingGeometry_NICOS_Fix_debuginfo"
	@if test -f $(cmt_local_InDetTrackingGeometry_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometry_NICOS_Fix_debuginfo_makefile) InDetTrackingGeometry_NICOS_Fix_debuginfo; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometry_NICOS_Fix_debuginfo_makefile) InDetTrackingGeometry_NICOS_Fix_debuginfo
	$(echo) "(constituents.make) InDetTrackingGeometry_NICOS_Fix_debuginfo done"

clean :: InDetTrackingGeometry_NICOS_Fix_debuginfoclean ;

InDetTrackingGeometry_NICOS_Fix_debuginfoclean :: $(InDetTrackingGeometry_NICOS_Fix_debuginfoclean_dependencies) ##$(cmt_local_InDetTrackingGeometry_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting InDetTrackingGeometry_NICOS_Fix_debuginfoclean"
	@-if test -f $(cmt_local_InDetTrackingGeometry_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometry_NICOS_Fix_debuginfo_makefile) InDetTrackingGeometry_NICOS_Fix_debuginfoclean; \
	fi
	$(echo) "(constituents.make) InDetTrackingGeometry_NICOS_Fix_debuginfoclean done"
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometry_NICOS_Fix_debuginfo_makefile) InDetTrackingGeometry_NICOS_Fix_debuginfoclean

##	  /bin/rm -f $(cmt_local_InDetTrackingGeometry_NICOS_Fix_debuginfo_makefile) $(bin)InDetTrackingGeometry_NICOS_Fix_debuginfo_dependencies.make

install :: InDetTrackingGeometry_NICOS_Fix_debuginfoinstall ;

InDetTrackingGeometry_NICOS_Fix_debuginfoinstall :: $(InDetTrackingGeometry_NICOS_Fix_debuginfo_dependencies) $(cmt_local_InDetTrackingGeometry_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_InDetTrackingGeometry_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometry_NICOS_Fix_debuginfo_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_InDetTrackingGeometry_NICOS_Fix_debuginfo_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : InDetTrackingGeometry_NICOS_Fix_debuginfouninstall

$(foreach d,$(InDetTrackingGeometry_NICOS_Fix_debuginfo_dependencies),$(eval $(d)uninstall_dependencies += InDetTrackingGeometry_NICOS_Fix_debuginfouninstall))

InDetTrackingGeometry_NICOS_Fix_debuginfouninstall : $(InDetTrackingGeometry_NICOS_Fix_debuginfouninstall_dependencies) ##$(cmt_local_InDetTrackingGeometry_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_InDetTrackingGeometry_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetTrackingGeometry_NICOS_Fix_debuginfo_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetTrackingGeometry_NICOS_Fix_debuginfo_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: InDetTrackingGeometry_NICOS_Fix_debuginfouninstall ;
...
cmt_local_tagfile_check_install_python_modules = $(bin)$(InDetTrackingGeometry_tag)_check_install_python_modules.make
...
cmt_local_tagfile_check_install_python_modules = $(bin)$(InDetTrackingGeometry_tag).make
...
cmt_local_tagfile_find_packages = $(bin)$(InDetTrackingGeometry_tag)_find_packages.make
...
cmt_local_tagfile_find_packages = $(bin)$(InDetTrackingGeometry_tag).make
...
cmt_local_tagfile_compile = $(bin)$(InDetTrackingGeometry_tag)_compile.make
...
cmt_local_tagfile_compile = $(bin)$(InDetTrackingGeometry_tag).make
...
cmt_local_tagfile_compile_pkg = $(bin)$(InDetTrackingGeometry_tag)_compile_pkg.make
...
cmt_local_tagfile_compile_pkg = $(bin)$(InDetTrackingGeometry_tag).make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(InDetTrackingGeometry_tag)_new_analysisapp.make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(InDetTrackingGeometry_tag).make
...
cmt_local_tagfile_new_pkg = $(bin)$(InDetTrackingGeometry_tag)_new_pkg.make
...
cmt_local_tagfile_new_pkg = $(bin)$(InDetTrackingGeometry_tag).make
...
cmt_local_tagfile_new_alg = $(bin)$(InDetTrackingGeometry_tag)_new_alg.make
...
cmt_local_tagfile_new_alg = $(bin)$(InDetTrackingGeometry_tag).make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(InDetTrackingGeometry_tag)_new_analysisalg.make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(InDetTrackingGeometry_tag).make
...
cmt_local_tagfile_new_asgtool = $(bin)$(InDetTrackingGeometry_tag)_new_asgtool.make
...
cmt_local_tagfile_new_asgtool = $(bin)$(InDetTrackingGeometry_tag).make
...
cmt_local_tagfile_new_jobo = $(bin)$(InDetTrackingGeometry_tag)_new_jobo.make
...
cmt_local_tagfile_new_jobo = $(bin)$(InDetTrackingGeometry_tag).make
...
cmt_local_tagfile_new_skeleton = $(bin)$(InDetTrackingGeometry_tag)_new_skeleton.make
...
cmt_local_tagfile_new_skeleton = $(bin)$(InDetTrackingGeometry_tag).make
...
cmt_local_tagfile_make_skeleton = $(bin)$(InDetTrackingGeometry_tag)_make_skeleton.make
...
cmt_local_tagfile_make_skeleton = $(bin)$(InDetTrackingGeometry_tag).make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(InDetTrackingGeometry_tag)_checkout_pkg.make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(InDetTrackingGeometry_tag).make
...
cmt_local_tagfile_cppcheck = $(bin)$(InDetTrackingGeometry_tag)_cppcheck.make
...
cmt_local_tagfile_cppcheck = $(bin)$(InDetTrackingGeometry_tag).make
