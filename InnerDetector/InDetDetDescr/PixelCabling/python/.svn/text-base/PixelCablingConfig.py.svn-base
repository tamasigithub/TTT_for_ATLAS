    ...
    # Offline mode
        ...
        if (globalflags.DataSource() == 'geant4'):
            ...
            if geoFlags.isSLHC():
                ...
                if "BrlInclOptRing4.0_ref" == geoFlags.GeoType():
                    IdMappingDat = "ITk_Atlas_IdMapping_InclBrl4_OptRing.dat"
                elif "BrlIncl4.0_ref" == geoFlags.GeoType():
