...
#cmt_local_tagfile = $(InDetReadoutGeometry_tag).make
cmt_local_tagfile = $(bin)$(InDetReadoutGeometry_tag).make
...
InDetReadoutGeometry_extratags = -tag_add=target_InDetReadoutGeometry
...
not_InDetReadoutGeometry_dependencies = { n=0; for p in $?; do m=0; for d in $(InDetReadoutGeometry_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
InDetReadoutGeometrydirs :
	@if test ! -d $(bin)InDetReadoutGeometry; then $(mkdir) -p $(bin)InDetReadoutGeometry; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)InDetReadoutGeometry
else
InDetReadoutGeometrydirs : ;
endif
...
ifndef QUICK
$(cmt_local_InDetReadoutGeometry_makefile) : $(InDetReadoutGeometry_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetReadoutGeometry.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetReadoutGeometry_extratags) build constituent_config -out=$(cmt_local_InDetReadoutGeometry_makefile) InDetReadoutGeometry
else
$(cmt_local_InDetReadoutGeometry_makefile) : $(InDetReadoutGeometry_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetReadoutGeometry) ] || \
	  [ ! -f $(cmt_final_setup_InDetReadoutGeometry) ] || \
	  $(not_InDetReadoutGeometry_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building InDetReadoutGeometry.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetReadoutGeometry_extratags) build constituent_config -out=$(cmt_local_InDetReadoutGeometry_makefile) InDetReadoutGeometry; \
	  fi
endif
...
$(cmt_local_InDetReadoutGeometry_makefile) : $(InDetReadoutGeometry_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetReadoutGeometry.make"; \
	  $(cmtexe) -f=$(bin)InDetReadoutGeometry.in -tag=$(tags) $(InDetReadoutGeometry_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_InDetReadoutGeometry_makefile) InDetReadoutGeometry
else
$(cmt_local_InDetReadoutGeometry_makefile) : $(InDetReadoutGeometry_dependencies) $(cmt_build_library_linksstamp) $(bin)InDetReadoutGeometry.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetReadoutGeometry) ] || \
	  [ ! -f $(cmt_final_setup_InDetReadoutGeometry) ] || \
	  $(not_InDetReadoutGeometry_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(InDetReadoutGeometry_extratags) build constituent_makefile -out=$(cmt_local_InDetReadoutGeometry_makefile) InDetReadoutGeometry

InDetReadoutGeometry :: $(InDetReadoutGeometry_dependencies) $(cmt_local_InDetReadoutGeometry_makefile) dirs InDetReadoutGeometrydirs
	$(echo) "(constituents.make) Starting InDetReadoutGeometry"
	@if test -f $(cmt_local_InDetReadoutGeometry_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetReadoutGeometry_makefile) InDetReadoutGeometry; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetReadoutGeometry_makefile) InDetReadoutGeometry
	$(echo) "(constituents.make) InDetReadoutGeometry done"

clean :: InDetReadoutGeometryclean ;

InDetReadoutGeometryclean :: $(InDetReadoutGeometryclean_dependencies) ##$(cmt_local_InDetReadoutGeometry_makefile)
	$(echo) "(constituents.make) Starting InDetReadoutGeometryclean"
	@-if test -f $(cmt_local_InDetReadoutGeometry_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetReadoutGeometry_makefile) InDetReadoutGeometryclean; \
	fi
	$(echo) "(constituents.make) InDetReadoutGeometryclean done"
#	@-$(MAKE) -f $(cmt_local_InDetReadoutGeometry_makefile) InDetReadoutGeometryclean

##	  /bin/rm -f $(cmt_local_InDetReadoutGeometry_makefile) $(bin)InDetReadoutGeometry_dependencies.make

install :: InDetReadoutGeometryinstall ;

InDetReadoutGeometryinstall :: $(InDetReadoutGeometry_dependencies) $(cmt_local_InDetReadoutGeometry_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_InDetReadoutGeometry_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetReadoutGeometry_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_InDetReadoutGeometry_makefile) install
...
$(foreach d,$(InDetReadoutGeometry_dependencies),$(eval $(d)uninstall_dependencies += InDetReadoutGeometryuninstall))

InDetReadoutGeometryuninstall : $(InDetReadoutGeometryuninstall_dependencies) ##$(cmt_local_InDetReadoutGeometry_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_InDetReadoutGeometry_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetReadoutGeometry_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetReadoutGeometry_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: InDetReadoutGeometryuninstall ;
...
InDetReadoutGeometry_optdebug_library_extratags = -tag_add=target_InDetReadoutGeometry_optdebug_library
...
not_InDetReadoutGeometry_optdebug_library_dependencies = { n=0; for p in $?; do m=0; for d in $(InDetReadoutGeometry_optdebug_library_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
InDetReadoutGeometry_optdebug_librarydirs :
	@if test ! -d $(bin)InDetReadoutGeometry_optdebug_library; then $(mkdir) -p $(bin)InDetReadoutGeometry_optdebug_library; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)InDetReadoutGeometry_optdebug_library
else
InDetReadoutGeometry_optdebug_librarydirs : ;
endif
...
ifndef QUICK
$(cmt_local_InDetReadoutGeometry_optdebug_library_makefile) : $(InDetReadoutGeometry_optdebug_library_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetReadoutGeometry_optdebug_library.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetReadoutGeometry_optdebug_library_extratags) build constituent_config -out=$(cmt_local_InDetReadoutGeometry_optdebug_library_makefile) InDetReadoutGeometry_optdebug_library
else
$(cmt_local_InDetReadoutGeometry_optdebug_library_makefile) : $(InDetReadoutGeometry_optdebug_library_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetReadoutGeometry_optdebug_library) ] || \
	  [ ! -f $(cmt_final_setup_InDetReadoutGeometry_optdebug_library) ] || \
	  $(not_InDetReadoutGeometry_optdebug_library_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building InDetReadoutGeometry_optdebug_library.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetReadoutGeometry_optdebug_library_extratags) build constituent_config -out=$(cmt_local_InDetReadoutGeometry_optdebug_library_makefile) InDetReadoutGeometry_optdebug_library; \
	  fi
endif
...
$(cmt_local_InDetReadoutGeometry_optdebug_library_makefile) : $(InDetReadoutGeometry_optdebug_library_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetReadoutGeometry_optdebug_library.make"; \
	  $(cmtexe) -f=$(bin)InDetReadoutGeometry_optdebug_library.in -tag=$(tags) $(InDetReadoutGeometry_optdebug_library_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_InDetReadoutGeometry_optdebug_library_makefile) InDetReadoutGeometry_optdebug_library
else
$(cmt_local_InDetReadoutGeometry_optdebug_library_makefile) : $(InDetReadoutGeometry_optdebug_library_dependencies) $(cmt_build_library_linksstamp) $(bin)InDetReadoutGeometry_optdebug_library.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetReadoutGeometry_optdebug_library) ] || \
	  [ ! -f $(cmt_final_setup_InDetReadoutGeometry_optdebug_library) ] || \
	  $(not_InDetReadoutGeometry_optdebug_library_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(InDetReadoutGeometry_optdebug_library_extratags) build constituent_makefile -out=$(cmt_local_InDetReadoutGeometry_optdebug_library_makefile) InDetReadoutGeometry_optdebug_library

InDetReadoutGeometry_optdebug_library :: $(InDetReadoutGeometry_optdebug_library_dependencies) $(cmt_local_InDetReadoutGeometry_optdebug_library_makefile) dirs InDetReadoutGeometry_optdebug_librarydirs
	$(echo) "(constituents.make) Starting InDetReadoutGeometry_optdebug_library"
	@if test -f $(cmt_local_InDetReadoutGeometry_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetReadoutGeometry_optdebug_library_makefile) InDetReadoutGeometry_optdebug_library; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetReadoutGeometry_optdebug_library_makefile) InDetReadoutGeometry_optdebug_library
	$(echo) "(constituents.make) InDetReadoutGeometry_optdebug_library done"

clean :: InDetReadoutGeometry_optdebug_libraryclean ;

InDetReadoutGeometry_optdebug_libraryclean :: $(InDetReadoutGeometry_optdebug_libraryclean_dependencies) ##$(cmt_local_InDetReadoutGeometry_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting InDetReadoutGeometry_optdebug_libraryclean"
	@-if test -f $(cmt_local_InDetReadoutGeometry_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetReadoutGeometry_optdebug_library_makefile) InDetReadoutGeometry_optdebug_libraryclean; \
	fi
	$(echo) "(constituents.make) InDetReadoutGeometry_optdebug_libraryclean done"
#	@-$(MAKE) -f $(cmt_local_InDetReadoutGeometry_optdebug_library_makefile) InDetReadoutGeometry_optdebug_libraryclean

##	  /bin/rm -f $(cmt_local_InDetReadoutGeometry_optdebug_library_makefile) $(bin)InDetReadoutGeometry_optdebug_library_dependencies.make

install :: InDetReadoutGeometry_optdebug_libraryinstall ;

InDetReadoutGeometry_optdebug_libraryinstall :: $(InDetReadoutGeometry_optdebug_library_dependencies) $(cmt_local_InDetReadoutGeometry_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_InDetReadoutGeometry_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetReadoutGeometry_optdebug_library_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_InDetReadoutGeometry_optdebug_library_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(InDetReadoutGeometry_optdebug_library_dependencies),$(eval $(d)uninstall_dependencies += InDetReadoutGeometry_optdebug_libraryuninstall))

InDetReadoutGeometry_optdebug_libraryuninstall : $(InDetReadoutGeometry_optdebug_libraryuninstall_dependencies) ##$(cmt_local_InDetReadoutGeometry_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_InDetReadoutGeometry_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetReadoutGeometry_optdebug_library_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetReadoutGeometry_optdebug_library_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: InDetReadoutGeometry_optdebug_libraryuninstall ;
...
cmt_InDetReadoutGeometryrchk_has_target_tag = 1

#--------------------------------------

ifdef cmt_InDetReadoutGeometryrchk_has_target_tag

cmt_local_tagfile_InDetReadoutGeometryrchk = $(bin)$(InDetReadoutGeometry_tag)_InDetReadoutGeometryrchk.make
cmt_final_setup_InDetReadoutGeometryrchk = $(bin)setup_InDetReadoutGeometryrchk.make
cmt_local_InDetReadoutGeometryrchk_makefile = $(bin)InDetReadoutGeometryrchk.make

InDetReadoutGeometryrchk_extratags = -tag_add=target_InDetReadoutGeometryrchk

else

cmt_local_tagfile_InDetReadoutGeometryrchk = $(bin)$(InDetReadoutGeometry_tag).make
cmt_final_setup_InDetReadoutGeometryrchk = $(bin)setup.make
cmt_local_InDetReadoutGeometryrchk_makefile = $(bin)InDetReadoutGeometryrchk.make

endif

not_InDetReadoutGeometryrchk_dependencies = { n=0; for p in $?; do m=0; for d in $(InDetReadoutGeometryrchk_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
InDetReadoutGeometryrchkdirs :
	@if test ! -d $(bin)InDetReadoutGeometryrchk; then $(mkdir) -p $(bin)InDetReadoutGeometryrchk; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)InDetReadoutGeometryrchk
else
InDetReadoutGeometryrchkdirs : ;
endif
...
ifndef QUICK
$(cmt_local_InDetReadoutGeometryrchk_makefile) : $(InDetReadoutGeometryrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetReadoutGeometryrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetReadoutGeometryrchk_extratags) build constituent_config -out=$(cmt_local_InDetReadoutGeometryrchk_makefile) InDetReadoutGeometryrchk
else
$(cmt_local_InDetReadoutGeometryrchk_makefile) : $(InDetReadoutGeometryrchk_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetReadoutGeometryrchk) ] || \
	  [ ! -f $(cmt_final_setup_InDetReadoutGeometryrchk) ] || \
	  $(not_InDetReadoutGeometryrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building InDetReadoutGeometryrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetReadoutGeometryrchk_extratags) build constituent_config -out=$(cmt_local_InDetReadoutGeometryrchk_makefile) InDetReadoutGeometryrchk; \
	  fi
endif
...
$(cmt_local_InDetReadoutGeometryrchk_makefile) : $(InDetReadoutGeometryrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetReadoutGeometryrchk.make"; \
	  $(cmtexe) -f=$(bin)InDetReadoutGeometryrchk.in -tag=$(tags) $(InDetReadoutGeometryrchk_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_InDetReadoutGeometryrchk_makefile) InDetReadoutGeometryrchk
else
$(cmt_local_InDetReadoutGeometryrchk_makefile) : $(InDetReadoutGeometryrchk_dependencies) $(cmt_build_library_linksstamp) $(bin)InDetReadoutGeometryrchk.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetReadoutGeometryrchk) ] || \
	  [ ! -f $(cmt_final_setup_InDetReadoutGeometryrchk) ] || \
	  $(not_InDetReadoutGeometryrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(InDetReadoutGeometryrchk_extratags) build constituent_makefile -out=$(cmt_local_InDetReadoutGeometryrchk_makefile) InDetReadoutGeometryrchk

InDetReadoutGeometryrchk :: $(InDetReadoutGeometryrchk_dependencies) $(cmt_local_InDetReadoutGeometryrchk_makefile) dirs InDetReadoutGeometryrchkdirs
	$(echo) "(constituents.make) Starting InDetReadoutGeometryrchk"
	@if test -f $(cmt_local_InDetReadoutGeometryrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetReadoutGeometryrchk_makefile) InDetReadoutGeometryrchk; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetReadoutGeometryrchk_makefile) InDetReadoutGeometryrchk
	$(echo) "(constituents.make) InDetReadoutGeometryrchk done"

clean :: InDetReadoutGeometryrchkclean ;

InDetReadoutGeometryrchkclean :: $(InDetReadoutGeometryrchkclean_dependencies) ##$(cmt_local_InDetReadoutGeometryrchk_makefile)
	$(echo) "(constituents.make) Starting InDetReadoutGeometryrchkclean"
	@-if test -f $(cmt_local_InDetReadoutGeometryrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetReadoutGeometryrchk_makefile) InDetReadoutGeometryrchkclean; \
	fi
	$(echo) "(constituents.make) InDetReadoutGeometryrchkclean done"
#	@-$(MAKE) -f $(cmt_local_InDetReadoutGeometryrchk_makefile) InDetReadoutGeometryrchkclean

##	  /bin/rm -f $(cmt_local_InDetReadoutGeometryrchk_makefile) $(bin)InDetReadoutGeometryrchk_dependencies.make

install :: InDetReadoutGeometryrchkinstall ;

InDetReadoutGeometryrchkinstall :: $(InDetReadoutGeometryrchk_dependencies) $(cmt_local_InDetReadoutGeometryrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_InDetReadoutGeometryrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetReadoutGeometryrchk_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_InDetReadoutGeometryrchk_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : InDetReadoutGeometryrchkuninstall

$(foreach d,$(InDetReadoutGeometryrchk_dependencies),$(eval $(d)uninstall_dependencies += InDetReadoutGeometryrchkuninstall))

InDetReadoutGeometryrchkuninstall : $(InDetReadoutGeometryrchkuninstall_dependencies) ##$(cmt_local_InDetReadoutGeometryrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_InDetReadoutGeometryrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetReadoutGeometryrchk_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetReadoutGeometryrchk_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: InDetReadoutGeometryrchkuninstall ;
...
cmt_local_tagfile_install_root_include_path = $(bin)$(InDetReadoutGeometry_tag)_install_root_include_path.make
...
cmt_local_tagfile_install_root_include_path = $(bin)$(InDetReadoutGeometry_tag).make
...
cmt_local_tagfile_install_includes = $(bin)$(InDetReadoutGeometry_tag)_install_includes.make
...
cmt_local_tagfile_install_includes = $(bin)$(InDetReadoutGeometry_tag).make
...
cmt_local_tagfile_make = $(bin)$(InDetReadoutGeometry_tag)_make.make
...
cmt_local_tagfile_make = $(bin)$(InDetReadoutGeometry_tag).make
...
cmt_local_tagfile_CompilePython = $(bin)$(InDetReadoutGeometry_tag)_CompilePython.make
...
cmt_local_tagfile_CompilePython = $(bin)$(InDetReadoutGeometry_tag).make
...
cmt_local_tagfile_qmtest_run = $(bin)$(InDetReadoutGeometry_tag)_qmtest_run.make
...
cmt_local_tagfile_qmtest_run = $(bin)$(InDetReadoutGeometry_tag).make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(InDetReadoutGeometry_tag)_qmtest_summarize.make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(InDetReadoutGeometry_tag).make
...
cmt_local_tagfile_TestPackage = $(bin)$(InDetReadoutGeometry_tag)_TestPackage.make
...
cmt_local_tagfile_TestPackage = $(bin)$(InDetReadoutGeometry_tag).make
...
cmt_local_tagfile_TestProject = $(bin)$(InDetReadoutGeometry_tag)_TestProject.make
...
cmt_local_tagfile_TestProject = $(bin)$(InDetReadoutGeometry_tag).make
...
cmt_local_tagfile_new_rootsys = $(bin)$(InDetReadoutGeometry_tag)_new_rootsys.make
...
cmt_local_tagfile_new_rootsys = $(bin)$(InDetReadoutGeometry_tag).make
...
cmt_local_tagfile_doxygen = $(bin)$(InDetReadoutGeometry_tag)_doxygen.make
...
cmt_local_tagfile_doxygen = $(bin)$(InDetReadoutGeometry_tag).make
...
cmt_local_tagfile_post_install = $(bin)$(InDetReadoutGeometry_tag)_post_install.make
...
cmt_local_tagfile_post_install = $(bin)$(InDetReadoutGeometry_tag).make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(InDetReadoutGeometry_tag)_post_merge_rootmap.make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(InDetReadoutGeometry_tag).make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(InDetReadoutGeometry_tag)_post_merge_genconfdb.make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(InDetReadoutGeometry_tag).make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(InDetReadoutGeometry_tag)_post_build_tpcnvdb.make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(InDetReadoutGeometry_tag).make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(InDetReadoutGeometry_tag)_all_post_constituents.make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(InDetReadoutGeometry_tag).make
...
cmt_local_tagfile_checkreq = $(bin)$(InDetReadoutGeometry_tag)_checkreq.make
...
cmt_local_tagfile_checkreq = $(bin)$(InDetReadoutGeometry_tag).make
...
cmt_InDetReadoutGeometry_NICOS_Fix_debuginfo_has_no_target_tag = 1

#--------------------------------------

ifdef cmt_InDetReadoutGeometry_NICOS_Fix_debuginfo_has_target_tag

cmt_local_tagfile_InDetReadoutGeometry_NICOS_Fix_debuginfo = $(bin)$(InDetReadoutGeometry_tag)_InDetReadoutGeometry_NICOS_Fix_debuginfo.make
cmt_final_setup_InDetReadoutGeometry_NICOS_Fix_debuginfo = $(bin)setup_InDetReadoutGeometry_NICOS_Fix_debuginfo.make
cmt_local_InDetReadoutGeometry_NICOS_Fix_debuginfo_makefile = $(bin)InDetReadoutGeometry_NICOS_Fix_debuginfo.make

InDetReadoutGeometry_NICOS_Fix_debuginfo_extratags = -tag_add=target_InDetReadoutGeometry_NICOS_Fix_debuginfo

else

cmt_local_tagfile_InDetReadoutGeometry_NICOS_Fix_debuginfo = $(bin)$(InDetReadoutGeometry_tag).make
cmt_final_setup_InDetReadoutGeometry_NICOS_Fix_debuginfo = $(bin)setup.make
cmt_local_InDetReadoutGeometry_NICOS_Fix_debuginfo_makefile = $(bin)InDetReadoutGeometry_NICOS_Fix_debuginfo.make

endif

not_InDetReadoutGeometry_NICOS_Fix_debuginfo_dependencies = { n=0; for p in $?; do m=0; for d in $(InDetReadoutGeometry_NICOS_Fix_debuginfo_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
InDetReadoutGeometry_NICOS_Fix_debuginfodirs :
	@if test ! -d $(bin)InDetReadoutGeometry_NICOS_Fix_debuginfo; then $(mkdir) -p $(bin)InDetReadoutGeometry_NICOS_Fix_debuginfo; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)InDetReadoutGeometry_NICOS_Fix_debuginfo
else
InDetReadoutGeometry_NICOS_Fix_debuginfodirs : ;
endif
...
ifndef QUICK
$(cmt_local_InDetReadoutGeometry_NICOS_Fix_debuginfo_makefile) : $(InDetReadoutGeometry_NICOS_Fix_debuginfo_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetReadoutGeometry_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetReadoutGeometry_NICOS_Fix_debuginfo_extratags) build constituent_config -out=$(cmt_local_InDetReadoutGeometry_NICOS_Fix_debuginfo_makefile) InDetReadoutGeometry_NICOS_Fix_debuginfo
else
$(cmt_local_InDetReadoutGeometry_NICOS_Fix_debuginfo_makefile) : $(InDetReadoutGeometry_NICOS_Fix_debuginfo_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetReadoutGeometry_NICOS_Fix_debuginfo) ] || \
	  [ ! -f $(cmt_final_setup_InDetReadoutGeometry_NICOS_Fix_debuginfo) ] || \
	  $(not_InDetReadoutGeometry_NICOS_Fix_debuginfo_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building InDetReadoutGeometry_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -tag=$(tags) $(InDetReadoutGeometry_NICOS_Fix_debuginfo_extratags) build constituent_config -out=$(cmt_local_InDetReadoutGeometry_NICOS_Fix_debuginfo_makefile) InDetReadoutGeometry_NICOS_Fix_debuginfo; \
	  fi
endif
...
$(cmt_local_InDetReadoutGeometry_NICOS_Fix_debuginfo_makefile) : $(InDetReadoutGeometry_NICOS_Fix_debuginfo_dependencies) build_library_links
	$(echo) "(constituents.make) Building InDetReadoutGeometry_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -f=$(bin)InDetReadoutGeometry_NICOS_Fix_debuginfo.in -tag=$(tags) $(InDetReadoutGeometry_NICOS_Fix_debuginfo_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_InDetReadoutGeometry_NICOS_Fix_debuginfo_makefile) InDetReadoutGeometry_NICOS_Fix_debuginfo
else
$(cmt_local_InDetReadoutGeometry_NICOS_Fix_debuginfo_makefile) : $(InDetReadoutGeometry_NICOS_Fix_debuginfo_dependencies) $(cmt_build_library_linksstamp) $(bin)InDetReadoutGeometry_NICOS_Fix_debuginfo.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InDetReadoutGeometry_NICOS_Fix_debuginfo) ] || \
	  [ ! -f $(cmt_final_setup_InDetReadoutGeometry_NICOS_Fix_debuginfo) ] || \
	  $(not_InDetReadoutGeometry_NICOS_Fix_debuginfo_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(InDetReadoutGeometry_NICOS_Fix_debuginfo_extratags) build constituent_makefile -out=$(cmt_local_InDetReadoutGeometry_NICOS_Fix_debuginfo_makefile) InDetReadoutGeometry_NICOS_Fix_debuginfo

InDetReadoutGeometry_NICOS_Fix_debuginfo :: $(InDetReadoutGeometry_NICOS_Fix_debuginfo_dependencies) $(cmt_local_InDetReadoutGeometry_NICOS_Fix_debuginfo_makefile) dirs InDetReadoutGeometry_NICOS_Fix_debuginfodirs
	$(echo) "(constituents.make) Starting InDetReadoutGeometry_NICOS_Fix_debuginfo"
	@if test -f $(cmt_local_InDetReadoutGeometry_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetReadoutGeometry_NICOS_Fix_debuginfo_makefile) InDetReadoutGeometry_NICOS_Fix_debuginfo; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetReadoutGeometry_NICOS_Fix_debuginfo_makefile) InDetReadoutGeometry_NICOS_Fix_debuginfo
	$(echo) "(constituents.make) InDetReadoutGeometry_NICOS_Fix_debuginfo done"

clean :: InDetReadoutGeometry_NICOS_Fix_debuginfoclean ;

InDetReadoutGeometry_NICOS_Fix_debuginfoclean :: $(InDetReadoutGeometry_NICOS_Fix_debuginfoclean_dependencies) ##$(cmt_local_InDetReadoutGeometry_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting InDetReadoutGeometry_NICOS_Fix_debuginfoclean"
	@-if test -f $(cmt_local_InDetReadoutGeometry_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetReadoutGeometry_NICOS_Fix_debuginfo_makefile) InDetReadoutGeometry_NICOS_Fix_debuginfoclean; \
	fi
	$(echo) "(constituents.make) InDetReadoutGeometry_NICOS_Fix_debuginfoclean done"
#	@-$(MAKE) -f $(cmt_local_InDetReadoutGeometry_NICOS_Fix_debuginfo_makefile) InDetReadoutGeometry_NICOS_Fix_debuginfoclean

##	  /bin/rm -f $(cmt_local_InDetReadoutGeometry_NICOS_Fix_debuginfo_makefile) $(bin)InDetReadoutGeometry_NICOS_Fix_debuginfo_dependencies.make

install :: InDetReadoutGeometry_NICOS_Fix_debuginfoinstall ;

InDetReadoutGeometry_NICOS_Fix_debuginfoinstall :: $(InDetReadoutGeometry_NICOS_Fix_debuginfo_dependencies) $(cmt_local_InDetReadoutGeometry_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_InDetReadoutGeometry_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetReadoutGeometry_NICOS_Fix_debuginfo_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_InDetReadoutGeometry_NICOS_Fix_debuginfo_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : InDetReadoutGeometry_NICOS_Fix_debuginfouninstall

$(foreach d,$(InDetReadoutGeometry_NICOS_Fix_debuginfo_dependencies),$(eval $(d)uninstall_dependencies += InDetReadoutGeometry_NICOS_Fix_debuginfouninstall))

InDetReadoutGeometry_NICOS_Fix_debuginfouninstall : $(InDetReadoutGeometry_NICOS_Fix_debuginfouninstall_dependencies) ##$(cmt_local_InDetReadoutGeometry_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_InDetReadoutGeometry_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_InDetReadoutGeometry_NICOS_Fix_debuginfo_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_InDetReadoutGeometry_NICOS_Fix_debuginfo_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: InDetReadoutGeometry_NICOS_Fix_debuginfouninstall ;
...
cmt_local_tagfile_find_packages = $(bin)$(InDetReadoutGeometry_tag)_find_packages.make
...
cmt_local_tagfile_find_packages = $(bin)$(InDetReadoutGeometry_tag).make
...
cmt_local_tagfile_compile = $(bin)$(InDetReadoutGeometry_tag)_compile.make
...
cmt_local_tagfile_compile = $(bin)$(InDetReadoutGeometry_tag).make
...
cmt_local_tagfile_compile_pkg = $(bin)$(InDetReadoutGeometry_tag)_compile_pkg.make
...
cmt_local_tagfile_compile_pkg = $(bin)$(InDetReadoutGeometry_tag).make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(InDetReadoutGeometry_tag)_new_analysisapp.make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(InDetReadoutGeometry_tag).make
...
cmt_local_tagfile_new_pkg = $(bin)$(InDetReadoutGeometry_tag)_new_pkg.make
...
cmt_local_tagfile_new_pkg = $(bin)$(InDetReadoutGeometry_tag).make
...
cmt_local_tagfile_new_alg = $(bin)$(InDetReadoutGeometry_tag)_new_alg.make
...
cmt_local_tagfile_new_alg = $(bin)$(InDetReadoutGeometry_tag).make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(InDetReadoutGeometry_tag)_new_analysisalg.make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(InDetReadoutGeometry_tag).make
...
cmt_local_tagfile_new_asgtool = $(bin)$(InDetReadoutGeometry_tag)_new_asgtool.make
...
cmt_local_tagfile_new_asgtool = $(bin)$(InDetReadoutGeometry_tag).make
...
cmt_local_tagfile_new_jobo = $(bin)$(InDetReadoutGeometry_tag)_new_jobo.make
...
cmt_local_tagfile_new_jobo = $(bin)$(InDetReadoutGeometry_tag).make
...
cmt_local_tagfile_new_skeleton = $(bin)$(InDetReadoutGeometry_tag)_new_skeleton.make
...
cmt_local_tagfile_new_skeleton = $(bin)$(InDetReadoutGeometry_tag).make
...
cmt_local_tagfile_make_skeleton = $(bin)$(InDetReadoutGeometry_tag)_make_skeleton.make
...
cmt_local_tagfile_make_skeleton = $(bin)$(InDetReadoutGeometry_tag).make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(InDetReadoutGeometry_tag)_checkout_pkg.make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(InDetReadoutGeometry_tag).make
...
cmt_local_tagfile_cppcheck = $(bin)$(InDetReadoutGeometry_tag)_cppcheck.make
...
cmt_local_tagfile_cppcheck = $(bin)$(InDetReadoutGeometry_tag).make
