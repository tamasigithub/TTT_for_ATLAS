----------> uses
# use DetDescrConditions DetDescrConditions-* DetectorDescription/DetDescrCond (no_version_directory)
...
#       use CLIDSvc CLIDSvc-* Control (no_version_directory)
#       use DataModel DataModel-* Control (no_version_directory)
# use IdDictDetDescr IdDictDetDescr-* DetectorDescription (no_version_directory)
#   use AtlasPolicy AtlasPolicy-*  (no_version_directory)
...
#   use CLIDSvc CLIDSvc-* Control (no_version_directory)
# use TRT_ConditionsData TRT_ConditionsData-* InnerDetector/InDetConditions (no_version_directory)
#   use AtlasPolicy AtlasPolicy-*  (no_version_directory)
#   use GaudiInterface GaudiInterface-* External (no_version_directory)
#   use CLIDSvc CLIDSvc-* Control (no_version_directory)
#   use Identifier Identifier-* DetectorDescription (no_version_directory)
...
use IdDictDetDescr IdDictDetDescr-00-00-07 DetectorDescription (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasCore/20.20.10)
...
use DetDescrConditions DetDescrConditions-00-01-21-01 DetectorDescription/DetDescrCond (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasConditions/20.20.10)
use TRT_ConditionsData TRT_ConditionsData-00-00-52 InnerDetector/InDetConditions (/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.20.10/AtlasConditions/20.20.10)
...
no_pack_dist_check (from package InDetReadoutGeometry) applied [InDetReadoutGeometry]
----------> CMTPATH
