...
${CMTROOT}/${CMTBIN}/cmt.exe setup -csh -pack=InDetTrackingGeometryXML -version=InDetTrackingGeometryXML-00-00-73 -path=/nfs/dust/atlas/user/tkar/20.20.10.7/InnerDetector/InDetDetDescr  -no_cleanup $* >${cmtInDetTrackingGeometryXMLtempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe setup -csh -pack=InDetTrackingGeometryXML -version=InDetTrackingGeometryXML-00-00-73 -path=/nfs/dust/atlas/user/tkar/20.20.10.7/InnerDetector/InDetDetDescr  -no_cleanup $* >${cmtInDetTrackingGeometryXMLtempfile}"
