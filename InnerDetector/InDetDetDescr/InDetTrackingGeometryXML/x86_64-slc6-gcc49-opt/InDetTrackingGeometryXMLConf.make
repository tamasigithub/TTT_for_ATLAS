...
InDetTrackingGeometryXMLConfinstall : /afs/cern.ch/work/t/tkar/testarea/20.20.10.7/InnerDetector/InDetDetDescr/InDetTrackingGeometryXML/genConf/InDetTrackingGeometryXML/$(confpy)
	@echo "Installing /afs/cern.ch/work/t/tkar/testarea/20.20.10.7/InnerDetector/InDetDetDescr/InDetTrackingGeometryXML/genConf/InDetTrackingGeometryXML in /afs/cern.ch/work/t/tkar/testarea/20.20.10.7/InstallArea/python" ; \
	 $(install_command) --exclude="*.py?" --exclude="__init__.py" --exclude="*.confdb" /afs/cern.ch/work/t/tkar/testarea/20.20.10.7/InnerDetector/InDetDetDescr/InDetTrackingGeometryXML/genConf/InDetTrackingGeometryXML /afs/cern.ch/work/t/tkar/testarea/20.20.10.7/InstallArea/python ; \

/afs/cern.ch/work/t/tkar/testarea/20.20.10.7/InnerDetector/InDetDetDescr/InDetTrackingGeometryXML/genConf/InDetTrackingGeometryXML/$(confpy) : $(conflib) /afs/cern.ch/work/t/tkar/testarea/20.20.10.7/InnerDetector/InDetDetDescr/InDetTrackingGeometryXML/genConf/InDetTrackingGeometryXML
	$(genconf_silent) $(genconfig_cmd)   -o /afs/cern.ch/work/t/tkar/testarea/20.20.10.7/InnerDetector/InDetDetDescr/InDetTrackingGeometryXML/genConf/InDetTrackingGeometryXML -p $(package) \
...
/afs/cern.ch/work/t/tkar/testarea/20.20.10.7/InnerDetector/InDetDetDescr/InDetTrackingGeometryXML/genConf/InDetTrackingGeometryXML:
	@ if [ ! -d /afs/cern.ch/work/t/tkar/testarea/20.20.10.7/InnerDetector/InDetDetDescr/InDetTrackingGeometryXML/genConf/InDetTrackingGeometryXML ] ; then mkdir -p /afs/cern.ch/work/t/tkar/testarea/20.20.10.7/InnerDetector/InDetDetDescr/InDetTrackingGeometryXML/genConf/InDetTrackingGeometryXML ; fi ;

InDetTrackingGeometryXMLConfclean :: InDetTrackingGeometryXMLConfuninstall
	$(cleanup_silent) $(remove_command) /afs/cern.ch/work/t/tkar/testarea/20.20.10.7/InnerDetector/InDetDetDescr/InDetTrackingGeometryXML/genConf/InDetTrackingGeometryXML/$(confpy) /afs/cern.ch/work/t/tkar/testarea/20.20.10.7/InnerDetector/InDetDetDescr/InDetTrackingGeometryXML/genConf/InDetTrackingGeometryXML/$(confdb)
